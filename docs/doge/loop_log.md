...
```text
### YYYY-MM-DDTHH:MM:SSZ ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick N
- Unit: [task_id / gap_id]
- Found: ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¦
- Wrote: [files/rows]
...
### 2026-07-19T00:00:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ bootstrap
- Unit: scaffold
...
### 2026-07-19T12:00:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 1
- Unit: rq_001 (L0 general government expenditure)
- Found: NAI/NBB EDP press release 2026-04-20 Table 1 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ 2025 total expenditure **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬347,956 million** (54.2% of GDP); primary **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬333,675 million** (52.0% GDP); GDP ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬642,015 million. 2024 total ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬335,100 million (54.1% GDP). Strong confidence, preliminary ESA estimate.
...
- Next: rq_002 L1 split by subsector (EDP PR has deficits by subsector, not full expenditure ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ need NBB.Stat/COFOG)

### 2026-07-19T12:30:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 2
- Unit: rq_002 (L1 expenditure by ESA subsector)
- Found: Eurostat `gov_10a_main` TE MIO_EUR BE (updated 2026-04-22, provisional). **2025 unconsolidated TE:** S.1311 central **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬181,526.1m**; S.1312 state **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬128,623.8m**; S.1313 local **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬44,986.7m**; S.1314 SS **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬141,680.4m**. Sum ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬496.8bn vs consolidated S.13 **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬347.956bn** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ gap ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ intergovernmental transfers (double-count if summed). 2024: 171675 / 125077 / 44491 / 135689 m EUR.
...
### 2026-07-19T13:00:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 3
- Unit: rq_003 (top 15 spending entities / holders)
- Found (mixed metrics ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ do not sum): ESA sectors 181.5 / 141.7 / 128.6 / 45.0 bn (2025 TE); **Flanders BO2026 uitgaven ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬66.0 bn**; **RIZIV global ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬45.222 bn** / care auth. **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬39.712 bn** (2025); **Wallonia initial 2025 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬22.029 bn**; FWB ~**ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬15 bn** (medium); GG interest **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬14.282 bn**; defence COFOG **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬8.8 bn**. Ranks 12ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ15 Unknown (Brussels city/ministries).
- Wrote: entity_rank_snapshot.csv; budgets.csv (+7); entities updates; sources (+5); rq_003=done; modeÃÂÃÂ¢ÃÂÃÂÃÂÃÂsprint2_taxex; ticks=3
- FOI opened: gap_bru_total_2025 (draft letter; not ready ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ missing recipient contacts)
- Next: rq_004 FPS tax expenditure inventory

### 2026-07-19T13:30:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 4
- Unit: rq_004 (FPS federal tax expenditure inventory)
- Found: Downloaded official XLSX (123619 bytes). Parsed 171 measures with latest-year values. **Top by ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬m:** CIT DTR **21936**; VAT basic necessities **10589**; CIT FDI capital gains **7193**; PIT pensions **4679**; VAT construction **3261**; CIT losses **1355**; **excise heating gas oil 1333**; CIT innovation **1208**; VAT horeca **1199**; ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¦ (years differ: PIT/WT 2026, EIWT/EXC 2024, CIT/VAT 2023).
...
### 2026-07-19T14:00:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 5
...
### 2026-07-19T14:30:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 6
- Unit: rq_006 (Flanders L5 discretionary sample)
- Found: **VRT basistoelage ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬296.4m/yr** (BHO 2026ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ2030; PQ 296.400 kEUR). **Jobbonus ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬228m** VEK BO2026. **Oosterweel ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬889.9m** BO2026 line. **Relance VV ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬436.4m**. Dienstencheques **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬151.4m reform line** (not full TCO). Subsidy-efficiency package **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬350m** cuts. Culture/equality L5 beneficiaries not in public top lists this tick.
...
- FOI opened: 3 new drafts (not ready ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ contacts TBD)
- Next: rq_007 federal cabinet / communication costs

### 2026-07-19T15:00:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 7
- Unit: gap_vl_cjsm_l5 (FOI draft finish ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ priority 8 before research)
- Found: Official Flanders FOI channel ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ **Team Openbaarheid van Bestuur**, **openbaarheid@vlaanderen.be**, Herman Teirlinckgebouw Havenlaan 88 bus 20, 1000 Brussel (vlaanderen.be openbaarheid page).
...
- FOI opened/updated: gap_vl_cjsm_l5 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ ready; human must fill identity and send
- Next: other prio-8 FOI drafts (dienstencheques) or rq_007 federal cabinets

### policy ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ commit/push each tick
- LOOP.md ÃÂÃÂÃÂÃÂ§6 and doge-loop skill require **git commit + push** after every tick that changes files.
- Old scheduler 019f7a359ff7 cancelled; then 019f7af13075 (30m); now **019f7c315adb every 15m** with commit/push.

### 2026-07-19T15:30:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 8
- Unit: gap_vl_dienstencheques_tco (FOI draft finish ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ priority 8)
...
- FOI: gap_vl_dienstencheques_tco ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ ready (not sent)
- Next: rq_007 federal cabinet / communication costs

### 2026-07-19T16:00:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 9
- Unit: rq_007 (federal cabinets + comms overhead)
- Found: Belga/Brussels Times (2025-02-14): **30% cabinet cut ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬21m/yr** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ implied baseline **~ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬70m** (medium). FTE **838 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ 586** target. No consolidated federal **communication** total found.
...
- FOI: gap_fed_cabinets_comms ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ ready (federal form; not sent)
- Next: rq_008 City Ghent project subsidies

### 2026-07-19T16:30:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 10
- Unit: rq_008 (Ghent L5 subsidies)
- Found: **NTGent** werkings **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬2,327,728** + investering **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬260,000**/yr (HLN). Structural culture **~ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬8m/yr** for **28** orgs. Culture pot **~ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬10m/yr** after **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1.4m** cut. MJP: **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬120m/yr** operating savings target + **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1bn** investments multi-year.
...
- FOI: gap_gent_subsidies_top20 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ ready (not sent)
- Next: rq_009 dual-structure overhead catalogue

### 2026-07-19T17:00:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 11
- Unit: rq_009 (dual-structure overhead catalogue)
- Found: **VRT ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬296.4m + RTBF ordinary ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬350.8m ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬647.2m** dual PSB (strong). Dual education communities (Flanders OV ~ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬20.3bn; FWB total ~ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬15bn partial). Multi-parliaments (cost TBD). Dual PES VDAB/FOREM/Actiris (TBD). Multi-layer econ agencies (TBD). ESA unconsolidated subsector sum premium **~ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬148.9bn** vs S.13 (transfer double-count scale ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ not cash waste).
...
### 2026-07-19T17:30:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 12
- Unit: rq_010 (multi-year commitment models)
- Found/modelled: Full **cash_by_year** JSON on multi-year rows ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ **VRT 2026ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ2030** flat 296.4m; **RTBF** 350.8m (3y illustrative); **RRF BE** 5.3bn planned / 3.3bn disbursed end-2025; **NTGent** + **Gent 28 orgs** 6y flat; Gent savings 120mÃÂÃÂÃÂÃÂ6. Single-year lines retained. Flat years tagged ILLUSTRATIVE where not year-stamped in source.
- Wrote: commitments.csv rewrite (12 rows); rq_010=done; new queue rq_011ÃÂÃÂ¢ÃÂÃÂÃÂÃÂrq_014; ticks=12
- FOI: none new
- Next: rq_013 company-car taxex (prio 8) or rq_011 Wallonia L5

### 2026-07-19T18:00:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 13
- Unit: rq_013 (company car tax expenditure)
- Found: Tax Foundation Europe (2025 research citing EU data): Belgium company-car **tax expenditures ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬2.3 bn in 2024** (0.37% GDP; 3.2% of federal TE; 13.2% of labour TE). FPS inventory export lacks a single full package line (only residual e.g. CIT business-car CG ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬12.4m; PIT electric cars ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬0.85m).
...
### 2026-07-19T18:30:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 14
- Unit: rq_011 (Wallonia L5 sample)
- Found: **AWEX ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬76m** constant budget; **facultative subsidies ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬8m** (2026); **structural savings ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬270.4m** (2026); **TEC/OTW ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬45m** cited (medium); **APE savings ~ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬83m** order (medium understatement). Wallonia total dÃÂÃÂÃÂÃÂ©penses initial 2025 already in budgets (ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬22.03bn).
...
### 2026-07-19T19:00:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 15
- Unit: rq_012 (VDAB / FOREM / Actiris budgets)
- Found: **Actiris ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬727m (2025) ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬689m (2026)** after ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬38m cut (strong). **VDAB** savings path **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬20m (2025) ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬40m (2027 accelerated) ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬80m by 2028**; total budget **~ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬790m medium** (10%/~ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬79m inference). **FOREM** total not found ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ FOI.
...
### 2026-07-19T19:30:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 16
- Unit: user priority middleman systems + rq_014 FOI ready
- Found/doctrine: **Cheque economy** (eco/meal/restricted vouchers) = state/tax favours pay that only buys limited goods + issuer sandwich ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ default should be **cash wages**. **Union-channelled chÃÂÃÂÃÂÃÂ´mage** = public benefit paid via multi-cashier private/associative channels ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ core state task; need unit-cost FOI. FPS inventory parse lacks clear meal/eco-cheque TE package line.
...
### 2026-07-19T20:00:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 17
...
### 2026-07-19T20:30:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 18
- Unit: rq_016 (unemployment payment channels)
- Found: Architecture confirmed ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ benefits paid via **union payment funds** or **Hulpkas**. Hulpkas **admin budget 2025 = ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬6,084,000** (strong official). Benefit stock separate from cashier admin. Union-fund public admin grants and **unit cost/dossier** still unknown ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ FOI ready.
...
- Next: queue empty of open research ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ spawn continuous tasks or work FOI draft backlog

### 2026-07-19T21:00:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 19
- Unit: rq_017 (Brussels BCR total expenditure)
- Found: Cour des comptes report 13 Mar 2026 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ SGRBC **crÃÂÃÂÃÂÃÂ©dits de liquidation ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬8.0 bn**, **engagement ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬8.9 bn** (2026). Major liquidation lines: **STIB ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1.168 bn**; pouvoirs locaux ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬758m; commissions communautaires ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬692m; **Actiris programme ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬648m**; dette ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬728m; titres-services ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬304m. SEC financing balance after ops **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬956.6 m**.
...
### 2026-07-19T21:15:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 20
- Unit: rq_018 (FOI drafts ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ ready batch)
- Found/done: Completed send-ready letters for **gap_multi_parliaments**, **gap_wal_l5_top_subsidies**, **gap_forem_budget**, **gap_vdab_full_budget**. gap_bru already answered. All high-value FOI now **ready** (not sent ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ human).
...
### 2026-07-19T21:30:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 21
- Unit: rq_019 (leaderboard recompute)
- Found: Recomputed cost_score from ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬ bands + priority_index for all rows; sorted CSV. **Top 5:** cheque economy 8.68 ÃÂÃÂÃÂÃÂ· heating oil 8.33 ÃÂÃÂÃÂÃÂ· company cars 8.22 ÃÂÃÂÃÂÃÂ· VAT horeca 7.73 ÃÂÃÂÃÂÃÂ· pro diesel 7.22. Snapshot `data/leaderboard_top15.md`.
- Wrote: leaderboard.csv sorted; leaderboard_top15.md; recompute script; rq_019=done; rq_020ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ022 queued; ticks=21
- FOI: none
- Next: rq_021 meal voucher TE secondary (prio 8)

### 2026-07-19T21:45:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 22
...
### 2026-07-20T00:15:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 23
- Unit: rq_020 (Oosterweel multi-year envelope)
- Found: Full project cost **~EUR 7.2 billion** (VRT NWS 2024 class / press consensus). Annual BO2026 correction line remains **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬889.859m** (centenboekje) ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ not the full TCO.
...
### 2026-07-20T00:30:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 24
- Unit: rq_022 (Antwerp L5 sample)
- Found: MJP **opex ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬2.2ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ2.4bn/yr**, **invest ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬2.4bn / 6y (ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬400m/yr)**. Gemeentefonds **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬807.2m** (2024). Toneelhuis city subsidy **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬2.74m/yr** (to 2025). Safety domain **~1/5 budget** (~ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬460m order, medium secondary).
...
- Next: queue empty ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ spawn more continuous tasks or idle_waiting_foi
- Note: tick 24 data was left uncommitted after research_queue wipe (permission error); restored queue + committed with tick 25.

### 2026-07-20T00:40:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 25
- Unit: rq_023 (Federal toelagenregister + NMBS PSO financing)
- Found: BOSA/VRT **federaal toelagenregister** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ **8ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¯993 items / ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬179.916 bn** federal transfers 2025 (not full federal spend). **Facultatieve subsidies ~ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬900m**; structural cut target **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬200m from 2029**. NMBS press 2025: **rail-sector savings ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬675m (2025ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ2029)**; debt ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1.532 bn; EBITDA ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬54.2m; **annual state exploitatievergoeding EUR total still not in public press**. 2026 rail cut **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬100m** (SNCB 60% / Infrabel 40%, Belga).
- Wrote: entities nmbs+infrabel; budgets; commitments; leaderboard lb_fed_facultative + lb_nmbs_pso_opacity; FOI gap_nmbs_annual_toelage ready; sources; rq_022 marked done; rq_023=done; queued rq_024ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ026; ticks=25
- FOI: gap_nmbs_annual_toelage ready (not sent)
- Next: rq_024 De Lijn annual subsidy or rq_026 NBB 25bn enterprise subsidies

### 2026-07-20T01:00:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 26
- Unit: rq_024 (De Lijn Flanders annual subsidy)
- Found: Official De Lijn press 2025: **dotatie ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬27.5m** (absolute total not stated); surplus **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬20k**; ticket revenue **+~10%**; passengers **372.9m**; Vlaamse extra **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬400m e-buses** (652 ordered); imposed savings **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬35.5m** + internal hefbomen **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬45m** recurrent 2026; fare-control revenue target **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬50m** 2026. Secondary press: **~ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1.14 bn** dotatie ÃÂÃÂ¢ÃÂÃÂÃÂÃÂvorig jaarÃÂÃÂ¢ÃÂÃÂÃÂÃÂ (2023 class, medium). Jaarverslag PDF URL public but download **403** this tick.
...
- Next: rq_026 NBB 25bn enterprise subsidies (prio 7) or rq_025 LiÃÂÃÂÃÂÃÂ¨ge L5

### 2026-07-20T01:20:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 27
- Unit: rq_026 (NBB enterprise subsidies 25bn deep dive)
- Found (NBB Economic Review 2025/9, strong): **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬25.1 bn** subsidies+investment grants to enterprises in **2024 (4.1% GDP)**. Split: **fed+SS subsidies ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬10.3 bn**; **C+R subsidies ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬11.3 bn**; **C+R inv. grants ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬2.1 bn**; **fed inv. grants ~ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬0.9 bn**. Flanders **~ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬6.8 bn** subsidies 2023; Wallonia **~ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬3.1 bn**; BCR **>~ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1 bn**. Federal subsidies 2023 **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬6.8 bn** (~2/3 tax remittance exemptions). SS wage **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬3.5 bn** 2023. **~2/3 package = wage subsidies** (BV non-remittance, SSC targets, dienstencheques). Wallonia L5: APE **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬543 m**, titres-services **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬534 m**, green cert **~ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬323 m**. Bpost **>ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬300 m** 2023; coalition NMBS **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬250 m by 2029**, bpost **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬50 m**. BE subsidies ~double euro-area on D.3 path.
- Wrote: entity bpost; budgets (package + regional L4 samples); commitments; leaderboard lb_nbb_ent_subsidies + wage block + bpost; PDF raw; sources; rq_026=done; queued rq_027ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ028; ticks=27
- FOI: none new (primary source rich)
- Next: rq_027 federal tax remittance exemption L5 or rq_025 LiÃÂÃÂÃÂÃÂ¨ge

### 2026-07-20T01:40:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 28
- Unit: rq_027 (Federal tax remittance exemption EIWT L5)
- Found (FPS inventory EIWT 2024, strong): **package sum ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬4.356 bn** (33 lines). Top: **night work ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1.010 bn**; R&D masters ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬601m; construction nightshift ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬416m; continuous work ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬367m; PhD researchers ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬330m; scientific institutions ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬266m; **shift work ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬244m**; universities research ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬229m; structural ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬218m; overtime ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬186m. Clusters: **night/shift ~ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬2.04 bn**; **R&D researchers ~ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1.60 bn**. Rekenhof Dec 2023: **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬3.9 bn in 2021** (vs ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬2.9 bn 2017); control/Belspo gaps. Aligns with NBB ~2/3 of federal ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬6.8 bn enterprise subsidies.
...
- Next: rq_025 LiÃÂÃÂÃÂÃÂ¨ge L5 or rq_028 bpost PSO

### 2026-07-20T02:00:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 29
- Unit: rq_025 (LiÃÂÃÂÃÂÃÂ¨ge city L5 subsidy sample)
- Found (Ville de LiÃÂÃÂÃÂÃÂ¨ge **budget service ordinaire 2026** PDF, strong): recettes **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬710.2 m**, dÃÂÃÂÃÂÃÂ©penses **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬685.6 m**, surplus **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬24.7 m** (ordinary perimeter ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ not consolidated). Culture dept total **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬12.4 m**. Named L5 city subsidies 2026: **OPRL ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬795k** (flat 2024ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ26); **OpÃÂÃÂÃÂÃÂ©ra Royal de Wallonie ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬428k**; **ThÃÂÃÂÃÂÃÂ©ÃÂÃÂÃÂÃÂ¢tre de LiÃÂÃÂÃÂÃÂ¨ge (Emulation) ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬263k**; **CIAC ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬180k**; Trianon/Art Wallon **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬114.75k** (cut from ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬150k). Press 1.1ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ1.2 bn figures likely broader perimeter.
...
### 2026-07-20T02:20:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 30
- Unit: rq_028 (bpost PSO multi-year subsidy path)
- Found: **Press concession ~ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬125 m/yr** (was ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬175 m); government scrap saves **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬125 m/yr from 2027**. Extension to **30 Jun 2024 budget ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬75.0 m** (bpost 4Q23 deck). NBB: bpost subsidies **>ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬300 m in 2023** (ESA package). Phase-out of newspaper delivery subsidy through **2027**. bpost: press revenues **~ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬50 m in 2024** (~ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬35 m less favourable contracts). Overcompensation provision **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬82.5 m** repay to State (fines/679/plates). Coalition **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬50 m** path on remaining bpost subsidies (NBB). Residual **USO compensation cash-by-year still opaque** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ FOI.
- Wrote: budgets; commitments; leaderboard; FOI gap_bpost_uso_split ready; sources; PDF raw; rq_028=done; queued rq_029ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ031; ticks=30
- FOI: gap_bpost_uso_split ready (not sent)
- Next: rq_030 offshore wind CfD (prio 7) or rq_029 city L5

### 2026-07-20T02:40:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 31
- Unit: rq_030 (Offshore wind federal support path)
- Found (Rekenhof Nov 2023, strong): eastern zone **2.26 GW / 9 parks**; cumulative **production support ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬3.41 bn** + **connection ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬209 m** = **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬3.62 bn** through end-2021; lifetime estimate **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬12.68 bn** (minister Feb 2020; EC notification had used ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬10 bn); degressivity cost to federal general means **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬989.6 m** (2013ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ2021); household offshore surcharge 2021 **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬49.49**; from 2022 financing via special excise + general means. CREG AR2023: **support cost 2023 = ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬179.4 m**; net production **8ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¯020 GWh**. Variable FiP parks saw reduced/zero support in high-price 2022ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ23 years (cap/clawback).
...
### 2026-07-20T03:00:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 32
- Unit: rq_031 (Maribel Social Funds)
- Found (NBB Econ Review 2025/9 Tables A1ÃÂÃÂ¢ÃÂÃÂÃÂÃÂA2, strong): **Maribel SS-sector ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¯460 m (2023) / ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¯461 m (2024)** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ nearly half of all SS enterprise subsidies (ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬3ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¯496 m total 2024). Federal Maribel add-on **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬56 m / ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬59 m**. Package **~ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1.52 bn 2024**. Purpose: extra jobs in non-profit healthcare/social/public services (late 1980s). Related SS wage lines: targeted SSC **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬926 m**; hospital employees **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬663 m**. Bonus same tables: **NMBS D.31 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¯127 m 2024** (was ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¯284 m 2023); **bpost ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬329 m 2024**; **offshore ESA ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬592 m 2024** (vs CREG 179.4 m 2023 different perimeter).
...
### 2026-07-20T03:20:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 33
- Unit: rq_029 (Brugge city L5 sample ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ chose Brugge over Charleroi for official MJP PDFs)
- Found (Stad Brugge **MJP 2026ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ2031**, strong, consolidated Stad+OCMW): total uitgaven **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬483.6 m** (2026); exploitatie **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬399.9 m**; investeringen **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬70.0 m**; Gemeentefonds **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬110.4 m**; cultuur BD10 **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬22.7 m**. Nominatieve L5 2026: **Politiezone ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬33.75 m**; **HVZ Zone 1 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬10.03 m**; **Brugge Plus loon ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬2.76 m** (+ overhead ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬0.61 m + event lines); **Concertgebouw werk ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬705k** + **invest onderhoud ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬720k/yr** + gevelschil **~ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬6.4 m** multi-year; **Entrepot ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬894k**; Stadsmakers **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬567k**; BMCC **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬639k**; Cercle invest **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1.0 m** 2026.
...
### 2026-07-20T03:40:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 34
- Unit: rq_033 (Charleroi city L5 / budget map)
- Found (council press medium): budget **~ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬567 m** balanced 2026; recettes propres **2025 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬577.9 m**; **4P transfers ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬240.3 m** (~38% of spend, path to 50% by 2030); Plan OxygÃÂÃÂÃÂÃÂ¨ne **~ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬48 m** Walloon aid; expenditure cut **~ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬40 m** (RTBF); invest borrowing only **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬20 m**; BSCA profit claim **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬25 m 2025** + passenger tax debate; PBA renovation request **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬7.6 m** (higher-tier grant, not confirmed city L5). Named third-party culture lines still weak publicly ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ FOI.
...
### 2026-07-20T04:00:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 35
- Unit: rq_032 (NBB annex A1 multi-year fill + reconciliation)
- Found (NBB Econ Review 2025/9 Table A1 NAI, strong): **NMBS D.31** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬965m (2000) / **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¯284 m (2023)** / **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¯127 m (2024)**; **NMBS D.92** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬784m / **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬767 m** / **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬830 m** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ package **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬2ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¯051 m (2023)** / **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¯957 m (2024)**. **bpost D.31** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬215m / **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬324 m** / **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬329 m**. **Offshore wind D.31** **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬283 m (2023)** / **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬592 m (2024)** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ vs CREG cash support **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬179.4 m (2023)** (perimeter gap). Federal public-enterprise D.3 total **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¯456 m (2024)**. FPS Kamer cash-line cross-check not found this tick ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ FOI remains + new rq_034.
- Wrote: multi-year budgets; commitments cash_by_year; leaderboard NMBS package (opacity closed); FOI priority tweaks; rq_032=done; queued rq_034ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ036; ticks=35
- FOI: gap_nmbs + gap_offshore updated notes (not sent)
- Next: rq_035 RIZIV top-line (prio 7) or rq_034 NMBS FPS cash

### 2026-07-20T04:20:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 36
- Unit: rq_035 (RIZIV care budget top-line)
- Found (RIZIV official 20 Oct 2025, strong): **2026 global VGV ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬46.775 bn**; **authorized geneeskundige verstrekkingen ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬40.986 bn** (+ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1.274 bn / **+3.2%** vs 2025). Prior year anchors kept: global **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬45.222 bn** / care **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬39.712 bn** (2025). **Correction package ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬470.775 m** for 2026 (drugs ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬227.9 m, doctors ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬150 m, hospitals ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬50 m, ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¦). Health index honoraria **2.72%**. Non-care effort **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬33.5 m**. Core entitlement ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ efficiency audits not crude abolition.
...
### 2026-07-20T04:40:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 37
- Unit: rq_034 (FPS/BOSA federal budget NMBS cross-check)
- Found: **Exact Kamer/FPS article codes for NMBS cash lines not in public summary this tick.** Best reconciliation remains **NBB ESA A1** (D.31+D.92 **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1.957 bn 2024**). **FPB (BOSA initial 2026):** federal **subsidies ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬7.9 bn**; **investments ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬6.5 bn** of which **~17% ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Infrabel = ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1.105 bn** (Infrabel in GG; NMBS outside). FPB cites NBB: NMBS+bpost top public-enterprise subsidy recipients. **Savings path** (VRT medium): **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬188 m** next year ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬663 m** structural end legislature (not MRÃÂÃÂ¢ÃÂÃÂÃÂÃÂs ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬2.1 bn). Standaard medium: NMBS personnel **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1.34 bn** ~half opex.
...
### 2026-07-20T05:00:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 38
- Unit: rq_036 (Company cars FPS package deep lines)
- Found: **Full package still only secondary ~ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬2.3 bn (2024)** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ not a single FPS inventory line. Explicit FPS **car-named residual** sum **~ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬13 m** (CIT business cars CG ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬12.44 m + electric cars ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬0.85 m + small VAT invalids). Related mobility taxex now mapped: **professional diesel ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬557.83 m**; industrial gas oil motor **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬312.54 m**; commuting public **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬376.84 m**; other commute **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬155.33 m**; bike commute **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬126.89 m**. Opacity of official BIK/SSC/PIT package decomposition ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ FOI prio 9.
- Wrote: taxex residual sum + pro diesel + mobility lines; leaderboard note; FOI gap_company_cars_te_package ready; rq_036=done; queued rq_037ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ039; ticks=38
- FOI: gap_company_cars_te_package ready (not sent)
- Next: rq_038 defence (prio 7) or rq_037 pro diesel phase-out

### 2026-07-20T05:20:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 39
- Unit: rq_038 (Defence expenditure latest)
- Found (Strategische Visie Defensie 2025 official, strong): **2% GDP defence effort from 2025** (halt any decline) ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ **2.5% by 2034**. Capacity portfolio **2026ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ2034**: vastlegging **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬33.784 bn** / vereffening **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬24.661 bn** (constant ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬2026). Structure target ~35% personnel / 40% ops / 25% investment by 2035. Existing **NAI COFOG ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬8.8 bn (2025, 1.14% GDP)** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ  NATO cash perimeter. **FPB/BOSA 2026:** ~**71% of ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬6.5 bn federal invest ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Defence = ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬4.615 bn**. Secondary: ~**ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬12.8 bn** NATO-path 2025 (press); SIPRI ~**$14.5 bn / ~2.0% GDP**. Core public good ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ procurement efficiency not crude cut.
...
### 2026-07-20T05:40:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 40
- Unit: rq_037 (Professional diesel phase-out path)
- Found: Refund rates **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬0.1935/l (2024)** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬0.1924 (2025)** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬0.1913 (2026)** (slow). Peak path from **~ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬0.2476/l** (2020ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ21 class). **FPS taxex inventory 2024: ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬557.83 m**. **FPS FFS inventory 2026 (benchmark1): ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬831.2 m** professional diesel. **2021 revenue loss ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬905.8 m** (climat.be/FPS). Bonus same FFS table: **company cars ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬3,141.7 m (2024)** PIT+VAT+SSC official (supersedes 2.3bn secondary); fuel cards **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬661.6 m**; total direct FFS **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬10.78 bn (1.7% GDP)**.
...
### 2026-07-20T06:00:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 41
- Unit: rq_039 (GG interest expense multi-year)
- Found (NAI EDP Table 1, strong, Apr 2026): interest expense **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬8.581 bn (2021)** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬8.755 bn (2022)** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬11.677 bn (2023)** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬13.524 bn (2024)** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬14.282 bn (2025)** = **2.2% GDP** last two years. Fourth consecutive absolute rise. Context: deficit **5.2% GDP**, debt **107.9% GDP** end-2025. **FPB:** federal Entity I interest **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬12.3 bn** in 2026 initial budget. Not waste ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ cost of past deficits; fix is primary surplus.
- Wrote: multi-year budgets 2021ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ25 + federal 2026; commitment; leaderboard; EDP PDF raw; source note; rq_039=done; queued rq_040ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ042; ticks=41
- FOI: none
- Next: rq_040 fuel cards FFS or rq_041 debt path

### 2026-07-20T06:20:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 42
- Unit: rq_040 (Fuel cards FFS multi-year)
- Found (FPS FFS inventory 2026 Table 3, strong): **Fuel cards PIT+SSC** **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬688.2 m (2021)** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1,119.3 m (2022 peak)** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬852.8 m (2023)** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬661.6 m (2024)** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ decline attributed to **fleet electrification**. **VAT fuel cards ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬52.8 m (2024)**. **EV charging cards** rising **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬20.8 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬59.4 m**. Full fuel+charge package **~ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬775 m (2024)**. Also filled **pro diesel FFS series** 1052/558/773/831 m 2021ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ24. Transport sector: fuel cards + pro diesel dominate direct FFS.
...
### 2026-07-20T06:40:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 43
- Unit: rq_041 (GG debt path and snowball risk)
- Found (strong): **NAI EDP Apr 2026** debt **107.9% GDP** end-2025 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ **~ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬692.7 bn** (0.1079 ÃÂÃÂÃÂÃÂ GDP ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬642.015 bn). Deficit **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ5.2% GDP**; interest flow **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬14.282 bn** (2.2% GDP). **NBB Jun 2026 projections** (cut-off 22 May 2026): debt **111.3% / 112.9% / 114.8%** for 2026ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ28 (~**115%** by 2028); deficit path **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ5.2 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ5.3 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ5.5 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ5.7%**. **FPB Jun 2025** (older horizon): deficit **5.4% ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ 6.5% by 2030**; debt **~120% GDP by 2030**. Snowball: primary deficit persists while interest rises ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ ratio climbs; fix is **primary surplus**, not labelling debt as L5 waste.
- Wrote: budgets debt stock+ratio path+deficit; commitment cmt_gg_debt_path; leaderboard lb_gg_debt_stock; entity gg_debt; sources NBB/FPB; rq_041=done; queued rq_043ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ044; ticks=43
- FOI: none
- Next: rq_042 Flanders BO2026 confirm or rq_043 Debt Agency EUR stock

### 2026-07-20T07:00:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 44
- Unit: rq_042 (Flanders total expenditure BO2026 confirm)
- Found (strong): **DFB official page + parliament vote (Jan 2026):** BO2026 uitgaven **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬66.0 bn**; **OV+WVG = 58%**. **Evaluatierapport:** consolidated **VEK ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬66.03 bn** (BA2025 **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬66.47 bn**; constant-policy would be **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬67.05 bn** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ measures cut **~ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1.01 bn**); **VAK ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬64.75 bn**. **Receipts ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬61.6 bn**; **ESR saldo ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬2.9 bn** (ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1.7 bn after doelstelling corrections). Deltas: index **+ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬718.9 m**; VV **+ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬370.9 m**; rente **+ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬323.5 m**; retro premie **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬301.6 m**; subsidies **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬210 m**. Entity rank #4 reconfirmed (budgeted, not ESA TE).
...
### 2026-07-20T07:20:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 45
- Unit: rq_043 (Federal Debt Agency Entity I stock)
- Found (BDA Review 2025/Outlook 2026 PDF, strong): federal gross debt **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬518.68 bn (end-2024)** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬552.69 bn (end-2025)** **+ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬34.0 bn**. Composition end-2025: **OLO ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬462.8 bn**; TC **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬42.9 bn**. **Avg life 10.38 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ 9.98 years**; duration **8.43 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ 7.27 y**; fixed rate **87.4%**; 12m refinancing risk **15.64%** (cap 17.5%); financial cost at issuance (EUR) **2.01%**. Gross borrow 2025 **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬53.31 bn** / net **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬28.35 bn**. Plan 2026: gross **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬59.55 bn** / net **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬26.37 bn** / OLO issue **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬51.60 bn**. Live BDA site (medium): **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬567.615 bn** on **2026-06-30**. Perimeter: federal BDA **~80%** of GG ESA **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬692.7 bn** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ do not double-count.
...
### 2026-07-20T07:40:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 46
- Unit: rq_044 (Primary balance path vs debt-stabilising)
- Found (strong): **NBB Jun 2026 projections** primary balance **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ2.9% / ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ2.8% / ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ2.7% / ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ2.7%** GDP for **2025ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ28** while overall deficit widens **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ5.2 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ5.7%** (interest wedge growing). Debt **107.9 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ 114.8%**. **IMF Art IV 2025**: primary ~**3.1 ppt of GDP below** debt-stabilising primary of **+0.3% GDP** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ gap ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬19.9 bn** (0.031 ÃÂÃÂÃÂÃÂ GDP ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬642.0 bn). **NBB Review 2025/11**: snowball = (rÃÂÃÂ¢ÃÂÃÂÃÂÃÂg)ÃÂÃÂÃÂÃÂdebt ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ primary; with **r>g** and primary deficit, debt path explosive unless primary improves. **EC/MTFSP**: planned structural primary improvement **+2.4 pp 2025ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ29** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ delivery still open. Not L5 waste: the DOGE north star for fiscal math.
...
### 2026-07-20T08:00:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 47
- Unit: rq_045 (Flanders BA2026 adaptation)
- Found (Rekenhof Jun 2026 + Vlaams Parlement, strong): BA2026 ESR **ontvangsten ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬62.2 bn** / **uitgaven ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬67.1 bn** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ **vorderingensaldo ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬3.6 bn** (BO was ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬2.9 bn). Vs begrotingsdoelstelling (excl Oosterweel+relance): **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬2.18 bn** (was ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1.7 bn). Deltas vs BO: VEK **+ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1.081 bn**, VAK **+ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬3.034 bn** (Lantis/Oosterweel VAK **+ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬2.514 bn**); index VEK **+ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬324.5 m**; Fluvius VEK **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1.1 bn**. OV **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬20.2 bn VEK** / WVG **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬17.8 bn VEK**. Schuld **+ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬6.8 bn** (+13.5% y/y); rating AA-. Entity rank #4 updated to **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬67.1 bn**.
...
### 2026-07-20T08:20:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 48
- Unit: rq_046 (Belgium MTFSP structural primary + net expenditure path)
- Found (official MTFSP PDF + Council rec Jun 2025, strong): **Structural primary balance** plan **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ1.8 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ1.2 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ0.7 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ 0.0 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ +0.6% GDP (2025ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ29)** = **+2.4 pp** (matches EC country-report phrasing). **Net nationally financed primary expenditure growth**: **3.6 / 2.5 / 2.5 / 2.1 / 2.1%** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ **5y avg 2.56%** (EC ref 2.53%). **Deficit path** to **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ3.0% GDP by 2029**; plan debt peaks **107.3%** then **106.7%** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ **actual 2025 already 107.9%** and NBB primary **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ2.9%** worse than plan **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ2.4%**. 7-year adjustment; Entity I/II split deferred (OverlegcomitÃÂÃÂÃÂÃÂ© Mar 2025 commitment). Delivery risk is the DOGE angle ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ not a waste line.
...
### 2026-07-20T08:40:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 49
- Unit: rq_047 (Flanders consolidated Maastricht debt path)
- Found (Rekenhof Table 14, strong): consolidated Maastricht debt **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬50.172 bn (end-2025)** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬56.552 bn (BO2026)** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬56.971 bn (BA2026)** = **+ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬6.799 bn / +13.5%** y/y. **Direct MVG debt** **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬42.397 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬49.802 bn** (+ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬7.405 bn). Components BA2026: consolidated entities financial **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬7.17 bn**; PPS **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬0.64 bn**; green certs **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬0.55 bn**; intra/inter-sector holdings corrections **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬11.38 bn**. Debt/receipts **91.6%** (old schuldnorm target **<65%**). Netto-actief end-2024 **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬13.3 bn**. Ratings: Fitch **AA-** (stable); S&P **AA-**; MoodyÃÂÃÂ¢ÃÂÃÂÃÂÃÂs **A1**. Drivers: deficit, Oosterweel, relance, ESR 8/9 (Fluvius, social housingÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¦). Non-Maastricht federal claims: hospital infra **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬2.184 bn** + autonomiefactor **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬0.474 bn** (not in stock).
...
### 2026-07-20T09:00:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 50
- Unit: rq_048 (Entity I vs II MTFSP effort split)
- Found (strong): **MTFSP Mar 2025** deferred Entity I/II split. **HRF Apr 2025** (recalc of Jul 2024): **verdeelsleutel 3** = share of (final primary expenditure + own receipts) ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ preferred key. Differentiated **max net primary exp growth %** (7y path): **Entity I avg 2.72%** (2025 **3.81%**, 2026 **2.96%**); **Flanders 2.68%** (3.63 / 2.17); **FWB 1.52%**; **Wallonia 1.45%**; **Brussels ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ0.22%** (very tight); **DG negative**. **OverlegcomitÃÂÃÂÃÂÃÂ© Mar 2026** SWA: uses sleutel 3 for current plan; **fallback binding targets** if no agreement; control accounts via HRF; **defence national escape clause fully to federal** (Rekenhof/APR). GG outturn path still **3.8% / 2.0%** net exp 2025ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ26 (cumul 5.9% < 6.1% cap, APR). Parliaments still ratifying SWA.
...
### 2026-07-20T09:20:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 51
- Unit: rq_049 (Flanders non-Maastricht federal claims)
- Found (Rekenhof BA2026 ÃÂÃÂÃÂÃÂ§5.1, strong): Flanders owes federal government **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬2.1843 bn** (ziekenhuisinfrastructuur) + **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬473.8 m** (definitieve vaststelling **autonomiefactor**) = **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬2.658 bn** total. **Excluded from Maastricht** consolidated debt (ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬56.97 bn). Rekenhof: these stocks are **no longer reported in de algemene toelichting**; recommends Vlaams Parlement be kept informed. Multi-year amortisation cash-by-year **not public** this tick ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ FOI.
- Wrote: three budget rows; commitment; leaderboard; FOI gap_vl_non_maastricht_claims **ready** (not sent); rq_049=done; ticks=51
- FOI: gap_vl_non_maastricht_claims ready ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ human send only
- Next: rq_050 SWA ratification / control accounts

### 2026-07-20T09:40:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 52
- Unit: rq_050 (SWA ratification + Entity control accounts)
- Found (strong/medium): **SWA timeline** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ OverlegcomitÃÂÃÂÃÂÃÂ© **27 Mar 2026** draft economic-governance SWA (replaces **13 Dec 2013**); **Flanders government 8 May 2026** principal OK + draft assent decree ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ SERV/RvS; **federal Ministerraad 13 May 2026** draft assent law (secondary reports); **SERV advice Jun 2026**; Rekenhof Jun 2026: still needs each entity government + **parliament** assent ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ **full multi-parliament ratification not confirmed** this tick. **Entity I control account** (Kamer 56K1468, budget-basis approx): net exp **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬190.3 bn (2025) / ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬196.9 bn (2026)**; growth **4.6% / 2.3%** vs HRF **3.81% / 2.96%**; annual deviation **+ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1.5 / ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1.3 bn**; cumul after defence flex **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ0.30% / ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ0.71% GDP** (under norm). Official HRF multi-entity public ledgers not yet a complete published suite.
- Wrote: Entity I net-exp + control budgets; commitment/leaderboard update; sources + Kamer PDF; rq_050=done; queued rq_051ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ052; ticks=52
- FOI: none
- Next: rq_052 Flanders net-exp vs 2.17% cap (prio 4) or rq_051 regional SWA assent

### 2026-07-20T10:00:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 53
- Unit: rq_052 (Flanders HRF net-exp compliance vs 2.17% cap)
- Found (BO2026 Algemene Toelichting Table 10 via eval/SERV, strong): HRF-concept **finale primaire uitgaven ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬63.047 bn (2025) / ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬62.106 bn (2026)**; **netto-uitgaven ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬62.036 / ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬61.296 bn**; after DRM **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬60.761 bn (2026)**; **growth ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ2.1%** vs **HRF sleutel 3 cap +2.17%** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ **margin ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ4.23 pp** (clearly **compliant** at BO). SERV: ÃÂÃÂ¢ÃÂÃÂÃÂÃÂlijkt te voldoenÃÂÃÂ¢ÃÂÃÂÃÂÃÂ. **BA2026 (Rekenhof)**: calculation in Ch.VI still cited but **not on final BA numbers** (uses DBP/process estimates; admin lacks APR microdata) ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ method lag, not a re-computed growth % this tick. Do not invent BA growth.
...
### 2026-07-20T10:20:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 54
- Unit: rq_053 (Wallonia total expenditure 2026 initial)
- Found (ExpGen budget initial 2026 official PDF, strong): **dÃÂÃÂÃÂÃÂ©penses ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬21.335748 bn** (was ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬22.029416 bn 2025 init, **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬694 m**); **recettes ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬18.515734 bn**; **solde brut ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬2.820 bn**; **solde SEC ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬2.015736 bn** (path ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ2.015 / ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ1.124 / ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ0.600 / +0.039 bn 2026ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ29). Structural savings **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬270.4 m**. Net primary exp **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬19.463 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬19.056 bn** growth **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ2.09%** vs CSF key cap **+0.92%** (~3 pp under, indicative). Entity rank #8 updated to 2026 envelope.
...
### 2026-07-20T10:40:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 55
- Unit: rq_054 (FWB total expenditure 2026 primary source)
- Found (DGBF ÃÂÃÂÃÂÃÂ©lÃÂÃÂÃÂÃÂ©ments-clÃÂÃÂÃÂÃÂ©s official, strong): **initial 2026** recettes **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬13.602 bn** / dÃÂÃÂÃÂÃÂ©penses liquidation **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬15.406879 bn** / solde brut **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1.667 bn** / **SEC ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1.608 bn**. Breakdown: Education-Recherche-Formation **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬10.929 bn**; SantÃÂÃÂÃÂÃÂ©-Culture-Sport **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬2.325 bn**; Services gÃÂÃÂÃÂÃÂ©nÃÂÃÂÃÂÃÂ©raux **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1.185 bn**; dette publique **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬0.393 bn**; dotations RW/COCOF **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬0.575 bn**. Multiyear SEC path **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ1.608 / ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ1.405 / ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ1.390 / ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ1.224 bn** (2026ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ29). **Adjusted 2026** (gov press 30 Apr): recettes **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬13.67 bn** / dÃÂÃÂÃÂÃÂ©penses **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬15.59 bn** / deficit **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1.77 bn** (+ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬160 m vs initial 1.61). Supersedes medium ~ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬15 bn press estimate. Entity rank #9 updated strong.
...
### 2026-07-20T11:00:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 56
- Unit: rq_055 (Brussels region 2026 total vs SGRBC 8bn)
- Found (Cour des comptes Budgets RBC 2026, strong): reconfirmed **SGRBC crÃÂÃÂÃÂÃÂ©dits liquidation ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬8.0 bn** / **engagement ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬8.9 bn** (+1.2% / +6.0% vs crÃÂÃÂÃÂÃÂ©dits provisoires 2025). **Solde financement SEC** entitÃÂÃÂÃÂÃÂ© rÃÂÃÂÃÂÃÂ©gionale **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬956.6 m** (gov; Cour content-diff **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬978.2 m**). **Solde net ÃÂÃÂÃÂÃÂ  financer** SGRBC **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1.746 bn**. **Dette consolidÃÂÃÂÃÂÃÂ©e ~ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬16.1 bn** end-2025 (+ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬3.5 bn 2023ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ25); direct LT **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬13.4 bn**; path cap +ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬3 bn to **>ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬19.1 bn** by 2029. Top lines: **STIB ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1.168 bn**; Actiris **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬648 m**; commissions communautaires **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬692 m**; dettes service **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬728 m** liq. HRF net primary path for BCR **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ0.61% 2026** not reported in exposÃÂÃÂÃÂÃÂ© ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ rq_056. Dual perimeter: SGRBC 8.0bn ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ  press ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ7.6/6.6 bnÃÂÃÂ¢ÃÂÃÂÃÂÃÂ manoeuvrable figures.
...
### 2026-07-20T11:20:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 57
- Unit: rq_056 (Brussels net primary exp vs HRF ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ0.61%)
- Found (strong): **HRF Apr 2025** BCR (+locals) net primary growth caps: **+2.03% (2025)** / **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ0.61% (2026)** / avg **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ0.22% (2025ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ31)** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tightest large entity path. **Cour des comptes Budgets RBC 2026**: exposÃÂÃÂÃÂÃÂ© confirms multi-year spending cuts narrative but **does not publish** the EU/HRF **dÃÂÃÂÃÂÃÂ©penses primaires nettes** growth rate ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ compliance **cannot be scored** from public budget tables alone. **SGRBC liquidation +1.2%** (Cour) is a **different metric** (gross credits) ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ not a substitute for net-primary compliance (do not invent a verdict). FOI for official calculation.
...
### 2026-07-20T11:40:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 58
- Unit: rq_057 (STIB multi-year regional financing)
- Found (strong): **Regional programme 42.112** budget 2026 **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1.167619 bn** (+ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬51.3 m vs 2025 provisional). **STIB statutory accounts ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Intervention RBC fonctionnement**: **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬546.1 m (2023)** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬633.1 m (2024)** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬642.5 m (2025)** (not equal to full 42.112 package). **Capital grants** recognized **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬348.9 m (2025)**. **Investment programme** executed **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬475 m (2024)** / **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬427.4 m (2025)**; **PPI path** **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬591.5 / 666.1 / 768.6 / 724.4 m (2026ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ29)** but Cour: must cut **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬964.6 m** vs STIB 2025 PPI plan (Metro 3 + other arbitrages). Compare De Lijn: still **~ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1.14 bn class medium** + FOI gap_de_lijn_dotatie. Dual perimeter: company opex intervention ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ  regional budget line.
...
### 2026-07-20T12:00:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 59
- Unit: rq_058 (TEC/OTW Wallonia multi-year subsidy)
- Found (strong dual-perimeter): **Minister Henry PQ 596** (Apr 2024): OTW **financing ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬960 m (2024)** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1.003 bn (2028)** indexation; **+ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬200 m** step 2023ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ24; **invest plan ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1.586 bn (2024ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ28)**. **Cour des comptes RW BI2025**: OTW **company recettes ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1.088.8 m / dÃÂÃÂÃÂÃÂ©penses ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1.200.6 m**; SEC recettes ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1.018.4 m / solde **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬139.4 m**; regional **programme 14.045** CL **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬813.7 m (2024) ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬861.1 m (2025)**. **Dolimont** official: **+ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬45 m 2025 vs 2024 hors PRW** (corrects earlier ÃÂÃÂ¢ÃÂÃÂÃÂÃÂcutÃÂÃÂ¢ÃÂÃÂÃÂÃÂ mislabel). **Desquesnes CSP note Dec 2025**: rewrite 2026ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ29; coverage **10%ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¥14% by 2030**; internal savings **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬20 m by 2029**; TÃÂÃÂÃÂÃÂ D **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬22 m 2028ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ29**. Absolute AB cash series 2023ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ26 + 2026 CSP socle still incomplete ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ FOI.
...
### 2026-07-20T12:15:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 60
- Unit: rq_051 (Wallonia / FWB / Brussels SWA economic-governance assent)
- Found (strong government track; weak final votes): **OverlegcomitÃÂÃÂÃÂÃÂ© 27 Mar 2026** closed multi-entity SWA (replaces 2013). **FWB gouvernement 30 Apr 2026** ODJ point 14: **1st reading** avant-projet dÃÂÃÂÃÂÃÂ©cret assentiment (Doc 1589). **Wallonie GW 13 May 2026** ODJ B5: **1st reading** avant-projets dÃÂÃÂÃÂÃÂ©crets assentiment (Doc 2760). **Federal Ministerraad 13 May 2026**: avant-projet de **loi** assentiment approved (Van Peteghem). **Flanders** 8 May principal + SERV advice **1 Jun 2026**. **PFWB commission** (Degryse): all entities agreed text; legislative path aimed **summer multi-parliament**; uses **HRF mixte clÃÂÃÂÃÂÃÂ©**; WAL/FWB may split shared norm; default future key 50/50 CSF+BE. **Dolimont PQ 30 Mar** still pre-deal (negotiation). **Brussels** government/parliament public assent dossier **not found** this tick. **No final adopted assent law/decree** found for any parliament as of tick.
...
### 2026-07-20T12:30:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 61
- Unit: rq_060 (Wallonia net primary exp vs HRF)
- Found (strong): **HRF Apr 2025 sleutel 3** Waals Gewest (+locals): max net primary growth **2.65% (2025) / 0.92% (2026)** / avg **1.45% (2025ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ31)**. **ExpGen BI2026 Table 3**: dÃÂÃÂÃÂÃÂ©penses primaires nettes **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬19.463 bn (2025) ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬19.056 bn (2026)**; growth **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ2.09%** vs norme CSF/HRF **+0.92%** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ **margin ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ3.01 pp** (clearly **compliant** / under cap). Breakdown: total exp 20.973ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ20.694; ÃÂÃÂ¢ÃÂÃÂÃÂÃÂinterest ÃÂÃÂ¢ÃÂÃÂÃÂÃÂEU ÃÂÃÂ¢ÃÂÃÂÃÂÃÂcofin ÃÂÃÂ¢ÃÂÃÂÃÂÃÂDRM ÃÂÃÂ¢ÃÂÃÂÃÂÃÂone-off. ExpGen noted key still uncertain at budget drafting (pre-SWA); post-tick-60 SWA confirms mixte HRF key applies. Parallel Flanders BO: ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ2.1% vs 2.17% cap; Brussels still FOI opaque.
...
### 2026-07-20T12:45:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 62
- Unit: rq_061 (FWB net primary exp vs HRF 0.74%)
- Found (strong cap; strong opacity): **HRF sleutel 3** Franse Gemeenschap: **2.75% (2025) / 0.74% (2026)** / avg **1.52%**. **DGBF ÃÂÃÂÃÂÃÂ©lÃÂÃÂÃÂÃÂ©ments-clÃÂÃÂÃÂÃÂ©s 2026**: dep **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬15.407 bn** / recettes **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬13.602 bn** / SEC **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1.608 bn** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ **no** net-primary growth table. **Cour des comptes** (PFWB commission on adj 2025): exposÃÂÃÂÃÂÃÂ© **omits** dÃÂÃÂÃÂÃÂ©penses primaires nettes vs CSF **2.75%**; gov acknowledged and **postponed** integration / said would not compare to CSF given joint WALÃÂÃÂ¢ÃÂÃÂÃÂÃÂFWB path. Adjusted 2026 press: dep **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬15.59 bn** deficit **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1.77 bn** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ still not net-primary. **Cannot score compliance** without inventing euros (do not use gross dep growth as proxy). Parallel: Flanders/Wallonia published tables; Brussels FOI already.
...
### 2026-07-20T13:00:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 63
- Unit: rq_062 (Namur city L5 subsidy sample)
- Found (strong, official DGF note BI2026, Conseil 16 Dec 2025): **Recettes ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬301.394 m** / **dÃÂÃÂÃÂÃÂ©penses ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬300.761 m** / **boni exercice propre ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬0.633 m**. **Structural deficit ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬19.809 m** after stripping Plan OxygÃÂÃÂÃÂÃÂ¨ne exceptional + CPAS provision. **OxygÃÂÃÂÃÂÃÂ¨ne draw ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬45.678 m** (max 2026 + solde 2024). Transfers: **CPAS ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬24.15 m**; **Police ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬27.59 m**; **Secours NAGE ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬6.24 m**. **Monde associatif ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬8.471 m (ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ9.82% / ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬0.923 m)** with full L5 table: **SONEFA ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬2.633 m** (protected); **CCR ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬0.715 m**; **piÃÂÃÂÃÂÃÂ©tonnier primes ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬0.700 m**; **NEW ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬0.414 m**; **OTN ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬0.397 m**; **CAC ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬0.360 m**; **Namur 2030 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬0.500 m** full cut; linear **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ20%** associations / **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ10%** para-communal. Fabriques dÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ©glise **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1.418 m**. Open data `subsides-attribues` only to **2020** (stale). Mons deferred to rq_063.
- Wrote: entity city_namur; 19 budgets; 2 commitments; leaderboard OxygÃÂÃÂÃÂÃÂ¨ne; sources + DGF PDF raw; rq_062=done; seeded rq_063 Mons; ticks=63
- FOI: none (2026 L5 table public; open-data lag noted)
- Next: rq_063 Mons L5 or rq_059 final SWA votes

### 2026-07-20T13:15:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 64
- Unit: rq_063 (Mons city L5 subsidy sample)
- Found (mixed): **MonsMag #133** (official Ville de Mons): BI2026 **recettes ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬242.5 m**, **boni ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬2.1 m**, departmental **economies ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬8 m**, Plan OxygÃÂÃÂÃÂÃÂ¨ne **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬27 m**, invest **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬12 m**, exceptional precarity aid **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬200k**, Walloon cut **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬5 m**, **4P ~ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬25 m** narrative. **CPAS ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬27.7 m (+ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬2.1 m)** RTBF quoting collÃÂÃÂÃÂÃÂ¨ge (medium). **Official full BI2026 PDF not on mons.be** (archives stop at 2024 presentations; compte 2025 published). **Budget 2025 strong**: recettes **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬246.24 m** / dÃÂÃÂÃÂÃÂ©penses **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬244.18 m**. **L5 2025** (article lines): MARS fonct **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬400k** + music **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬124k** + anim **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬150k**; Basket UMH **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬220k** + sponsor **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬250k**; RCA **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬380k**; Film festival **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬45k**.
...
### 2026-07-21T08:00:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 65
- Unit: rq_064 (Plan OxygÃÂÃÂÃÂÃÂ¨ne multi-city envelope)
- Found (strong dual track): **Collignon PQ Feb 2023**: 34 communes requested **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1.791 bn** cumul 2022ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ26; GW validated **tranche 2022 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬302.1 m** for **21 communes** (interest full + 15% capital for 16/21). **Desquesnes Jul 2025**: first **2025 bank lot ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬66.1 m** / **15 communes** (ING **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬40.86 m** 13c; Belfius **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬25.29 m** Tournai+Verviers) with named amounts (e.g. Herstal **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬8.52 m**, Verviers **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬19.25 m**, Huy **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬6.01 m**). **Desquesnes CRI Dec 2025**: 6 large cities without bank offer ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ **CRAC borrows ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬210 m** (2ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬105 m) and on-lends **2025** draw rights; regional cost ~**ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬25 m/yr** for 21 communes. City samples already: Namur **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬45.7 m** 2026 strong; Mons **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬27 m** Mag; Charleroi ~**ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬48 m** medium. Full multi-year per-commune table still incomplete ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ FOI.
...
### 2026-07-21T08:20:00Z ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½ tick 66
- Unit: rq_065 (FEDER Wallonia named project L5 sample)
- Found (strong, official RÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½sumÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½ citoyen 2025 WalEurope PDF): **Programme invest class ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½1.488 bn** (EU **~ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½600 m**); **FTJ envelope ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½456 m** (EU **~ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½183 m**, Charleroi/Mons/Tournai); **374 FEDER + 62 FTJ** public projects retained. Named L5 grants (total / FEDER / Wallonie): **Campus4U Charleroi HELHa+UCLouvain ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½21.302 m / ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½8.521 m / ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½12.781 m**; **LiÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½ge Fontainebleau/Sainte-Marguerite ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½10.032 m / ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½4.459 m / ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½5.574 m**; **Namur ville apaisÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½e portfolio ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½5.019 m / ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½2.231 m / ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½2.789 m**; **DUNE3S ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½3.989 m / ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½1.835 m / ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½2.154 m**; **IDEA CLICK Mons ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½0.566 m**; **Arlon cyclo-piÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½ton ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½0.521 m**; **Cap Innove ID2GREEN ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½0.226 m**; **ICE Louvain ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½0.223 m**. Co-financed investment ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½ **not pure waste**; residual issue is incomplete machine-readable full L5 cash list (resume samples only).
...
### 2026-07-21T08:35:00Z ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½ tick 67
- Unit: rq_059 (multi-parliament final SWA economic-governance assent votes)
- Found (strong process; **no final votes**): Reconfirmed OverlegcomitÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½ **27 Mar 2026** SWA (replaces 2013); **VL Regering 8 May** principal OK voorontwerp decree; **SERV 1 Jun** advice; **Vlaams Parlement Ingekomen 60-Nr.33 (17 Jun 2026)** only registers SERV mededeling ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½ **not** a plenary-adopted instemmingsdecreet. Federal **MR 13 May** avant-projet de loi; **FWB 30 Apr** / **WAL 13 May** GW first readings (tick60). **Brussels** public assent dossier still **not found**. Searches of Kamer/VP/PW/PFWB + BS class: **no final plenaire adoption dates** as of **2026-07-21**. Degryse summer multi-parliament target **not evidenced**.
...
### 2026-07-21T08:50:00Z ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½ tick 68
- Unit: rq_067 (Flanders EFRO/Interreg 2021-27 named L5 sample)
- Found (strong programme; partial L5): **EFRO Vlaanderen EU ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½276.078 m** (meer ontwikkeld **ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½163.516 m** + Limburg transitie **ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½112.563 m**); total programme budget class **~ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½596 m** (40%/60% co-financing). Priorities: Slim **ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½160.045 m** / Duurzaam **ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½106.697 m**. Named GTI slices: Kempen **ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½10.885 m**; West-Vlaanderen **ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½25.728 m**; stedelijke ontwikkeling Antwerpen+Gent **ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½19.791 m** (Themis VR mededeling). **Interreg VL-NL**: keep.eu total **ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½410.811 m** / EU **ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½205.406 m**; portal **110** projects, **ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½205.5 m** allocated; themes slim **ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½72.5 m** / groen **ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½73.6 m** / sociaal **ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½47.1 m** / grenzen **ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½7.3 m**. VLAIO bulk project portal **blocked/incomplete** for individual 2021-27 project EUR this tick; older 2014-20 L5 not used as 2021-27 sample.
...
### 2026-07-21T09:05:00Z ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½ tick 69
- Unit: rq_068 (Brussels EFRO/FEDER 2021-27 L5 sample)
- Found (strong OP; reclassified press figure): Official OP PDF: **EU ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½121.284 m** + national **ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½181.926 m** = **total ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½303.210 m** (40% EU). Priorities totals: **P1 ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½125.832 m** / **P2 ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½136.445 m** / **P3 ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½13.644 m** / **P4 ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½27.289 m**. be.brussels (06.07.2026): **120 projects selected** under 2021-27; **ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½191 m / 68 projects is 2014-2020 results**, not current OP. Named **call envelopes** (FEDER+RBC): digital OS1.2 **ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½29.222 m**; saut qualitatif **ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½15.142 m**; accompagnement PME **ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½6.679 m**. Individual project EUR bulk incomplete ? FOI.
...
### 2026-07-21T09:20:00Z ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½ tick 70
- Unit: rq_069 (German-speaking Community / Ostbelgien budget + L5 sample)
- Found (strong, Rechnungshof 13 Nov 2024 UHH 2025): **Hauptverwaltung Ausgaben AE ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½685.707 m** / VE **ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½687.602 m**; Einnahmen **ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½595.819 m**; **konsolidierter ESVG-Saldo -ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½113.878 m** (Investitionen **ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½104.4 m** im Defizitpfad). Einnahmen: **Bundesdotation ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½342.5 m** (allgemein 321.3 + zweckgeb. 21.2); **Wallonie-Transfer ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½93.1 m**; Anleihen **ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½111.2 m** (davon RRF ~ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½11.2 m). AE nach OB: **Unterricht ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½187.097 m**; **Gesundheit/Soziales ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½146.039 m**; **Infrastruktur ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½103.773 m**; **Kultur/Sport/Jugend ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½22.792 m**. Infrastrukturplan: **142 Projekte / ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½94.2 m**; IT **ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½6.5 m**; Kommunaldotationen Unterhalt **ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½3.0 m**. Paasch/BRF Okt 2025 (medium): Sparpakete **~ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½23 m/Jahr** + Infra-KÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½rzung **ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½32 m**; Krankenhaus-Investbedarf **=ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½150 m** (zwei HÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½user).
...
### 2026-07-21T09:35:00Z ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½ tick 71
...
- Next: **rq_070** Province LiÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½ge/Luxembourg budget L1+L5 (prio 3)

### 2026-07-21T09:50:00Z ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½ tick 72
- Unit: rq_070 (Province de LiÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½ge budget L1 + L5 sample)
- Found (strong, official Budget 2026 PDF 25-26/010): **Service ordinaire** recettes **ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½563.597 m** / dÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½penses **ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½563.574 m** (boni **ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½22.968**). **2025 aprÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½s MB** ~**ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½696.4 m** dep. Compte **2024** dÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½p. eng. **ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½664.5 m**. **Extraordinaire 2026** recettes **ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½68.151 m** / dÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½p. **ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½68.140 m**. Combined dep. **~ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½631.7 m**. Named: **prÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½compte immobilier ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½258.5 m** rec; **fonds des provinces ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½40.1 m**; **zones de secours provincial ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½45.600 m** (zones 1ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½5 **ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½44.428 m** + zone 6 DG **ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½1.172 m**); **enseignement secondaire ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½142.197 m**; **supÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½rieur ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½69.302 m**; **sports ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½8.311 m**; **OpÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½ra Royal Wallonie ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½150k**; **OPL ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½70k**.
...
### 2026-07-22T10:20:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 73
...
### 2026-07-22T11:05:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 76
...
### 2026-07-22T11:20:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 77
...
- Ord sum **EUR 1,932,150,627** (~EUR 1.93 bn); total ord+extra **EUR 2,069,243,296**; zones transfer sum **EUR 188,199,958** (+ Hainaut provision **EUR 6.0 m** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ **EUR 194,199,958**). PrÃÂÃÂÃÂÃÂ©compte sum **EUR 814,300,000**; fonds des provinces sum **EUR 164,015,104**. Hainaut alone **43.0%** of ord dep. Zones/ord **9.7%**. Caveat: Liege = official province PDF; others = CoA projet.
...
### 2026-07-22T11:50:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 79
- Unit: rq_078 (Provincie West-Vlaanderen MJP 2026-2031 L1 + L5 sample)
- Found (strong debt/invest/AFM; medium subsidy class ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ M2/T2 tables largely image-only): Official fin-nota PDF PR **27 Nov 2025**. **Invest 2026-2031 EUR 363,500,000** (own patrim **EUR 246,500,000** + grants-out **EUR 116,900,000**; avg **~EUR 60m/yr**). **Invest receipts EUR 52,600,000** over 6y (Fietsfonds-heavy). **Debt 01/01/2026 EUR 92,341,480** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ **EOY 2031 EUR 207,200,000**; new loans **EUR 190,000,000** (2026 chart **EUR 28,250,000**). **BBR 2026 EUR 15,204,117**; **AFM 2026 EUR 10,913,984** / 2031 **EUR 8,697,410** (structureel evenwicht OK). **Werkingssubsidies class ~EUR 55m/yr** (~1/4 exp; T2 not OCR); agencies **~EUR 35m** (POM/Inagro/Westtoer); **WFIV base EUR 400,000**. Opcentiemen rate **186.22** (VLABEL 13 Sep 2025; chart ~115-155m not digitised). Second-home tax RvS relief **EUR 9m**. Pension responsabilisering **EUR 2.84m** 2026 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ 4.89m 2030. Full single-year exploitatie-uitgaven total **not text-extracted** (image tables).
...
### 2026-07-22T12:20:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 81
...
### 2026-07-22T12:35:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 82
...
### 2026-07-22T12:50:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 83
...
- Unit: rq_095 (Walloon province L5 named subsidies ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Hainaut CoA + Liege budget)
- Found (strong): **Hainaut** CoA 2026: **ASBL Voies d'eau du Hainaut EUR 2,300,000** (incl **+1.8m** severance after canal tourism stop); **ASBL Teralis cut to 0** (was 0.4m; French domains sold); transfers hors zones **EUR 15.5m**; **CathÃÂÃÂÃÂÃÂ©drale Tournai invest EUR 3,900,000** (3.7m external subsidy); **199 entities** with aids >=50k/yr (annex exists; **amounts not in CoA PDF**; CoA flags **no motivation** for extraprovincialisation); 53 management contracts 2024. **Liege** budget 2026 named: tourism sites paraprovinciaux **EUR 516,011**; MNEMA **EUR 150,000**; Service social agents **EUR 190,878**; GIG **EUR 110,000**; DG cooperation **EUR 871,000**; Opera **EUR 150,000**; OPL **EUR 70,000**; Theatre Liege **EUR 60,000**; BRF 90k; RTC sport 124k; Parc HFE 60k. **FTPL** (Federation Tourisme) line **EUR 1** obligatoire 2026 (was **1.2m** 2025 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ major cut/restructure in table).
- Wrote: 18 budgets; 6 commitments; 4 leaderboard; entities; 2 sources; rq_095=done; seeded rq_096 Hainaut annex/FOI; ticks=95
- FOI: **not drafted this tick** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ rq_096 opened for 199-entity EUR list if public annex missing
- Next: **rq_096** Hainaut named ASBL list (prio 3) or **rq_089** SWA Q4 (prio 1)


### 2026-07-22T16:19:00Z -- tick 96
- Unit: rq_096 (Hainaut full named ASBL EUR list ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ public search + FOI)
- Found (strong process; **public list still missing**): Re-checked CoA Hainaut budget 2026 PDF and web/portal search for a published annex of the **199 entities** with provincial aids >= EUR 50k/yr. **No machine-readable or PDF named EUR list** found on public portals this tick. CoA remains best primary evidence that the annex **exists** administratively and that **motivation for extraprovincialisation is missing**. Action: **FOI draft** `gap_hainaut_asbl_list_2026` (FR, publicite de l'administration) status **ready** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ **human send only**.
...
- Found (strong synthesis, no new primary PDF): From ticks 95ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ98 only. **Known package EUR:** BW **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬10,000,000** (31 entities, motivated) + Lux **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬4,300,000** (ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ17.8% vs 2025) = **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬14,300,000**. **Entity counts:** Hainaut **199** (unmotivated, FOI) + BW **31** + Namur **10** (3 unmotivated) = **240**. LiÃÂÃÂÃÂÃÂ¨ge: named sample (tourism 516k; culture 280k; FTPL cut to ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1) not a CoA ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¥50k package total. Opacity rank worstÃÂÃÂ¢ÃÂÃÂÃÂÃÂbest total disclosure: **Hainaut > Lux names > Namur > LiÃÂÃÂÃÂÃÂ¨ge sample > BW**. FOI ready human-send: Hainaut + Lux.
...
- Found (strong synthesis, **not additive**): Flanders **werkingssubsidies sum 5 = ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬194,175,471**; named POM+tourism 4 = **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬38,472,193** (WVL 59%). Wallonia **known ASBL packages BW+Lux only = ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬14,300,000**; entity counts H+BW+N = **240**; Hainaut 199 FOI. L1 context: VL exp ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1.11bn vs WAL ord ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1.93bn (different systems). Mechanism: VL MJP/T2 named L5 stronger public; WAL CoA annex often body-missing amounts; dual accounting forbids ÃÂÃÂ¢ÃÂÃÂÃÂÃÂBelgian provincial subsidyÃÂÃÂ¢ÃÂÃÂÃÂÃÂ headline. Invalid claim: WAL ASBL < VL werksubs as total comparison.
...
- Found (strong, Stad Gent open **subsidieregister** 8718 rows): **2024 charged total ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬331,933,746** (intern ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬268.3m incl Politiezone ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬110.6m / Ivago ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬62.7m / HVZ ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬42.3m; **extern ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬63.7m**; **extern+werking ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬47.5m**). **Cultuurdienst 2024 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬11,559,533** (311 orgs). Named culture: **NTGent ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬2,985,451** (werking ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬2,725,451 + invest ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬260k); Opera Ballet VL ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1,459,913; VIERNULVIER ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬965,374; Minard ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬550k. **2025 partial** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬107.4m only. Antwerp city: **no parallel open named EUR register** found this tick.
...
- Unit: rq_102 (Brugge/Namur/ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¦ city open subsidy register scan)
- Found (strong Brugge OD): **subsidieregister** 5831 rows 2022ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ2026. **2024 total ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬99,253,042**; **2025 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬97,980,016**; 2026 partial ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬31.2m. Named: **Brugge Plus ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬7,317,328 (2024)** / ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬7.03m (2025); **Concertgebouw ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬2,110,837 (2024)** / ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1.26m (2025); **Entrepot ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1,086,176 (2024)**. Core top: Politiezone ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬32.9m; Mintus ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬26.2m; HVZ ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬10.1m. **Namur OD** `subsides-attribues`: **stale 2019ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ2020 only** (156 rows); SONEFA 2020 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬2.13m ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ BI2026 associatif still from DGF not OD. Charleroi/Mons named OD not found this tick.
...
- Found (strong Mons ord 2025 PDF): recettes **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬246,241,166** / dÃÂÃÂÃÂÃÂ©penses **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬244,180,818**; rÃÂÃÂÃÂÃÂ©sultat prÃÂÃÂÃÂÃÂ©sumÃÂÃÂÃÂÃÂ© 01/01/2026 **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬2,060,348**. Named: **RCA ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1,156,471** + fonct ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬815k + piscine **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1,900,000**; **MARS package ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬674k** (fonct 400k + anim 150k + musical 124k); OT personnel ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬289k + fonct ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬274k; Fondation Mons ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬110k; charte activitÃÂÃÂÃÂÃÂ©s ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬100k / fonct ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬50k; film festival ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬45k; Basket UMH ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬220k. **BI2026 PDF still not on mons.be**. Charleroi: only 2026 call forms ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ **no named EUR list**.
...
- Found (strong synthesis, **not additive**): Transparency ladder **Gent > Brugge > Mons PDF > Namur stale OD > Antwerp=Charleroi FOI**. Gent register 2024 **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬331.9m** (extern+werking **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬47.5m**; culture **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬11.6m**; NTGent **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬2.99m**). Brugge 2024 **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬99.3m** (Brugge Plus **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬7.32m**; Concertgebouw **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬2.11m**). Mons ord 2025 dep **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬244.2m** (MARS **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬674k**; RCA package multi-m). Core police/zones dominate OD tops ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ not pure L5 waste pools. Invalid: sum cities or compare raw register totals without perimeter.
- Wrote: `cities_l5_transparency_compare_2026.md`; 3 budget xrefs; 1 cmt; 1 lb; 1 source; rq_104=done; seeded rq_105; ticks=104
- FOI: none new (stack: Antwerp, Charleroi, Mons2026, Hainaut, Lux ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ human send)
...
- After ticks 117ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ120 idle (no public open work; FOI ready human-only), auto-pause to stop 15m idle fires.
...
- **Unit rq_117 Unia funding (strong primary RA 2024ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ2025):**
  - 2024 subsidies **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬9,454,426** = federal **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬8,170,698** + federated **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1,283,728** (WAL **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬761,698**; FWB **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬354,971**; BXL **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬145,867**; DG **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬21,192**; Flanders **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬0**).
  - 2025 subsidies **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬9,628,106** = federal **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬8,304,698** + federated aggregate **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1,323,408**.
  - Personnel 2025 **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬9,050,949**. Coalition **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ25% federal** path (not yet full cash outturn).
  - Dual: **VMRI** Flanders budget class **~ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬5.279m (2025)** / request **~ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬5.598m (2026)** (medium VP).
- Wrote: `unia_funding_map.md`; entities Unia+VMRI; 16 budgets; 2 cmt; 2 lb; 4 sources; FOI `gap_unia_funding_detail` ready; seeded rq_118ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ121 (IEFH, FIRM, Myria, hole-fill); ticks=122.
...
- Unit: **rq_133** (FOREM full budget primary) ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ prio 7 / PES dual with VDAB
- Found (primary **FOREM RA 2023**; **no invent euros**):
  - **Budget global ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬3.091 bn**; federal-managed slice ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬0.300 bn; **internal exp ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬2.763 bn**.
  - **Aides emploi/formation ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬2.067 bn** (75%); **fonctionnement ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬0.514 bn** (19%); tiers ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬0.180 bn.
  - **Subvention RW ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬2.662 bn**; other receipts ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬71.6 m; staff **4,919 / 3,992 FTE**.
  - Dual PES honesty: FOREM mass includes APE/titres-services passthrough ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ **not apples-to-apples** with VDAB VL krediet ~ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬0.75 bn.
  - 2024ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ26 RA still missing ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ FOI residual.
...
- Unit: **rq_132** (VDAB full budget primary) ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ prio 7 / FOI-adjacent PES
- Found (primary **BBT BO2026 Werk** pfile 2250747; **no invent euros**):
  - **Strong:** VDAB VL kredieten BA2025 **VEK ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬765.690 m** / VAK ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬760.621 m ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ BO2026 **VEK ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬750.702 m** / VAK ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬750.604 m.
  - Split BO2026: activering **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬561.009 m** VEK; competenties **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬189.693 m** VEK.
  - **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬20 m** werkings toelage cut; **+ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬3 m** index on competenties toelage.
  - **Medium:** PQ52 premise **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬962 m** total 2024 of which **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬783 m** VL dotatie (minister deferred to jaarrekening); conceptnota **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬945 m** werkings 2025 (81.2% VL).
  - Residual: official jaarrekening institutional total (EU+own) + L5 splits ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ FOI.
...
- Unit: **rq_124** (Federal BGD / toelagen top discretionary L5) ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ prio 8 last
- Found (primary **BOSA** register + dept/OISZ/AOI tables; **no invent euros**):
  - Register **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬179.916 bn / 8,993 items (2025)**; path 162.4 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ 171.6 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ 179.9 bn 2023ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ25.
  - **By type 2025:** HH+ASBL **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬141.915 bn**; regions **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬19.443 bn**; firms **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬4.777 bn**; local **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬4.682 bn**; BV TE **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬4.668 bn**; foreign **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬2.592 bn**; Maribel **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬0.894 bn**; SSC exempt **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬0.943 bn**.
  - **Dept 2025:** SS **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬27.687 bn**; regions **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬17.730 bn**; autonomous **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬5.470 bn**; HH/ASBL **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬4.968 bn**; companies **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬3.075 bn**.
  - **OISZ out ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬142.955 bn** (HH **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬136.384 bn**); **AOI ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬0.774 bn**.
  - Assignment funds **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬83.552 bn**; 2023 TE inventory **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬39.401 bn** (VAT 16.2 largest).
  - Named L5 top-50: interactive only ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ FOI **gap_fed_register_l5_top50** ready.
...
- Next: **prio7** IEFH/FIRM, regional L5, VDAB/FOREM, parties, taxex remainder ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ **prio8 queue empty**


### 2026-07-27T16:20:00Z -- tick 129
- Unit: **rq_154** (Cheque economy official TE line primary) ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ prio 8 / FOI-adjacent
- Found (primary **Rekenhof advies** Kamer DOC 56 0785/004, 4 Mar 2026; **no invent euros**):
  - **(Para)fiscale uitgave maaltijdcheques privÃÂÃÂÃÂÃÂ© 2024: ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1.07 bn** (SSC+PB net of VenB) ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ **strong CoA** from RSZ+VIA.
  - **VIA market:** face issued **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬3.550 bn 2024** (3.344 bn 2023); **3.142 m** beneficiaries; avg face ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬7.23; 156.3 cheques/person.
  - **FPS inventaris fiscale uitgaven:** lists meal-voucher TE but **amount not estimated** (CoA explicit).
  - **AABEO** CIT-only gov reform impact: **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬55.8 / 62.7 / 65.6 m** 2026ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ28.
  - Federal public direct cost class **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬71.6 m**; **ecocheques aggregate still Unknown**.
  - Supersedes thesis ~1.4 bn as best official meal estimate (keep medium triangulation).
- Wrote: sources +2; taxex +budgets +cmt; lb_cheque_economy ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ 1.07bn strong; FOI residual eco+FPS euro; raw PDF; rq_154=**done**; ticks=129
...
- Unit: **rq_125** (Flanders BO2026 top 30 named subsidies L5) ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ prio 8
- Found (primary Centenboekje BO2026 PDF; **no invent euros**):
  - Domain VEK already mapped; extracted **30+ named measure lines** (Jobbonus 228m, Oosterweel 889.9m, VV 436.4m, subsidy cut pkg 350m, uitstel 370m, hervorm 462.7m, werk 229.0m, dienstencheques effort 151.4m, Warm 98.5m, Welvarend 206.9m, Gemeentefonds +115.1m, rente +330.6m, VRT +49.3m, De Lijn VEK ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ61.3m, retro premies ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ189.9/ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ111.7m, index 718.9m, ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¦).
...
- FOI: none new (centenboekje is L3ÃÂÃÂ¢ÃÂÃÂÃÂÃÂL4; L5 ASBL lists remain prior FOI stack)
- Next: prio8 **rq_124** federal BGD / **rq_154** cheques TE


### 2026-07-27T15:40:00Z -- tick 127
- Unit: **rq_130** (NMBS PSO cash-by-year primary) ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ prio 8 / FOI-adjacent
- Found (primary **Openbaredienstcontract NMBSÃÂÃÂ¢ÃÂÃÂÃÂÃÂStaat 2023ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ2032** Art.115ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ116; **no invent euros**):
  - **Compensatie = invest + variable (57% ODV tickets) + specific + fixed exp**
  - **Betalingstraject courante mÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬ (Art.116 table):**  
  ...
  - Deferred **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬536.513 m/yr** non-indexed from last monthly advances (var+fixed).
  - Cross-check: NBB ESA D.31+D.92 **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1.957 bn 2024** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ order of core3 2.016.
  - FPS/BOSA **budget article cash codes still unknown** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ FOI residual.
...
- Unit: **rq_131** (De Lijn full dotatie series primary) ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ prio 8 / FOI-adjacent
- Found (primary SV 955 PeetersÃÂÃÂ¢ÃÂÃÂÃÂÃÂDe Ridder 26 Feb 2026; **no invent euros**):
  - **Strong multi-year toelage** (Vervoersautoriteit via PQ): exp+inv **2019ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ2024** ends at **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1.497683 bn 2024** (exp **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1.228474 bn** + inv **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬0.269209 bn**); 2023 exp **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1.164150 bn** (supersedes press ~1.14bn medium).
  - ODC **basistoelage base ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬938.7 m**; 2025 KN+AN+VoM **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬955.331659 m ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬919.831649 m** after savings target.
  - 2025 own revenues **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬255.098 m**; GIP invest **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬661.025 m** (vergroening ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬460.9 m); availability fees **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬52.592 m** (2025) / **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬54.760 m** BO2026.
  - Minister deferred full 2025ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ26 exp+inv total to BBT (Q1ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ2) ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ **FOI residual** for comparable 2025ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ26 row.
- Wrote: sources +1; budgets ~20 lines; cmt + lb upgraded strong; FOI draft residual; raw PDF; rq_131=**done**; ticks=126
- FOI: gap_de_lijn_dotatie still **ready** (priority 6; 2019ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ24 filled)
- Next: prio8 **rq_124** BGD / **rq_125** VL subsidies / **rq_130** NMBS / **rq_154** cheques


### 2026-07-27T15:00:00Z -- tick 125
- Unit: **rq_123** (VL gelijke kansen full programme L5 beyond Wassalon) ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ prio 8
- Found (primary; **no invent euros**):
  - **Strong (VP BBT Open Vld 7 Nov 2025, pfile 2247885):** Gelijke Kansen **werkingsbudget 2026 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬15.162m** (ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬18k y/y order); **projectsubsidies ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬4.361m** reserved; **VEK +ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1.888m** rebalance; staff **10.3 VTE / ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1,000,767.29** budgetlast.
  - **Named research L5:** Rode vlaggen KH Vives **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬119,018.50** incl BTW; non-binariteit UGent **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬119,634**; expertendatabank eval **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬45,000** (17,424+27,611 Ipsos).
  - **Campaign:** BBT confirms **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬800,000** mensenrechtencampagne via **LDV United** raamcontract (upgrades Wassalon contractor from medium claim ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ **strong** parliament answer).
  - **Inter:** toelage **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1.333m 2025 / ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1.354m 2026**; IedereenOveral top-up **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬163k** (2024 budget, Jul24ÃÂÃÂ¢ÃÂÃÂÃÂÃÂDec25).
  - **Portal strong names / no EUR:** dozens of lopende projecten (Pride 6 orgs, Safe spaces, GAMS/Plan/Zij-Kant, Turboplan, etc.) ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ amounts still FOI.
...
- Next: prio8 **rq_124** BGD / **rq_125** VL subsidies / **rq_130ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ131** NMBS/De Lijn / **rq_154** cheques


### 2026-07-27T14:40:00Z -- tick 124
- Unit: **rq_152** (GG expenditure bridge % of ~ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬348bn tagged) ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ prio 9 open
- Found (synthesis from prior primary rows; **no invent euros**):
  - **L0:** S.13 TE 2025 **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬347.956 bn** (54.2% GDP) + primary ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬333.675 bn + interest ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬14.282 bn ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ **100% tagged** (strong NBB/Eurostat).
  - **L1:** unconsol. S.1311 181.5 / S.1312 128.6 / S.1313 45.0 / S.1314 141.7 bn; sum ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬496.8 bn; transfer wedge **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬148.9 bn** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ **100% L1 map**.
  - **L2 partial:** FL BA2025 66.5 + WAL 22.0 + FWB ~15 + BRU 8 + DG 0.7 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬112 bn** class vs S.1312 128.6 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬15ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ20 bn residual** order in state layer (perimeter/year, not exact identity). RIZIV 45.2 bn ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ **32%** of S.1314. Federal/local L5 thin.
  - **L5 end-receivers:** samples only ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ **do not claim** near-complete naming of 348bn.
...
- Unit: **rq_122** (VL Het Wassalon 800k deepen tender L5) ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ prio 9 open
- Found (primary / sourced; no invent euros):
  - **Strong (official):** ABB vlaanderen.be 17 Jun 2026 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ campaign **3 years**, **2 seasons/year**; host Daphne Agten; themes LGBTQI+ / disability / gender; YT+Spotify+IG+FB; Mechelen launch.
  - **MediumÃÂÃÂ¢ÃÂÃÂÃÂÃÂstrong (minister via VRT):** Gennez commissie Welzijn ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ full package **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬800,000 / 3y** (creatie+productie+marketing+middenveld); **raamcontract** prijsafspraken; **Sept 2026** evaluation.
  - **Medium (VRT press metrics):** YT top episode ~**2,300** views/month; IG ~**636** followers; IG clips often **10k+**; Spotify listens not public.
  - **Medium (secondary claims, not tender PDF):** LDV United via VL raam ÃÂÃÂ¢ÃÂÃÂÃÂÃÂstrategische en creatieve communicatiepartnersÃÂÃÂ¢ÃÂÃÂÃÂÃÂ (Doorbraak quoting VB MP); **NoStrezz** portfolio self-claim ÃÂÃÂ¢ÃÂÃÂÃÂÃÂfully producedÃÂÃÂ¢ÃÂÃÂÃÂÃÂ.
  - Cash-by-year and gunningsbedragen **still Unknown** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ FOI residual.
...
- **Tick 176 coverage (vs ÃÂ¢ÃÂÃÂ¬347.956 bn TE 2025):** L0 **100%** ÃÂÃÂ· L1 **100%** ÃÂÃÂ· L2 entity totals **~60ÃÂ¢ÃÂÃÂ65%** ÃÂÃÂ· L5 named end-receivers **~8ÃÂ¢ÃÂÃÂ12%** ÃÂÃÂ· FOI ready **~55**.
- **Waste top 3:** cheque economy (8.83) ÃÂÃÂ· company cars FPB (8.50) ÃÂÃÂ· heating oil FFS (8.43). High-abs honourable: **Het Wassalon** (abs 9.5, prio 7.4).
...
- Trade-off: ticks often run 2ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ15 min ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ possible **concurrent** fires; one unit per fire still; no force-push.
- Updated `LOOP.md` cadence section.


### 2026-07-27T14:05:00Z -- seed (user): Wassalon + mass L5 queue
- User: keep loop; **Het Wassalon** gelijke kansen **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬800k / 3y** (news Jul 2026) not yet in dataset ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ add high absurdity; seed many RQs for end-receivers / every-cent map.
- **Found (not in prior ticks):** Minister Gennez (VP, Jul 2026) ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ campaign+vodcast **Het Wassalon** (ABB) **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬800,000 over three years** (~ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬267k/yr illustrative). Press (HLN): early views **~661** class (medium secondary). High clown/absurdity candidate (**abs 9.5**, priority_index **~7.4**).
- Wrote: budgets + cmt + **lb_vl_wassalon_podcast**; FOI **gap_vl_wassalon_tender** ready; sources VRT+HLN.
- **Seeded open RQs rq_122ÃÂÃÂ¢ÃÂÃÂÃÂÃÂrq_155** (34 units): Wassalon deepen, gelijke kansen L5, federal BGD top50, VL/WAL/FWB/BRU L5, SS/NMBS/De Lijn/VDAB/FOREM, parties, unions, mutualities, hospitals, unis, intercommunales, cities, defence, energy, **rq_152 GG bridge % of ~ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬348bn tagged**, taxex remainder, cheques, company-cars split.
- Honesty: GG **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬348bn** will **not** be fully named L5 soon ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ map is L0 totals + samples + FOI residual; rq_152 will measure coverage gap.
- Next loop picks **rq_122** (prio 9) or **rq_152** (prio 9).


### 2026-07-27T00:20:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 105
- Unit: **rq_105** (Federal/Flanders L5 recheck ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ FPS TE + VLAIO)
- Found:
  - **FPS taxex inventory XLSX re-download**: size 123619 bytes; MD5 `cb04adbe94e0fd27e25a511c100878be` **identical** to tick4 copy ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ **no new year sheets**. Existing tax_expenditures top20 still valid.
  ...
  - Speurgids Table 1 (strong): EWI broad **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬5,289.65m**; economisch beleid **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬619.32m** (via FIO/VLAIO); wetenschap+innovatie **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬4,669.33m** of which FIO/VLAIO WIB **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬437.03m**.
  - Table 36 FIO Innovatie: **bedrijfssteun O&O ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬210.90m**; clusters **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬82.55m**; Moonshot **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬20m**.
  - Table 11/13 L5 instruments: **Kmo-portefeuille 2024 outturn ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬42.716m** (province split); BO2025 **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬40m**; Kmo-groei outturn **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬11.869m**; STS 2024 **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬12.216m** (line zeroed BO2025 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Transitie en Transformatie; STS cut ~ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬20m); **Carbon leakage CIE BO2025 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬261.59m** (largest single econ instrument); imec **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬155.4m** VIB **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬87.97m** Flanders Make **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬54.94m**.
...
### 2026-07-27T00:40:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 106
...
- Found (strong process; negative on final votes):
  ...
  - Process still maxes at: Overleg **27 Mar 2026** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ VL gov **8 May** principal + SERV **1 Jun** filed ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ federal MR **13 May** avant-projet loi ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ WAL/FWB **1st reading** ODJs; **Brussels** still thin.
  - New primary **APR 2026** (BOSA, **30 Apr 2026**) ch.5: reform of 2013 interfederal budget SWA; after signature, SWA + assent acts ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ **Raad van State** advice **by summer**; then entity **parliaments by year-end**. Matches stalled public track mid/late July.
  - Kamer PDF 56K1569 blocked (WAF); not used as source this tick.
- Wrote: sources (+src_apr_2026_bosa, recheck note); commitments **cmt_swa_econ_governance_2026** (status pending_assent; ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬0 not a spend envelope); rq_089=done; spawned **rq_106** CIE L5 (prio4) + **rq_107** SWA year-end recheck (prio1); raw apr_2026_bosa.pdf; ticks=106
- FOI opened: none
- Next: **rq_106** carbon leakage CIE L5 beneficiaries (Speurgids ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬261.59m); human FOI stack unchanged

### 2026-07-27T01:00:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 107
- Unit: **rq_106** (Carbon leakage CIE L5 beneficiaries / evaluation)
- Found (strong totals; L5 names still opaque):
  - **FIO VEK ICL** (BO2026 tech vragen, keuro): **2024 250.234m** / **2025 261.588m** / **2026 BO 216.609m** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ matches Speurgids 261.59m for 2025.
  - **PQ 251** (Diependaele 20 Feb 2026): **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬258m** toegekend in 2025 voor emissiejaar 2024; **+ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬40m** uitzonderingsmechanisme EY 2022ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ23; budget **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬216m** 2026.
  - **PQ 28** (2 Oct 2025): CIE = **grootste VLAIO-bedrijfssubsidie**; cite **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬229m in 2024**; investeringsplicht-controles nog niet gestart (tot 2028 voor EY2021); **14 bedrijven** missen product-elektriciteitsbenchmark (50% herinvestering); terugvorderingen **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬19.898.396** (2020ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ24).
...
- Wrote: sources +3; programmes CIE 2024ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ26; commitments cash path + exception cmt; leaderboard refresh; **FOI gap_vl_cie_l5_beneficiaries ready**; rq_106=blocked_foi; spawned **rq_108** FIO O&O L5; raw PQs + tech PDF; ticks=107
- FOI opened: **gap_vl_cie_l5_beneficiaries** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ ready (human send only)
- Next: **rq_108** VLAIO FIO bedrijfssteun O&O L5 sample; human FOI stack includes CIE

### 2026-07-27T01:20:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 108
- Unit: **rq_108** (VLAIO FIO bedrijfssteun O&O named L5 / open data)
- Found (strong aggregates + partial named L5; bulk list FOI):
  - **PQ177** innovatiesteun OND+ONTW+ICON decision-year: Flanders **2025 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬196.90m** (388 firms / 390 projects); multi-year path 2020ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ25 public; full portfolio incl ISS/Schaalklaar/haalbaarheid **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬214.15m** 2025.
  - **PQ209** ontwikkelingsprojecten only: **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬443m** 2021ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ25 on **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1.275bn** project cost (~35% avg); 918/1093 approved 2023ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ25; province split ANT 110.9 / OV 132.5 / WVL 79.3 / VBR 70.3 / LIM 38.0 / other 12.0 mEUR. Individual project names **withheld for confidentiality** (Excel bijlage not in PDF).
  - **PQ351 named L5 Woosh**: KMOGS ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬50k; ONTW ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬158.3k + ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬376.0k; haalbaarheid ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬46.2k; Schaalklaar ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬350k (codes public).
  - **Speurgids 2025**: speerpuntcluster geoormerkt **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬54.2m** / 38 projects 2024 (Catalisti 5.31 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¦ Intercluster 14.2); **Moonshot ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬24.54m** / 10 projects; Edtech Station **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1.8m**/3y.
...
- FOI opened: **gap_vl_fio_project_l5** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ ready (human send; complements gap_vl_cie_l5)
- Next: **rq_109** federal TE/FFS recheck or **rq_107** SWA year-end (low)

### 2026-07-27T01:40:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 109
- Unit: **rq_109** (FPS FFS / taxex inventory micro-update)
- Found (strong primary Jul 2026 editions):
  - **FFS 5th inventory** (FPS Finance+Health, data cut 1 Jan 2026, pub Jul 2026): **direct fossil subsidies 2024 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬10,781.9m** (1.7% GDP); path 12.09 / 13.45 / 11.66 / 10.78 bn 2021ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ24. Confirms prior EN summary: company cars EHS **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬3,141.7m**; fuel cards **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬661.6m**; pro diesel FFS **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬831.2m**; aviation kerosene **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬754.6m**; VAT reduced gas HH **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬635.2m**; agriculture intermediate **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬378.5m**. International air+sea **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1,006.5m**. Broad sum direct+intl+indirect+EHS ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬15.15bn** (press ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ15bnÃÂÃÂ¢ÃÂÃÂÃÂÃÂ class).
  - **Inventory of Federal Tax Expenditures (2024)** PDF: quantified total **2023 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬39,402.01m** (6.74% GDP); path 28.9ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ39.4 bn 2018ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ23 (+6.37%/yr avg). By tax 2023: VAT **16.20bn**; PIT federal **9.67bn**; EIWT **4.42bn**; CIT **3.81bn**; excise **2.44bn**. Social objective **42.4%** of quantified.
  - Taxex XLSX recheck already identical earlier; this PDF adds **official global aggregates** not fully seeded before.
  - Method note (strong): FFS ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ  cash budget gain if abolished; TE inventory ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ  ESA spending; do not double-count FFS into TE total.
...
### 2026-07-27T02:00:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 110
- Unit: **rq_110** (Kerosene aviation + VAT gas HH multi-year / reform notes)
- Found (strong FFS 2026 primary):
  - **Aviation kerosene** (Table 20, ETD min ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬330/1000l): **2019ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ24 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬677.0 / 471.8 / 594.2 / 687.7 / 689.5 / 754.6 m** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ rising post-COVID; sum **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬3.875bn**. FFS eval: unjustified economically and environmentally; unilateral national tax weak; EU ETD proposal higher rate after 10y transition still blocked; coalition 2025ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ29 cites Chicago Convention revision.
  - **VAT gas households 6%**: **2021ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ24 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬0 / 610.1 / 694.3 / 635.2 m**; electricity HH fossil-share **0 / 277.1 / 285.6 / 226.9 m**. Crisis cut made permanent class.
  - **VAT air tickets** (indirect): **87.5 / 180.4 / 208.8 / 224.5 m** 2021ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ24; stacks on kerosene.
  - **Boarding tax** (separate instrument, not kerosene): budget/programme law path ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬5ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬10 from 2027 class; later press scaled to ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬7 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ **medium secondary**, not FFS inventory.
...
### 2026-07-27T02:20:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 111
- Unit: **rq_111** (Stookolie / agriculture intermediate FFS multi-year)
- Found (strong FFS 2026 Tables 16+19):
  - **Huisbrandolie total** (bench1): **2019ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ24 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬2,129.8 / 2,263.3 / 2,096.5 / 1,856.8 / 1,798.2 / 1,836.4 m**. 2024 split low-S **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1,526.7m** + high-S **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬309.7m**. Long-run volume ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ3.7%/yr. FFS eval: **not justified environmentally or socially** (heating oil users not concentrated in lowest income quartile; 87% homeowners in HBS).
  - Taxex inventory product-specific line (~**ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1,333m** prior seed) remains separate method ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ FFS gasoline-TOE higher.
  - **Agriculture intermediate** total: **2020ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ24 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬548.9 / 562.6 / 629.9 / 442.8 / 378.5 m** (mostly product rate diffs, not pure exemption).
  - **Sociaal Verwarmingsfonds** cash: **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬12.6m** 2024 / **70,112** households ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ targeted contrast to ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1.8bn untargeted excise preference.
  - Binnenvaart **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬84.3m** / bagger **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬24.7m** 2024 intermediate package.
...
- FOI opened: none
- Next: **rq_112** industrial reduced gas rate (ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬903m) or low **rq_107** SWA

### 2026-07-27T02:40:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 112
- Unit: **rq_112** (Industrial reduced gas rate + inland waterways FFS)
- Found (strong FFS 2026 Table16/19 + ÃÂÃÂÃÂÃÂ§4.3.3):
  - **Aardgas verlaagd tarief** (EBO/sector agreements, bench1): **2019ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ24 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1,091 / 1,031 / 1,191 / 1,295 / 1,052 / 903 m**. Peak energy-crisis 2022; declining 2023ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ24.
  ...
  - **Binnenvaart** intermediate: **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬84.3m** 2024 (path 84ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ91m).
  - Gasolie industrial/commercial: **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬365.9m** 2024 (path ~366ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ416m).
...
- FOI opened: **gap_fed_gas_reduced_firms** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ ready (human send)
- Next: **rq_113** aardgas product-diff ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬4.09bn or low **rq_107** SWA

### 2026-07-27T03:00:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 113
- Unit: **rq_113** (Natural gas product rate-diff FFS + social tariff path)
- Found (strong FFS 2026 Tables 15+1):
  - **Aardgas product rate-diff** (bench1 vs gasoline TOE): **2019ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ24 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬4,741.5 / 4,538.0 / 5,124.3 / 4,854.2 / 3,722.4 / 4,089.4 m**. Largest single product-diff line. End-use: industry **55.8%**, housing **25.2%**, commercial **12.8%**, agriculture **4.9%**, transport **1.4%**. Bench2 2024 split: business **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬470.3m** + non-business **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1,353.3m**. Pre-2022 series exclude federal gas contribution (method break).
  - **Not double-count** with EBO reduced rate (ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬903m) or VAT 6% gas HH (ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬635m) ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ different instruments.
  - **Sociaal tarief gas** (permanent CREG cash): **89 / 79 / 95 / 428 / 268 / 96 m** 2019ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ24. **RVT extension** peak **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬462.2m** 2023 then **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬27.7m** 2024. Targeted contrast to untargeted ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬4.09bn product gap.
  - Diesel product residual after petrol equalisation: **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬273.3m** 2024.
...
### 2026-07-27T03:20:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 114
- Unit: **rq_114** (FFS synthesis snapshot + LPG/coal residual lines)
- Found / wrote:
  - **Synthesis** `docs/doge/data/ffs_federal_top_lines_2024.md`: package totals (direct **ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬10.78bn**, broad ~**ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬15.2bn**) + mapped high-EUR lines already in CSVs ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ **no invented euros**, explicit non-additive warning.
  - **LPG heating** Table16 multi-year: **2019ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ24 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬108.6 / 138.8 / 140.0 / 120.3 / 117.8 / 127.6 m**.
  - **Coal HH** exemption: **27.8 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ 10.8 m** 2019ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ24 (declining); FFS notes reduced VAT solid fuels abolished Jul 2025.
...
### 2026-07-27T03:35:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 115
- Unit: **rq_115** (Leaderboard priority_index recompute after FFS wave)
- Method: ran `raw/recompute_leaderboard.py` ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ cost_score from annual EUR bands; priority = 0.55*cost + 0.35*abs + 0.10*(10-diff); sorted 157 rows.
- Top 10 after recompute:
  1. cheque economy **8.68** ÃÂÃÂÃÂÃÂ· 2. heating oil FFS **8.43** ÃÂÃÂÃÂÃÂ· 3. company cars **8.22**
  4ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ5. EIWT package / night-shift cluster **8.08** ÃÂÃÂÃÂÃÂ· 6ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ8. wage block / FFS direct total / gas product-diff **7.98**
  9. VL non-Maastricht claims **7.83** (stock-as-annual field) ÃÂÃÂÃÂÃÂ· 10. VAT horeca **7.73**
- FFS wave impact: **lb_ffs_direct_total** + **lb_gas_product_diff** enter top 8; heatoil rises (cost_score 9ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ9.5 from ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¬1.84bn); company cars stays #3.
...
### 2026-07-27T03:50:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 116
- Unit: **rq_107** (SWA multi-parliament final assent recheck ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ sixth)
- Found (strong process; **still no final votes** as of **2026-07-27**):
  - **Rekenhof Kamer 56K1469/002** (BA2026 comments): SWA Overleg **25/27 Mar 2026** improves entity-level net-primary paths + fallback; EC positive; **\"moet evenwel nog ter goedkeuring worden voorgelegd aan de diverse parlementen\"** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ still not multi-parliament approved.
  ...
  - APR2026 path: parliament assent by **year-end** ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ mid-year recheck correctly negative.
...
### 2026-07-27T04:05:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 117
- Unit: **idle** (mode already idle_waiting_foi)
- Queues: no in_progress research; no FOI draft; only open research is **rq_116** (SWA Q4 2026 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ skip mid-year per instructions). All material gaps are **FOI ready** awaiting human send.
...
### 2026-07-27T04:20:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 118
...
### 2026-07-27T04:35:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 119
- Unit: **idle** (idle_waiting_foi)
...
### 2026-07-27T04:50:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 120
- Unit: **idle** (idle_waiting_foi)
- No public open work (rq_116 mid-year skip). FOI ready human-only.
- Wrote: loop_state cursor only.
- Next: human FOI or new research_queue; rq_116 after Oct 2026.

### 2026-07-27T05:05:00Z ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ tick 121
- Unit: **idle** (idle_waiting_foi)
- No public open work (rq_116 mid-year skip). FOI ready human-only.
- Wrote: loop_state cursor only.
- Next: human FOI or new research_queue; rq_116 after Oct 2026.

### 2026-07-27T17:40:00Z ÃÂÃÂ tick 133
- Unit: **rq_137** (Political party federal+regional financing L5)
- Found (strong 2024; medium 2025):
  - **Direct public subsidies 2024: ÃÂÃÂ83.7m** (77% of party income ÃÂÃÂ108.7m) ÃÂÃÂ Maddens/KU Leuven from Kamer DOC 56 0961 party accounts.
  - Split: **fed dotatie ÃÂÃÂ36.7m** ÃÂÃÂ· **VL+WAL regional ÃÂÃÂ16.1m** ÃÂÃÂ· **fractietoelagen ÃÂÃÂ26.3m** ÃÂÃÂ· provincial **ÃÂÃÂ3.5m** ÃÂÃÂ· FR connected inst **ÃÂÃÂ1.2m**.
  - Mandataris contributions **ÃÂÃÂ11.1m** (indirect); private gifts only ÃÂÃÂ1.0m (VB+PVDA).
  - Off-books: parliamentary group **staff ~ÃÂÃÂ104.6m** ? broad package **ÃÂÃÂ188.3m**; all assemblies opex **ÃÂÃÂ619m** of which ~29.7% to parties.
  - Senate boost post-2024 **ÃÂÃÂ10.6m** (28.9% of federal dot); abolish-without-rewrite party hit **ÃÂÃÂ25.4m**.
  - **2025 direct ÃÂÃÂ86.5m** medium (press/Belga; vote-base rise offsets freeze narrative).
  - Kamer formula primary: fixed + ÃÂÃÂ/vote, public-sector index, -5.32% 2023-24 only (src_kamer_dotatie_method).
...
### 2026-07-27T18:00:00Z ÃÂÃÂ tick 134
- Unit: **rq_126** (Wallonie budget 2026 top named ASBL/dotations L5)
- Found (strong primary ExpGen + GW CP):
  - **FOREM prog 18.130 consolidated ÃÂÃÂ2.8336bn** eng/liq 2026 (new single line).
  - **17.093 SantÃÂÃÂ©/Familles/Handicap ÃÂÃÂ7.027bn**; Action sociale 329.6m; CrÃÂÃÂ¨ches 16.3m; Affaires int. 2.682bn.
  - Named: **IFAPME 88.3m** ÃÂÃÂ· **Parlement 76.3m** ÃÂÃÂ· **CWaPE 9.3m** ÃÂÃÂ· **Cabinets 28.0m** ÃÂÃÂ· **CESE 7.9m** ÃÂÃÂ· **Recherche 247.5m** ÃÂÃÂ· **Eco outils 132.5m** ÃÂÃÂ· **Eco sociale 30.5m**.
  ...
  - Garanties 1er rang stock end-2024 **ÃÂÃÂ8.822bn** (SWCS/CRAC/FLFNW/SWL dominant).
...
### 2026-07-27T18:20:00Z ÃÂÃÂ tick 135
- Unit: **rq_127** (FWB budget 2026 named culture education transfers L5)
- Found (strong ExpGen + GW CP; medium sector savings path):
  - Totals already mapped: dep ~15.4bn; edu ~10.9bn class; deficit **ÃÂÃÂ1.6bn** 2026 ? path **ÃÂÃÂ1.2bn** 2029; net structural ~**ÃÂÃÂ500m** to 2029.
  - Named: **debt cost ÃÂÃÂ357m** ÃÂÃÂ· **DO45 Recherche ÃÂÃÂ262.6m** (FNRS Loterie 7.1m; -1.5m index cut) ÃÂÃÂ· **WBI ÃÂÃÂ42.9m** ÃÂÃÂ· **WBE ÃÂÃÂ39.7m** ÃÂÃÂ· **presse quotidienne ÃÂÃÂ12.9m** ÃÂÃÂ· **mÃÂÃÂ©dias proximitÃÂÃÂ© ÃÂÃÂ10m** ÃÂÃÂ· **sport CL ÃÂÃÂ67.9m** ÃÂÃÂ· **FP traitements ÃÂÃÂ437.6m**.
  - **ONE**: structural +**ÃÂÃÂ43m** (Cigogne/contrat) vs IT -3m + non-index actors **ÃÂÃÂ7.84m**; MILAC not implemented.
  - **Culture**: non-index **ÃÂÃÂ3.7m** + moratoria non-spend **ÃÂÃÂ10.2m**; Grignoux -200k of 409k; Point Culture phase-out path.
  - **SupÃÂÃÂ©rieur** savings package **ÃÂÃÂ14m** 2026 (minerval compensations 9m; CHU LiÃÂÃÂ¨ge capital stop 2.8m).
...
### 2026-07-27T18:45:00Z ÃÂÃÂ tick 136
- Unit: **rq_128** (Brussels SGRBC top named transfers STIB culture L5)
- Found (strong CoA 13 Mar 2026; Visit medium press):
  - SGRBC **eng ÃÂÃÂ8.9bn / liq ÃÂÃÂ8.0bn**; Table9 top programmes ÃÂÃÂ71% of liq.
  - **STIB ÃÂÃÂ1.1676bn** ÃÂÃÂ· **Actiris ÃÂÃÂ648.1m** (-78.2m) ÃÂÃÂ· **titres-services ÃÂÃÂ303.8m** ÃÂÃÂ· **SLRB eng ÃÂÃÂ687m / liq ÃÂÃÂ418m** ÃÂÃÂ· **Bruxelles-PropretÃÂÃÂ© liq ÃÂÃÂ411.1m** ÃÂÃÂ· **commissions ÃÂÃÂ691.7m** ÃÂÃÂ· **dette liq ÃÂÃÂ727.8m** ÃÂÃÂ· **pouvoirs locaux ÃÂÃÂ757.6m** ÃÂÃÂ· **routes liq ÃÂÃÂ263.9m**.
  - Culture flagship: **Kanal eng ÃÂÃÂ86.7m** (+ÃÂÃÂ60m participation/credit); CoA flags OAA2 list omission.
  - Initiatives rÃÂÃÂ©gionales **eng ÃÂÃÂ330m / liq ÃÂÃÂ130m** (Vivaqua+Confex); finops path SLRB 400 / Vivaqua 180 / Confex 150 / Kanal 60 within ÃÂÃÂ1bn max.
  - Facultatives **-ÃÂÃÂ25m/yr** 2026-29; emploi BEE total **ÃÂÃÂ983.6m**; PPI STIB cut path **ÃÂÃÂ964.6m** 2026-29.
  - Visit.brussels cut **~ÃÂÃÂ5.7m** 2026 medium press only.
...
### 2026-07-27T19:10:00Z ÃÂÃÂ tick 137
- Unit: **rq_153** (FPS taxex remaining top 20 not yet imported)
- Found (strong FPS inventory XLSX latest-year per sheet):
  - Imported **20** measures previously missing from tax_expenditures.csv (sum latest-year ÃÂÃÂ **ÃÂÃÂ48.6bn** ÃÂÃÂ not additive with prior top20; many structural design lines).
  - Largest **current** additions: **PIT tax-free basic ÃÂÃÂ18.058bn** (2023) ÃÂÃÂ· **professional expenses salaries ÃÂÃÂ9.842bn** ÃÂÃÂ· **family allowances exemption ÃÂÃÂ2.900bn** ÃÂÃÂ· **dependent-children tax-free ÃÂÃÂ2.694bn** ÃÂÃÂ· **distinct taxation rates ÃÂÃÂ2.665bn** ÃÂÃÂ· foreign-income 100% ÃÂÃÂ2.271bn.
  - Other: WT movable first-bracket ÃÂÃÂ565m ÃÂÃÂ· marital quotient ÃÂÃÂ545m ÃÂÃÂ· disability allow ÃÂÃÂ420m ÃÂÃÂ· overtime credit ÃÂÃÂ386m ÃÂÃÂ· unemployment TE ÃÂÃÂ350m ÃÂÃÂ· flexi-jobs ÃÂÃÂ314m ÃÂÃÂ· CIT intra-group ÃÂÃÂ321m ÃÂÃÂ· R&D refundable credit ÃÂÃÂ315m ÃÂÃÂ· industrial motor gas oil ÃÂÃÂ313m.
  - Historical peaks included for inventory completeness: venture capital old system **ÃÂÃÂ5.375bn** (2011); owner-occupied housing 2008; imputed income 2013.
  - Leaderboard: structural tax-free basic (low absurdity) ÃÂÃÂ· professional expenses ÃÂÃÂ· family allow ÃÂÃÂ· distinct taxation (higher reform interest).
...
### 2026-07-27T19:30:00Z ÃÂÃÂ tick 138
- Unit: **rq_138** (Trade union public grants SS/federal ÃÂÃÂ unemployment payment organisms)
- Found (strong parliament; medium path):
  ...
  - **Private OP admin from ONEM 2024: ÃÂÃÂ169m** (Kamer DOC 56 1296 cites official).
  - **Total all OP incl HVW: ~ÃÂÃÂ219m** (same bill + QRVA 56 028 citing minister: 219m for 333k werklozen/SWT).
  - Implied HVW share ~ÃÂÃÂ50m vs site institutional budget **ÃÂÃÂ6.084m** ÃÂÃÂ dual perimeter; keep both.
  - Path Clarinval: envelope **-ÃÂÃÂ20m 2026 / -ÃÂÃÂ27m 2027** vs 2025 (~16% cut) while full-unemp dossiers path **-~63%** by 2027 (184k lose benefit).
  - 2022 Dermagne formula change: **+ÃÂÃÂ7.6m** that year; **+ÃÂÃÂ13m** effect by 2025; softens cuts when unemployment falls.
...
### 2026-07-27T19:50:00Z ÃÂÃÂ tick 139
- Unit: **rq_139** (Mutualities RIZIV public financing ÃÂÃÂ admin package)
- Found (strong KB-cited; medium 2025):
  - **5 landsbonden admin envelope:** **ÃÂÃÂ1.195bn 2023** ÃÂÃÂ· **ÃÂÃÂ1.285bn 2024** (KB 9 Apr 2024 BS) ÃÂÃÂ· **ÃÂÃÂ1.375bn 2025** medium (+7% y/y; +15% in 2y).
  - **HR Rail Care:** **ÃÂÃÂ22.8m 2024** / ÃÂÃÂ21.2m 2023.
  - Total 5+rail 2024 ÃÂÃÂ **ÃÂÃÂ1.308bn**.
  - Members end-2022 (proportional split base): CM 4.59m ÃÂÃÂ· Solidaris 3.28m ÃÂÃÂ· Helan 2.26m ÃÂÃÂ· Neutral 0.59m ÃÂÃÂ· Liberal 0.54m.
  - vs RIZIV care authorized **ÃÂÃÂ40.99bn 2026** ? admin class ~**3.4%** of care package.
  - Accountability reform path: **ÃÂÃÂ25m 2026 ? ÃÂÃÂ100m 2029** (medium reform motives).
...
### 2026-07-27T20:10:00Z ÃÂÃÂ tick 140
- Unit: **rq_143** (Antwerp city open data / ebesluit subsidy recheck)
- Found (strong ebesluit primary; no Gent-style full register):
  - **Toneelhuis 2025: ÃÂÃÂ2.805m** (2.74m werking + 65k gebouwbeheerder) ÃÂÃÂ college Dec 2024.
  - **Opera Ballet Vlaanderen 2025: ÃÂÃÂ1.9m** werk + **ÃÂÃÂ0.508m** invest.
  - **deSingel 2024: ÃÂÃÂ0.100m** (talent/Dear Antwerp).
  - **Zorgbedrijf 2024 package:** werk **ÃÂÃÂ33.63m** + responsabilisering **ÃÂÃÂ20.56m** + invest **ÃÂÃÂ11.97m** ÃÂÃÂ **ÃÂÃÂ66.2m** (largest named city transfer); 2023 werk 36.3 + resp 15.8 + invest 14.5.
...
### 2026-07-27T20:30:00Z ÃÂÃÂ tick 141
- Unit: **rq_155** (Company cars TE component split primary)
- Found (strong FPB WP 202504 Jun 2025; FFS prior):
  - **FPB central TE: ~ÃÂÃÂ4.7bn (2025) ? ~ÃÂÃÂ5.2bn (2028)** if BIK taxed as wage (CASMO); sensitivity **ÃÂÃÂ3ÃÂÃÂ6bn**.
  - **Components (direction):** private-use cluster (PIT + SSC on availability dominant) ÃÂÃÂ **ÃÂÃÂ4.2bn** of 2025 gap; **non-recovered VAT ~ÃÂÃÂ0.6bn** (2028); **CIT offset -ÃÂÃÂ0.1bn**.
  - Named TE categories: SS contribution on availability ÃÂÃÂ· income tax on availability ÃÂÃÂ· VAT on energy ÃÂÃÂ· income tax+SS on fuel/electricity ÃÂÃÂ· disallowed expenses.
  - **FFS inventory 2024 ÃÂÃÂ3.142bn** remains narrower official inventory line; dual methods kept (not force-reconcile).
...
### 2026-07-27T20:50:00Z ÃÂÃÂ tick 142
- Unit: **rq_129** (SS Maribel named fund L5 sample beyond NBB totals)
- Found (strong fund jaarverslagen + FOD WASO):
  - **FSM 319.01 Flanders** (VSPF 2023): social **ÃÂÃÂ75.938m** + fiscal **ÃÂÃÂ14.788m** = **ÃÂÃÂ90.726m**; max ÃÂÃÂ46.7k/VTE.
  - **FSM socioculture Flanders** (VSPF 2023): social **ÃÂÃÂ31.589m**; total social+fiscal **ÃÂÃÂ38.012m** (~833 VTE; ~600 orgs).
  - **FSM 319 bicommunal** (FeBi): social **ÃÂÃÂ5.108m 2023 / ÃÂÃÂ5.801m 2024**; fiscal **ÃÂÃÂ0.941m / ÃÂÃÂ1.037m**.
  - **Public sector fund:** annual fiscal-substitute compensation **ÃÂÃÂ38.72m** (FOD WASO).
  - Sample sum class **~ÃÂÃÂ174m** ÃÂÃÂ **12%** of NBB SS Maribel **ÃÂÃÂ1.461bn 2024** ÃÂÃÂ residual especially **PC 330 health** bulk still FOI.
...
### 2026-07-27T21:10:00Z ÃÂÃÂ tick 143
- Unit: **rq_118** (IEFH/IGVM federal equality institute funding map)
- Found (strong IEFH Rapport annuel 2024 primary):
  - **Federal dotation 2024: ÃÂÃÂ33.939m** (budget authority; may exceed cash).
  - **Total expenditure 2024: ÃÂÃÂ24.793m** ÃÂÃÂ personnel ÃÂÃÂ6.908m (28%) ÃÂÃÂ· ops ÃÂÃÂ2.562m ÃÂÃÂ· **subsidies to orgs ÃÂÃÂ1.609m** ÃÂÃÂ· **CPVS ÃÂÃÂ10.926m (44%)** ÃÂÃÂ· projects ÃÂÃÂ2.735m ÃÂÃÂ· inv ÃÂÃÂ0.053m.
  - Multi-year exp path (kÃÂÃÂ): 2020 12830 ? 2021 9841 ? 2022 14650 ? 2023 22931 ? 2024 24793.
  - **Protocols 2024: ÃÂÃÂ222.9k** (WAL 81.3 ÃÂÃÂ· FWB 33.5 ÃÂÃÂ· BXL 100.0 ÃÂÃÂ· DG 8.1 ÃÂÃÂ· **Flanders 0**).
  - Lottery ÃÂÃÂ150k; own ÃÂÃÂ76k; EU Gender&Work ÃÂÃÂ1.014m; COCOF/Actiris renewals ÃÂÃÂ47.8k/ÃÂÃÂ32.5k.
...
- Found (strong FIRM annual reports 2024 EN + 2025 NL primary):
  ...
  - **Expenditure:** 2023 **EUR 1.653m** ÃÂÃÂ· 2024 **EUR 2.489m** ÃÂÃÂ· 2025 **EUR 3.516m**.
  - **Total budget 2025: EUR 4.984m** (grant + surplus **EUR 1.215m**); 2026 finance **EUR 5.083m** (grant 3.223 + surplus 1.860).
  - Large **surplus buffer** (balance end-2024 **EUR 1.860m** ÃÂÃÂ· end-2025 **EUR 1.468m**).
...
- Found (strong JV2023 + JV2024 + JV2025 web + PQ130):
  - **Overheidsfinanciering:** 2022 **EUR 290.6m** ÃÂÃÂ· 2023 **297.9m** ÃÂÃÂ· 2024 **304.4m** ÃÂÃÂ· 2025 **306m**.
  ...
  - **Eigen inkomsten:** 2023 **199.7** ÃÂÃÂ· 2024 **203.7** ÃÂÃÂ· 2025 **222.3**; total rev 2025 **528.4m**.
...
- Found (strong Actiris Rapport annuel 2024 Budget table):
  - **Budget final 2024: EUR 767.506m** ÃÂÃÂ· **exp realized EUR 729.736m** (95.1%) ÃÂÃÂ· recettes **753.574m**.
  - **Top L5 realized:** 6e reforme **EUR 225.0m** (30.8%) ÃÂÃÂ· **ACS jobs EUR 200.9m** (27.5%) ÃÂÃÂ· functioning **EUR 167.9m** (23.0%) ÃÂÃÂ· partnerships **EUR 57.7m** ÃÂÃÂ· economie sociale **EUR 34.5m**.
  - Other named: jeunes 8.8 ÃÂÃÂ· contrats insertion 7.3 ÃÂÃÂ· Garantie Jeunes 7.1 ÃÂÃÂ· cheques 6.8 ÃÂÃÂ· reforme aide 4.7 ÃÂÃÂ· secteurs ref 4.9.
...
- Found (strong CRC HO 2024 + KU Leuven JV 2025):
  - **VL universities 1st stream 2024: EUR 1.441bn** (werking **1.355bn** ÃÂÃÂ· invest **45.6m** ÃÂÃÂ· STUVO **30.4m**); path 1.167?1.441bn 2020-24.
  - **AHOVOKS effectieve werkingsmiddelen 2024: EUR 1.224bn**; **EUR 8,286/student**; 149,848 students.
  - **2nd/3rd/4th streams 2024:** 460m ÃÂÃÂ· 712m ÃÂÃÂ· 378m (research).
...
- Found (strong Rekenhof 2025 + VNR + Fluvius + NBB):
  ...
  - **GSC:** 2023 **EUR 822m** ÃÂÃÂ· cum **10.51bn**; NBB broader green cert **956/858m 2023-24**.
  - **WKC CHP:** 2023 **EUR 174m** ÃÂÃÂ· cum **1.79bn**; Fluvius cert inventory **EUR 602m** EOY2025 (CHP 521m).
  - **Heat premiums (warmtepomp etc):** 2023 **EUR 22m** ÃÂÃÂ· cum **112m** 2014-23 (netbeheerder).
  - **Calls/ad hoc:** groene warmte **109m** ÃÂÃÂ· PV premie **158m** ÃÂÃÂ· retro **159m** ÃÂÃÂ· warmtenet **53.5m** ÃÂÃÂ· call stroom **37m**.
...
### 2026-07-28T00:30:00Z ÃÂ¢ÃÂÃÂ tick 153
...
- Found (strong primary Kamer Doc 56 1281/004 sectie 07):
  ...
  - Secondary social-media claim **EUR 2.213m** does **not** match Kamer AB (~1.6m) ÃÂ¢ÃÂÃÂ **do not use** as official.
...
### 2026-07-28T00:50:00Z ÃÂ¢ÃÂÃÂ tick 154
- Unit: **rq_149** (Housing regional subsidies ÃÂ¢ÃÂÃÂ VL social housing + WAL SWL)
- Found (strong primary BBT Wonen BO2026 + WAL DO16):
  - **VL programme QD WONEN BO2026:** VAK **EUR 3.291bn** ÃÂÃÂ· VEK **EUR 348.0m** (BA2025 VEK 377.8m).
  ...
  - **EIB facility:** **EUR 1.7bn** (first tranche **700m**) preferential loans ÃÂ¢ÃÂÃÂ not pure grant.
  - **WAL SWL named liq sum ~EUR 118.0m:** PEI **55.3** ÃÂÃÂ· PRW liq **25.5** ÃÂÃÂ· PIVERT **22.4** ÃÂÃÂ· Ancrage **9.8** ÃÂÃÂ· Impulsion **5.0**.
...
### 2026-07-28T01:15:00Z ÃÂ¢ÃÂÃÂ tick 155
- Unit: **rq_145** (Brussels communes Ixelles / Schaerbeek / Anderlecht L5 sample)
- Found:
  - **Ixelles (medium ÃÂ¢ÃÂÃÂ DH quotes echevine Gilson):** ord rec **~EUR 253m** ÃÂÃÂ· ord dep **~EUR 258m+** ÃÂÃÂ· provisions **>5.5m** ÃÂÃÂ· invest **46.2m** (emprunt **26.9m**) ÃÂÃÂ· transfers **+9.4m** (CPAS **+6.07m** ÃÂÃÂ· Iris catch-up **4.75m** ÃÂÃÂ· police **+0.3m**) ÃÂÃÂ· debt path **119ÃÂ¢ÃÂÃÂ210m** ÃÂÃÂ· participatif **0.17m strong**.
  - **Schaerbeek (strong note + medium RTBF total):** invest **EUR 60m** ÃÂÃÂ· Brichaut creche **6.5m** (commune **1.3m**) ÃÂÃÂ· Hoogvorst **~6m** (commune **2m**) ÃÂÃÂ· RenovaS Dupont **5m** ÃÂÃÂ· Plantes **3m** ÃÂÃÂ· sport **>2m** ÃÂÃÂ· trottoirs **1.5m** ÃÂÃÂ· Terdelt **1.2m** ÃÂÃÂ· CPAS federal class **~17m** ÃÂÃÂ· AS hire **0.95m**.
  - **Anderlecht (strong CP):** equilibrium claimed ÃÂÃÂ· asphalt **1.2m** ÃÂÃÂ· sidewalks **0.85m** ÃÂÃÂ· associative/sport maintained without EUR totals.
- Wrote: sources 5; entities 3; budgets ~27; cmt 3; lb 4; rq_145=done; FOI residual ready.
- FOI: gap_bru_communes_subsidies_top20 (full BI PDFs + ASBL top20 ÃÂÃÂ3) human send only.
- Next: prio5 **rq_146 DGD** / **rq_147 defence** / **rq_150 justice** / **rq_121 hole-fill**.

### 2026-07-28T01:40:00Z ÃÂ¢ÃÂÃÂ tick 156
- Unit: **rq_146** (Federal development cooperation DGD / Enabel L5 envelopes)
- Found (strong primary DGD AR 2025 + Enabel RA 2025-26):
  - **DGD total:** **EUR 1,117.97m 2025** (1,440.92m 2024; 1,285.90m 2023); cut **ÃÂ¢ÃÂÃÂ106m** year1 of **ÃÂ¢ÃÂÃÂ25% by 2027**.
  - **Channels:** Enabel line **212.02m** ÃÂÃÂ· gov subtotal **250.35m** ÃÂÃÂ· humanitarian **170m** (protected).
  - **Themes:** climate **365.3m** ÃÂÃÂ· stability **301.8m** ÃÂÃÂ· humanitarian theme **181.5m** ÃÂÃÂ· other **175.0m** ÃÂÃÂ· health **98.8m**.
  - **Top recipients:** DRC **104.49m** ÃÂÃÂ· Burkina **28.0** ÃÂÃÂ· Uganda **27.8** ÃÂÃÂ· Burundi **27.2** ÃÂÃÂ· Niger **26.3** ÃÂÃÂ· Palestine **24.7** ÃÂÃÂ· Senegal **20.1** ÃÂÃÂ· Ukraine **18.2** ÃÂÃÂ· Benin **17.8** ÃÂÃÂ· Mali **14.6**.
  - **Named samples:** LDCF **18.5m** ÃÂÃÂ· Sahel package **50m** ÃÂÃÂ· SOFF +**8.3m**.
  - **Enabel:** turnover **407.1m** (was 329.2m) ÃÂÃÂ· charges **438.1m** ÃÂÃÂ· personnel **91.0m** ÃÂÃÂ· EU contracts **152m** ÃÂÃÂ· intl finance **182m** ÃÂÃÂ· assets **217.4m**.
...
### 2026-07-28T02:05:00Z ÃÂ¢ÃÂÃÂ tick 157
- Unit: **rq_147** (Defence major contracts L5 named)
- Found (strong primary SV2025 + Rekenhof 2025_16):
  - **Portfolio 2026-34 (Cst26):** commit **EUR 33.784bn** ÃÂÃÂ· pay **24.661bn** (Land 13.9 ÃÂÃÂ· Air 10.3 ÃÂÃÂ· Maritime 3.4 ÃÂÃÂ· ICI 3.5 ÃÂÃÂ· Comdo 2.7).
  - **Named L5 (SV):** F-35 **+11** **1.672bn** (+ support **445m**) ÃÂÃÂ· 3rd **ASWF** **1.270bn** ÃÂÃÂ· **NASAMS** 10 FU **2.032bn** ÃÂÃÂ· SBAMD long 3 FU **1.982bn** ÃÂÃÂ· MCM toolboxes **657m** ÃÂÃÂ· SAR heli 4 **193m**.
  - **Camo (CoA):** 382 Griffon + 60 Jaguar **1.575bn** invest ÃÂÃÂ· lifecycle TCO **ÃÂ¢ÃÂÃÂ¥14.7bn**/25y ÃÂÃÂ· STAR motorized extra **4.78bn** ÃÂÃÂ· STAR law **+11.176bn** 2023-30.
...
### 2026-07-28T02:30:00Z ÃÂ¢ÃÂÃÂ tick 158
- Unit: **rq_150** (Justice prisons courts dual NL/FR overhead sample)
- Found (strong primary FOD PSP + Rekenhof DBFM 2023):
  - **Justitie ~EUR 2.7bn/yr:** courts **1.431bn** ÃÂÃÂ· prisons **799m** ÃÂÃÂ· cults **136.2m** ÃÂÃÂ· central **184.1m** ÃÂÃÂ· grants **303m** ÃÂÃÂ· ops **496.7m** ÃÂÃÂ· invest **74.7m** ÃÂÃÂ· personnel **67%**.
  - **Detention:** unit cost **EUR 55,624** (2022) ÃÂÃÂ· pop **13,483** / capacity **11,098** (121.5% Nov 2025).
  - **DBFM prisons (CoA):** 9 sites **3,874** places ÃÂÃÂ· annual fees **ÃÂ¢ÃÂÃÂ¥153.1m** full ÃÂÃÂ· **25y EUR 3.828bn** ÃÂÃÂ· Haren **48.4m/yr** (1,190 places) ÃÂÃÂ· MP1 **53.0m/yr** ÃÂÃÂ· off-balance **2.6bn** eoy2022.
  - Dual NL/FR: constitutional; euro L5 (tolk/vertaling) **not** published ÃÂ¢ÃÂÃÂ FOI.
...
### 2026-07-28T02:55:00Z ÃÂ¢ÃÂÃÂ tick 159
...
- Found (strong city sources + BeSafe mechanism):
  ...
  - **City-side sample (ranked):** Gent **EUR 110.6m** (2024 register) ÃÂÃÂ· Charleroi ZPL **82.9m** (BI2026) ÃÂÃÂ· Brugge **33.75m** (MJP 2026; 32.9m register 2024) ÃÂÃÂ· Namur **27.6m** (2026).
  - **Sample sum (mixed years):** **EUR 254.8m** (4 cities, city-side only).
  - **Gent MJP path (medium press):** **~746m / 6y** (~120ÃÂ¢ÃÂÃÂ130m/yr class).
...
- Next: prio5 **rq_121** FOI-adjacent public hole-fill; **rq_116** SWA deferred (OctÃÂ¢ÃÂÃÂDec).

### 2026-07-28T03:20:00Z ÃÂ¢ÃÂÃÂ tick 160
- Unit: **rq_121** (FOI-adjacent hole-fill batch ÃÂ¢ÃÂÃÂ NMBS 2025 + VDAB 2024)
- Found:
  - **NMBS 2025 (strong official):** EBITDA **EUR 54.2m** (was 131.6m) ÃÂÃÂ· economic debt **1.532bn** (was 2.146bn) ÃÂÃÂ· invest **>820m** (rolling **350** ÃÂÃÂ· stations **213** ÃÂÃÂ· digital **152** ÃÂÃÂ· workshops **89**) ÃÂÃÂ· ODC path hyp **ÃÂ¢ÃÂÃÂ100m** vs 2025 contractual assumptions ÃÂÃÂ· rail sector savings demand **675m 2025-29** ÃÂÃÂ· staff **16,976** ÃÂÃÂ· passengers **207.8m** ÃÂÃÂ· punctuality **91.7%**.
  - **VDAB 2024:** staff **4,761** (ÃÂ¢ÃÂÃÂ230) strong JV ÃÂÃÂ· institutional total **962m** / VL dots **783m** medium (VP PQ premise; minister ÃÂ¢ÃÂÃÂ jaarrekening) ÃÂÃÂ· PMO ~**160m** project means since 2019.
...
- Next: prio5 **rq_152** ÃÂÃÂ· deferred **rq_116** SWA.

### 2026-07-28T03:45:00Z ÃÂ¢ÃÂÃÂ tick 161
- Unit: **rq_156** (FOI-adjacent hole-fill ÃÂ¢ÃÂÃÂ **Infrabel geconsolideerd JV 2024** rail dual NMBS)
- Found (strong primary PDF 4.4 MB, 53 pp):
  - **Omzet** EUR **843.2m** 2024 (875.2m 2023).
  - **Exploitatiesubsidies** **560.9m** (583.9m) ÃÂ¢ÃÂÃÂ ÃÂ¢ÃÂÃÂ23.0m y/y.
  - **Kapitaalsubsidies** P&L recognition **794.9m** (774.7m); **stock** LT+ST **18.589bn**.
  - Bedrijfsopbrengsten vÃÂÃÂ³ÃÂÃÂ³r kap. **1.967bn**; EBITDA-like **114.4m**; bedrijfsresultaat **82.0m**; **resultaat 33.6m**.
  - Balanstotaal **25.231bn**; materiÃÂÃÂ«le VA **20.323bn** (+452.7m invest effect); fin. debt **~3.24bn**; cash **625m**.
  - **Liefkenshoek PPS:** annual specific State subsidy **50.61m (2008 ÃÂ¢ÃÂÃÂ¬)** through 2032; LT receivable restatement **416.6m**.
  - Credit line up to **1bn** invest 2025-29; Alstom switches **~80m**; Thales cyber **20m/5y** (editorial medium).
  - Note: P&L personnel only **75.7m** ÃÂ¢ÃÂÃÂ bulk staff via **HR Rail** inside **diensten 1.508bn**.
- De Lijn 2025 JV PDF still **403** on ctfassets; press metrics already in DB (surplus 20k; pax 372.9m; ÃÂ¢ÃÂÃÂ27.5m dotatie).
...
### 2026-07-28T04:05:00Z ÃÂ¢ÃÂÃÂ tick 162
- Unit: **rq_157** (FOI-adjacent hole-fill ÃÂ¢ÃÂÃÂ **FOREM Wallonie budget 2026 programme 130 L5**)
- Found (strong primary EP Jeholet DO18, kEUR table eng=liq):
  ...
  - **APE 1.279bn** (45%) ÃÂÃÂ· **titres-services 568.4m** ÃÂÃÂ· **fonctionnement FOREM 419.7m** ÃÂÃÂ· SESAM **106.9m** ÃÂÃÂ· ONSS draw **136.8m** ÃÂÃÂ· CISP **104.3m** ÃÂÃÂ· activation **76.2m**.
  - 2025 legacy: prog12 **370.1m** ÃÂÃÂ· titres **567.6m** ÃÂÃÂ· formation prog22 **344.6m** (folded into 130 in 2026).
...
### 2026-07-28T04:25:00Z ÃÂ¢ÃÂÃÂ tick 163
- Unit: **rq_158** (FOI-adjacent hole-fill ÃÂ¢ÃÂÃÂ **VL universities per-institution CRC HO 2024**)
- Found (strong primary CRC PDF; 1st-stream reverse-engineered medium):
  - Sector: bedrijfsopbr **3.504bn** ÃÂÃÂ· kosten **3.467bn** ÃÂÃÂ· bedrijfsresult **37.0m** (was 131m) ÃÂÃÂ· resultaat **159.6m** ÃÂÃÂ· personnel **2.198bn** ÃÂÃÂ· invest **260.2m** ÃÂÃÂ· VTE **30ÃÂ¢ÃÂÃÂ¯419**.
  - **Results 2024:** KUL **+180.2m** ÃÂÃÂ· UGent **ÃÂ¢ÃÂÃÂ32.3m** ÃÂÃÂ· UA **+2.4m** ÃÂÃÂ· UHasselt **+9.5m** ÃÂÃÂ· VUB **ÃÂ¢ÃÂÃÂ0.2m**.
  - **Invest:** KUL **108.1m** ÃÂÃÂ· UGent **57.6m** ÃÂÃÂ· VUB **54.6m** ÃÂÃÂ· UA **24.7m** ÃÂÃÂ· UHasselt **15.2m**.
  - **Students:** KUL 56ÃÂ¢ÃÂÃÂ¯114 ÃÂÃÂ· UGent 46ÃÂ¢ÃÂÃÂ¯128 ÃÂÃÂ· UA 20ÃÂ¢ÃÂÃÂ¯414 ÃÂÃÂ· VUB 19ÃÂ¢ÃÂÃÂ¯889 ÃÂÃÂ· UHasselt 7ÃÂ¢ÃÂÃÂ¯303 (sum 149ÃÂ¢ÃÂÃÂ¯848).
  - **VTE:** KUL 12ÃÂ¢ÃÂÃÂ¯350 ÃÂÃÂ· UGent 8ÃÂ¢ÃÂÃÂ¯938 ÃÂÃÂ· UA 4ÃÂ¢ÃÂÃÂ¯019 ÃÂÃÂ· VUB 3ÃÂ¢ÃÂÃÂ¯618 ÃÂÃÂ· UHasselt 1ÃÂ¢ÃÂÃÂ¯494.
  - **1st stream implied (medium):** UGent **~428m** ÃÂÃÂ· UA **~207m** ÃÂÃÂ· VUB **~166m** ÃÂÃÂ· UHasselt **~94m** (+ KUL **546.5m strong JV**); sum ÃÂ¢ÃÂÃÂ sector **1.441bn**.
...
### 2026-07-28T04:45:00Z ÃÂ¢ÃÂÃÂ tick 164
- Unit: **rq_159** (FOI-adjacent hole-fill ÃÂ¢ÃÂÃÂ **bpost Consolidated AR 2024 SGEI package**)
- Found (strong primary consol AR PDF, note 6.7 + related-party):
  - **SGEI remuneration:** **EUR 227.8m 2024** / **311.9m 2023** (ÃÂ¢ÃÂÃÂ84.1m y/y).
  - Method: net avoided cost (NAC); 7th management contract SGEIs (retail network ÃÂ¢ÃÂÃÂ¥1300 points, cash-at-counter, pensions, ad-hoc) + press newspapers/periodicals **until 2024-06-30**.
  ...
  - Overcompensation provision **75.0m** (prior years, 3 services); SGEI receivable **74.6m** eoy2023 ÃÂ¢ÃÂÃÂ **0** eoy2024.
  - Dual series: NBB ESA D.31 **329m** 2024 vs SGEI **227.8m** ÃÂ¢ÃÂÃÂ residual **~101m** medium perimeter gap (2023 gap only ~12m).
...
### 2026-07-28T05:05:00Z ÃÂ¢ÃÂÃÂ tick 165
- Unit: **rq_160** (FOI-adjacent hole-fill ÃÂ¢ÃÂÃÂ **FWB universities DO54 BI2026 per-institution L5**)
- Found (strong primary Budget des dÃÂÃÂ©penses 2026, *en milliers d'euros*, eng=liq):
  - **Alloc fonctionnement 2026:** UCLouvain **330.911m** ÃÂÃÂ· ULB **275.862m** ÃÂÃÂ· ULiÃÂÃÂ¨ge **249.252m** ÃÂÃÂ· UMons **89.797m** ÃÂÃÂ· UNamur **72.197m** ÃÂÃÂ· **sum 1.018bn** (2025 sum **978.8m**).
  - **DO54 CELL total 1.153bn** 2026 (prog1 CommunautÃÂÃÂ© **361.0m** ÃÂÃÂ· prog2 libres **718.8m** ÃÂÃÂ· prog4 **69.8m**).
  - Social unis: Comm **12.2m** ÃÂÃÂ· libres **28.3m** ÃÂÃÂ· minerval compensations **52.4m** (was 56.5m) ÃÂÃÂ· aides rÃÂÃÂ©ussite **14.9m** ÃÂÃÂ· art.34 **11.4m**.
  - CHU LiÃÂÃÂ¨ge capital line **2.785m ÃÂ¢ÃÂÃÂ 0** 2026 (matches ExpGen savings note).
  - Hautes ÃÂÃÂcoles CF allocations globales **122.5m** + social HE **41.3m** (DO55 sample).
...
### 2026-07-28T05:25:00Z ÃÂ¢ÃÂÃÂ tick 166
- Unit: **rq_161** (FOI-adjacent hole-fill ÃÂ¢ÃÂÃÂ **HR Rail NV PR institutional omzet/FTE**)
- Found (medium: Companyweb citing **NBB CBSO** jaarrekening BE0541.691.352; filing class 2026-06-10):
  - **Omzet:** **EUR 2.368bn 2025** (+2.75%) ÃÂÃÂ· **2.305bn 2024** ÃÂÃÂ· **2.206bn 2023** ÃÂÃÂ· **2.078bn 2022**.
  - **FTE:** **27ÃÂ¢ÃÂÃÂ¯811 (2025)** ÃÂÃÂ· 27ÃÂ¢ÃÂÃÂ¯568.5 (2024) ÃÂÃÂ· 27ÃÂ¢ÃÂÃÂ¯524.5 (2023) ÃÂÃÂ· 27ÃÂ¢ÃÂÃÂ¯435 (2022).
  - **Resultaat:** ~**1.57m 2025** (pass-through; not a profit centre) ÃÂÃÂ· equity **28.3m**.
  - **Brutomarge** ÃÂ¢ÃÂÃÂ omzet (payroll re-invoice to NMBS+Infrabel under KB 11 Dec 2013).
  - Dual rail stack: NMBS staff count 16ÃÂ¢ÃÂÃÂ¯976 (2025 results) ÃÂ¢ÃÂÃÂ HR Rail 27.8k (rest mostly Infrabel).
...
### 2026-07-28T05:45:00Z ÃÂ¢ÃÂÃÂ tick 167
- Unit: **rq_162** (FOI-adjacent hole-fill ÃÂ¢ÃÂÃÂ **VIPA 2026 envelope + De Lijn MJR path**)
- Found (strong primary: MJR 2025-30 + VP commissie Gennez + begroting tables):
  - **VIPA total:** **EUR 180m 2026** (no +20m expansion) ÃÂÃÂ· path **295m 2029**.
  - **Hospital forfait:** **77.3m 2025 ÃÂ¢ÃÂÃÂ 89.6m 2026** (+14.5m room new awards).
  - Ouderen forfait **~35ÃÂ¢ÃÂÃÂ40m** ÃÂÃÂ· handicap auth **16.8m** ÃÂÃÂ· instandhouding **+27.2m** (table 27.692m).
  - Expansion cut **ÃÂ¢ÃÂÃÂ20m** ÃÂÃÂ· classic VEK budgeted **33m** vs need claim 68m ÃÂÃÂ· kinderopvang shift **60m**.
  - **De Lijn ESR-ontvangsten (own, not toelage):** BA2025 **264.3m** ÃÂÃÂ· BO2026 **313.8m** ÃÂÃÂ· const **263.8m** ÃÂÃÂ· 2030 **250.9m**.
  - E-bus VAK extra **+400m** path ÃÂÃÂ· OV savings **ÃÂ¢ÃÂÃÂ50m 2026** ÃÂ¢ÃÂÃÂ **ÃÂ¢ÃÂÃÂ125m 2029** ÃÂÃÂ· MOW punctual **30m/yr** ÃÂÃÂ· VEK peaks **+145m 2027** / **+59m 2028** ÃÂÃÂ· VEK actualisatie **ÃÂ¢ÃÂÃÂ61.3m**.
...
### 2026-07-28T06:05:00Z ÃÂ¢ÃÂÃÂ tick 168
- Unit: **rq_163** (FOI-adjacent hole-fill ÃÂ¢ÃÂÃÂ **CREG AR2025 offshore support + nuclear repartition**)
- Found (strong primary CREG Rapport annuel 2025 FR, 92 pp):
  ...
  - Production: inject **6ÃÂ¢ÃÂÃÂ¯780 GWh** (vs 7ÃÂ¢ÃÂÃÂ¯054 in 2024); net certified **6ÃÂ¢ÃÂÃÂ¯912 GWh**.
  ...
  - Bonus L5: nuclear contribution de rÃÂÃÂ©partition **Electrabel 152.5m + Luminus 8.8m = 161.3m 2025**.
...
### 2026-07-28T06:25:00Z ÃÂ¢ÃÂÃÂ tick 169
- Unit: **rq_164** (FOI-adjacent hole-fill ÃÂ¢ÃÂÃÂ **CREG federal GC OSP + CRM costs**)
- Found (strong CREG AR2025 ÃÂÃÂ§3.1.3.5; medium Elia auction press):
  - **Federal GC OSP financing (Elia):** est **EUR 675.707m 2025** ÃÂ¢ÃÂÃÂ **551.352m 2026** (ÃÂ¢ÃÂÃÂ125.4m; higher power ref price 87.56 vs 58.02 ÃÂ¢ÃÂÃÂ¬/MWh).
  - Settlements: StateÃÂ¢ÃÂÃÂElia **39.5m** H2-2024; EliaÃÂ¢ÃÂÃÂState **110.4m** H1-2025.
  ...
  - **Elia Oct 2025 auctions** (Y-1/Y-2/Y-4): package cost **125.4m** (was **182.9m**); **4ÃÂ¢ÃÂÃÂ¯556 MW** (171 new); WAP **14.1k ÃÂ¢ÃÂÃÂ¬/MW/y**.
...
### 2026-07-28T06:45:00Z ÃÂ¢ÃÂÃÂ tick 170
- Unit: **rq_165** (FOI-adjacent hole-fill ÃÂ¢ÃÂÃÂ **Elia Transmission Belgium IAR 2025**)
- Found (strong primary integrated annual report, consol FS ÃÂ¢ÃÂÃÂ¬m):
  - **Revenue 1.667bn 2025** (1.258bn 2024) ÃÂÃÂ· **profit 300.7m** (245.0m) ÃÂÃÂ· **EBIT 448.7m**.
  - Settlement mechanism **ÃÂ¢ÃÂÃÂ160.9m** 2025 (was **+247.8m** 2024) ÃÂ¢ÃÂÃÂ OSP/GC volatility link.
  - Personnel **264.0m** ÃÂÃÂ· services **646.0m** ÃÂÃÂ· D&A **266.9m**.
  - **CAPEX ~1.47bn** ÃÂÃÂ· **RAB 7.8bn** ÃÂÃÂ· PPE **7.14bn** ÃÂÃÂ· assets **11.68bn** ÃÂÃÂ· equity **4.43bn** (inject **+1.057bn**).
  - Loans LT **4.86bn** + ST **0.63bn** ÃÂÃÂ· cash **1.50bn** ÃÂÃÂ· dividends **99.7m**.
  - CAPEX plan **7.5bn 2025ÃÂ¢ÃÂÃÂ28** ÃÂÃÂ· 2026 invest plan **1.7bn** ÃÂÃÂ· Baekeland **~400m** ÃÂÃÂ· Green Bond **500m**.
  - Grid **8ÃÂ¢ÃÂÃÂ¯851 km** ÃÂÃÂ· reliability **99.99%** ÃÂÃÂ· dual with Fluvius DSO + CRM host.
- Mons BI2026 / Antwerp full register still not newly filled.
...
### 2026-07-28T07:05:00Z ÃÂ¢ÃÂÃÂ tick 171
- Unit: **rq_166** (FOI-adjacent hole-fill ÃÂ¢ÃÂÃÂ **Sibelga BCR DSO 2024 + Fluvius EG deepen**)
- Found (strong primary Sibelga accounts + Fluvius investor update):
  - **Sibelga 2024:** turnover **EUR 415.4m** (379.6m 2023) ÃÂÃÂ· op. profit **74.7m** ÃÂÃÂ· profit **49.1m** ÃÂÃÂ· distributed to municipalities **49.1m**.
  - Assets **1.511bn** ÃÂÃÂ· equity **861m** ÃÂÃÂ· LT fin. debt **357m** ÃÂÃÂ· tangible FA **1.326bn**.
  - Tariff proposal: total income **347.5m** ÃÂÃÂ· fair margin **47.9m** ÃÂÃÂ· manageable **131.4m** ÃÂÃÂ· non-manageable **216.1m** ÃÂÃÂ· RAB init **1.198bn** (end-2018).
  - **Fluvius deepen:** ops result **482m** ÃÂÃÂ· network tariff rev **2.931bn** ÃÂÃÂ· GEC/CHP cost **+149m** ÃÂÃÂ· WACC **5.2%** ÃÂÃÂ· EQ/RAB **33%** ÃÂÃÂ· staff **5ÃÂ¢ÃÂÃÂ¯997** ÃÂÃÂ· dividend policy **60%** ÃÂÃÂ· assets **19.8bn**.
...
### 2026-07-28T07:25:00Z ÃÂ¢ÃÂÃÂ tick 172
- Unit: **rq_167** (FOI-adjacent hole-fill ÃÂ¢ÃÂÃÂ **Vivaqua SC Rapport Financier 2024**)
- Found (strong primary annual accounts, RSM audit unqualified):
  - **CA EUR 325.925m 2024** (333.958m 2023) ÃÂÃÂ· ventes/prestations **469.7m** ÃÂÃÂ· op. profit **25.7m** ÃÂÃÂ· **net loss ÃÂ¢ÃÂÃÂ0.86m** (FRT 2022ÃÂ¢ÃÂÃÂ23 charge **20.6m**).
  - Users Brussels **303.1m** ÃÂÃÂ· wholesale **41.8m** ÃÂÃÂ· production immobilisÃÂÃÂ©e **114.1m** (assain **72.8m**).
  - Assets **1.804bn** ÃÂÃÂ· equity **559.5m** ÃÂÃÂ· LT fin. debt **1.021bn** ÃÂÃÂ· total dettes **1.215bn**.
  - **Subsides en capital net 127.8m** (public nets **26.7m** + Modave **0.8m** + tiers **100.3m**).
  - **MFC Brugel path** 2022ÃÂ¢ÃÂÃÂ26: **16.2 / 21.6 / 24.7 / 28.7 / 27.8m** (sum ~**119m** in tariffs).
  - Hydria assainissement **35.0m** ÃÂÃÂ· BCR **BEI guarantee 206.6m** ÃÂÃÂ· Hydralis pension gap **147.0m** off-BS (cover **83.8%**).
  - **No dividend** (IPM tax regime ÃÂ¢ÃÂÃÂ profits to immunised reserves only). FTE **1ÃÂ¢ÃÂÃÂ¯262**.
...
### 2026-07-28T07:45:00Z ÃÂ¯ÃÂ¿ÃÂ½ tick 173
- Unit: **rq_168** (FOI-adjacent hole-fill ÃÂ¯ÃÂ¿ÃÂ½ **ORES Assets Walloon DSO 2024**)
- Found (strong primary investor presentation BGAAP + IFRS consol accounts):
  - **Turnover BGAAP EUR 1,067.9m 2024** (1,130.3m 2023) ÃÂ¯ÃÂ¿ÃÂ½ **EBITDA 322.1m** (30.2% margin) ÃÂ¯ÃÂ¿ÃÂ½ **EBIT 151.6m** ÃÂ¯ÃÂ¿ÃÂ½ **net 72.4m** (IFRS profit **66.89m**).
  - **Gridfee 907.6m** (elec **716.7m** + gas **190.9m**) ÃÂ¯ÃÂ¿ÃÂ½ RAB **4.17bn** ÃÂ¯ÃÂ¿ÃÂ½ CAPEX **434m** (2023: 384m).
  - Assets BGAAP **5.057bn** ÃÂ¯ÃÂ¿ÃÂ½ equity **2.050bn** ÃÂ¯ÃÂ¿ÃÂ½ LT debt **2.143bn** ÃÂ¯ÃÂ¿ÃÂ½ ST debt **319m** ÃÂ¯ÃÂ¿ÃÂ½ capital subsidies BS **110.1m**.
  - **Dividendes associÃÂ¯ÃÂ¿ÃÂ½s 76.145m** 2024 (AR; IFRS paid re 2023: **74.668m**) ÃÂ¯ÃÂ¿ÃÂ½ municipal public transfer from regulated tariffs.
  - CWaPE 2025 auth rev: elec **630.4m** + gas **218.5m** ÃÂ¯ÃÂ¿ÃÂ½ WACC **4.027%** ÃÂ¯ÃÂ¿ÃÂ½ funding need 2025 **~530m**.
  - Elec regulatory balances total **242.5m** ÃÂ¯ÃÂ¿ÃÂ½ gas **67.6m** ÃÂ¯ÃÂ¿ÃÂ½ 100% Walloon municipal ownership via intercommunales.
...
### 2026-07-28T08:05:00Z ÃÂ¯ÃÂ¿ÃÂ½ tick 174
- Unit: **rq_169** (FOI-adjacent hole-fill ÃÂ¯ÃÂ¿ÃÂ½ **RESA SA Intercommunale comptes 2024**)
- Found (strong primary NBB annual accounts, AG 04-06-2025, PwC):
  - **Chiffre d'affaires EUR 383.881m 2024** (392.969m 2023) ÃÂ¯ÃÂ¿ÃÂ½ ventes/prestations **500.682m** (incl prod. immobilisÃÂ¯ÃÂ¿ÃÂ½e **94.6m**).
  - **Op. profit 76.915m** ÃÂ¯ÃÂ¿ÃÂ½ pre-tax **63.501m** ÃÂ¯ÃÂ¿ÃÂ½ **net 48.250m** (51.113m 2023).
  - Assets **1.955bn** ÃÂ¯ÃÂ¿ÃÂ½ fixed **1.594bn** ÃÂ¯ÃÂ¿ÃÂ½ equity **955.6m** ÃÂ¯ÃÂ¿ÃÂ½ capital **657.9m**.
  - LT financial debt **759.6m** (bonds **500m** + credit **259.6m**) ÃÂ¯ÃÂ¿ÃÂ½ total dettes **977.2m**.
  - **Dividend (rÃÂ¯ÃÂ¿ÃÂ½munÃÂ¯ÃÂ¿ÃÂ½ration de l'apport) 18.8m** (same 2023) ÃÂ¯ÃÂ¿ÃÂ½ bÃÂ¯ÃÂ¿ÃÂ½nÃÂ¯ÃÂ¿ÃÂ½fice ÃÂ¯ÃÂ¿ÃÂ½ distribuer **18.95m**.
  - Capital subsidies BS **39.762m** (was **7.792m** 2023) ÃÂ¯ÃÂ¿ÃÂ½ personnel **107.3m** ÃÂ¯ÃÂ¿ÃÂ½ D&A **57.4m**.
...
### 2026-07-28T08:25:00Z ÃÂ¯ÃÂ¿ÃÂ½ tick 175
- Unit: **rq_170** (FOI-adjacent hole-fill ÃÂ¯ÃÂ¿ÃÂ½ **De Lijn GeÃÂ¯ÃÂ¿ÃÂ½ntegreerd jaarverslag 2025**)
- Found (strong primary statutory accounts + press, figures in kEUR ÃÂ¯ÃÂ¿ÃÂ½1000):
  - **Omzet EUR 1,420.0m 2025** (1,423.7m 2024) ÃÂ¯ÃÂ¿ÃÂ½ bedrijfsopbrengsten **1,497.1m** ÃÂ¯ÃÂ¿ÃÂ½ bedrijfskosten **1,627.8m** ÃÂ¯ÃÂ¿ÃÂ½ bedrijfsverlies **-130.7m**.
  - **Vlaams Gewest tussenkomst in omzet 1,207.9m** (incl PPS beschikbaarheidsvergoeding **53.1m**) ÃÂ¯ÃÂ¿ÃÂ½ main public cash perimeter.
  - **Kapitaalsubsidies cash 247.3m** 2025 ÃÂ¯ÃÂ¿ÃÂ½ BS kapitaalsubsidies **2,143.3m** ÃÂ¯ÃÂ¿ÃÂ½ assets **3,085.4m** ÃÂ¯ÃÂ¿ÃÂ½ equity **2,252.1m**.
  - Personnel **625.4m** ÃÂ¯ÃÂ¿ÃÂ½ diensten **731.9m** ÃÂ¯ÃÂ¿ÃÂ½ CAPEX aanschaf **299.6m** ÃÂ¯ÃÂ¿ÃÂ½ LT debt **371.8m** (PPS leasing).
  - **Net profit 20k** (matches press) ÃÂ¯ÃÂ¿ÃÂ½ dotatie **-27.5m** delta 2025 ÃÂ¯ÃÂ¿ÃÂ½ e-bus order **400m** / 652 buses ÃÂ¯ÃÂ¿ÃÂ½ 2026 hefbomen **45m** + imposed **35.5m**.
  - Passengers **372.9m** ÃÂ¯ÃÂ¿ÃÂ½ closes material **gap_de_lijn** public perimeter (residual: optional cash-code recon).
...
### 2026-07-28T08:45:00Z ÃÂ¯ÃÂ¿ÃÂ½ tick 176
- Unit: **rq_171** (FOI-adjacent hole-fill ÃÂ¯ÃÂ¿ÃÂ½ **SWDE Rapport Financier 2024**)
- Found (strong primary RF + Faits & chiffres; kEUR ÃÂ¯ÃÂ¿ÃÂ½1000):
  - **CA full EUR 568.129m 2024** (Faits; incl assainissement) ÃÂ¯ÃÂ¿ÃÂ½ CA hors assain **340.575m** ÃÂ¯ÃÂ¿ÃÂ½ produits exploitation **428.7m**.
  - **EBITDA 132.5m** ÃÂ¯ÃÂ¿ÃÂ½ op. result **-10.8m** ÃÂ¯ÃÂ¿ÃÂ½ fin. result **+22.5m** (NRB sale gain **24.5m**) ÃÂ¯ÃÂ¿ÃÂ½ **net 10.253m**.
  - Assets **2.369bn** ÃÂ¯ÃÂ¿ÃÂ½ equity **1.465bn** ÃÂ¯ÃÂ¿ÃÂ½ capital subsidies **285.4m** ÃÂ¯ÃÂ¿ÃÂ½ LT fin. debt **644.9m** ÃÂ¯ÃÂ¿ÃÂ½ gross fin. debt **722m**.
  - CAPEX **272.4m** (travaux **263.5m**) ÃÂ¯ÃÂ¿ÃÂ½ personnel **136.0m** ÃÂ¯ÃÂ¿ÃÂ½ D&A **116.4m**.
  - **No dividend** (bÃÂ¯ÃÂ¿ÃÂ½nÃÂ¯ÃÂ¿ÃÂ½fice ÃÂ¯ÃÂ¿ÃÂ½ distribuer 0; all to reserves). CVD **2.80 ÃÂ¯ÃÂ¿ÃÂ½/mÃÂ¯ÃÂ¿ÃÂ½** ÃÂ¯ÃÂ¿ÃÂ½ pop served **2.53m** ÃÂ¯ÃÂ¿ÃÂ½ 190 communes.
...
### 2026-07-28T09:05:00Z ÃÂ¢ÃÂÃÂ tick 177
- Unit: **rq_172** (FOI-adjacent hole-fill ÃÂ¢ÃÂÃÂ **Aquafin JV BE-GAAP 2024 + SPGE en bref 2024**)
...
### 2026-07-28T09:25:00Z ÃÂ¢ÃÂÃÂ tick 178
- Unit: **rq_173** (FOI-adjacent hole-fill ÃÂ¢ÃÂÃÂ **De Watergroep JV 2024**)
...
- Note: public Farys files found only Creat Services DV (omzet 70ÃÂ¢ÃÂÃÂ89m service co), not Farys ov full utility accounts ÃÂ¢ÃÂÃÂ residual for next tick.
...
### 2026-07-28T09:45:00Z ÃÂ¢ÃÂÃÂ tick 179
- Unit: **rq_174** (FOI-adjacent hole-fill ÃÂ¢ÃÂÃÂ **Pidpa Financieel jaarverslag 2025**)
...
- Found (strong primary statutaire jaarrekening VOL; vector-rendered pages):
  - **Omzet EUR 254.546m 2025** (225.867m 2024) ÃÂÃÂ· bedrijfsopbrengsten **426.904m** ÃÂÃÂ· bedrijfskosten **406.668m**.
  - **Bedrijfswinst 20.237m** ÃÂÃÂ· PBT **23.150m** ÃÂÃÂ· tax **6.687m** ÃÂÃÂ· **net profit 16.509m** (16.917m 2024).
  - Assets **571.527m** ÃÂÃÂ· equity **313.681m** ÃÂÃÂ· inbreng **189.275m** ÃÂÃÂ· reserves **120.613m**.
  - Debt total **250.161m** ÃÂÃÂ· LT fin debt **37.747m** ÃÂÃÂ· capital subsidies **1.767m**.
  - Uit te keren winst (vergoeding inbreng) **4.160m** ÃÂÃÂ· personnel **57.585m**.
  - JV ops: produce **154.2m m3** ÃÂÃÂ· staff **488** ÃÂÃÂ· invest water **15.4m** + sewer **57m**.
  - KBO **0204.923.881** ÃÂÃÂ· Grant Thornton unqualified ÃÂÃÂ· dual VL water with DWG/Pidpa; Farys ov residual.
...
- Found (strong primary integrated annual report maatschappelijke jaarrekening; prior public files were Creat Services DV only):
  - **Omzet EUR 506.292m 2024** (496.0m 2023 / 454.0m 2022) ÃÂÃÂ· bedrijfsopbrengsten **597.954m**.
  - **Bedrijfswinst 73.736m** ÃÂÃÂ· PBT **38.609m** ÃÂÃÂ· **net 38.180m** (29.2m 2023).
  - Assets **3.655bn** ÃÂÃÂ· MVA **3.231bn** (~88pct) ÃÂÃÂ· equity **1.921bn** ÃÂÃÂ· cap subsidies **245m**.
  - LT debt **1.337bn** (bank 934m + MTN/other 371m) ÃÂÃÂ· ST debt **370m** ÃÂÃÂ· invest MVA **190m**.
  - Personnel **96.8m** ÃÂÃÂ· fin. costs **42.8m** ÃÂÃÂ· sport+water+sewer perimeter (ex-TMVW).
...
- Unit: **rq_178 seed** (user flag ÃÂ¢ÃÂÃÂ aircon + fridge subsidies high clown)
...
- Unit: **rq_178** (high-clown ÃÂ¢ÃÂÃÂ **Mijn Kortingsbon white goods + MVP lucht-lucht airco**)
- Found (strong portals + medium/strong parliamentary QA; **no invent of redeemed cash**):
  ...
  - **Verstuurde** bonnen (SV89/718): **2020 9_808** ÃÂÃÂ· **2021 14_629** strong ÃÂÃÂ· **2022 ~29_258** medium (2x 2021).
  - Face-value issued (sent x250, **not cash paid**): **2.45m / 3.66m / ~7.3m** 2020-22.
  - **2019 used** wash 2_314 + fridge 2_329 ÃÂ¢ÃÂÃÂ **1.161m** cash medium (prior PQ cite; partial).
...
- FOI: **gap_vl_odv_mvp_cash** ready (redeemed cash by appliance + air-air split) ÃÂ¢ÃÂÃÂ human send only.
- Next: prio5 **rq_177**; deferred **rq_116** SWA.
...
- Found (strong primary regulated press 2026-03-31; dual electricity Elia):
  ...
  - **CAPEX 261.751m** (92.1m 2024): transmission **246.2m** (KnokkeÃÂ¢ÃÂÃÂEvergem **68.5m**) ? storage 11.5m ? LNG 4.1m.
...
- Found (strong primary official figures page):
  ...
  - Non-recurrent charges **586m** 2025 (1.259bn 2024) ? non-rec income 112m ÃÂ¢ÃÂÃÂ large valuation swing.
...
- Port of Antwerp-Bruges: cargo throughput public; **authority financial accounts still thin** on open press (factsheet cargo-only) ÃÂ¢ÃÂÃÂ residual for next tick.
...
- FOI: L5 investee list + impairments + State capital path ÃÂ¢ÃÂÃÂ human send only.
...
- Found (strong primary official press 2026-05-08):
  ...
  - Ownership: **SFPIM/FPIM 25%** + PMV/private consortium **75%** ÃÂ¢ÃÂÃÂ links tick184 SFPIM.
  - Jobs class **64k** direct+indirect ? noise-efficient flights **42%** (was 20% 2016).
  - Dual: national hub vs Charleroi BSCA residual.
- Port of Antwerp-Bruges authority P&L still not in open press (cargo-only) ÃÂ¢ÃÂÃÂ residual **rq_182**.
...
- Found (strong primary management report on 2024 consol FS):
  ...
  - Cover capacity **33bn** class medium (portal AA S&P) ÃÂ¢ÃÂÃÂ contingent sovereign-linked risk.
...
- Port of Antwerp-Bruges authority P&L still thin public ÃÂ¢ÃÂÃÂ residual **rq_185**.
...
- Refreshed **doge_waste_top10_current.md**: top10 unchanged (cheque 8.83 ÃÂ¢ÃÂÃÂ¦ gas product 7.98); n_lb=296; Credendo cover just outside top10.
...
- Found (strong primary Rapport annuel 2024; NBB-deposited accounts):
  ...
  - **PKPL truck toll 347m** (+11.2%; 1.92bn paid-km stable) ÃÂ¢ÃÂÃÂ main funding of structural network.
...
- FOI: residual partners (hetpaleis AMUZ JEF De Roma Morpho Tutti Fameus ÃÂ¢ÃÂÃÂ¦) + full register human send; Mons BI2026 residual; police zone toelage ebesluit candidate.
...
### 2026-07-28T20:05:00Z - tick 210 ÃÂ¢ÃÂÃÂ progress coverage % + waste top10
- Unit: **progress@210** (mandatory every-10-ticks refresh; no new research unit)
- Coverage (order-of-magnitude vs ?347.956 bn TE):
  - **A L0 / B L1:** 100% / 100% (unchanged strong)
  - **C L2:** **~70ÃÂ¢ÃÂÃÂ78%** (up from ~68ÃÂ¢ÃÂÃÂ76% @200) ÃÂ¢ÃÂÃÂ Fedasil 929m, MDK GIP, PZA 321m, Enabel
  - **D L5:** **~8ÃÂ¢ÃÂÃÂ15%** still thin structural ÃÂ¢ÃÂÃÂ Antwerp culture sample 7.4m, CAW 2.3m, FreeClinic 0.97m
...
- Found (strong ebesluit main Dec2024 + AMJP9 delta Dec2025):
  ...
  - Algemene werking **29.024m** after index withhold then **+419k** index release; invest **13.0ÃÂ¢ÃÂÃÂ13.2m**.
  - Vs **2024 package 66.2m** (prior tick140) ÃÂ¢ÃÂÃÂ slight decline on general werk, higher respons.
...
- Found (strong ebesluit 2026_CBS_00260 college 16 Jan 2026):
  ...
  - Vs **2025 package 65.0m** ÃÂ¢ÃÂÃÂ jump **+24.3m** (+37%); structure shift (personnel surplus + discounts explicit).
...
- Found (strong ebesluit 2026_CBS_01117 college 13 Feb 2026):
  ...
  - Vs **2025 locked 81.535m** ÃÂ¢ÃÂÃÂ jump **+5.9m**; invest 3.17 vs 1.75; communes Antwerpen+Wijnegem 2026-31.
...
### 2026-07-28T23:20:00Z - tick 220 ÃÂ¢ÃÂÃÂ progress coverage % + waste top10
- Unit: **progress@220** (mandatory every-10-ticks refresh; no new research unit)
- Coverage (order-of-magnitude vs ?347.956 bn TE):
  - **A L0 / B L1:** 100% / 100% (unchanged strong)
  - **C L2:** **~72ÃÂ¢ÃÂÃÂ80%** (up from ~70ÃÂ¢ÃÂÃÂ78% @210) ÃÂ¢ÃÂÃÂ Antwerp mega AGB/zone stack **~631m** same-year 2026 (PZA+ZBA+AGSO+BZA+Integratie+ÃÂ¢ÃÂÃÂ¦)
  - **D L5:** **~8ÃÂ¢ÃÂÃÂ16%** still thin structural ÃÂ¢ÃÂÃÂ culture sample **7.92m** (8 houses), CAW 2.3m, FreeClinic 0.97m, FAMEUS/STW/Rataplan
  - **E FOI ready:** **~71** (total FOI rows ~75)
...
- Found (strong markup annex ebesluit PDF):
  ...
  - Note: stad omzet 138m ÃÂ¢ÃÂÃÂ  city ebesluit partial lock 38.8m (subset/timing); not double-count AGB as pure city opex.
...
- Found (strong deliberations.be primary):
  ...
  - Housing NPG medium: 84 logements renovation **2.68m** UREBA/PIVW; Art.60 posts 260ÃÂ¢ÃÂÃÂ380 / Art.61 70ÃÂ¢ÃÂÃÂ140.
  - Full **Ville de Mons BI2026 PDF** still not published on mons.be budgets page (only 2025 comptes) ÃÂ¢ÃÂÃÂ FOI residual ASBL L5.
...
- Found (strong primary):
  ...
  - Full **Ville Mons BI2026 PDF** still not on mons.be ÃÂ¢ÃÂÃÂ FOI residual ASBL L5 + Mons share of IDEA dividends.
...
- Found (strong Cour des comptes report 6 May 2026, 27pp PDF):
  - **SCR recettes EUR 1,978.869m**; **dep eng 2,027.747m** / **liq 2,040.467m**; solde **ÃÂ¢ÃÂÃÂ61.6m**.
  - **SEC solde after sous-util 64.7m: ÃÂ¢ÃÂÃÂ35.0m** (path 0 by 2029: ÃÂ¢ÃÂÃÂ35/ÃÂ¢ÃÂÃÂ23/ÃÂ¢ÃÂÃÂ11/0).
  ...
  - HRF net primary cap **2.29% 2026** / avg **2.73% 2025-31**; CoA notes exposÃÂÃÂ© omits net-primary series.
...
- Found (strong primary):
  ...
  - **SEC solde ÃÂ¢ÃÂÃÂ22.708m** after sous-util **35.758m** (path 0 by 2029: ÃÂ¢ÃÂÃÂ22.7/ÃÂ¢ÃÂÃÂ15/ÃÂ¢ÃÂÃÂ7.5/0).
  - Missions liq: **Phare 210.270m** (~31.5%); Aide 113.9m; Formation 91.8m (BF dot **63.2m**); Admin 58.4m; Sante 57.0m; Enseignement 51.7m.
  - **Bruxelles Formation OAA 96.2m** balanced; debt path **182.7ÃÂ¢ÃÂÃÂ203.7m** EOY25-26 (SPABS soudure 180.3m).
  ...
  - Dual stack map: COCOM SCR 2.04bn + COCOF 0.70bn + VGC exp 0.17bn class (**do not sum** ÃÂ¢ÃÂÃÂ inter-dotations).
...
- Found (strong Vlaamse uitgavenbegroting decree 2026 primary / Themis PDF):
  ...
  - **Dual Phare COCOF 210.3m** ÃÂ¢ÃÂÃÂ VAPH VEK ~**14x** Phare (not unit-cost adjusted; dual AViQ residual).
  - **VSB IVA:** rec=VEK **4,748.450m**; VAK **4,381.513m** (art.35) ÃÂ¢ÃÂÃÂ care WZC open-end class.
  - **Opgroeien regie IVA:** rec=VEK **7,611.411m**; VAK **7,578.928m** (art.36) ÃÂ¢ÃÂÃÂ Groeipakket open-end.
...
- Found (strong primary):
  ...
  - Prog **17.093 total CE 7,026.6m / CL 7,062.5m** (includes federal hospital 179.6m, Famiwal 36.4m, CRAC, Wallonie Sante ÃÂ¢ÃÂÃÂ not pure AViQ).
  - **Inexecution annex:** 2023 **389.9m (5.73%)** ÃÂ¢ÃÂÃÂ implied budget **~6.80bn**; 2024 **316.8m (4.43%)** ÃÂ¢ÃÂÃÂ **~7.15bn**; recurring corrected **219m / 202m**.
...
- Found (strong EPCO UAP tables BI2026):
  ...
  - **4-CAF prestations sum EUR 3,013.5m** ÃÂ¢ÃÂÃÂ reconciles AViQ AF envelope **3,008.5m** (+ regulator path).
...
- Coverage (order-of-magnitude vs EUR 347.956 bn TE):
  - **A L0 / B L1:** 100% / 100% (unchanged strong)
  - **C L2:** **~78-86%** (up from ~74-82% @230) ÃÂ¢ÃÂÃÂ WVG IVAs VAPH 2.87 + VSB 4.75 + Opgroeien 7.61; AViQ 6.81; COCOM 2.04 + COCOF 0.70 + VGC 0.17; Mons Ville/CPAS; AF channels
  - **D L5:** **~10-18%** still thin ÃÂ¢ÃÂÃÂ AF multi-caisse named + prior Antwerp culture/social; operator L5 FOI stack
...
- Found (strong FWB budget initial 2026 DO19 table eng=liq, kEUR):
  ...
  - Dual: VL **Opgroeien regie 7.61bn** (incl Groeipakket AF ÃÂ¢ÃÂÃÂ different perimeter); press class ~750m/550m subsidies aligns.
...
### 2026-07-29T08:30:00Z ÃÂ¢ÃÂÃÂ tick 243
- Unit: rq_234 (Maisons de Justice deepen + VL Justitiehuizen dual)
- Found (strong primary):
  - **FWB DO18 Maisons de Justice BI2026** (`fwb_budget_dep_2026.pdf`): **eng ÃÂ¢ÃÂÃÂ¬28.362m / liq ÃÂ¢ÃÂÃÂ¬30.124m** (2025 eng 28.700 / liq 30.276).
  - Split 2026: Prog0 subsistance 0.575/0.837m; **Prog1 surveillance ÃÂÃÂ©lectronique 3.433/4.958m** (aide dÃÂÃÂ©tenus SE **3.203m**); **Prog3 partenariats eng 24.354 / liq 24.292m** (~81% eng); Prog4 0/0.037m.
  - Act31 agrÃÂÃÂ©ÃÂÃÂ©s (eng): aide au lien **6.851m**, psy **5.668m**, sociale **4.180m**, accompagnement **3.792m**, communication **1.734m**, juridique **1.244m** (sum eng **23.469m**); projets particuliers **0.605m**; urgences **0.280m**.
  - Related infra DO15 act14 SAJ-SPJ+MDJ **10.595m** (shared; medium).
  - **VL dual receipt** BBT FB BO2026: Dotatie Justitiehuizen art. 47/10 BFW **BA2025 ÃÂ¢ÃÂÃÂ¬88.767m ÃÂ¢ÃÂÃÂ BO2026 ÃÂ¢ÃÂÃÂ¬90.357m** (+1.590m). Receipt only ÃÂ¢ÃÂÃÂ full AJH spend/top-up residual (beleidsnota: VL tops up).
...
- Next: rq_235 hole-fill; rq_116 SWA deferred OctÃÂ¢ÃÂÃÂDec 2026

### 2026-07-29T09:00:00Z ÃÂ¢ÃÂÃÂ tick 244
- Unit: **rq_235** (FOI-adjacent hole-fill ÃÂ¢ÃÂÃÂ **VL AJH full spend** closes gap_vl_justitiehuizen_spend public side)
- Found (strong primary OP2026 + BBT BU2025):
  ...
  - Federal JH receipt still **90.357m** BO2026 ÃÂ¢ÃÂÃÂ agency broader than JH (youth transfer drives 2026 jump).
  - Dual: FWB DO18 MDJ **30.1m** vs VL AJH **240m** vs receipt **90.4m** ÃÂ¢ÃÂÃÂ **not additive** (perimeters differ; FWB personnel may be outside DO18; Fonds JH partners still federal Globaal Plan).
...
### 2026-07-29T09:30:00Z ÃÂ¢ÃÂÃÂ tick 245
- Unit: **rq_236** (FOI-adjacent hole-fill ÃÂ¢ÃÂÃÂ **FWB federal MDJ receipt dual VL** + DG residual FOI)
- Found (strong primary ExpGen BI2026 + CoA DG 2026):
  - **FWB LSF art.47/10 Dotation Maisons de justice:** 2025 INI **ÃÂ¢ÃÂÃÂ¬54.5m** / AJU **ÃÂ¢ÃÂÃÂ¬54.7m** / 2026 INI **ÃÂ¢ÃÂÃÂ¬55.7m**.
  - Dual receipt same article: **FWB 55.7m vs VL BO2026 90.357m** (not additive with spend).
  - DO18 programme liq still **ÃÂ¢ÃÂÃÂ¬30.124m** ÃÂ¢ÃÂÃÂ wedge class **~ÃÂ¢ÃÂÃÂ¬25.6m** outside DO18 (personnel DO11 + other; medium not audited identity).
  - DO11 traitements total **ÃÂ¢ÃÂÃÂ¬437.6m**; new 2026 remun pack MDJ+AJ **ÃÂ¢ÃÂÃÂ¬8.9m** (AGMJ+AGAJ **5.4m** combined + MDJ carceral reform **3.4m**); Brussels **12 ETP** retained; partner non-index **-449k** + training cuts.
  - **DG Justizhaus:** CoA UHH 2025+2026 **no euro line**; fed global dot 2026 **351.1m** (earmarked **17.0m**) ÃÂ¢ÃÂÃÂ JH share unknown ÃÂ¢ÃÂÃÂ FOI.
...
### 2026-07-29T10:00:00Z ÃÂ¢ÃÂÃÂ tick 246
- Unit: **rq_237** (FOI-adjacent hole-fill ÃÂ¢ÃÂÃÂ **FWB Egalite des chances dual VL Gelijke Kansen**)
- Found (strong Exp. particulier depenses 2026 Coppieters DO11 table):
  - Package TOTAL **CE ÃÂ¢ÃÂÃÂ¬14.494m / CL ÃÂ¢ÃÂÃÂ¬7.850m** 2026 (2025: 12.742 / 9.548).
  ...
  - Dual VL: GK werkings **15.162m** (projectsubs **4.361m**) ÃÂ¢ÃÂÃÂ different perimeter; do not sum.
...
### 2026-07-29T10:30:00Z ÃÂ¢ÃÂÃÂ tick 247
- Unit: **rq_238** (FOI-adjacent hole-fill ÃÂ¢ÃÂÃÂ **FPS taxex / fossil energy subsidies inventory**)
- Found (strong primary climat.be 4e Inventaire federal energies fossiles 2025, Benchmark 1):
  - **Direct fossil subsidies 2022 EUR 13.268 bn** (2.4% GDP); path 11.68ÃÂ¢ÃÂÃÂ13.27bn 2018-22.
  ...
  - **Company cars EHS** **3.434bn** 2022 (path 2.63ÃÂ¢ÃÂÃÂ3.43); dual FPS/FPB methods.
...
### 2026-07-29T11:00:00Z ÃÂ¢ÃÂÃÂ tick 248
- Unit: **rq_239** (FOI-adjacent hole-fill ÃÂ¢ÃÂÃÂ **Wallonie egalite dual FWB/VL**)
- Found (strong ExpGen + EP Coppieters prog 17.094):
  ...
  - Dual/triple: FWB pack CL **7.85m** | VL GK **15.16m** | WAL core **~5.7m liq** ÃÂ¢ÃÂÃÂ **not additive**.
...
### 2026-07-29T11:30:00Z ÃÂ¢ÃÂÃÂ tick 249
- Unit: **rq_240** (FOI-adjacent hole-fill ÃÂ¢ÃÂÃÂ **Charleroi culture/sport L5**)
- Found (strong BI2024 synthese eComptes + BI2026 context):
  - **PBA ASBL EUR 1.339834m**; **CCR 0.734m**; ASBL culturelles **1.1515m**; CEME **0.1008m** ÃÂ¢ÃÂÃÂ culture sample **3.326m**.
  - **Parc des Sports 0.738m** + sport clubs **0.603m** ÃÂ¢ÃÂÃÂ sport sample **1.341m**.
  - Menages ASBL **1.338m**; social ASBL **0.380m**.
  - BI2026: transfers **240.3m** (-10.9m); pox subsides **ÃÂ¢ÃÂÃÂ0.5m**; CPAS +0.7m; ZPL ÃÂ¢ÃÂÃÂ5.6m; ZOHE ÃÂ¢ÃÂÃÂ5.3m; named 2026 matrix residual FOI.
...
- Coverage (order-of-magnitude vs EUR 347.956 bn TE):
  - **A L0 / B L1:** 100% / 100% (unchanged strong)
  - **C L2:** **~79-87%** (up from ~78-86% @240) ÃÂ¢ÃÂÃÂ VL AJH 240m; FWB MDJ 30.1m + fed receipt 55.7m; equality dual/triple FWB 7.85 / VL GK 15.2 / WAL ~5.7m
  - **D L5:** **~11-19%** still thin ÃÂ¢ÃÂÃÂ Charleroi culture 3.33m + sport 1.34m; equality category L5; AF multi-caisse prior
  - **E FOI ready:** **~87** (total FOI rows ~91)
- Inventory: budgets ~2691; commitments ~460; leaderboard ~459; entities ~957 lines; sources ~501
- Waste top10: **changed** ÃÂ¢ÃÂÃÂ fossil 4e inventaire enters #2 (13.3bn), #4 accises 10.5bn, #6 company cars EHS 3.43bn, #7 mazout 1.86bn; cheque still #1 (8.83)
...
### 2026-07-29T12:30:00Z ÃÂ¢ÃÂÃÂ tick 251
- Unit: **rq_242** (FOI-adjacent hole-fill ÃÂ¢ÃÂÃÂ **equal.brussels call + WAL DIVICO named L5**)
- Found (strong/medium primary):
  - **equal.brussels appel 2026** envelope **~EUR 2m** (FAQ; min **25k**/project; period Sep2026ÃÂ¢ÃÂÃÂNov2027) ÃÂ¢ÃÂÃÂ dual FWB/VL/WAL equality map.
  - **WAL PÃÂÃÂ´le ressources violences ASBL ~616k/yr** (was 551k 2024); co-finance COCOF+FWB.
  - **DIVICO named:** LiÃÂÃÂ¨ge **115k**, Namur **60k**, BW **115k** (+55), Nord-Lux **60k** (Hainaut exploratory); uplift **+115k**.
  - DF **094.109** pluriann eng **4.155m** / liq **0.831m** (named: PÃÂÃÂ´le, ARCA, CAIPS, CODEF, Observatoire, Volontariat, FinancitÃÂÃÂ©).
  - Pack nouveau dÃÂÃÂ©part: policy only (no dedicated cash line yet).
...
### 2026-07-29T13:00:00Z ÃÂ¢ÃÂÃÂ tick 252
- Unit: **rq_243** (FOI-adjacent hole-fill ÃÂ¢ÃÂÃÂ **federal art.47/10 MDJ triple VL/FWB/DG**)
- Found (strong primary Kamer 56K1470 middelenbegroting table, indexed FLWB; PDF download blocked agent-side):
  ...
  - Cross-check: VL BO2026 receipt 90.357m; FWB ExpGen 55.7m ÃÂ¢ÃÂÃÂ close class.
...
### 2026-07-29T13:30:00Z ÃÂ¢ÃÂÃÂ tick 253
- Unit: **rq_244** (FOI-adjacent hole-fill ÃÂ¢ÃÂÃÂ **AWEX dual FIT export agencies**)
- Found (strong primary EP Jeholet BI2026 table milliers EUR):
  ...
  - 2025 package **67.547m** (dot **66.664m**) ÃÂ¢ÃÂÃÂ **treasury remonte 9m** not repeated 2026.
...
### 2026-07-29T14:00:00Z ÃÂ tick 254
- Unit: **rq_245** (FOI-adjacent hole-fill ÃÂ **hub.brussels dual AWEX/FIT export**)
- Found (strong primary hub.brussels Rapport activite 2024 Annexe 2):
  ...
  - Dual/triple: AWEX **76.843m** 2026 | hub **46.166m** 2024 | FIT residual FOI (years differ ÃÂ not additive).
...
### 2026-07-29T14:30:00Z ÃÂ tick 255
- Unit: **rq_246** (FOI-adjacent hole-fill ÃÂ **dual tourism Toerisme VL + visit.brussels; AGMJ ETP**)
- Found (strong/medium primary):
  - **Toerisme Vlaanderen programme SQ BO2024**: VAK **ÃÂ66.466m** / VEK **ÃÂ74.816m** (excl apparaat) ÃÂ BBT 13-R strong.
  ...
  - **visit.brussels** Cour VISIT.39.302.08 prog 302 **ÃÂ14.9m** BI2024 (partial ÃÂ not full ASBL).
...
### 2026-07-29T15:00:00Z ÃÂ tick 256
- Unit: **rq_247** (FOI-adjacent hole-fill ÃÂ **VISITWallonia dual tourism + Tourisme Wallonie**)
- Found (strong primary EP Lescrenier BI2026 + bud37):
  ...
  - Triple promo: TV SQ VEK **74.8m** | Visit prog302 **14.9m** partial | VW global **15.4m** (years/scopes differ ÃÂ not additive).
...
### 2026-07-29T15:30:00Z ÃÂ tick 257
- Unit: **rq_248** (FOI-adjacent hole-fill ÃÂ **FIT dual AWEX export package**)
- Found (strong primary BBT SP Diependaele 2026 + JR2025 pfile 2321600):
  ...
  - Dual/triple export: AWEX **76.843m** 2026 | FIT package **63.1m** | hub.brussels **46.166m** 2024 (years differ ÃÂ not additive).
...
### 2026-07-29T16:00:00Z ÃÂ tick 258
- Unit: **rq_249** (FOI-adjacent hole-fill ÃÂ **WBI dual international FWB/WAL vs Flanders**)
- Found (strong primary RA2024 + CdC RD26):
  ...
  - Dual Flanders: SN Buitenlands Beleid **8.971m** BO2026 (partial; FIT trade 63.1m separate) ÃÂ scopes differ not additive.
...
### 2026-07-29T16:30:00Z ÃÂ tick 259
- Unit: **rq_250** (FOI-adjacent hole-fill ÃÂ **WAL WBI dotation closes dual financing**)
- Found (strong primary Parlement wallon bud27 Dolimont):
  ...
  - CdC 2025A1: WBI consolidÃÂ© **-19.6m** mainly emphytÃÂ©ose 12.1m Sainctelette.
...
- Coverage (order-of-magnitude vs EUR 347.956 bn TE):
  - **A L0 / B L1:** 100% / 100% (unchanged strong)
  - **C L2:** **~81-89%** (up from ~79-87% @250) ÃÂ export triple AWEX 76.8 + FIT 63.1 + hub 46.2; tourism TV 74.8 + VW 15.4 + TW 48.6; WBI 96.4 + FWB/WAL dots 73.0; justice fed 147.3
  - **D L5:** **~12-20%** still thin ÃÂ agency packages lift C more than pure L5
...
### 2026-07-29T17:30:00Z ÃÂ tick 261
- Unit: **rq_252** (FOI-adjacent hole-fill ÃÂ **Enabel dual APEFE development cooperation**)
...
### 2026-07-29T18:00:00Z ÃÂ tick 262
- Unit: **rq_253** (FOI-adjacent hole-fill ÃÂ **PMV JR2025 dual Wallonie Entreprendre**)
- Found (strong primary JR2025 statutory kEUR):
  - **Total assets EUR 4.236bn** end-2025 (was **1.626bn** 2024) ÃÂ BAC/deelnemingen jump.
  ...
  - Dual **WE equity ~4.98bn** 2025 (prior map) ÃÂ regional holdings comparable scale; SFPIM federal third layer.
...
### 2026-07-29T18:30:00Z ÃÂ tick 263
- Unit: **rq_254** (FOI-adjacent hole-fill ÃÂ **Mons ASBL L5 sample BI2025**)
- Found (strong primary Mons budget ordinaire 2025 extract):
  - Named L5 sample **n=22** lines sum **~ÃÂ7.5m** (RCA cluster ~4.25m + MARS package 0.67m + OT + Basket UMH 0.22m + Garance 0.17m + Fondation Mons2025 + film 45k + charte associative + ÃÂ).
...
### 2026-07-29T19:00:00Z ÃÂ tick 264
- Unit: **rq_255** (FOI-adjacent hole-fill ÃÂ **finance&invest.brussels dual PMV/WE**)
...
### 2026-07-29T19:30:00Z ÃÂ tick 265
- Unit: **rq_256** (FOI-adjacent hole-fill ÃÂ **Innoviris dual VLAIO R&I**)
...
### 2026-07-29T20:00:00Z ÃÂ tick 266
- Unit: **rq_257** (FOI-adjacent hole-fill ÃÂ **FWO dual FNRS fundamental research funds**)
- Found (strong primary JV/RA/Resultats):
  - **FWO VL VAK** **ÃÂ470.3m** 2024 / **ÃÂ448.2m** 2025; **VEK** **436.8m** / **464.6m**.
  - Fund projects **180?201m**; fund mandaten **109?112m**; SBO pack ~**94ÃÂ95m**; infra **66.2?19.6m** (one-off timing).
  - Beheers **19.3m (4.11%)** ? **23.1m (5.16%)**; agency bezold **9.0?9.3m**; federal package class **ÃÂ44m**.
  - **FNRS public subs** **ÃÂ241.8m** 2024 / **ÃÂ253.7m** 2025; global **262/279m**.
  - FNRS split 2025: FWB **182.8m**; fed **40.8m**; WAL **22.8m**; Loterie **7.3m**; dons/TÃÂ©lÃÂ©vie class **~24.7m**.
  - Doctorants remun **ÃÂ58.3m** 2025; dual community research (not Innoviris/VLAIO applied).
...
### 2026-07-29T20:30:00Z ÃÂ tick 267
- Unit: **rq_258** (FOI-adjacent hole-fill ÃÂ **Sciensano federal public health science budget path**)
- Found (strong primary beheersovereenkomst 2024-29 annex + RA2024):
  - Total budget annex **ÃÂ135.671m** 2024 / **ÃÂ133.192m** balanced path 2025-29.
  - **Basis dotatie ÃÂ30.709m**/yr real (fixed 2024-29); new initiatives **ÃÂ2.479m** 2024 only.
  - Own sales/services **ÃÂ88.483m**; received subsidies **ÃÂ14.0m**.
  - Personnel package ~**ÃÂ83.7m** 2024 (N_LIM 57.6 + LIM 26.0) ? **ÃÂ82.2m** 2025.
  - Werkingskosten N_LIM **ÃÂ42.1m**; ESR saldo **-ÃÂ1.5m** 2024 then 0.
  - RA2024 key figures: budget **ÃÂ132m** of which **ÃÂ77m** external (perimeter note vs 135.7m annex).
...
### 2026-07-29T21:00:00Z ÃÂ tick 268
- Unit: **rq_259** (FOI-adjacent hole-fill ÃÂ **APEFE fonctionnement dots dual Enabel**)
- Found (strong primary FWB/WBI budget BI2026 p699+justificatifs):
  - **APEFE fonctionnement FWB** AB 41.60.01: **ÃÂ471k** eng+liq 2025 and 2026.
  - **APEFE fonctionnement WAL** AB 41.60.02: **ÃÂ510k** 2025 / **ÃÂ490k** 2026.
  - Combined public fonct dots **ÃÂ981k** 2025 / **ÃÂ961k** 2026.
  ...
  - Dual **Enabel ÃÂ435.6m** 2025 vs APEFE public fonct **~ÃÂ1m** (scale gap; not additive).
...
### 2026-07-29T21:30:00Z ÃÂ tick 269
- Unit: **rq_260** (FOI-adjacent hole-fill ÃÂ **FAVV food chain dual Sciensano**)
- Found (strong primary RC heffingen + BP 21-24 + minister savings note):
  - **Heffingen 2024 excl bonus ÃÂ51.931m**; FTE controllers **142.34**.
...
### 2026-07-29T22:00:00Z ÃÂ tick 270 (progress milestone)
- Unit: **rq_261** (mandatory progress@270 coverage % + waste top10)
- Coverage vs ÃÂ347.956 bn TE:
  - **A L0 / B L1:** **100%** strong
  - **C L2:** **~82ÃÂ90%** (up from ~81ÃÂ89% @260) ÃÂ FWO/FNRS dual, Sciensano, FAVV path, FIB, Innoviris
  - **D L5:** **~13ÃÂ21%** still thin; Innoviris full L5 2024 + Mons sample lift
  - **E FOI ready:** **~98** drafts (answered ~5)
- Waste top10: **stable** cheque/fossil/company cars/EIWT (pi 8.83ÃÂ8.08); dual hole-fills are core public goods not pure waste
- Inventory: budgets ~2938 ÃÂ· commitments ~485 ÃÂ· leaderboard ~518 ÃÂ· entities ~197 ÃÂ· sources ~547 ÃÂ· FOI rows ~104
...
### 2026-07-29T22:30:00Z ÃÂ tick 271
- Unit: **rq_262** (FOI-adjacent hole-fill ÃÂ **AFMPS medicines dual Sciensano/FAVV**)
- Found (strong primary RA2024 + medium DC-CT 2025 path):
  - Budget **ÃÂ128.745m** / realisations **ÃÂ115.560m** 2024 (**90%**).
  - Personnel real **ÃÂ63.374m** (budget 74.6m); federal **dotation ÃÂ28.651m** (~25% of real).
  - **Sciensano expertise ÃÂ7.054m** paid (dual); ICT **14.1m**; NAT blood **9.4m**.
  - Fees: packaging **18.3m**; DM **13.3m**; AMM only **6.3m of 16.6m** (38% shortfall).
  - Staff **564** (NL 290 + FR 274); DC-CT path budget **ÃÂ141m** 2025 (70?92?141m 2015-25 class).
...
### 2026-07-29T23:00:00Z ÃÂ tick 272
- Unit: **rq_263** (FOI-adjacent hole-fill ÃÂ **KCE dual health quad**)
- Found:
  - **Strong primary INAMI 2025:** transfert centre de connaissance **ÃÂ22.483m** (kEUR table beheerskosten).
  - Press exact **ÃÂ22.482.228** 2025 RIZIV admin toelage (reconciles); **ÃÂ26.447.351** 2026 (+**ÃÂ3.965m** / **+17.6%**) medium ministerraad KB draft.
...
### 2026-07-29T23:30:00Z ÃÂ tick 273
- Unit: **rq_264** (FOI-adjacent hole-fill ÃÂ **INAMI e-health stack + FAM dual health SS**)
- Found (strong primary INAMI 2025 + CoA FAM Nov 2025):
  - **e-gezondheid / e-santÃÂ© ÃÂ113.436m** + **Dotatie e-health ÃÂ19.112m** = **ÃÂ132.548m** stack 2025.
  - **FAM** INAMI dotatie **ÃÂ26.516m** 2025; CoA: cum indemn **ÃÂ101.1m** end-2024; ops excl indemn **ÃÂ12.4m** 2023; open cases **989** (was 2445 end-2019).
  - INAMI OA admin **ÃÂ988.052m**; AFMPS INAMI line **ÃÂ3.443m** 2025 cross-check.
...
- Found (strong primary CoA 182e):
  ...
  - OISZ loonmatrix sample **~848m** (RVA 211 FPD 171 RSZ 158 RIZIV 118 ÃÂ¢ÃÂÃÂ¦).
  - SS saldo **+537m** 2024.
...
- Coverage vs EUR 347.956 bn TE:
  - **A L0 / B L1:** **100%** strong
  - **C L2:** **~84-92%** (up from ~82-90% @270) ÃÂ¢ÃÂÃÂ SS CoA 139.3bn + pensions 66.8bn + OISZ beheer (FPD/RSZ/RVA) + Smals 579m + KSZ + health stack + CREG/BIPT
...
- Inventory: budgets ~3081 ÃÂÃÂ· commitments ~503 ÃÂÃÂ· leaderboard ~558 ÃÂÃÂ· entities ~216 ÃÂÃÂ· sources ~561 ÃÂÃÂ· FOI rows ~112
...
- Coverage vs EUR 347.956 bn TE:
  - **A L0 / B L1:** **100%** strong
  - **C L2:** **~86-94%** (up from ~84-92% @280) ÃÂ¢ÃÂÃÂ FSMA/NBB + asylum chain DVZ/CGVS/RVV + nuclear NIRAS/Bel V/SCK/MYRRHA + ASEVA; Hedera CAP 15bn **stock** off pure TE pie
...
- Inventory: budgets ~3277 ÃÂÃÂ· commitments ~522 ÃÂÃÂ· leaderboard ~604 ÃÂÃÂ· entities ~232 ÃÂÃÂ· sources ~579 ÃÂÃÂ· FOI rows ~122
...
- Found (strong primary Kamer 55K2933/016 + FOD overzicht Jul2026):
  - Calls **IÃÂ¢ÃÂÃÂVI** awards sum **ÃÂ¢ÃÂÃÂ¬129.146m** / **84** projects (0.22+27.9+29.1+23.0+24.4+24.5m).
  - BA **24.75m/yr** + ops **250k**; financed by Doel1&2 LTO fee **20m/yr** 2016ÃÂ¢ÃÂÃÂ25.
  - Public overzicht: **140** named projects calls IÃÂ¢ÃÂÃÂX (Jul 2026); sample Elia/SCK/Fluxys/BASF/INOVYN SMR.
  - Per-project EUR still opaque ÃÂ¢ÃÂÃÂ FOI.
...
- Found (strong primary Kamer 55K2933/016):
  ...
  - AGMJ: CFWB chiffres cles portal has interactive budget dashboards ÃÂ¢ÃÂÃÂ no machine-readable EUR this tick; wage FOI still ready.
...
- Coverage vs EUR 347.956 bn TE:
  - **A L0 / B L1:** **100%** strong
  - **C L2:** **~87-95%** (up from ~86-94% @290) ÃÂ¢ÃÂÃÂ FPS Economy energy crisis CREG ~2bn peak + H2 RRF 316m eng + press concession + telecom 66m + Airbus 45m + ETF 129m awards + quality infra 11m + surendettement 6.2m
  - **D L5:** **~15-23%** ÃÂ¢ÃÂÃÂ ETF 140 named projects (EUR FOI); H2/telecom/Airbus L5 residual
...
- Inventory: budgets ~3626 ÃÂÃÂ· commitments ~557 ÃÂÃÂ· leaderboard ~645 ÃÂÃÂ· entities ~249 ÃÂÃÂ· sources ~588 ÃÂÃÂ· FOI rows ~131
...
- Found:
  - **Statbel** (strong Kamer): FTE **275.6** (01 Jul 2022); ops+fund+enqueteurs pack **~ÃÂ¢ÃÂÃÂ¬4.4m** 2023 class (functioning ~0.99 + fund contract 0.84 + enqueteurs ~1.71 + other); statutaire payroll **pour mÃÂÃÂ©moire** FOI.
...
- Note: FPS Economy Kamer 55K2933 largely mined ÃÂ¢ÃÂÃÂ next prefer new primary PDFs
...
- Found (strong primary KSC Jaarverslag 2024):
  - NBB play-limit checks paid **ÃÂ¢ÃÂÃÂ¬453,878** 2024; **~ÃÂ¢ÃÂÃÂ¬700k** est 2025 = **8.6%** of total budget ÃÂ¢ÃÂÃÂ total budget class **~ÃÂ¢ÃÂÃÂ¬8.14m** (medium derived).
...
- Coverage vs EUR 347.956 bn TE:
  - **A L0 / B L1:** **100%** strong
  - **C L2:** **~88-96%** (up from ~87-95% @300) ÃÂ Kamer-dotatie 9-inst pack **149.3m** kred 2026; RvS **~50m** IBZ-hosted dual Hof; CoA consultancy **~0.84bn/yr** class; KSC/GBA/Ombuds mapped
  - **D L5:** **~15-24%** ÃÂ consultancy top buyers named (NMBS/Infrabel/Finances 3y); ETF EUR FOI residual
...
- Found:
  ...
  - **Equity** **28.4m ÃÂ¢ÃÂÃÂ 14.4m** YE25 (ÃÂ¢ÃÂÃÂ49pct extraction/sale watch).
...
- Found:
  ...
  - **NMBS statutory FTE = 0** (strong Companyweb/NBB) ÃÂ¢ÃÂÃÂ all legal employment via HR Rail.
  - Dual map: NMBS **16,976** + Infrabel YE **9,402** = **26,378** vs HR **27,811** residual **~1.4k** class (HR admin + FTE/headcount/date mix).
  - EUR residual: NMBS payroll-share class **~ÃÂ¢ÃÂÃÂ¬1.50 bn** of HR **ÃÂ¢ÃÂÃÂ¬2.305 bn** 2024 (after Infrabel **ÃÂ¢ÃÂÃÂ¬809.6m** services).
  - Unit-cost class ~**ÃÂ¢ÃÂÃÂ¬86ÃÂ¢ÃÂÃÂ88k**/head both sides (method-sensitive medium).
...
- Found (strong primary Expose general depenses FWB 2026):
  ...
  - New: AGMJ+AGAJ **5.4m** + MDJ carceral **3.4m**; partner non-index **ÃÂ¢ÃÂÃÂ449k**; formation cuts **ÃÂ¢ÃÂÃÂ321k** class.
  - ETNIC moyens BI2026 **123m** (119.4ÃÂ¢ÃÂÃÂ123; perimeter may differ CoA full recettes).
...
- Coverage vs EUR 347.956 bn TE:
  - **A L0 / B L1:** **100%** strong
  - **C L2:** **~89-96%** (up from ~88-96% @310) ÃÂ¢ÃÂÃÂ public ICT dual Smals/Digipolis/ETNIC/Cipal/Ypto; rail dual HR 2.37bn + NMBS 16976/FTE0 + Infrabel 9402 + payroll 810m + RailFac 15m; AGMJ 801 ETP + DO11 437.6m
  - **D L5:** **~16-25%** ÃÂ¢ÃÂÃÂ consultancy/Ypto/Smals external mechanisms; ASBL bulk residual
...
- Found (strong NBB/Companyweb KBO 0263.893.151):
  - Omzet **23.6 / 25.9 / 26.2 / 27.2m** 2022-25; net **~14-15m**/yr; equity **ÃÂ¢ÃÂÃÂ¬167m** YE2025.
  - FTE **136**; negative brutomarge **ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ¬25.7m** 2025 (other income residual).
  - **Triple wedge:** IBZ toelage **ÃÂ¢ÃÂÃÂ¬76.5m** vs contract ops **ÃÂ¢ÃÂÃÂ¬46.5m** vs statutory omzet **ÃÂ¢ÃÂÃÂ¬27.2m**.
...
- Found (strong NBB/Companyweb KBO 0206.048.091):
  ...
  - Net **18.8 / 9.1 / 15.8 / 18.6m**; equity **281 ÃÂ¢ÃÂÃÂ 328m**.
  - FTE **894.5 ÃÂ¢ÃÂÃÂ 966.3**.
...
- Found (strong NBB/Companyweb KBO 0223.967.357 + official press 16 Jan 2026):
  ...
  - Prizes paid **ÃÂ1.266bn** 2025; retail **1172m** / online **494m**.
  - Society return **ÃÂ362.5m** after 2024 results; hope **ÃÂ370m** for 2025; **1970** projects.
...
- Found (strong official Proximus FY2025 press 27 Feb 2026 + shareholder structure):
  - Group reported rev **ÃÂ6,539m ? ÃÂ6,620m** 2024-25 (+1.2%); underlying **ÃÂ6,430m ? ÃÂ6,307m**.
  - Domestic EBITDA **ÃÂ1,699m** 2025; Global EBITDA **ÃÂ170m**.
  - Net Group share **ÃÂ447m ? ÃÂ398m** (-11%; Global GW impairment).
  - CapEx **ÃÂ1,249m**; organic FCF **ÃÂ130m** (reported FCF 480m).
  - Dividend proposed **ÃÂ0.60/share**; SFPIM **~53.5% capital / ~56% voting** (180.9m shares).
...
- Found (strong official Bnode press 6 Mar 2026 + AR2025 key figures):
  - Op income **ÃÂ4,341.3m ? ÃÂ4,482.3m** 2024-25 (+3.2%; Staci full year).
  - Adj EBIT **ÃÂ224.9m ? ÃÂ179.7m** (high end of ~180m guidance).
  - Reported **net loss ÃÂ39.4m** (one-offs ÃÂ55.5m + Staci interest); adj result still **+ÃÂ51.0m**.
  - **No dividend** 2025; Belgian State via SFPIM **51.04%** (102.1m shares).
  - BU: Bpost last-mile adj EBIT **ÃÂ67.0m** (mail -10% parcels +2%); Paxon **ÃÂ58.6m**; Landmark **ÃÂ85.3m**.
  - Rebrand **bpostgroup ? Bnode**; 8th management contract under negotiation; dual Proximus listed majority-state SOE.
  - Prior SGEI **ÃÂ227.8m 2024** still residual for 2025 cash FOI.
...
- Found (strong Kamer 56K0856/016 24 Apr 2025 + NBB/Companyweb BOZAR):
  - Federal dots 2024/init2025: **BOZAR ÃÂ15.529m / ÃÂ15.798m**; **Monnaie ÃÂ42.173m / ÃÂ42.957m**; **NOB ÃÂ10.896m / ÃÂ11.094m**.
  - Sum **ÃÂ68.598m ? ÃÂ69.850m** (pre 1.8% linear cut review).
  - Nationale Loterij provisional 2024: BOZAR **ÃÂ3.095m**; Monnaie **ÃÂ1.489m**; NOB **ÃÂ1.484m** (sum **ÃÂ6.067m**).
  - BOZAR statutory omzet **ÃÂ5.90 / 7.30 / 8.16 / 8.95m** 2022-25; net **ÃÂ0.42m**; equity **ÃÂ50.8m**; FTE **227**.
...
- Found (strong Belnet AR2024 budgetary results + general accounts primary):
  - P&L exp/income **ÃÂ¢ÃÂÃÂ¬17.3 / 23.0 / 35.0m** 2022-24.
  - Services invoiced **ÃÂ¢ÃÂÃÂ¬7.95 / 7.86 / 10.75m**; institutional transfer **ÃÂ¢ÃÂÃÂ¬9.34 / 14.62 / 23.73m**.
  - Remuneration **ÃÂ¢ÃÂÃÂ¬7.76m** 2024; total assets **ÃÂ¢ÃÂÃÂ¬42.2m**; net assets **ÃÂ¢ÃÂÃÂ¬10.6m**.
  - Budget exp **ÃÂ¢ÃÂÃÂ¬27.3m** 2024; FedWAN fund **ÃÂ¢ÃÂÃÂ¬2.69m**; FedOSC fund **ÃÂ¢ÃÂÃÂ¬1.84m**.
  - Dual: research/education NREN vs Smals SS/federal ICT (~ÃÂ¢ÃÂÃÂ¬579m); BNIX peaks public.
...
- Found (strong FRWB/CFPS advisory 30 Jan 2025 + Kamer 56K0827/001):
  - BELSPO managed budget **~ÃÂ¢ÃÂÃÂ¬570m** current (FRWB) / **ÃÂ¢ÃÂÃÂ¬630m 2024** class (resolution).
  - Split: ESA/international **~57%** (floor **>ÃÂ¢ÃÂÃÂ¬250m**); FWI base financing **~25%**; national RDI **~13%**.
  - Coalition specific cut **ÃÂ¢ÃÂÃÂ¬93m (ÃÂ¢ÃÂÃÂ15%)** on department; resolution notes plan **>20%** class.
  - 10 FWI + Belnet **>2400** staff; heritage value class **ÃÂ¢ÃÂÃÂ¬3.5bn**; museums **1.5m** visitors/yr.
  - Federal RDI fiscal incentives **ÃÂ¢ÃÂÃÂ¬2.0ÃÂ¢ÃÂÃÂ2.2bn** class (FPS Finance; off BELSPO cash).
...
- Coverage vs EUR 347.956 bn TE:
  - **A L0 / B L1:** **100%** strong
  - **C L2:** **~90-97%** (up from ~89-96% @320) ÃÂ¢ÃÂÃÂ listed SOE dual Proximus ÃÂ¢ÃÂÃÂ¬6.62bn + Bnode/bpost ÃÂ¢ÃÂÃÂ¬4.48bn; Nationale Loterij ÃÂ¢ÃÂÃÂ¬1.67bn; federal culture triple ~ÃÂ¢ÃÂÃÂ¬70m; Belnet ÃÂ¢ÃÂÃÂ¬35m; BELSPO ~ÃÂ¢ÃÂÃÂ¬570-630m
  - **D L5:** **~16-26%** ÃÂ¢ÃÂÃÂ lottery society / SFPIM dividend / Belspo FWI / bpost SGEI mechanisms FOI-adjacent; ASBL bulk residual
...
- Found (strong BELSPO MERI Statistics in Brief No. 8, 2025):
  - BE ESA contribution **~ÃÂ¢ÃÂÃÂ¬190m 2015 ÃÂ¢ÃÂÃÂ ÃÂ¢ÃÂÃÂ¬284m 2025**; avg **~ÃÂ¢ÃÂÃÂ¬194m** 2021-24 (vs ÃÂ¢ÃÂÃÂ¬179m 2016-20 / ÃÂ¢ÃÂÃÂ¬156m 2011-15).
  - Of avg 2021-24: private industry **ÃÂ¢ÃÂÃÂ¬148.2m**; public research **ÃÂ¢ÃÂÃÂ¬23.1m**; universities **ÃÂ¢ÃÂÃÂ¬22.7m**.
  - Private space turnover **ÃÂ¢ÃÂÃÂ¬713.5m** 2024 (multiplier ~6x); ESA-backed **4,016 FTE** (2,257 R&D).
  - ~**90%** of federal public space funding via ESA; geo-return principle.
  - CM25 press: **ÃÂ¢ÃÂÃÂ¬1.109bn / 5y** pledge class (medium).
...
- Found (strong BELSPO NewRV timeline + financing study class):
  - CM **28 Oct 2016** budget **ÃÂ¢ÃÂÃÂ¬54.45m** (incl VAT) for replacement vessel.
  - CM **22 Dec 2017** award Freire Shipyard (Vigo) **ÃÂ¢ÃÂÃÂ¬53.7m**.
  - Launch press **11 Feb 2020**: project cost **~ÃÂ¢ÃÂÃÂ¬54m** VAT included.
  - Delivery Zeebrugge **Dec 2021**; baptism **25 Jun 2022** (Princess Elisabeth).
  - Operator **Genavir** (FR oceanographic fleet) from **Nov 2021**.
  - Financing study class ops **ÃÂ¢ÃÂÃÂ¬4.3m/yr** for **300 days** (2 crews) ÃÂ¢ÃÂÃÂ medium, not outturn.
...
- Found (strong BELSPO Jaarverslag 2024 figures page):
  - Budgettaire realisaties **ÃÂ¢ÃÂÃÂ¬582.4m** 2024 (tightens prior 570-630m class).
  - Space **ÃÂ¢ÃÂÃÂ¬283.4m** (~half; dual ESA MERI ÃÂ¢ÃÂÃÂ¬284m 2025).
  - ADBA+ION (FWI Belnet Polar Cinematek) **ÃÂ¢ÃÂÃÂ¬162.6m** (>25%).
  - Mgmt organs **ÃÂ¢ÃÂÃÂ¬19.4m** (3%; personnel **ÃÂ¢ÃÂÃÂ¬16.9m**).
  - Nat+int RDI **ÃÂ¢ÃÂÃÂ¬56.5m** (~10%); PRT ending 2024 **ÃÂ¢ÃÂÃÂ¬15.7m**.
  - Diverse subsidies ex-space ~10% (SCK Myrrha VKI nuclear/H2 class).
  - EU research fund prog5 **ÃÂ¢ÃÂÃÂ¬26.9m** exp 2024 (extra federal budget).
...
- Found (strong BELSPO P4Science Information File call 2024-2025 primary PDF):
  ...
  - Call indicative total **ÃÂ¢ÃÂÃÂ¬15.261.890** covering two budget years.
  - Competitive **20%**: **ÃÂ¢ÃÂÃÂ¬2.852.380** all FSI (+**ÃÂ¢ÃÂÃÂ¬250k** already committed to international calls).
  - Non-competitive **80%**: **ÃÂ¢ÃÂÃÂ¬12.394.510** allocated by FSI (repartition key 10 BELSPO-FSI; flat rate Sciensano/NICC/WHI).
  - Largest non-comp: **KBIN ÃÂ¢ÃÂÃÂ¬1.883m** ÃÂÃÂ· **ARA ÃÂ¢ÃÂÃÂ¬1.696m** ÃÂÃÂ· **KMMA ÃÂ¢ÃÂÃÂ¬1.221m** ÃÂÃÂ· **KIK ÃÂ¢ÃÂÃÂ¬1.186m** ÃÂÃÂ· **BIRA ÃÂ¢ÃÂÃÂ¬1.152m**.
  - Smaller: KBS 1.098 ÃÂÃÂ· KMKG 0.963 ÃÂÃÂ· KMI 0.959 ÃÂÃÂ· KMSKB 0.595 ÃÂÃÂ· Sciensano 0.564 ÃÂÃÂ· KBR 0.555 ÃÂÃÂ· NICC 0.393 ÃÂÃÂ· WHI 0.131.
  - **Project R&D only** ÃÂ¢ÃÂÃÂ not base ADBA+ION ÃÂ¢ÃÂÃÂ¬162.6m financing (residual FOI).
  - Dual: federal FSI projects vs community FWO/FNRS (~ÃÂ¢ÃÂÃÂ¬450m / ~ÃÂ¢ÃÂÃÂ¬250m class prior ticks).
...
- Found (strong BELSPO FED-tWIN page + RMAH strategy + climat.be inventory):
  ...
  - Rates (RMAH cites BELSPO): **ÃÂ¢ÃÂÃÂ¬125k/yr** first 5y ÃÂ¢ÃÂÃÂ **ÃÂ¢ÃÂÃÂ¬75k/yr** next 5y; ~**ÃÂ¢ÃÂÃÂ¬1m/profile** 10y class; programme **~ÃÂ¢ÃÂÃÂ¬125m** full-path medium class (staggered FOI).
  - Climate FedTwin subset: **13** projects **ÃÂ¢ÃÂÃÂ¬9.25m** 2020-26 (strong).
  - **DIGIT-04** 2019-24: **ÃÂ¢ÃÂÃÂ¬37.63m** all 10 FSI + Cinematek; RMAH ~ÃÂ¢ÃÂÃÂ¬380k/yr class.
  - Climate portfolio: **ÃÂ¢ÃÂÃÂ¬39.2m** 2019-27 / **ÃÂ¢ÃÂÃÂ¬32.9m** 2022-26 (BRAIN-P1 11.7; STEREO 7; ESA Climate+DTE 9; Polar 1.67; BELGICA 2.0).
  - Dual: FSIÃÂ¢ÃÂÃÂ11 universities NL/FR; heritage digitisation dual community.
...
- Found (strong BELSPO S4Policy InfoFile v6 + AR2024 PROBA-3 PDF):
  - **S4Policy Policy Driven** 4-call total **ÃÂ¢ÃÂÃÂ¬34.256.160** (2024-2031).
  - Call1 **ÃÂ¢ÃÂÃÂ¬6.155.110** ÃÂÃÂ· Call2 **ÃÂ¢ÃÂÃÂ¬7.951.700** ÃÂÃÂ· Call3 **ÃÂ¢ÃÂÃÂ¬8.791.270** ÃÂÃÂ· Call4 **ÃÂ¢ÃÂÃÂ¬11.358.080**.
  ...
  - Dual with **P4Science** ÃÂ¢ÃÂÃÂ¬15.26m FSI capacity (prior tick).
  - **PROBA-3**: mission **ÃÂ¢ÃÂÃÂ¬166m** of which Belgium **ÃÂ¢ÃÂÃÂ¬63.4m** via BELSPO **GSTP+PRODEX**; launch **4 Dec 2024**.
...
- Found (strong BELSPO STEREO IV InfoFile call 2025 + EO portal):
  ...
  - Programme budget **ÃÂ¢ÃÂÃÂ¬28.15m**.
  - Call 2025 thematic network projects tentatively **~ÃÂ¢ÃÂÃÂ¬7.4m** (subject to final budget).
  - Eighth EO phase since 1985 (TELSAT/STEREO IÃÂ¢ÃÂÃÂIII continuity).
  - Dual: partnerships **highly recommended** both Flemish and French community teams; foreign teams max **20%** of project budget.
  - Themes: climate EO ÃÂÃÂ· hazards ÃÂÃÂ· biodiversity/health ÃÂÃÂ· green cities.
...
- Found (strong BELSPO CM-ESA Bremen 2025 debrief primary PDF):
  - BE total space **2025-2030**: **ÃÂ¢ÃÂÃÂ¬1.845bn** = 1.277 base + **168 MoD ESA** + **400 one-off** (~**ÃÂ¢ÃÂÃÂ¬369m/y**).
  - ESA share class **~ÃÂ¢ÃÂÃÂ¬335m/y**; intergov Eumetsat/ECMWF/ESO ~25m/y; EU/bilat/nat ~10m/y.
  - BE ESA CM25 subscription **ÃÂ¢ÃÂÃÂ¬1.109bn** incl MoD (5.06% of ESA ÃÂ¢ÃÂÃÂ¬22.07bn); prior CM22 ÃÂ¢ÃÂÃÂ¬946.86m.
  - InÃÂÃÂ©luctables **ÃÂ¢ÃÂÃÂ¬1.050bn**; new ESA commits **ÃÂ¢ÃÂÃÂ¬934m** (836m for 2026-30).
  - PRODEX **ÃÂ¢ÃÂÃÂ¬99m** (24 uncond + 75 cond); GSTP **ÃÂ¢ÃÂÃÂ¬103.9m** (79.9 TBA); Science **ÃÂ¢ÃÂÃÂ¬106.4m**; Basic **ÃÂ¢ÃÂÃÂ¬52.2m**.
  - MoD invest programmes space **2026-2034 ÃÂ¢ÃÂÃÂ¬617m**; dual NATO-accountable constraint.
...
- Found (strong EUMETSAT Annual Report 2024 audited accounts extract):
  - Belgium Member State contribution **ÃÂ¢ÃÂÃÂ¬13.480m** 2024 (table 13.480 kEUR).
  - Total MS contributions **ÃÂ¢ÃÂÃÂ¬506.037m**; BE share **~2.66%**.
  - EUMETSAT expenditure budgets 2024 total **ÃÂ¢ÃÂÃÂ¬763.2m** (EPS-SG 254.3 ÃÂÃÂ· MTG 219.1 ÃÂÃÂ· Copernicus 111.4 ÃÂÃÂ· GB 91 ÃÂÃÂ· EPS 37.4 ÃÂÃÂ· DestinE 24.3 ÃÂÃÂ· MSG 23.3 ÃÂÃÂ· Jason-CS 2.4).
  - Dual: KMI/IRM meteorological user + BELSPO intergov space path.
  - Aligns CM25 intergov class **~ÃÂ¢ÃÂÃÂ¬25m/y** (EUMETSAT + ECMWF + ESO); residual ECMWF/ESO FOI.
...
- Coverage vs EUR 347.956 bn TE:
  - **A L0 / B L1:** **100%** strong
  - **C L2:** **~91-98%** (up from ~90-97% @330) ÃÂ¢ÃÂÃÂ BELSPO AR2024 **ÃÂ¢ÃÂÃÂ¬582.4m** L2; BE space CM25 **ÃÂ¢ÃÂÃÂ¬1.845bn** 2025-30 dual MoD; EUMETSAT **ÃÂ¢ÃÂÃÂ¬13.48m**; prior SOE/lottery/culture/Belnet
  - **D L5:** **~16-27%** ÃÂ¢ÃÂÃÂ P4Science 15.26m FSI; FED-tWIN; S4Policy 34.26m; STEREO IV 28.15m; PROBA-3 BE 63.4m; climate 39.2m; awards/cash FOI residual
...
- Found (strong VAF Jaarverslag 2024 + 2025 primary):
  - **2024 VL dots:** Film Culture **ÃÂ¢ÃÂÃÂ¬20.490m** ÃÂÃÂ· Media **ÃÂ¢ÃÂÃÂ¬7.450m** ÃÂÃÂ· Game **ÃÂ¢ÃÂÃÂ¬2.768m** ÃÂ¢ÃÂÃÂ **ÃÂ¢ÃÂÃÂ¬30.708m**.
  - Filmfonds total budget **ÃÂ¢ÃÂÃÂ¬20.535m** (creatie **ÃÂ¢ÃÂÃÂ¬11.753m**: fictie 7.753 / doc 1.575 / anim 1.575); spend **ÃÂ¢ÃÂÃÂ¬21.576m**.
  - Mediafonds available **ÃÂ¢ÃÂÃÂ¬8.894m** (incl dienstenverdelers/OTT **ÃÂ¢ÃÂÃÂ¬0.781m**); spend **ÃÂ¢ÃÂÃÂ¬8.554m**.
  - **2025 VL dots:** Film **ÃÂ¢ÃÂÃÂ¬20.820m** ÃÂÃÂ· Media **ÃÂ¢ÃÂÃÂ¬7.173m** ÃÂÃÂ· Game **ÃÂ¢ÃÂÃÂ¬2.800m** ÃÂ¢ÃÂÃÂ **ÃÂ¢ÃÂÃÂ¬30.793m**.
...
- Found (strong FWB CCA Bilan 2024 official):
  - Global AV envelope **>ÃÂ¢ÃÂÃÂ¬44m** 2024 (was **ÃÂ¢ÃÂÃÂ¬43.15m** 2023).
  - **FWB ÃÂ¢ÃÂÃÂ¬26.6m** + editors/distributors **ÃÂ¢ÃÂÃÂ¬17.4m** (RTBF **ÃÂ¢ÃÂÃÂ¬5.8m** + private **ÃÂ¢ÃÂÃÂ¬11.6m** SMA legal investment).
  - Commission du CinÃÂÃÂ©ma promises **ÃÂ¢ÃÂÃÂ¬13.24m**; Commission SÃÂÃÂ©ries **ÃÂ¢ÃÂÃÂ¬1.635m** (first year); opÃÂÃÂ©rateurs **ÃÂ¢ÃÂÃÂ¬4.198m**; promo **ÃÂ¢ÃÂÃÂ¬0.712m**.
  - Tax shelter raised **ÃÂ¢ÃÂÃÂ¬84.73m** (+14% vs 2023) ÃÂ¢ÃÂÃÂ investor money not CCA budget.
  - Europe Creative MEDIA BE projects **ÃÂ¢ÃÂÃÂ¬9.4m**.
  - Dual: VAF Flanders VL dots **~ÃÂ¢ÃÂÃÂ¬30.7m** same class; federal CINEMATEK residual FOI.
...
- Found (strong FPS Finance Inventory of Federal Tax Expenditures 2024 / 2026 PDF):
  - Tax shelter **audiovisual** Art.194ter CIT TE multi-year: **ÃÂ¢ÃÂÃÂ¬212.15m 2023** (204.38 2022; 183.73 2021; 173.36 2020).
  - Reform spike post-2014: **ÃÂ¢ÃÂÃÂ¬7.44m 2014 ÃÂ¢ÃÂÃÂ ÃÂ¢ÃÂÃÂ¬191.41m 2015**.
  - **Scenic/performing arts** extension: **ÃÂ¢ÃÂÃÂ¬41.82m 2023** (21.88 2022).
  - **Video games** extension: **ÃÂ¢ÃÂÃÂ¬1.33m 2023** (0.20 2022).
  - **Package 2023: ÃÂ¢ÃÂÃÂ¬255.3m** (AV+scenic+games).
  - Dual culture stack: VAF VL dots ~ÃÂ¢ÃÂÃÂ¬30.7m + CCA envelope >ÃÂ¢ÃÂÃÂ¬44m + federal TE; CCA raised investor cash ÃÂ¢ÃÂÃÂ¬84.73m 2024 is **different metric** from TE revenue-forgone.
...
- Found (strong Wallimage Bilan 2024/2025 PDF + VAF Screen Flanders page + Gaming page):
  - **Wallimage Coproductions invest:** **ÃÂ¢ÃÂÃÂ¬7.0948m** 2024 (49 projects) ÃÂÃÂ· **ÃÂ¢ÃÂÃÂ¬6.686m** 2025 (47 projects).
  - **Walloon spend generated:** **ÃÂ¢ÃÂÃÂ¬46.232m** 2024 (~652%) ÃÂÃÂ· **ÃÂ¢ÃÂÃÂ¬51.436m** 2025 (**769%** record).
  - **Wallimage Entreprises:** **ÃÂ¢ÃÂÃÂ¬3.720m** (12 deals 2024) ÃÂÃÂ· **ÃÂ¢ÃÂÃÂ¬4.191m** (19 deals 2025); stock **ÃÂ¢ÃÂÃÂ¬13.59m** EOY24 ÃÂ¢ÃÂÃÂ **ÃÂ¢ÃÂÃÂ¬10.23m** EOY25.
  - **Production volant** capacity **ÃÂ¢ÃÂÃÂ¬6.5m/yr** since 2018; **Gaming** FY2026 budget **ÃÂ¢ÃÂÃÂ¬2.0m**.
  - **Screen Flanders:** VLAIO Hermes **ÃÂ¢ÃÂÃÂ¬3.5m/yr**; max **ÃÂ¢ÃÂÃÂ¬400k** recoupable advances; VAF admin.
  - Dual stack: economic (Wallimage~ÃÂ¢ÃÂÃÂ¬10.8m + SF ÃÂ¢ÃÂÃÂ¬3.5m) on top of culture (VAF ~ÃÂ¢ÃÂÃÂ¬30.7m + CCA >ÃÂ¢ÃÂÃÂ¬44m) + federal Tax Shelter TE.
...
- Found (strong primary screen.brussels Bilan 2025 + 2024 nutshell + Results 2023 + CineRegio):
  - **2025:** nearly **ÃÂ¢ÃÂÃÂ¬3m** / allocated **ÃÂ¢ÃÂÃÂ¬2.9m** in **26** projects; claimed return **ÃÂ¢ÃÂÃÂ¬27.3m**; ratio **9.2x** (2016-2025).
  - Format split 2025 of ÃÂ¢ÃÂÃÂ¬2.9m: LM 37% ÃÂÃÂ· anim 30% ÃÂÃÂ· series 30% ÃÂÃÂ· doc 3%.
  - **2024:** **ÃÂ¢ÃÂÃÂ¬3.0m** in **27** projects; claimed return **ÃÂ¢ÃÂÃÂ¬34.122m**; ratio **9.5x**.
  - **2023:** **>ÃÂ¢ÃÂÃÂ¬3m** / available **ÃÂ¢ÃÂÃÂ¬3.1m** in **29** projects; claimed **ÃÂ¢ÃÂÃÂ¥ÃÂ¢ÃÂÃÂ¬24m** spend; apps **ÃÂ¢ÃÂÃÂ¬6.3m**.
  - CineRegio: annual **ÃÂ¢ÃÂÃÂ¬3m**; max **ÃÂ¢ÃÂÃÂ¬500k** refundable advances; min BCR spend **ÃÂ¢ÃÂÃÂ¬250k**.
  - **Triple economic AV 2024-class ~ÃÂ¢ÃÂÃÂ¬17.3m:** Wallimage Coprod+Ent ~ÃÂ¢ÃÂÃÂ¬10.8m + Screen Flanders ÃÂ¢ÃÂÃÂ¬3.5m + screen.brussels ÃÂ¢ÃÂÃÂ¬3.0m (not TE-additive).
  - Stack still separate: culture VAF ~ÃÂ¢ÃÂÃÂ¬30.7m + CCA >ÃÂ¢ÃÂÃÂ¬44m + federal Tax Shelter TE.
...
- Found (strong primary VL BBT Sport BO2026 + ADEPS RA2025):
  - **Sport Vlaanderen prog HF BO2026:** VAK **ÃÂ¢ÃÂÃÂ¬177.121m** ÃÂÃÂ· VEK **ÃÂ¢ÃÂÃÂ¬167.136m** (excl DAB/apparaat/prog B).
  - **BA2025 same perimeter:** VAK **ÃÂ¢ÃÂÃÂ¬183.884m** ÃÂÃÂ· VEK **ÃÂ¢ÃÂÃÂ¬185.264m**.
  - **Toelage IS 2026:** VAK **ÃÂ¢ÃÂÃÂ¬175.934m** ÃÂÃÂ· VEK **ÃÂ¢ÃÂÃÂ¬165.949m** (HB0-1HFH2NY-IS + HB0-1HFH5NY-IS).
  - **ISE BO2026:** Sport voor allen VEK **ÃÂ¢ÃÂÃÂ¬125.546m** ÃÂÃÂ· Infra **ÃÂ¢ÃÂÃÂ¬30.876m** ÃÂÃÂ· Topsport **ÃÂ¢ÃÂÃÂ¬31.659m** ÃÂÃÂ· Antidoping **ÃÂ¢ÃÂÃÂ¬1.445m**.
  - **ADEPS / FWB sport 2025:** **ÃÂ¢ÃÂÃÂ¬49.891m** (0.3% FWB total; ordinaire + SACA/Loterie).
  - Subventions 2025: federations forfait **ÃÂ¢ÃÂÃÂ¬8.320m** + plan-programme **ÃÂ¢ÃÂÃÂ¬12.932m** ÃÂÃÂ· CSL **ÃÂ¢ÃÂÃÂ¬5.593m** ÃÂÃÂ· SHN **ÃÂ¢ÃÂÃÂ¬1.251m** ÃÂÃÂ· jeunes **ÃÂ¢ÃÂÃÂ¬3.262m** ÃÂÃÂ· ASL used **ÃÂ¢ÃÂÃÂ¬2.555m**.
  - Staff: **587** agents + **1,215** occasional (8,142 contracts); **64** federations / **6,846** clubs / **813,207** affiliates.
  - **Dual class ~ÃÂ¢ÃÂÃÂ¬235m** 2025 (VL VEK 185.3 + ADEPS 49.9; not TE-additive).
...
- Found (strong primary FWO JV2024/2025 + FNRS RA2024):
  - **FWO VL vastlegging:** **ÃÂ¢ÃÂÃÂ¬470.342m** BA2024 ÃÂÃÂ· **ÃÂ¢ÃÂÃÂ¬448.182m** BA2025.
  - **FWO vereffening total:** **ÃÂ¢ÃÂÃÂ¬436.818m** 2024 ÃÂÃÂ· **ÃÂ¢ÃÂÃÂ¬464.623m** 2025.
  - FO projects vast 2024 **ÃÂ¢ÃÂÃÂ¬180.070m** / mandaten **ÃÂ¢ÃÂÃÂ¬109.378m**; SBO proj **ÃÂ¢ÃÂÃÂ¬51.460m** + mand **ÃÂ¢ÃÂÃÂ¬43.005m**; infra **ÃÂ¢ÃÂÃÂ¬66.176m**.
  - Beheerskosten **ÃÂ¢ÃÂÃÂ¬19.324m** (4.11% 2024) ÃÂÃÂ· **ÃÂ¢ÃÂÃÂ¬23.107m** (5.16% 2025).
  - **FNRS public subsidies 2024:** **ÃÂ¢ÃÂÃÂ¬241.818m** (FWB **ÃÂ¢ÃÂÃÂ¬173.540m** ÃÂÃÂ· fed IISN/FRSM **ÃÂ¢ÃÂÃÂ¬40.327m** ÃÂÃÂ· WAL **ÃÂ¢ÃÂÃÂ¬19.932m** ÃÂÃÂ· LN **ÃÂ¢ÃÂÃÂ¬8.020m**).
  - FNRS total resources **ÃÂ¢ÃÂÃÂ¬262.183m** (incl Telvie **ÃÂ¢ÃÂÃÂ¬10.871m** + dons **ÃÂ¢ÃÂÃÂ¬8.997m**).
  - Spend: mandats **ÃÂ¢ÃÂÃÂ¬152.957m** ÃÂÃÂ· projets **ÃÂ¢ÃÂÃÂ¬93.259m** ÃÂÃÂ· admin **ÃÂ¢ÃÂÃÂ¬15.271m**.
  - **Dual class 2024 ~ÃÂ¢ÃÂÃÂ¬712m** (FWO vast 470.3 + FNRS public 241.8; not TE-additive).
...
- Found (strong primary AWV Ondernemingsplan 2025 + SOFICO RA2024):
  - **AWV 2024:** VAK **ÃÂ¢ÃÂÃÂ¬1.0207bn** ÃÂÃÂ· VEK **ÃÂ¢ÃÂÃÂ¬1.187bn** (96.54% spent).
  - **AWV 2025:** structureel onderhoud **ÃÂ¢ÃÂÃÂ¬138.5m** (snelwegen 49.5 ÃÂÃÂ· gewest 47 ÃÂÃÂ· kunstwerken 33 ÃÂÃÂ· DVM 9); fiets vastlegging min **ÃÂ¢ÃÂÃÂ¬158m** (2024 was **ÃÂ¢ÃÂÃÂ¬162m**); +18m wegen / +12m EM onderhoud.
  - **SOFICO 2024:** produits **ÃÂ¢ÃÂÃÂ¬495.1m** ÃÂÃÂ· charges **ÃÂ¢ÃÂÃÂ¬397.6m** ÃÂÃÂ· net **ÃÂ¢ÃÂÃÂ¬100.7m** ÃÂÃÂ· invest record **ÃÂ¢ÃÂÃÂ¬265m**.
  - **PKPL** (truck tolls) **ÃÂ¢ÃÂÃÂ¬347m** (+11.2%); network grands axes **ÃÂ¢ÃÂÃÂ¬370.8m** 2024 ÃÂÃÂ· cum **~ÃÂ¢ÃÂÃÂ¬3.7bn** since 2010.
  - Entretien+rehab class **~ÃÂ¢ÃÂÃÂ¬371m** 2024 (161+210).
...
- Found (strong primary VL BBT Onroerend Erfgoed BO2026 13-O):
  - **BO2026 total** (excl apparaatrek/prog B): VAK **ÃÂ¢ÃÂÃÂ¬121.823m** ÃÂÃÂ· VEK **ÃÂ¢ÃÂÃÂ¬127.789m**.
  - **BA2025:** VAK **ÃÂ¢ÃÂÃÂ¬150.764m** ÃÂÃÂ· VEK **ÃÂ¢ÃÂÃÂ¬132.084m** (incl one-off partners/Thermae).
  - **ISE Kwaliteit:** VAK **ÃÂ¢ÃÂÃÂ¬99.995m** ÃÂÃÂ· VEK **ÃÂ¢ÃÂÃÂ¬92.702m** (**82.1%** of policy credits).
  - **Premies** QG0-1QGD2CB-WT: VAK **ÃÂ¢ÃÂÃÂ¬92.864m** ÃÂÃÂ· VEK **ÃÂ¢ÃÂÃÂ¬83.188m**; standaard max **ÃÂ¢ÃÂÃÂ¬45.3m**; wachtlijst new **ÃÂ¢ÃÂÃÂ¬9m**; cut **-ÃÂ¢ÃÂÃÂ¬6.562m**.
  - **Erfgoedleningen** PFV: VAK **ÃÂ¢ÃÂÃÂ¬7.0m** ÃÂÃÂ· VEK **ÃÂ¢ÃÂÃÂ¬9.383m** (ESR-neutral).
  - **ISE Partnerschappen:** VAK **ÃÂ¢ÃÂÃÂ¬16.953m** ÃÂÃÂ· VEK **ÃÂ¢ÃÂÃÂ¬29.540m**; prioritaire partners **ÃÂ¢ÃÂÃÂ¬1.710m**; IOED VAK **ÃÂ¢ÃÂÃÂ¬2.587m**.
  - Bourlaschouwburg max VL **ÃÂ¢ÃÂÃÂ¬40.17m** multi-year; Herita SWO 2026-2030 path.
...
- Coverage vs EUR 347.956 bn TE:
  - **A L0 / B L1:** **100%** strong
  - **C L2:** **~92-98%** (up from ~91-98% @340) ÃÂ¢ÃÂÃÂ FWO 470/448m + FNRS public 242m dual research; AWV VEK 1.19bn dual SOFICO 495m; Sport VL 167m dual ADEPS 50m; VAF/CCA + economic AV triple; OE heritage 128m; prior Belspo/CM25/EUMETSAT
  - **D L5:** **~17-28%** ÃÂ¢ÃÂÃÂ OE premies 83-93m envelope; dual-stack awards residual FOI
...
- Found (strong primary Wallonie Budget 2026 DO16):
  - **Programme 16.082** Monuments, sites et fouilles: CE=CL **ÃÂ¢ÃÂÃÂ¬46.215m**.
  - Line **082.001** Subvention a l'Agence wallonne du Patrimoine: **ÃÂ¢ÃÂÃÂ¬46.215m** eng=liq.
  - EU programming line 082.002: **ÃÂ¢ÃÂÃÂ¬0**.
  - Dual Flanders OE VEK **ÃÂ¢ÃÂÃÂ¬127.789m** / VAK **ÃÂ¢ÃÂÃÂ¬121.823m** 2026 ÃÂ¢ÃÂÃÂ dual class **~ÃÂ¢ÃÂÃÂ¬174m**.
...
- Unit: **rq_343** (FOI-adjacent hole-fill ÃÂ **dual regional agriculture VL Landbouw + WAL Aides/OPW**)
- Found (strong primary):
  - Flanders BBT Landbouw BO2026 (pfile 2227524): **VAK ÃÂ157.880m** ÃÂ· **VEK ÃÂ140.849m** excl. apparaatrek/prog B; TJ VEK **ÃÂ135.190m**; TK promotie **ÃÂ5.659m**.
  - Wallonie Budget 2026 DO15 prog **15.058** Aides: CE **ÃÂ93.325m** ÃÂ· CL **ÃÂ93.225m**; OPW Missions **ÃÂ45.049m** + Fonct **ÃÂ16.747m** + capital **ÃÂ20.017m** = package **ÃÂ81.813m** (nested); calamitÃÂ©s agricoles **ÃÂ9.300m**.
  - Dual class regional agri policy **~ÃÂ234m** (VL VEK + WAL aides) ÃÂ **excludes bulk EU CAP** direct payments via paying agencies.
  - DO15 total CL **ÃÂ570.184m** (ARNE combined agri+nature+env; not pure agri).
...
- Unit: **rq_344** (FOI-adjacent hole-fill ÃÂ **dual nature Flanders Omgeving/ANB + Wallonia Nature-ForÃÂªt**)
- Found (strong primary VR BBT Omgeving BO2026 + prior DO15):
  - Omgeving en Natuur excl. apparaatrek: **VAK ÃÂ690.943m** ÃÂ· **VEK ÃÂ696.049m** (multi-ISE).
  - ISE Natuur en biodiversiteit: **ÃÂ150.0m** total (MVG ~**ÃÂ22m** + DAB MINAfonds **ÃÂ128.0m**).
  - ANB apparaatrek QA-QD0: **ÃÂ49.500m**; INBO QA-QC0: **ÃÂ19.499m**.
  - Dual WAL prog 15.060 Nature-ForÃÂªt CL **ÃÂ28.879m** ? dual pure nature class **~ÃÂ179m** (not full Omgeving 696m).
...
- Unit: **rq_345** (FOI-adjacent hole-fill ÃÂ **dual waste/remediation OVAM Flanders + SPAQuE/dÃÂ©chets Wallonia**)
- Found (strong primary BBT Omgeving BO2026 + DO15):
  - ISE Afval en materialen: **ÃÂ105.9m** (MVG **ÃÂ102.4m** + MINA **ÃÂ3.5m**); UPV/zwerfvuil fonds TO **ÃÂ74.045m** jump.
  - OVAM dept toelage: **ÃÂ28.349m**; MINA toelage VEK **ÃÂ37.423m** / VAK **ÃÂ35.926m**.
  - ISE Bodem: **ÃÂ41.1m** (MINA-dominant).
  - SPAQuE dotation **ÃÂ24.138m**; WAL 15.064 dÃÂ©chets CL **ÃÂ9.859m**; 15.062 Air-Eau-Sol CL **ÃÂ64.071m** (ISSeP **ÃÂ23.783m** nested).
  - Dual waste class **~ÃÂ116m**; dual remediation class **~ÃÂ65m** (Bodem+SPAQuE). VMM water class **~ÃÂ132m** noted.
...
- Found (strong primary Rekenhof BBT E&K + BU2025 + EPNE 2026):
  - Flanders BBT E&K BO2026 (Rekenhof-corrected excl apparaatrek): VAK **EUR 958.573m** ÃÂ· VEK **EUR 1,104.825m**; TO **EUR 436.642m**.
  - BA2025: VAK **EUR 1,612.146m** ÃÂ· VEK **EUR 1,744.523m**.
  - BU2025 outturn: total VAK **EUR 1,239.576m** ÃÂ· VEK **EUR 1,201.859m**; QE Energie VAK **964.831m** / VEK **914.121m**; QH Klimaat VAK **274.745m** / VEK **287.738m**.
  - L5 BU2025: MVP net **EUR 204m** ÃÂ· Energieleningen **194m** ÃÂ· retro invest premies **240.6m** ÃÂ· REG-ODV other **68.2m** ÃÂ· WKK ODV **60m** ÃÂ· Call Groene Warmte **18.9m** ÃÂ· Energiehuizen **14.8m** ÃÂ· Energiefonds toelage **111.9m** ÃÂ· ICL klimaat **231.63m**.
  - WAL EPNE: prog **16.083** Energie CE **EUR 34.395m** ÃÂ· CL **EUR 28.360m** 2026 (2025 CE 80.512 / CL 74.765); Kyoto **15.074** **EUR 158m**; Fonds Energie **16.089** **EUR 7.986m**; AWAC dep **EUR 37.376m**; climate intl **EUR 13m**.
...
- Found (strong primary BBT Inburgering BO2026 + CoA 2022 + ILI press):
  - Flanders BBT excl apparaatrek: VAK **EUR 115.644m** ÃÂ· VEK **EUR 116.647m** BO2026 (BA2025 120.145 / 121.148).
  - **AgII toelage** SJ0-1SFC2DY-IS: **EUR 64.611m** (2025: 63.617m); institutional lonen **54.767m** ÃÂ· werking VAK **15.500m** ÃÂ· own rec **5.778m**.
...
- Found (strong primary VL BBT Cultuur BO2026 + FWB exp. particulier):
  - Flanders content class **~EUR 426.2m**: Kunsten VEK **157.966m** ÃÂ· Erfgoed **85.589m** ÃÂ· SCW **83.125m** ÃÂ· Amateur **14.031m** ÃÂ· Digital **20.161m** ÃÂ· Opera Ballet **31.045m** ÃÂ· KMSKA **12.123m** ÃÂ· Philharmonic **10.554m** ÃÂ· Literatuur **11.611m** (excl VIA 67.2m / infra mixed).
  - FWB DO20 Culture: CE **267.213m** ÃÂ· CL **367.468m** 2026 (2025 CL 362.582m).
  - L5 FWB: arts vivants CL **103.630m** ÃÂ· transversal **92.187m** ÃÂ· territoriale **67.383m** ÃÂ· musiques **52.725m** ÃÂ· patrimoines **23.000m**.
...
- Found (strong primary VL BBT Jeugd BO2026 + FWB exp. particulier DO23):
  - Flanders ISE Jeugd total **EUR 72.461m** BO2026 (BA2025 72.696m):
    ...
    - jeugdvakanties **9.792m** ÃÂ· innovatie **8.545m** ÃÂ· lokaal/int **2.309m**
    - ULDK **2.167m** ÃÂ· JINT **1.263m** ÃÂ· kinderrechten **0.844m**
  - FWB DO23 prog 2 Jeunesse: CE **67.951m** ÃÂ· CL **67.137m** 2026:
    - organisations de jeunesse **26.822m** ÃÂ· centres de jeunes CL **34.811m**
...
- Unit: **rq_351** (**progress milestone @360** ÃÂ coverage % + waste top10 refresh; no new euro invent)
- Snapshot (honest order-of-magnitude vs TE EUR 347.956 bn):
  - **A L0 / B L1:** **100%** (unchanged strong)
  - **C L2:** **~93ÃÂ98%** (up from ~92ÃÂ98% @350) ÃÂ dual sprint 351ÃÂ359: heritage/agri/nature/waste/energy **1.34bn**/integration/vocational/culture **~794m**/youth **~140m**
  - **D L5:** **~18ÃÂ29%** generous (IFAPME L5 + culture/youth decree lines; residual top-N FOI)
  - **E FOI ready:** **~170** (answered ~5; total FOI rows ~176)
- Inventory: budgets ~4420 ÃÂ· cmt ~641 ÃÂ· lb ~793 ÃÂ· entities ~320 ÃÂ· sources ~666
...
- Found (strong primary FWB exp. particulier + VL commissie Onderwijs 15-7-H):
  - FWB **DO56 Enseignement pour adultes** CE=CL **EUR 267.547m** 2026 (2025: 261.751m):
    - personnel **251.737m** (~94%) ÃÂ· fonctionnement ecoles **9.132m**
    - initiatives emploi **2.372m** ÃÂ· transversales **2.368m** ÃÂ· echec **1.830m**
...
- Found (strong primary VL BBT Cultuur domain tables + FWB exp. particulier prog7):
  ...
  - FWB **prog7 Action culturelle territoriale** CL **67.383m** (CE 110.872m):
    - centres culturels CL **32.372m** ÃÂ· bibliotheques **23.975m** (CE 41.114m)
    - CEC/amateurs **5.292m** ÃÂ· PointCulture **3.640m**
...
- Found (strong primary FWB exp. particulier DO25 + existing VRT BHO path):
  ...
  - **RTBF official 2026 L5:** ordinary **350.819m** ÃÂ· access **4.050m** ÃÂ· pension pool **13.956m** ÃÂ· TV5 frais **1.230m** + soutien **8.310m** ÃÂ· SEC **10.897m** = package **389.262m** (vs RA2025 package ~378m prior).
  - Medias de proximite class **~12.4m** ÃÂ· Presse **14.775m** ÃÂ· CSA **3.751m**.
...
- Found (strong primary VL BBT Cultuur SCW + FWB exp. particulier DO23 prog3):
  ...
  - FWB **Education permanente** prog3 CL **44.604m** / CE **30.442m** 2026:
    ...
    - formation animateurs **0.365m** ÃÂ· projets **0.482m** ÃÂ· loisirs culturels **0.626m**
...
- Found (strong primary VL BBT WVGA tech Q + FWB DO19 ONE):
  - Flanders **kinderopvang** **EUR 1,557.7m** BO2026:
    - voorschools **1,290m** ÃÂ· buitenschools **204.5m** ÃÂ· zij-instroom **30m**
    - residual VIA/loketten inside package
  - Related Opgroeien: PGJO **36.2m** ÃÂ· adoptie **3.9m** ÃÂ· consultatiebureaus **18m** ÃÂ· OverKop base **4.6m** ÃÂ· Huizen van het Kind **3.6m** + pilots **1.35m**
  - FWB **ONE** DO19 **EUR 760.837m** 2026 (2025: 711.833m):
    - dot main **604.028m** ÃÂ· IT 35.3 ÃÂ· reform 27.7 ÃÂ· places 5.0 ÃÂ· accueillantes 20.8 ÃÂ· emploi 49.4 ÃÂ· nouvelles 15.1
...
- Found (strong primary VL BBT WVG BU2025):
  ...
  - GCF2EA article BA VEK **141.740m** / BU **147.053m**:
    - **CAW 130.138m** ÃÂ· bis **1.240m** ÃÂ· teleonthaal **3.923m** ÃÂ· schuldhulp **1.498m**
...
- Found (strong primary VL BBT WVG BU2025 GDF2LA):
  ...
  - Named L5 inside GDF2LA:
    ...
    - Psyche VZW **2.716m** ÃÂ· erfelijkheid 4 centra **2.696m**
    - Vroegdetectie KJ **4.235m** ÃÂ· aanklampende zorg **1.324m**
    - Tandem **0.658m** ÃÂ· intersectorale teams JV **0.967m**
    - Familieplatform **0.541m** ÃÂ· VIKZ **0.690m**
...
- Found (strong primary VL BBT WVG BU2025):
  ...
  - **ISE Preventie** BA VEK **103.607m** / BU **80.360m**
    - GDF2JA ramingen: vaccins **29m** ÃÂ· partners **19.5m** ÃÂ· terrein **16m** ÃÂ· gezondheidsmakers **9m** ÃÂ· uitbreiding **10m**
...
- Found (strong primary VL BBT WVG BU2025):
  - **GCF2FA VIA** BA VEK **EUR 137.796m** / BU **141.687m**
    - GSD-V **81.178m** ÃÂ· 2de pensioenpijler priv **21.513m** ÃÂ· VSPF maribel **15.638m**
    - VVSG **4.681m** ÃÂ· SFNP **2.838m** ÃÂ· Verso/VIVO named ÃÂ· sample sum **~128.8m**
  - **GHF2TR sociale akkoorden** BA **217.298m** / BU **226.806m** (eindeloopbaan/maribel/syndicale ouderenzorg EL GGZ)
  - Vrijwilligerswerk GCF2EB BA **2.037m** (140 orgs ÃÂ· 1.860m autonomous)
...
- Found (strong primary BBT WVG BU2025 Orafin AVSB):
  ...
  - ZBO **350.488m** ÃÂ· ZZZ **137.083m** ÃÂ· ZPH **25.433m** (sum zorgbudgetten **513.004m**)
  - RCO **211.396m** ÃÂ· PVT+IBW **153.355m** ÃÂ· RZH **121.603m** ÃÂ· MOHM **101.016m**
  - AVSB **13.988m** ÃÂ· MBE **12.931m** ÃÂ· MDO **0.994m**
...
- Found (strong primary BBT WVG BU2025):
  ...
  - Agency exp VEK BU **2,735.733m** ÃÂ· receipts **2,810.173m**
  - **PVB** **1,517.536m** VEK: third-party **1,207.851m** ÃÂ· cash **309.684m**
  - Zorginstellingen subsidies **896.795m** (top-up/MFC/internaten)
  - 5,201 TBS ÃÂ· **4,551** persons ÃÂ· PAB awards **330**
  - Uitbreiding: PG1 52.4 ÃÂ· PG2 24.1 ÃÂ· PAB minors 13 ÃÂ· MFC/RTH 12.9m
...
- Found (strong primary INAMI Budget 2025 annexe 2/1):
  - **Doctors 11,642.546m** (consult 3,566 ÃÂÃÂ· imaging 1,753 ÃÂÃÂ· surgery 1,536 ÃÂÃÂ· clinbio 1,557)
  - **Hospital day package 8,513.199m** (verpleegdag 8,068)
  - **Pharma 6,979.202m** ÃÂÃÂ· **Nurses 2,319.840m** ÃÂÃÂ· **Dentists 1,622.006m** ÃÂÃÂ· **Kines 1,340.350m**
  - Implants 1,008 ÃÂÃÂ· Dialysis 582 ÃÂÃÂ· Rehab 627 ÃÂÃÂ· Maisons med 373 ÃÂÃÂ· Psycho 251 ÃÂÃÂ· LVZ 440 ÃÂÃÂ· Soc akkoord 295
  - **OA admin 988.052m** ÃÂÃÂ· INAMI beheer 121.7 ÃÂÃÂ· wet ziekenhuizen 2,696 ÃÂÃÂ· e-sante 113.4
  - GFB salaries 27,275 ÃÂÃÂ· self-emp 2,672 ÃÂÃÂ· alt fin salaries 7,319
...
- Found (strong primary PensionStat XLSX + FPD jaarverslag 2024):
  ...
  - **Sal 39,880.9** ÃÂÃÂ· **Fonct 23,428.5** ÃÂÃÂ· **Ind 5,737.7** m (2025)
  - Retraite **60,519.0** ÃÂÃÂ· Survie **8,528.1** m; min-benef spend **20,751.9** m
...
- Found (strong primary CoA Cahier 2025 SS + RSVZ Chiffres 2024):
  - GG indep **dep EUR 6,523.1m 2024** (pens 5,597.8 ÃÂÃÂ· invalidite 915.4 ÃÂÃÂ· path 5.54/6.01/6.52)
  - GG indep **rec 10,293.0m** ÃÂÃÂ· **cotis 5,627.8m** (personnes 5,322.3 ÃÂÃÂ· societes 297.9) ÃÂÃÂ· solde **-71.4m**
  - Dotations Etat **935.1m** ÃÂÃÂ· altfin **3,650.9m** ÃÂÃÂ· unpaid hors bilan **1,552.6m** cotis + **104.9m**
  - INASTI missions **9,712.4m** / beheer **106.9m** 2023
  - Affiliates **1,299,825** ÃÂÃÂ· CAS top ACERTA 341k ÃÂÃÂ· XERIUS 247k ÃÂÃÂ· LIANTIS 241k ÃÂÃÂ· societes 707k
...
- Found (strong primary CoA Cahier 2025 SS Tables 8/10/11/27):
  ...
  - Pecules **6,338.5m**: ONVA-caisse **~64.1% (~4,063m)** ÃÂÃÂ· 9 private CSV **~2,276m**
  - Cotis patronales **5,698.5m** ÃÂÃÂ· ONEM contrib **30.7m** ÃÂÃÂ· **FFE loan 200m** 0% 15y
  - Beheer **23.6m** 2023; beneficiaires **1,661,304** ouvriers 2024
  - Fedris **596.4m** (AT 327.1 MP 214.8 amiante 23.6) ÃÂÃÂ· CAAMI missions **642.6m**
...
- Found (strong primary CoA Cahier 2025 SS Tables 1-3 12-16):
  - GG sal **prestations EUR 60,514.7m 2024** (pens **40,125** ÃÂÃÂ· inv **13,449** ÃÂÃÂ· chom **6,391** ÃÂÃÂ· AT/MP **542**)
  - Rec **99,197.8m** ÃÂÃÂ· cotis **65,768.6m** (sal 60,186 ÃÂÃÂ· locaux 5,126) ÃÂÃÂ· solde **+83.9m**
  - Dots **9,488.8m** (equilibre 6,142 ÃÂÃÂ· ord 2,765 ÃÂÃÂ· federees 582) ÃÂÃÂ· altfin **21,367.4m**
  - Reductions cotis **3,592.6m** (bonus emploi 1,679 ÃÂÃÂ· structurelles 1,866) + cibles dep **920m**
  - Pensions publiques **21,041m** ÃÂÃÂ· dot Etat **15,472m** ÃÂÃÂ· fonds solidarise **3,436m**
  - INAMI soins consol dep **37,041m** ÃÂÃÂ· retenue pensions **1,753m**
...
- Found (strong primary CoA Budget 2026 + PensionStat GRAPA):
  - Entity I dep **268.7bn** ÃÂÃÂ· social **155.5bn** ÃÂÃÂ· SS prest **135.5bn** ÃÂÃÂ· cotis **86.1bn**
  - **Handicap 3.3bn** ÃÂÃÂ· **IGO/ages 1.0bn** ÃÂÃÂ· **RIS CPAS 2.2bn** (+Ukraine **299m**) = package **6.5bn**
  - Chomage **3.9bn** 2026 (vs 5.7bn; -31.5pct) ÃÂÃÂ· pens **72bn** ÃÂÃÂ· health **41.3bn** ÃÂÃÂ· indemn **15.9bn**
  - GRAPA stock **119,651** Jan2025 ÃÂÃÂ· avg **719 EUR/mo** ÃÂÃÂ· annualized **~1.03bn** medium dual 1.0bn
...
- Found (strong primary CoA Budget 2026):
  - Justice section **EUR 2,843m** (+82) + dedicated provisions **465.5m** (sec 112.5 ÃÂÃÂ· surpop 50 ÃÂÃÂ· infra 259 ÃÂÃÂ· effic 44)
...
- Found (strong primary CoA Budget 2026):
  ...
  - **Generale 829.8m**: justice divers **618.3** (prison infra **259** ÃÂÃÂ· ESA **176** ÃÂÃÂ· econ sociale **50** ÃÂÃÂ· admin reorg **36** ÃÂÃÂ· Tria **5.3** ÃÂÃÂ· CPL **2.7**) ÃÂÃÂ· Fedasil **100** ÃÂÃÂ· bpost **78** ÃÂÃÂ· vulnerables **33.5**
...
- Found (strong primary Kamer 56K1143):
  ...
  - Staff 2034: **34,500** active ÃÂÃÂ· **12,800** reserve ÃÂÃÂ· **8,500** civil; recruit 2026: 2800/1050/960
  - Largest packages: Combat Manoeuvre **6,003.8m** ÃÂÃÂ· SBAMD **4,014.0m** ÃÂÃÂ· F-35+11 **3,387.4m** ÃÂÃÂ· ASWF-3 **1,918.2m** ÃÂÃÂ· CSS **1,352.6m** ÃÂÃÂ· Joint land **1,535.5m** ÃÂÃÂ· mine warfare **1,170.9m**
...
- Found (strong primary CoA Budget 2026 Part III):
  - SS consol **rec 148,017.2m** / **dep 147,858.5m**; cotis **85,525** ÃÂÃÂ· subv PP **27,679** ÃÂÃÂ· altfin **27,222**
...
- Found (strong/medium primary CoA Budget 2026 Part II Ch.I recettes):
  - Cash total **164.4bn** ÃÂÃÂ· fiscal **157.9bn** ÃÂÃÂ· nonfiscal **6.5bn** ÃÂÃÂ· transfers **92.5bn** (R&C 59.2 ÃÂÃÂ· SS 27.3 ÃÂÃÂ· EU 4.15) ÃÂÃÂ· V&M **71.9bn**
...
- Found (strong primary CoA Budget 2026 Part I Entity I):
  ...
  - Tax **141.9** ÃÂÃÂ· SSC **86.1** (reductions **5.5** excl Maribel) ÃÂÃÂ· third-party **22.2**
  - Social **155.5bn** (57.9pct): SS prest **135.5** ÃÂÃÂ· pens **72** ÃÂÃÂ· health **41.3** ÃÂÃÂ· indemn **15.9** ÃÂÃÂ· chom **3.9** (-31.5pct)
  - Transfers own **66.5** (federated **59.1** ÃÂÃÂ· EU GNI **~5** +30pct) ÃÂÃÂ· eco **9.6** (rail 3.4 energy 1.5 ESA 0.41 bpost 0.155) ÃÂÃÂ· authority **23.2** (Defence 9.5)
  - Interest **12.2bn** (1.84pct GDP) path **17.8** / 2.5pct; taxex GG **39.4** / fed **29.7** (social 18.6 VAT6 10.6)
  - Conclave improve **~1.6bn** 2026 (fiscal net 1.6 ÃÂÃÂ· spend control 421 ÃÂÃÂ· cohesion cost 567 ÃÂÃÂ· social economy **50**/yr)
...
- Snapshot (honest order-of-magnitude vs TE EUR 347.956 bn):
  - **A L0 / B L1:** **100%** (unchanged strong)
  - **C L2:** **~97-99%** (up from ~96-99% @390) - Entity I 244.1/268.7 ÃÂÃÂ· SS consol 148 ÃÂÃÂ· fed cash fiscal 157.9 ÃÂÃÂ· NATO 13.1 ÃÂÃÂ· LPM 33.8 eng
...
- Inventory: budgets ~5670 ÃÂÃÂ· cmt ~706 ÃÂÃÂ· lb ~1037 ÃÂÃÂ· entities ~357 ÃÂÃÂ· sources ~729
...
- Found (strong/medium primary CoA Budget 2026 Part I Ch.III + FPB Feb):
  - BE deficit **-4.9pct** 2026 (vs -5.2 reest 2025); Entity I **-3.7** ÃÂÃÂ· Entity II **-1.2**
  - MTFS path to **-3.0pct** 2029; DBP worse by **0.5/0.3pp** 2025-26
  - Conclave improves Entity I **ÃÂ¢ÃÂÃÂ¬9.2bn** by 2029 (~half of 18.5bn overrun vs 3pct)
  - Expose end legislature Entity I deficit **ÃÂ¢ÃÂÃÂ¬31.2bn** (4.3pct); debt **85.6ÃÂ¢ÃÂÃÂ90.3pct**
  - FPB post-measures Entity I **ÃÂ¢ÃÂÃÂ¬36.5bn** (-5.0pct) = **ÃÂ¢ÃÂÃÂ¬5.3bn** worse; GG debt **109.4 / 116.6 / 122.2** 2026-31
  - Net primary margin Entity I **~ÃÂ¢ÃÂÃÂ¬0.9bn** under CSF 2025-26; military escape to 2028
  - IPP stretch **+ÃÂ¢ÃÂÃÂ¬1bn** 2029 optical; regions EU **ÃÂ¢ÃÂÃÂ¬500m**/yr from 2028 (no agreement)
  - ET prefin SEC artefact **ÃÂ¢ÃÂÃÂ¬18.3m** improves GG artificially
...
- Found (strong primary FPB press tables):
  - **Feb2026:** GDP **1.1** 2026; deficit **-4.9 ÃÂ¢ÃÂÃÂ -6.3** 2026-31; debt **107.4 ÃÂ¢ÃÂÃÂ 122.2**; emp rate **72.8ÃÂ¢ÃÂÃÂ75.2**; jobs **+276k**; ONEM benef **-138k**; admin U **-53k**; CPI **1.9** (ETS2 2.2 in 2028)
  - **Jun2026 (ME shock):** GDP **0.7** 2026; CPI **3.4**; deficit stabilise **-5.1** then **-6.4** 2031; debt **107.9ÃÂ¢ÃÂÃÂ122.3**; interest **3.5pct GDP** 2031; jobs **+20k** 2026 / **+230k** 2027-31; emp rate **74.8** 2031; admin U **-34k**; real income **-0.7** 2026
...
- Found (strong primary BFP/CEV/IWEPS press):
  - **CEV2026:** social exp **25.7%ÃÂ¢ÃÂÃÂ27.2% GDP** 2025-50; ageing cost **+1.5pp** to 2070; health **+2.1pp** ÃÂÃÂ· pens **+0.7pp**; reform saves **1.4pp** pens; low-prod cost **3.3pp**; benefit ratio **-13%** by 2070; pensioner poverty **8.5%** 2024
  ...
  - Deficits end: VL **~ÃÂ¢ÃÂÃÂ¬2bn** ÃÂÃÂ· WAL **ÃÂ¢ÃÂÃÂ¬1.6bn** ÃÂÃÂ· FWB **ÃÂ¢ÃÂÃÂ¬1.2bn** 2029 ÃÂÃÂ· BRU **ÃÂ¢ÃÂÃÂ¬0.8bn** 2029
...
- Found (strong primary ICN 20 Apr 2026 + NBB 12 Jun 2026):
  - **ICN 2025:** TE **ÃÂ¢ÃÂÃÂ¬347.956bn** ÃÂÃÂ· primary **ÃÂ¢ÃÂÃÂ¬333.7bn** ÃÂÃÂ· interest **ÃÂ¢ÃÂÃÂ¬14.3bn** ÃÂÃÂ· rec **ÃÂ¢ÃÂÃÂ¬314.7bn** ÃÂÃÂ· deficit **ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ¬33.2bn (ÃÂ¢ÃÂÃÂ5.2%)** ÃÂÃÂ· debt **ÃÂ¢ÃÂÃÂ¬692.5bn (107.9%)** ÃÂÃÂ· GDP **ÃÂ¢ÃÂÃÂ¬642.0bn**
  - Subsectors: fed **ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ¬24.1bn** ÃÂÃÂ· C&R **ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ¬8.9bn** ÃÂÃÂ· local **ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ¬0.4bn** ÃÂÃÂ· SS **+ÃÂ¢ÃÂÃÂ¬0.17bn**
  - C&R: VL **ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ¬4.1bn** ÃÂÃÂ· WAL **ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ¬2.9bn** ÃÂÃÂ· FWB **ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ¬1.5bn** ÃÂÃÂ· BRU **ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ¬1.0bn** ÃÂÃÂ· ETS interreg **+ÃÂ¢ÃÂÃÂ¬0.56bn**
  - Defence COFOG **ÃÂ¢ÃÂÃÂ¬8.8bn (1.4% GDP)** vs NATO cash 2%; orders pending **0.6% GDP**
  - Debt shares: fed **80.0%** ÃÂÃÂ· C&R **18.4%** (ÃÂ¢ÃÂÃÂ¬127.6bn) ÃÂÃÂ· local 4.0% ÃÂÃÂ· SS ÃÂ¢ÃÂÃÂ2.4%
  - **NBB Jun:** GDP **0.6%** 2026 ÃÂÃÂ· HICP **3.4%** ÃÂÃÂ· deficit **ÃÂ¢ÃÂÃÂ5.3/ÃÂ¢ÃÂÃÂ5.5/ÃÂ¢ÃÂÃÂ5.7** ÃÂÃÂ· debt **111.3ÃÂ¢ÃÂÃÂ114.8** ÃÂÃÂ· jobs **+16/35/42k** ÃÂÃÂ· UI **~100k** lost H1-26
...
- Found (strong primary CEV Jul 2026 FOR_VERG2026 + DATA_FOR_VERG_FR.xlsx):
  ...
  - **Pensions** 11.3?12.0 (+0.7); reform saves **1.4pp**; salariÃÂ© 6.6?7.4 public 3.8?3.2 indep 0.9?1.4
  ...
  - **GDP const2025** 642/642/679/885/1169 bn 2025/26/31/50/70 ? total social ~**ÃÂ165bn** 2025 class
  - Stocks: salariÃÂ© pensions **2.11m?3.11m**; public 0.50?0.65; GRAPA 0.12?0.13
  - Poverty income2024: pop **11%** pensioners **8.5%** unemp **40%** workers 4%; threshold **ÃÂ1565**/mo
...
- Found (strong primary REP_FLEXIJOBS / CoA+BFP Jan 2026 report):
  - Volume end-2024: **184360** workers ÃÂ· **~14m** hours ÃÂ· Q4 FTE **29500** (<1pct of 3.4m RSZ FTE)
...
- Snapshot (honest order-of-magnitude vs TE EUR 347.956 bn):
  - **A L0 / B L1:** **100%** (unchanged strong)
  - **C L2:** **~98-99%** (up from ~97-99% @400) - midterm Entity I/II ÃÂ· HermReg C&R ÃÂ· CEV branch ÃÂ· T10 labour 23.5bn ÃÂ· GG interest path 27.5bn
...
- Inventory: budgets ~6450 ÃÂ· cmt ~734 ÃÂ· lb ~1114 ÃÂ· entities ~357 ÃÂ· sources ~749
...
- Found (strong primary):
  - **BDA federal debt** **EUR 552.69bn** end-2025 (+34.0 vs 518.68); OLO **462.8** ÃÂ· TC **42.9** ÃÂ· EMTN **12.3** ÃÂ· EU SURE/RRF **6.3**
  - Indicators: avg life **9.98y** ÃÂ· duration **7.27y** ÃÂ· implicit cost **2.01%** ÃÂ· 12m refi **15.64%** ÃÂ· new LT issue cost **3.12%**
  - **2025 realised:** gross **53.31** ÃÂ· net **28.35** ÃÂ· OLO issue **45.71** ÃÂ· EMTN **3.52** ÃÂ· green taps **2.7** ÃÂ· syndications **19**
  - **2026 plan:** gross **59.55** ÃÂ· net **26.37** ÃÂ· OLO **51.60** ÃÂ· MLT total **56.32** ÃÂ· redemptions **28.0** + buybacks **4.6** ÃÂ· RRF/SAFE **1.32** ÃÂ· green eligible **5.0** (no new Green OLO)
...
- Found (strong primary FOR_PROMES_13296 real 2025 prices mEUR):
  ...
  - Shares 2025: doctors **31.0%** ÃÂ· hospital day **22.9%** ÃÂ· pharma net **18.6%** ÃÂ· home nursing **5.9%** ÃÂ· dental 4.3 ÃÂ· kine 3.5
...
- Found (strong primary Replica+EXPEDITION, dual fiscal 13299):
  - Baseline Dec2024 avg gross: **all 2123 EUR/mo** ÃÂ· new **2040** ÃÂ· D1 **453** ÃÂ· D10 **4363** (ratio **9.6**) ÃÂ· Gini **0.26**
  ...
  - Inequality new: D10/D1 **+9.1%** ÃÂ· Gini **+5.5%**; all **+1.5%/+1.7%**
  - Poverty **+0.6pp** all (to 6.1%) ÃÂ· **+0.4pp** new (to 6.3%); mainly min-pension welvaart freeze
...
- Found (strong primary press 17 Dec 2025 + Table1 mEUR):
  ...
  - **Social protection 126.541bn (37.7%)** ÃÂ¢ÃÂÃÂ old age/survivors **71.792** ÃÂÃÂ· sick/dis **24.255** ÃÂÃÂ· unemp **6.575** ÃÂÃÂ· other **23.919**
  - **Health 49.580bn (14.8%)** ÃÂÃÂ· **GPS 44.306** (interest **14.476** 4.3% rebound from 3.2% 2022) ÃÂÃÂ· **econ 39.854** ÃÂÃÂ· **edu 39.284**
  - **Defence 7.946bn (2.4% TE)** highest share 20y; **1.3% GDP** both NATO cash and COFOG after F-35 delivery spike
  - Order/safety 10.648 ÃÂÃÂ· culture 7.552 ÃÂÃÂ· env 7.176 ÃÂÃÂ· housing 2.401
  - Unemp share **halved in 20y** (5.3%ÃÂ¢ÃÂÃÂ2.0%); sick/dis **5.0%ÃÂ¢ÃÂÃÂ7.2%**; pens **18.4%ÃÂ¢ÃÂÃÂ21.4%**
...
- Found (strong primary EU Commission 3 Jun 2026; Spring Forecast cut-off 30 Apr):
  - **Deficit** 5.2% GDP 2025 ÃÂ¢ÃÂÃÂ **5.2%** 2026 ÃÂ¢ÃÂÃÂ **5.4%** 2027; **debt** 107.9 ÃÂ¢ÃÂÃÂ **110.5** ÃÂ¢ÃÂÃÂ **112.8**
  ...
  - **Public investment** 2.6% (2019) ÃÂ¢ÃÂÃÂ **3.3%** 2026
...
- Found (strong primary official):
  ...
  - Interest **13.7bn** ÃÂÃÂ· D.3 subsidies **21.8bn** ÃÂÃÂ· D.62 **109.3bn** ÃÂÃÂ· D.632 **49.2bn** ÃÂÃÂ· GFCF **19.3bn** ÃÂÃÂ· D.1 **77.3bn**
  - Path: deficit **-5.2% / -4.9%** 2025-26 after measures (unchanged -5.5); debt **107.3 / 110.1**
  - Net exp growth **4.3%** 2025 (overshoot vs 3.6) ÃÂ¢ÃÂÃÂ **1.3%** 2026 (cum **5.7** vs ref **6.1**)
  - Defence COFOG **1.4% / 1.7%** GDP 2025-26 (NATO cash 2%); SAFE max **8.34bn**
  - Measures 2026 net: Entity I **+1741m** ÃÂÃÂ· Entity II **+1972m** (VL D.3 **-912m** ÃÂÃÂ· WAL savings **270m** ÃÂÃÂ· BRU precaution **284m**)
  - Entity I effort **9.2bn by 2029**; spending reviews 2026: closed centres ÃÂÃÂ· fossil TE ÃÂÃÂ· R&D/night withholding
  - **FPS tax cash:** 2024 **150.280bn** ÃÂÃÂ· 2025 **153.104bn** ÃÂÃÂ· VAT **37.5/38.0** ÃÂÃÂ· wage **58.7/60.8** ÃÂÃÂ· excise **11.1/11.1**
...
- Found (strong primary EU 17 Feb 2026; COM Autumn forecast dual DBP):
  ...
  - TE path **335.3 ÃÂ¢ÃÂÃÂ 350.0 ÃÂ¢ÃÂÃÂ 361.0bn**; interest **13.7 ÃÂ¢ÃÂÃÂ 15.3 ÃÂ¢ÃÂÃÂ 17.0bn**
  - Net primary exp **319.4 / 331.4 / 340.9bn**; growth COM **3.8%** 2025 (vs 3.6; +0.7bn within NEC) ÃÂ¢ÃÂÃÂ **1.9%** 2026 (vs 2.5; -2.0bn)
  - DRM **+3.2bn (~0.5% GDP)** 2026; fiscal stance **contractionary 0.9%** GDP 2026
  - Defence COFOG **0.9ÃÂ¢ÃÂÃÂ1.7%** GDP 2021-26; NEC flex **0.5 / 0.8pp**; GDP **620.3 / 642.6 / 662.0bn**
...
- Found (strong primary FPS ESSPROS brochure; 2024 EE medium):
  - **2023 receipts 181.157bn** (30.1% GDP): employer **67.3** ÃÂÃÂ· protected **34.5** ÃÂÃÂ· gov **75.3 (41.6% TSR)** ÃÂÃÂ· other **4.1**
  - **2023 exp 174.210bn** (28.9% GDP): benefits **165.806** ÃÂÃÂ· admin **6.165** ÃÂÃÂ· other **2.238**
  - Benefits by risk 2023: old-age **69.584** ÃÂÃÂ· sickness **46.449** ÃÂÃÂ· disability **16.448** ÃÂÃÂ· family **12.233** ÃÂÃÂ· survivors **8.915** ÃÂÃÂ· unemp **5.521** ÃÂÃÂ· excl **5.395** ÃÂÃÂ· housing **1.262**
  - Cash **109.167** (65.8%) ÃÂÃÂ· kind **56.639** (sickness kind **40.614**)
  - **2024 EE benefits 177.884bn (+7.28%)**: old-age **74.546** ÃÂÃÂ· sickness **50.457** ÃÂÃÂ· disability **17.864** ÃÂÃÂ· family **13.162** ÃÂÃÂ· unemp **5.734**
  - Unemp share TSB **5.48%ÃÂ¢ÃÂÃÂ3.22%** 2019-24; disability share **9.3ÃÂ¢ÃÂÃÂ10.0%**; dual COFOG social narrower perimeter
...
- Found (strong primary neco.pdf 20 Apr 2026):
  - GG: TE **347.956bn** ÃÂÃÂ· rev **314.736** ÃÂÃÂ· deficit **-33.221 (-5.2%)** ÃÂÃÂ· debt **692.461 (107.9%)** ÃÂÃÂ· GDP **642.015**
  - Primary exp **+12.1bn** to 52.0% GDP; wages **80.226** ÃÂÃÂ· social benefits **164.823** ÃÂÃÂ· GFCF **19.947** ÃÂÃÂ· interest **14.282**
  - Subsectors deficit: fed **-24.081** ÃÂÃÂ· C&R **-8.948** ÃÂÃÂ· local **-0.366** ÃÂÃÂ· SS **+0.173**
  - **C&R 2025 deficits mEUR:** VL **-4132** ÃÂÃÂ· FWB **-1454** ÃÂÃÂ· DG **-103** ÃÂÃÂ· WAL **-2853** ÃÂÃÂ· BRU **-963** ÃÂÃÂ· interreg ETS **+557**
  - **C&R debt stocks:** VL **50.172bn (71% rev)** ÃÂÃÂ· FWB **15.433 (60%)** ÃÂÃÂ· DG **1.257 (210%)** ÃÂÃÂ· WAL **40.820 (220%)** ÃÂÃÂ· BRU **16.339 (250%)** ÃÂÃÂ· total **127.565bn (+51% 4y)**
...
- Snapshot (honest order-of-magnitude vs TE EUR 347.956 bn):
  ...
  - **C L2:** **~98-99%** (stable high) - C&R entity debt/deficit 2025 ÃÂÃÂ· ESSPROS 165.8-177.9bn ÃÂÃÂ· COFOG 2024 functions ÃÂÃÂ· DBP+COM TE 350-361 ÃÂÃÂ· FPS tax cash 153.1
...
- Inventory: budgets ~6677 ÃÂÃÂ· cmt ~755 ÃÂÃÂ· lb ~1181 ÃÂÃÂ· entities ~357 ÃÂÃÂ· sources ~738
...
- Found (strong primary INAMI 19 May 2026 PDFs):
  - **Salaried+unemployed cash total:** **ÃÂ¢ÃÂÃÂ¬6.959 ÃÂ¢ÃÂÃÂ ÃÂ¢ÃÂÃÂ¬9.971bn** 2021-25 (+6.19% YoY 2025); base **ÃÂ¢ÃÂÃÂ¬9.552bn** + prime rattrapage **ÃÂ¢ÃÂÃÂ¬419.5m**
  - Days **160.4m** ÃÂÃÂ· avg day **ÃÂ¢ÃÂÃÂ¬62.17** (+2.21%)
  - Stock **537.728** sal (+4.50%; **+1.6%** ex pension-age effect) ÃÂÃÂ· indep **38.915** (+9.79%) ÃÂÃÂ· **total 576.643**
  - Pathology sal: mental **209.245 (38.9%)** ÃÂÃÂ· osteo **169.238 (31.5%)** ÃÂÃÂ· tumors **26.591**
  - Regions sal: VL **267.356** ÃÂÃÂ· WAL **205.779** ÃÂÃÂ· BRU **50.741** ÃÂÃÂ· abroad **13.852**
  - Primary incapacity caseload **ÃÂ¢ÃÂÃÂ1.68%** 2024-25 (reform contact gate claimed)
  - Dual ESSPROS disability EE **ÃÂ¢ÃÂÃÂ¬17.9bn** broader perimeter (gap ~indep+other regimes)
...
- FOI: independent cash series parallel salaried tables ÃÂ¢ÃÂÃÂ human send only
...
- Found (strong primary INAMI 19 May 2026 PDFs costs+counts):
  - **Dep+burnout cost:** **ÃÂ¢ÃÂÃÂ¬1.518 ÃÂ¢ÃÂÃÂ ÃÂ¢ÃÂÃÂ¬2.698bn** 2019-24 (+11.8% YoY; **+77.8%** since 2019); dep **ÃÂ¢ÃÂÃÂ¬1.790bn** + burn **ÃÂ¢ÃÂÃÂ¬0.908bn**
  - **Mental group:** **ÃÂ¢ÃÂÃÂ¬3.886bn** (38.3% of all inv cost); stock **210.060**
  - **Total inv all causes sal+indep:** **ÃÂ¢ÃÂÃÂ¬10.156bn** 2024 (dual tick421 sal ~9.4bn + indep)
  - **Indep total cash:** **ÃÂ¢ÃÂÃÂ¬386 ÃÂ¢ÃÂÃÂ ÃÂ¢ÃÂÃÂ¬613m** 2019-24 (+59%) ÃÂ¢ÃÂÃÂ **fills FOI gap_inami_invalidite_indep_cash** (total cash path; jours residual optional)
...
- Found (strong primary INAMI 12 May 2026 PDFs cas+jours):
  - **Cash total general:** **ÃÂ¢ÃÂÃÂ¬407.6 ÃÂ¢ÃÂÃÂ ÃÂ¢ÃÂÃÂ¬601.3m** 2020-24 (+12.55% YoY 2024; **+47.5%** since 2020)
  - Base indemnities **ÃÂ¢ÃÂÃÂ¬591.0m** + prime rattrapage **ÃÂ¢ÃÂÃÂ¬10.3m** 2024
  - **Days:** **8.63 ÃÂ¢ÃÂÃÂ 10.39m** ÃÂÃÂ· **avg day ÃÂ¢ÃÂÃÂ¬46.41 ÃÂ¢ÃÂÃÂ ÃÂ¢ÃÂÃÂ¬56.87** (+3.72% YoY)
  - Stock eoy **28.913 ÃÂ¢ÃÂÃÂ 35.445** (+8.0% YoY; women +31% since 2020)
  - Patho 2024: mental **10.223 (28.8%)** ÃÂÃÂ· osteo **10.099 (28.5%)** ÃÂÃÂ· tumors 3.097 ÃÂÃÂ· trauma 3.157
  - Regions: VL **19.563** ÃÂÃÂ· WAL **11.529** ÃÂÃÂ· BRU **3.532** ÃÂÃÂ· abroad 821
  - Dual tick422 dep/burnout aggregate indep **ÃÂ¢ÃÂÃÂ¬613m** vs this official **ÃÂ¢ÃÂÃÂ¬601m** (~ÃÂ¢ÃÂÃÂ¬12m method delta; prefer Tableaux-style series)
...
- Found (strong primary INAMI 19 May 2026 PDFs cas+jours; provisional stock):
  - **Cash total general:** **ÃÂ¢ÃÂÃÂ¬667.0m** 2025 (+10.93% YoY; base **ÃÂ¢ÃÂÃÂ¬655.5m** + prime **ÃÂ¢ÃÂÃÂ¬11.5m**)
  - **Days:** **11.29m** ÃÂÃÂ· **avg day ÃÂ¢ÃÂÃÂ¬58.07** (+2.11% YoY)
  - Stock eoy **38.915** (+9.79%; matches tick421 indep headcount)
  - Patho 2025: mental **11.467 (29.5%)** ÃÂÃÂ· osteo **11.040 (28.4%)** ÃÂÃÂ· tumors 3.407
  - Regions: VL **21.038** ÃÂÃÂ· WAL **12.979** ÃÂÃÂ· BRU **4.037** ÃÂÃÂ· abroad 861
  - Dual recon: sal **ÃÂ¢ÃÂÃÂ¬9.971bn** tick421 + indep **ÃÂ¢ÃÂÃÂ¬0.667bn** = **ÃÂ¢ÃÂÃÂ¬10.638bn** total inv cash 2025
...
- Found (strong primary INAMI PDFs + SECM RA/press):
  ...
  - **Days** 38.82 -> **42.88m** ÃÂÃÂ· **avg day EUR 50.05 -> 61.85** (+7.36% YoY)
  - Split 2023: ouvriers **1.330bn** (avg 58.20) ÃÂÃÂ· employes **1.322bn** (avg 66.01)
...
- Found (strong primary INAMI PDFs stat_si2023_*_independants):
  ...
  - **Days** 2.86 -> **4.00m** ÃÂÃÂ· **avg day EUR 43.07 -> 52.09** (+8.38% YoY; forfait revalorisation+index)
  - Split 2023: men **122.4m** (avg 52.80) ÃÂÃÂ· women **85.9m** (avg 51.11)
...
- Found (strong primary INAMI PDFs sal + indep):
  ...
  - Split 2023: maternity rest **474.9m** (days 5.63m avg 84.42) ÃÂÃÂ· ecartement **221.8m** ÃÂÃÂ· paternity **101.9m** (20d max) ÃÂÃÂ· adopt 0.59 ÃÂÃÂ· foster 0.94
  - Days package **9.22m** (-2.79%) ÃÂÃÂ· avg day **86.82** (+9.18%); mat cases **65.600** (-5%)
...
- Found (strong primary PensionStat XLSX data-2025-fr Depenses_annuelles):
  ...
  - **Retraite 2025:** **60.52bn** (87.6%) ÃÂÃÂ· **Survie 8.53bn** (12.4%)
  - **Taux menage (household rate):** **5.923bn** 2025 (sal **4.750** + indep **1.173**; ~8.6% of legal; multi-year path extracted)
  - **Allocation de transition:** **~63.3m** 2025 (sal 49.4 ÃÂÃÂ· indep 6.8 ÃÂÃÂ· fonct 7.1)
  - Autres prestations sal ret **354m** ÃÂÃÂ· indep ret **189m**
  - Stock pensionnes nationality-sum **2.675m** ÃÂÃÂ· GRAPA **119.651**
...
- Found (strong primary SPF SS Rapport annuel 2025 PDF):
  ...
  - Split stock: ARR-only **27.608** ÃÂÃÂ· AI-only **106.868** ÃÂÃÂ· both **129.774**
  - Avg month **EUR 938** (AI-only 349 ÃÂÃÂ· ARR-only 924 ÃÂÃÂ· both 1.425)
  - Regions: VL **52.1%** ÃÂÃÂ· WAL **37.9%** ÃÂÃÂ· BRU **9.2%** ÃÂÃÂ· DG **0.7%**
  - Evals **155.334** ÃÂÃÂ· recognition stock **581.987** ÃÂÃÂ· first-req refusal **66.1%**
  - **SS macro 2025:** total exp **146.8bn** (~51% state); prest **132.9** ÃÂÃÂ· gestion **2.9** ÃÂÃÂ· divers **10.97**
  - Financing: cotis **83.2** ÃÂÃÂ· state **20.5** ÃÂÃÂ· altfin **26.2** ÃÂÃÂ· equilibre **7.4** ÃÂÃÂ· other **7.7** ÃÂÃÂ· federated **0.4**
...
- Snapshot (honest order-of-magnitude vs TE EUR 347.956 bn):
  - **A L0 / B L1:** **100%** (unchanged strong)
  - **C L2:** **~98-99%** - SS macro 146.8 ÃÂÃÂ· DG HAN 2.93 ÃÂÃÂ· FPD 69.05+menage 5.92 ÃÂÃÂ· INAMI inv 10.64 ÃÂÃÂ· primaire 2.86 ÃÂÃÂ· mat/pat 0.87
  - **D L5:** **~23-36%** generous (INAMI/FPD/DG HAN L5 fills; FOI ASBL/firm residual)
  - **E FOI ready:** **~215** (answered **~9**; total FOI rows **~226**)
- Inventory: budgets ~6982 ÃÂÃÂ· cmt ~775 ÃÂÃÂ· lb ~1229 ÃÂÃÂ· entities ~358 ÃÂÃÂ· sources ~749
...
- Found (strong primary Cour des comptes Budget Etat 2026 ÃÂÃÂ§7.2 table):
  ...
  - Loi 1965: base **179.8m** ÃÂ¢ÃÂÃÂ **156.4m** after index/reform/wait
...
- Found (strong primary Cour des comptes Budget Etat 2026 p18 + p58):
  - **Entity I social transfers:** handicap **EUR 3.3bn** ÃÂÃÂ· ages/IGO **1.0bn** ÃÂÃÂ· RIS CPAS **2.2bn** (+ Ukraine **299m** excl) = **6.5bn** triple
  - Dual recon: DG HAN **2.93bn** 2025 outturn ÃÂÃÂ· SPP IS table **2.241bn** 2026
  ...
  - Split: justice/divers **618.3** ÃÂÃÂ· Fedasil **100** ÃÂÃÂ· bpost contracts **78** ÃÂÃÂ· bien-etre **33.5**
  - Named inside justice/divers: surpop **259** ÃÂÃÂ· ESA **176** ÃÂÃÂ· eco sociale **50** ÃÂÃÂ· reorg **36** ÃÂÃÂ· Tria **5.3** ÃÂÃÂ· CPL **2.7** (sum ~529 of 618)
...
- Found (strong primary Cour des comptes Budget Etat 2026 p79-80 + p95-98):
  ...
  - Prestations **135.492bn**; GG sal **63.342** (pens **43.271** ÃÂÃÂ· MI **14.879** ÃÂÃÂ· chom **4.638** ÃÂÃÂ· autres **0.554**)
  - GG indep **7.012** (pens **5.920** ÃÂÃÂ· MI **1.070** ÃÂÃÂ· autres **0.022**)
  - **Soins 41.297bn** ÃÂÃÂ· **pens publiques 22.828bn** ÃÂÃÂ· autres prest **1.014** ÃÂÃÂ· **frais gestion 2.996** ÃÂÃÂ· **autres dep 9.370**
  - Dual: pens stack **72.018bn**; MI dual **15.949bn**; chom **-28.2%** YoY
  - Altfin **27.222bn** (ONSS **23.392** ÃÂÃÂ· INASTI **3.829**)
  ...
  - Pension reform 2026 savings **ÃÂ¢ÃÂÃÂ64m delay** (laws not yet Kamer)
...
- Found (strong primary Cour des comptes Budget Etat 2026 p82-83, cellule Pensions):
  ...
  - Largest lines 2027ÃÂ¢ÃÂÃÂ2030: **reforme calcul 679ÃÂ¢ÃÂÃÂ1.915bn** ÃÂÃÂ· **bonus-malus 273ÃÂ¢ÃÂÃÂ473m** ÃÂÃÂ· **carriere anticip 136ÃÂ¢ÃÂÃÂ323m** ÃÂÃÂ· **pens maladie pub extinct 94ÃÂ¢ÃÂÃÂ302m** ÃÂÃÂ· **index hautes pens 97ÃÂ¢ÃÂÃÂ253m** ÃÂÃÂ· **perequation 64ÃÂ¢ÃÂÃÂ156m** ÃÂÃÂ· **convergence 125m/yr flat**
  - Net **costs**: age flexible **ÃÂ¢ÃÂÃÂ47ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ77m** ÃÂÃÂ· alloc trans vs survie **ÃÂ¢ÃÂÃÂ36m 2027** then positive ÃÂÃÂ· transitoires **ÃÂ¢ÃÂÃÂ25ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ99m**
  - **Legislation still pending (CoA):** GRAPA conditions ÃÂÃÂ· survieÃÂ¢ÃÂÃÂtransition ÃÂÃÂ· menage extinction ÃÂÃÂ· periodes assimilees
  - SFP: models need major updates; late laws ÃÂ¢ÃÂÃÂ partial non-delivery risk (2026 already ÃÂ¢ÃÂÃÂ64m delay dual)
...
- Found (medium-strong primary Cour des comptes Budget Etat 2026 p84-90 + p94):
  ...
  - L5: **recontrol net 34.3ÃÂ¢ÃÂÃÂ1.045bn** (gross 38.7ÃÂ¢ÃÂÃÂ1.066; staff ÃÂ¢ÃÂÃÂ4.4ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ20.6) ÃÂÃÂ· **annual-ext 126.9ÃÂ¢ÃÂÃÂ868.8m** ÃÂÃÂ· solidaritÃÂÃÂ© **0ÃÂ¢ÃÂÃÂ77m** ÃÂÃÂ· psycho **2.9ÃÂ¢ÃÂÃÂ11.3m** ÃÂÃÂ· ETA **4.8ÃÂ¢ÃÂÃÂ22.3m** ÃÂÃÂ· WHP **0ÃÂ¢ÃÂÃÂ6.7m** ÃÂÃÂ· maladie fonct table **34/2/54/89m**
  - Exits target **90.204** (recontrol **43.056** + annual-ext **47.148**); dossiers recontrol **19.7kÃÂ¢ÃÂÃÂ94k/yr**
  ...
  - Dual: work-prime cost **28ÃÂ¢ÃÂÃÂ38.5m** (outside net table); maladie indem cost **16.5ÃÂ¢ÃÂÃÂ124.3m** vs cotis **51ÃÂ¢ÃÂÃÂ37m**
  - **Chomage waves p94:** **193.904** exclusions (BRU **41.709** ÃÂÃÂ· VL **62.676** ÃÂÃÂ· WAL **88.566** ÃÂÃÂ· DG **953**); 7 waves Jan2026ÃÂ¢ÃÂÃÂJul2027
...
- Found (strong/medium primary Cour des comptes Budget Etat 2026 p61-63 + p75-79):
  - **Fedasil save path:** **0 / 247 / 403 / 577 / 688m** (2025-2029)
    - Accueil network **0/172/303/452/538** ÃÂÃÂ· Retours **0/75/100/125/150**
    - Package dual **955.6ÃÂ¢ÃÂÃÂ802.2m** (dot 828.9ÃÂ¢ÃÂÃÂ702.2 + prov 126.6ÃÂ¢ÃÂÃÂ100); apps **39.6kÃÂ¢ÃÂÃÂ34.4k** (ÃÂ¢ÃÂÃÂ13.1%)
...
- Found (strong/medium primary Cour des comptes Budget Etat 2026 p28-31 + p59-60 + p84):
  - **INAMI health save 764.5m 2026 L5:** drugs **401.9** (price 80.3 ÃÂÃÂ· antiacid 65.8 ÃÂÃÂ· lipid 29.4 ÃÂÃÂ· partial-bill 42 ÃÂÃÂ· TM 27.9 ÃÂÃÂ· residual design **148.9**) ÃÂÃÂ· doctors **213.2** (lab 70.8 ÃÂÃÂ· imaging 68.5 ÃÂÃÂ· surgery 63.7 ÃÂÃÂ· delay risk **41.5**) ÃÂÃÂ· hosp **50** (day 47.1 cash-shift flag) ÃÂÃÂ· other **73.8** ÃÂÃÂ· TM-res **25.6**
  - **NATO multi-year 2025-29:** effort **12.73ÃÂ¢ÃÂÃÂ14.29bn** (~100% of 2pct need); s16 share **82.4ÃÂ¢ÃÂÃÂ79.7%**; std **167.5ÃÂ¢ÃÂÃÂ750m**
    - Extra spend **3.87ÃÂ¢ÃÂÃÂ3.07bn/yr** sum **16.78bn**; temp fin **7.15** (CIT Russian **6.15** + Belfius **1.0**); struct **4.83**; deficit temp **4.80**; asset optim **3.17** (opaque)
  - **Security provision 366.9m:** reinforce **250** (J112.5 police87.5 mig50) ÃÂÃÂ· surpop **60** ÃÂÃÂ· carry **6.2** ÃÂÃÂ· opaque **50.7** (J44+I6)
...
- Found (medium-strong primary Cour des comptes Budget Etat 2026 p100 Annexe 1 + p10 emp path):
  ...
  - **Entity recon bottom:** total **-421ÃÂ¢ÃÂÃÂ-5.525**; regions **-76ÃÂ¢ÃÂÃÂ-1.132**; communes **-25ÃÂ¢ÃÂÃÂ-321** (2029/30 top vs bottom totals differ slightly)
  - Largest cost: **quotitÃÂÃÂ© exemptÃÂÃÂ©e -531ÃÂ¢ÃÂÃÂ-4.988bn**; CSSS **-423m from 2028**; droits d'auteur **-142m/yr**; heures sup **-101m/yr**; bonus emploi fiscal **-60ÃÂ¢ÃÂÃÂ-218**
  - Revenue side: **UI tax-credit cut +257ÃÂ¢ÃÂÃÂ+216**; conjugal extinction **+66ÃÂ¢ÃÂÃÂ+79**; high-pension red. phase **+34ÃÂ¢ÃÂÃÂ+22**; true isolÃÂÃÂ©s **+135 from 2029**
  - **Employment-rate credibility:** coalition **73ÃÂ¢ÃÂÃÂ78% 2025-29** vs BFP Feb2026 **72.8ÃÂ¢ÃÂÃÂ74.3** (gap **3.7pp 2029**); dual return-effects overstated
...
- Found (medium-strong primary Cour des comptes Budget Etat 2026 p53-57):
  - **Partial replace:** **100m 2026 ÃÂ¢ÃÂÃÂ 175m 2030** (personnel+ops; excl regalian; 2/5 hire if miss; intermediate years unpublished)
  - **Statutaire employer cotis** (new hires after 31 May 2026): **10m 2026 / 284m 2029 / 365m 2030** (rate **9.5%ÃÂ¢ÃÂÃÂ38%**); CoA: flat hire-volume hyp contradicts contract-prefer policy
  - **Combined Entity I influence 459m 2029** (gov claim)
  - **Departmental hit:** Justice **3.3m/61 FTE ÃÂ¢ÃÂÃÂ 101m/1859 FTE** (622 judiciary); Defence **3.7ÃÂ¢ÃÂÃÂ113.3m 2029 / 297m 2034**; Police **26 FTE ÃÂ¢ÃÂÃÂ 700-821 FTE** capacity cut
  ...
  - Dual: droits d'auteur forfait remove **+30m**; VVPR hist **344ÃÂ¢ÃÂÃÂ760m 2022-24**
...
- Snapshot (honest order-of-magnitude vs TE EUR 347.956 bn):
  - **A L0 / B L1:** **100%** (unchanged strong)
  - **C L2:** **~98-99%** - SS consol 147.86 ÃÂÃÂ· Entity I social 6.5 ÃÂÃÂ· SPP IS 2.24 ÃÂÃÂ· NATO 13.1 ÃÂÃÂ· Fedasil 0.80 ÃÂÃÂ· coop 1.04 ÃÂÃÂ· liq 92
  - **D L5:** **~24-37%** generous (reform-measure L5: pens 0.8-2.2 ÃÂÃÂ· RTW 0.2-1.9 ÃÂÃÂ· sante 0.76 ÃÂÃÂ· IPP path ÃÂÃÂ· chom waves 194k; FOI ASBL/firm residual)
  - **E FOI ready:** **~215** (answered **~9**; total FOI rows **~226**)
- Inventory: budgets ~7744 ÃÂÃÂ· cmt ~793 ÃÂÃÂ· lb ~1309 ÃÂÃÂ· entities ~358 ÃÂÃÂ· sources ~758
...
- Found (strong primary DGD Annual Report 2025 ENG, provisional):
  - **Total DGD:** **ÃÂ¢ÃÂÃÂ¬1,117.97m 2025** (vs 1,440.92 2024 / 1,285.90 2023); cut **ÃÂ¢ÃÂÃÂ¬106m** of which **ÃÂ¢ÃÂÃÂ¥ÃÂ¢ÃÂÃÂ¬90m** under-use + multi review
  - **Themes 2025:** climate **365.3** (32.5%) ÃÂÃÂ· stability **301.8** ÃÂÃÂ· other **181.5** ÃÂÃÂ· humanitarian **175** (dual table **170**) ÃÂÃÂ· health **98.8**
  - **Channels 2025:** gov **250.4** (Enabel **212.0** + mgmt **25.6** + gov **7.2** + loans **5.6**) ÃÂÃÂ· nongov **247.4** ÃÂÃÂ· multi **257.9** ÃÂÃÂ· hum **170** ÃÂÃÂ· climate policy **102.2**
  - **Top20 sum ÃÂ¢ÃÂÃÂ¬369.7m** (~33%); DRC **104.49** largest
  - **Named:** LDCF **18.5m** (2nd donor) ÃÂÃÂ· CGIAR **9.3m** ÃÂÃÂ· Sahel Climate Enabel **50m** ÃÂÃÂ· mRNA/HTAP **8m/4y** ÃÂÃÂ· BIO approvals **240m**/30 projects
...
- Found (strong primary BIO Annual Report 2025 web):
  - **Approvals ÃÂ¢ÃÂÃÂ¬235m / 30** projects (signed **ÃÂ¢ÃÂÃÂ¬166m / 21**); committed stock **ÃÂ¢ÃÂÃÂ¬1.2bn / 171**; signed stock **ÃÂ¢ÃÂÃÂ¬1.033bn**
  - Financials: assets **ÃÂ¢ÃÂÃÂ¬1.196bn** ÃÂÃÂ· income **55.3** ÃÂÃÂ· cost of risk **20.1** ÃÂÃÂ· FX **ÃÂ¢ÃÂÃÂ5.9** ÃÂÃÂ· net **9.0** ÃÂÃÂ· dividend **4.5**
  - Africa **55%** approvals ÃÂÃÂ· gender **57%** of 2024-25 ÃÂÃÂ· direct enterprise **11** (vs 2) ÃÂÃÂ· jobs direct **~388k** EOY2024
  - **Named EUR L5:** Coris **20** ÃÂÃÂ· Orchidia **10** ÃÂÃÂ· Glacier **8** ÃÂÃÂ· FoodsCo **3** ÃÂÃÂ· Vital **3** ÃÂÃÂ· Kampani **2** ÃÂÃÂ· Limbua **2** ÃÂÃÂ· FEFISOL **2** ÃÂÃÂ· ACEP **1.5** (sample sum **ÃÂ¢ÃÂÃÂ¬51.5m**)
  - **Named USD face L5:** multiple **15m** lines (Adenia/Amartha/AtlÃÂÃÂ¡ntida/ADEMI/Bandwidth/Excelsior) ÃÂÃÂ· ECOM **10** ÃÂÃÂ· Helios **10** ÃÂÃÂ· Lendable **10** ÃÂÃÂ· Super Silica **3.7** ÃÂÃÂ· Ukraine fund **6** (no FX invent)
  - Dual: DGD AR **240m** approvals class; State capital subsidies extra **ÃÂ¢ÃÂÃÂ¬85m** strategy 2024-28
...
- Found (strong primary Alterfin Annual Report 2025 + 2024 dual):
  - **Capital ÃÂ¢ÃÂÃÂ¬69.70m** / **5,828** members (indiv 5,644 / inst 184); **first decline ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ¬1.1m** after **abolition of 5% tax break** on development-fund shares
  - **Portfolio mgmt+advisory:** **ÃÂ¢ÃÂÃÂ¬122.1m** (ÃÂ¢ÃÂÃÂ8.2% FX) vs **USD 143.6m** (+3.7% record); under mgmt **ÃÂ¢ÃÂÃÂ¬98.5m** / **USD 115.8m**
  - Disbursed key **ÃÂ¢ÃÂÃÂ¬95m** ÃÂÃÂ· under-mgmt **>USD 108m** record ÃÂÃÂ· advisory **ÃÂ¢ÃÂÃÂ¬23.2m** / **USD 26.7m**
  - Partners **142** in **32** countries (MFI **76** ÃÂÃÂ· agri **57** ÃÂÃÂ· funds **9**); families class **~4.32m**
  - BS assets **ÃÂ¢ÃÂÃÂ¬164.3m** ÃÂÃÂ· net loans **ÃÂ¢ÃÂÃÂ¬92.0m** ÃÂÃÂ· equity **ÃÂ¢ÃÂÃÂ¬73.1m** ÃÂÃÂ· debt/equity **1.20**
  - P&L net **ÃÂ¢ÃÂÃÂ¬733k** (ÃÂ¢ÃÂÃÂ13%); gross margin **+16%**; cost of risk **ÃÂ¢ÃÂÃÂ¬1.61m** (+30%); proposed dividend **1%**
  - FSMA AUM **ÃÂ¢ÃÂÃÂ¬226.1m** ÃÂ¢ÃÂÃÂ full AIFM/OPCA licence path H2-2026; Fefisol II **ÃÂ¢ÃÂÃÂ¬23.1m**/40 partners; BIO loan **USD 5m** dual
...
- Found (strong primary BRS AR 2025 magazine + dissolve press 13 May 2026):
  - **BRS MFC EOY2025:** assets **ÃÂ¢ÃÂÃÂ¬22.0m** ÃÂÃÂ· equity **ÃÂ¢ÃÂÃÂ¬21.4m** ÃÂÃÂ· capital **ÃÂ¢ÃÂÃÂ¬21.24m** (**1,420** A-members **ÃÂ¢ÃÂÃÂ¬3.74m** + C **ÃÂ¢ÃÂÃÂ¬17.5m**)
  - Ownership: Cera **45.6%** ÃÂÃÂ· individuals **35.3%** ÃÂÃÂ· KBC **17.6%** ÃÂÃÂ· BRS ASBL **1.5%**
  - Loans **ÃÂ¢ÃÂÃÂ¬2.0m** (AMC-SV **1.4** ÃÂÃÂ· El Ejido **0.3** ÃÂÃÂ· EBO-UG **0.3**) ÃÂÃÂ· MF funds **ÃÂ¢ÃÂÃÂ¬9.0m** (Triodos **3** ÃÂÃÂ· Incofin **1.6** ÃÂÃÂ· Fefisol **1.5** ÃÂÃÂ· Alterfin **1** ÃÂÃÂ· ECF **1** ÃÂÃÂ· Incofin Climate **1**) ÃÂÃÂ· cash **ÃÂ¢ÃÂÃÂ¬10.8m**
  - Profit **ÃÂ¢ÃÂÃÂ¬219k** ÃÂÃÂ· dividend **2.5% / ÃÂ¢ÃÂÃÂ¬534k** ÃÂÃÂ· dissolve provision **ÃÂ¢ÃÂÃÂ¬50k**
  - **Dissolve:** midnight **2026-06-30**; full A-share repay early Jul; Cera continues MF via **increased Alterfin + Incofin** stakes
  - **BRS ASBL:** assets **ÃÂ¢ÃÂÃÂ¬2.41m** ÃÂÃÂ· loss **ÃÂ¢ÃÂÃÂ¬85k** ÃÂÃÂ· income **ÃÂ¢ÃÂÃÂ¬503k** (donations **ÃÂ¢ÃÂÃÂ¬390k** + Cera tombola **ÃÂ¢ÃÂÃÂ¬109k**) ÃÂÃÂ· projects **ÃÂ¢ÃÂÃÂ¬403k** ÃÂÃÂ· **594** coaching days ÃÂÃÂ· **~94** KBC volunteers ÃÂÃÂ· **14** partners / **7** countries
...
- Found (strong primary Incofin IMF AR 2025 ENG PDF):
  - **Capital EUR 49.953m** (-1.264m / -2.5pct) ÃÂÃÂ· **equity 53.496m** ÃÂÃÂ· **BS 65.541m** ÃÂÃÂ· **portfolio 62.441m** (equity 17.4 + sub 7.5 + loans 37.5)
  - **Net loss 1.232m** (vs 0.658m 2024) ÃÂÃÂ· **dividend 0%** second year ÃÂÃÂ· mgmt fee Incofin IM **1.055m**
  - **Shareholders 2,348** (retail 2,205 / inst 143) ÃÂÃÂ· partners **38** / countries **25** ÃÂÃÂ· end-clients **3.3m** (64% women / 51% rural)
...
- Found (strong primary AR2023 + DGD impact PDF + BIO invest page + portfolio web):
  ...
  - **BS assets 9.14m** ÃÂÃÂ· credit portfolio **7.27m** ÃÂÃÂ· at-work **10m** ÃÂÃÂ· equity **9.10m** ÃÂÃÂ· first-loss **0.8m** ÃÂÃÂ· cash **0.58m**
...
- Found (strong primary KBF official figures snapshot + budget pie + over-ons + homepage):
  ...
  - **Support given 2025 >EUR 202m** ÃÂÃÂ· orgs **4,710** ÃÂÃÂ· individuals **445** ÃÂÃÂ· beneficiaries class **5,155**
  - Active funds **1,723** ÃÂÃÂ· project calls **201** ÃÂÃÂ· staff **200** ÃÂÃÂ· experts/juries **4,300** ÃÂÃÂ· third-party donations **>219k**
...
- Found (strong primary Nationale Loterij Jaarverslag 2024 + 2025 press):
  - **Omzet/inzetten 2024 EUR 1.553bn** (+4.4pct) ÃÂÃÂ· **2025 EUR 1.666bn** record
  ...
  - Projects **1,857** 2024 ÃÂÃÂ· ~**1,970** 2025 medium ÃÂÃÂ· prizes **1.057bn** ÃÂÃÂ· equity **234.74m** (capital 180m)
  - Ownership **State 78.72% / FPIM 21.28%** ÃÂÃÂ· digital stakes **415m** (27%) ÃÂÃÂ· board pay **0.38m**
  - Product L5 2024: EuroMillions **489m** ÃÂÃÂ· Instant **486m** ÃÂÃÂ· Lotto **441m**
...
- Found (strong primary KB 2 jun 2024 OpenJustice provisional plan; definitive total from AR/Stradalex):
  - **Provisional total EUR 200.0m** ÃÂÃÂ· **definitive 217.5m** (+17.5m extra matches AR)
  - **Cat1 deelstaten 54.88m (27.44%):** VL **33.121738m** ÃÂÃÂ· FWB **21.295733m** ÃÂÃÂ· DG **0.462529m**
  - **Cat2:** DGD **84.708565m** (largest) ÃÂÃÂ· KBF **9.8m** (dual KBF pie path)
  - **Named L5 sample:** Unia **4.309m** ÃÂÃÂ· Myria **1.077m** ÃÂÃÂ· IEFH **0.15m** ÃÂÃÂ· BOIC **1.855m** ÃÂÃÂ· Olympic Talents **1.5m** ÃÂÃÂ· BPC **0.375m** ÃÂÃÂ· Bozar **3.095m** ÃÂÃÂ· Munt **1.489m** ÃÂÃÂ· NOB **1.484m** ÃÂÃÂ· Antigif **2.2m** ÃÂÃÂ· Child Focus **1.6m** ÃÂÃÂ· Rode Kruis **1.634m** ÃÂÃÂ· Regie Gebouwen **3.088m** ÃÂÃÂ· Nationaal Prestige **10.656m** ÃÂÃÂ· Sports fed **2.7m** ÃÂÃÂ· calls armoede+SDG **3.0m**
...
- Snapshot (honest order-of-magnitude vs TE EUR 347.956 bn):
  - **A L0 / B L1:** **100%** (unchanged strong)
  - **C L2:** **~98-99%** - + NL SOE 1.55-1.67bn omzet / society 362.5m ÃÂÃÂ· KBF 220-273m (public-utility off pure TE) ÃÂÃÂ· impact dual BIO/Alterfin/Incofin/Kampani/BRS
...
- Inventory: budgets ~8018 ÃÂÃÂ· cmt ~803 ÃÂÃÂ· lb ~1398 ÃÂÃÂ· entities ~367 ÃÂÃÂ· sources ~779
...
- Found (strong primary Antigifcentrum Jaarrapport 2024):
  - **Costs 2024 EUR 3.418m** ÃÂÃÂ· **income 3.420m** ÃÂÃÂ· surplus **ÃÂ¢ÃÂÃÂ¬2.2k**
  - **NL base subsidy EUR 2.200m** (Volksgezondheid via lottery) **matches KB plan exactly** ÃÂÃÂ· + ICT project **ÃÂ¢ÃÂÃÂ¬28.9k** ÃÂÃÂ· NL total **ÃÂ¢ÃÂÃÂ¬2.229m** (~65% income)
  - **Budget 2025:** NL base **ÃÂ¢ÃÂÃÂ¬2.624m** ÃÂÃÂ· costs **ÃÂ¢ÃÂÃÂ¬3.950m** (personnel **ÃÂ¢ÃÂÃÂ¬3.293m** spike) ÃÂÃÂ· income **ÃÂ¢ÃÂÃÂ¬3.930m**
  - Personnel outturn **ÃÂ¢ÃÂÃÂ¬2.133m** ÃÂÃÂ· staff **23 / 20.5 FTE** ÃÂÃÂ· calls **~64,000** ÃÂÃÂ· Lux convention **ÃÂ¢ÃÂÃÂ¬0.346m** ÃÂÃÂ· projects **ÃÂ¢ÃÂÃÂ¬0.440m** ÃÂÃÂ· industry essenscia/pharma **ÃÂ¢ÃÂÃÂ¬86.5k**
  - Status: public-utility foundation (KB 1967) ÃÂÃÂ· emergency service (KB 2002)
...
- Found (strong primary Child Focus Jaarverslag 2025 + 2024):
  - **Income 2025 EUR 9.595m** (2024 **9.306m**) ÃÂÃÂ· expenses **9.430m** / **9.267m** ÃÂÃÂ· result **0.182m** / **0.034m**
  - **Assets 7.825m** ÃÂÃÂ· equity **5.733m** ÃÂÃÂ· investments **5.726m**
  - **Dotaties/subsidies line 2.874m** 2025 ÃÂÃÂ· cash donations **5.681m** ÃÂÃÂ· in-kind **0.789m** ÃÂÃÂ· wages **5.208m** ÃÂÃÂ· honoraria **2.529m**
  - **NL:** plan werking **EUR 1.600m** 2024 ÃÂÃÂ· pie **21% 2024 / 20% 2025** implies **~1.95m / ~1.92m** total NL class (may include non-werking support) ÃÂÃÂ· renewed partnership 2025
  - Dual KBF pie **~1%** ÃÂÃÂ· EU projects **4-6%** ÃÂÃÂ· private recurrent donors **44-47%** ÃÂÃÂ· donors tax attests **36,525** 2025
  - Status: public-utility foundation ÃÂÃÂ· hotline **116 000**
...
- Found (strong primary Unia RA2025 already mapped + new dual arithmetic + BS L5):
  - **Federal subvention 2024 EUR 8.171m / 2025 8.305m** ÃÂÃÂ· **NL plan Unia 4.309m** = **~53% of federal 2024** ÃÂÃÂ· residual pure federal **EUR 3.862m**
  - **TCO 2025:** products **11.728m** ÃÂÃÂ· charges **11.715m** ÃÂÃÂ· result **13k** ÃÂÃÂ· subsidies **9.628m** (fed 8.305 + federated 1.323)
  - **BS EOY2025:** assets **8.881m** ÃÂÃÂ· equity **5.485m** (capital **3.451m**) ÃÂÃÂ· ST debt **2.885m** ÃÂÃÂ· provisions **0.511m**
  - **Cost L5:** personnel **9.051m** (~77%) ÃÂÃÂ· opex **1.530m** ÃÂÃÂ· projects **0.931m**
  - **Income L5:** activity **0.899m** ÃÂÃÂ· project products **0.718m**
...
- Found (strong primary Bozar Jaarverslag 2024 + prior Kamer/NBB/NL plan):
  ...
  - **Activity 2024:** visitors **625,840** ÃÂÃÂ· expo **323,459** (+56%) ÃÂÃÂ· concerts **152,715**/227 ÃÂÃÂ· talks **29,041** ÃÂÃÂ· film **12,040** ÃÂÃÂ· external **90,308**
  - **Staff 243** (188 permanent) ÃÂÃÂ· FTE plan max **249.98** ÃÂÃÂ· hires **118** ÃÂÃÂ· Maecenas **240**
  - Surrealism expo **118,886** visitors ÃÂÃÂ· management contract expired EOY2024 **+1y extension** pending new gov
...
- Found (strong primary NL/BNO press + Kamer 56K0856/016 + medium 56K1280/034):
  ...
  - **2026 cut path (medium rounded debate):** NOB **~11ÃÂ¢ÃÂÃÂ10m** ÃÂÃÂ· Monnaie **~42.75ÃÂ¢ÃÂÃÂ42.24m** ÃÂÃÂ· Bozar **~15.66ÃÂ¢ÃÂÃÂ15.52m** sum **~67.76m**
  - Activity: concerts path **41ÃÂ¢ÃÂÃÂ75**; house orchestra Bozar ~30 copros 2025; progressive integration residual
  - Bozar VL co-finance **~0.8m -0.1m**; RRF digital **7.5m** 2021-26 (beleidsnota)
  - **NOP NV satellite** brutomarge **0.328m** / 1.8 FTE ÃÂ¢ÃÂÃÂ **not** institutional TCO (perimeter warning)
...
- FOI: gap_fed_culture still ready ÃÂ¢ÃÂÃÂ residual **NOB AR TCO** + exact post-cut codes + signed contracts; culture triple financing layer largely closed
...
- Found (strong primary BOIC/Team Belgium + NL plan KB + Sport Vlaanderen press):
  ...
  - Public class if additive **~4.79m** (premies may sit outside annual plan lines ÃÂ¢ÃÂÃÂ medium)
...
- Found (strong primary RKV finance portal):
  ...
  - Asylum under **Fedasil opvangconventie** ÃÂ¢ÃÂÃÂ major named L5 under third-party **559m** path
...
- Found (strong Kamer AB tables + NL plan; weak political claims separated):
  - **AB path strong:** 2021 **1.268m** ÃÂÃÂ· 2022 **1.255** ÃÂÃÂ· 2023 **1.645** (55K2933) ÃÂÃÂ· 2024 **1.579** (56K1281; alt older 1.606) ÃÂÃÂ· 2025 **1.614** ÃÂÃÂ· 2026 **1.600**
  - **NL plan 2024 EUR 1.077m** ÃÂÃÂ· historic **0.900m** 2021 (cited)
...
- Found (inventory + synthesis ticks 451-459 dual NL end-receiver wave):
  - **A L0:** **100%** TE ÃÂ¢ÃÂÃÂ¬347.956bn
  - **B L1:** **100%** unconsol map
  - **C L2:** **~98-99%** (+ Monnaie TCO 65.4m ÃÂÃÂ· Bozar stack 18.6m ÃÂÃÂ· NOB 12.4m ÃÂÃÂ· RKV 313m)
...
- Inventory: budgets ~8160 ÃÂÃÂ· cmt ~814 ÃÂÃÂ· lb ~1489 ÃÂÃÂ· entities ~371 ÃÂÃÂ· sources ~800
- Waste top10: **stable** fossil/company-cars/cheque/EIWT; no reorder; dual NL maps off pure waste top10
- Dual/off-TE: culture triple ÃÂÃÂ· equality NL stack ÃÂÃÂ· RKV Fedasil L5 ÃÂÃÂ· lottery stakes 1.55-1.67bn
...
- Found (strong primary KB 28 Jul 2025 / BS / Refli):
  ...
  - **Communities:** VL **33.202m** ÃÂÃÂ· FWB **21.216m** ÃÂÃÂ· DG **0.463m** (27.44% key)
  - **DGD 84.709m** ÃÂÃÂ· **KBF 9.8m** flat
  - **Culture protocol embedded:** Bozar **3.5** + Munt **1.75** + NOB **1.75** = **7.0m** (confirms June 2026 protocol dual)
  - **Sport:** BOIC **2.0m** (was 1.855) ÃÂÃÂ· BPC **0.45** ÃÂÃÂ· Be Gold **1.5** ÃÂÃÂ· sports fed **2.7** ÃÂÃÂ· women high-level **1.0m** NEW
  - **Equality/HR:** Unia **4.309** ÃÂÃÂ· Myria **1.077** ÃÂÃÂ· IEFH **0.15** flat ÃÂÃÂ· SARC/CPVS **1.616m** NEW dual IEFH
  - **Health/hum:** Antigif **2.45** (up) ÃÂÃÂ· Child Focus **1.76** (up) ÃÂÃÂ· Rode Kruis **1.65**
  - **Prestige pot 6.176m** (cut vs 10.656m 2024 plan) ÃÂÃÂ· Regie **3.088** ÃÂÃÂ· Flagey **0.25** ÃÂÃÂ· Europalia **0.5** ÃÂÃÂ· Cinematek **0.7**
  - Project calls poverty **2.5m** ÃÂÃÂ· SDG local **1.5m** ÃÂÃÂ· G-sport **1.0m**
...
### 2026-08-02T21:45:00Z ÃÂ tick 462
- Unit: rq_453 (CPVS/SARC dual FOI-adjacent hole-fill)
- Found: **Strong dual CPVS stack.** (1) IEFH RA2024 CPVS cash **ÃÂ10.926m** (already mapped). (2) NL provisional 2025 SARC/CPVS **ÃÂ1.616m** (tick461). (3) **INAMI** primary: from 2026 INAMI funds hospital CPVS (13 centres); IEFH funded pre-2026 by size; IEFH keeps national coordination (src_inami_cpvs_transfer_2025). (4) **Kamer 56K0854/037** minister: 2026 annual envelope **ÃÂ26.4m** = Fonds Blouses blanches **ÃÂ11.7m** + extra 3 centres **ÃÂ5.8m** + IEFH?INAMI **ÃÂ8.9m**; Justice ÃÂ0. Dual recon: announced IEFH transfer 8.9 vs 2024 cash 10.9 residual FOI; NL lottery line additive not double-count of main channel. Flagey entity stub (NL 0.25m) ÃÂ AR TCO residual.
...
### 2026-08-02T22:45:00Z ÃÂ tick 464
- Unit: rq_455 (LOV2030 dual bidbook + NL definitive)
- Found: **Strong dual LOV2030.** Final bidbook ECoC: total operating **ÃÂ72.5m** = EU **1.5** + federal via NL **15** (3mÃÂ5 2026-30, CM 17 May 2024) + Flanders **30** + province **3** + city Leuven **10** (council 26 May 2025) + region mun **3** + private ambition **10** (medium). Artistic **ÃÂ47.12m**. Dual NL definitive plan 2025 line **ÃÂ10.5m** (front-load vs bidbook 3m/yr from 2026 ÃÂ residual FOI cash schedule).
...
### 2026-08-02T23:15:00Z ÃÂ tick 465
- Unit: **rq_456** (FOI-adjacent hole-fill ÃÂ **Pro League dual NL 3.5m FSR + Beliris culture dual + Art5/7 notes**)
- Found (strong primary KB 5 Jun 2026 + Pro League + Beliris 2025):
  ...
  - **Dual private layer:** Pro League own FSR grants **EUR 200k** to **28 clubs** (3ÃÂ13k each, Jul 2025) ÃÂ not public euro
...
### 2026-08-02T23:45:00Z ÃÂ tick 466
- Unit: **rq_457** (FOI-adjacent hole-fill ÃÂ **Chinese Pavilion PPP dual + Festivals VL/WAL classical dual**)
- Found (strong/medium primary):
  - **Chinees Paviljoen Laken PPP:** Regie works budget **ca EUR 6m** (primary agency page); Hennebert private target **6ÃÂ7m** / first **1m** in (medium press); opening class end-2027/2028; vzw Chinees Paleis Zijderoute; Koninklijke Schenking owner; closed 2013
  - **NL Art5.7 EUR 0.5m** definitive multi-year frame **to 2031** (Histoire des Belges 2030) ÃÂ strong dual public named layer
  - **Envelope caution:** Regie 6m vs private 6ÃÂ7m may be **same PPP envelope** ÃÂ do not sum as pure public without FOI
...
### 2026-08-03T00:15:00Z ÃÂ tick 467
- Unit: **rq_458** (FOI-adjacent hole-fill ÃÂ **Cinematek dual fed 3.3m + Europalia dual 573k + CRE dual**)
- Found (strong primary Kamer 56K0855/018 + NL KB + BELSPO):
  - **Cinematek BA 60.36.41.40.01:** 2023r **3.230m** ÃÂ· 2024a **3.296** ÃÂ· 2025i **3.306** ÃÂ· 2026 **3.236** ÃÂ· path to 3.098 2028 (kEUR tables)
...
### 2026-08-03T00:45:00Z ÃÂ tick 468
- Unit: **rq_459** (FOI-adjacent hole-fill ÃÂ **KIK-IRPA dual 6.97m + Art pool 33m + Proximity 1m**)
- Found (strong primary Kamer 56K0855/018 + NL KB):
  - **KIK-IRPA BA 60.34.41.30.22:** 2023r **6.598m** ÃÂ· 2024a **6.615** ÃÂ· 2025i **6.573** ÃÂ· path to 6.218 2028
  ...
  - **NL Proximity Art5.6 EUR 1.0m** ÃÂ Art6 split by province population (named L5 residual)
...
### 2026-08-03T01:15:00Z ÃÂ tick 469
- Unit: **rq_460** (FOI-adjacent hole-fill ÃÂ **BELSPO four FWI pools structural 132.3m 2025i**)
...
### 2026-08-03T01:45:00Z ÃÂ tick 470
- Unit: **rq_461** (**progress milestone @470** ÃÂ coverage % + waste top10 refresh; no new euro invent)
- Found (inventory + synthesis ticks 461ÃÂ469 dual/NL/FWI wave):
  - **A L0:** **100%** TE ÃÂ347.956bn
  - **B L1:** **100%** unconsol map
  - **C L2:** **~99%** (+ BELSPO four FWI pools **ÃÂ132.3m** ÃÂ· Cinematek dual **ÃÂ4.0m** ÃÂ· KIK-IRPA dual **ÃÂ7.0m** ÃÂ· LOV2030 **ÃÂ72.5m** envelope)
  - **D L5:** **~27ÃÂ40%** generous (+ NL definitive **ÃÂ240m** ÃÂ· LOV2030 plan 10.5 ÃÂ· Pro League 3.5 ÃÂ· CPVS 26.4 ÃÂ· Beliris culture 9.6 ÃÂ· Pavilion PPP ÃÂ· Festivals/Europalia/CRE duals)
  - **E FOI ready:** **~223** (answered **~9**; total FOI rows **~234**)
- Inventory: budgets ~8302 ÃÂ· cmt ~832 ÃÂ· lb ~1551 ÃÂ· entities ~398 ÃÂ· sources ~831
- Waste top10: **stable** fossil/company-cars/cheque/EIWT; no reorder; FWI/LOV/culture duals off pure waste top10
- Dual/off-TE: NL definitive 240m ÃÂ· FWI 132m structural ÃÂ· LOV2030 multi-level ÃÂ· lottery stakes
...
### 2026-08-03T02:15:00Z ÃÂ tick 471
- Unit: **rq_462** (FOI-adjacent hole-fill ÃÂ **Be Gold dual multi-community topsport 3.5m**)
- Found (strong primary Be Gold partners page + programme + NL plan match):
  - **Annual total EUR 3.500m** split: NL **1.500** (43%) ÃÂ· BOIC **0.750** ÃÂ· Sport Vlaanderen **0.740** ÃÂ· ADEPS/FWB **0.500** ÃÂ· Ostbelgien **0.010**
  - **NL plan Art3.26 1.5m** matches partners page exactly (strong dual closed)
  - **Cumulative since 2004 EUR 49,261,432.08**
  - **Athletes:** 148 (14ÃÂ24y) ÃÂ· 90F/58M ÃÂ· 20 disciplines ÃÂ· 4 teams ÃÂ· goal Top8 OS / Top3 PS ÃÂ· max 4y support from 2025
...
### 2026-08-03T02:45:00Z ÃÂ tick 472
- Unit: **rq_463** (FOI-adjacent hole-fill ÃÂ **Fairwork dual NL 250k + residual health/human NL batch 2.175m**)
- Found (strong plan + Fairwork AR2025 primary):
  - **Fairwork:** NL plan **ÃÂ250k** cat3.35 ÃÂ· AR2025 confirms NL + Fedasil + Warmste Week + 11.11.11 + Safe.brussels + SF323 ÃÂ· **1.142** requests (+47%) 92 countries ÃÂ· financing fragile (2 contracts not renewed) ÃÂ· **no euro TCO table** in AR
  - **Residual NL health/human batch sum ÃÂ2.175m:** IARC Lyon **ÃÂ759,770** ÃÂ· Antikankerfonds MCN **ÃÂ300k** ÃÂ· Opvangtehuizen **ÃÂ495k** ÃÂ· Holocaust memorial **ÃÂ370k** ÃÂ· Fairwork **ÃÂ250k**
...
### 2026-08-03T03:15:00Z ÃÂ tick 473
- Unit: **rq_464** (FOI-adjacent hole-fill ÃÂ **Reine Paola dual NL 260k + residual culture/social NL batch 3.32m**)
- Found (strong AR2025 + plan + medium press):
  - **Paola NL ÃÂ260k** cat3.5 ÃÂ· **Pelicano** 1.431 young ÃÂ avg **ÃÂ763** ÃÂ **ÃÂ1.092m** medium ÃÂ· **ÃÂ1.5m** aides directes claim ÃÂ· philanthropy centre **ÃÂ240k** out ÃÂ· awards **ÃÂ10kÃÂ3** ÃÂ· press **loss >ÃÂ1.1m** 2025 medium
  - **Residual NL culture/social batch sum ÃÂ3.315m:** Paola 0.26 ÃÂ· Grand ManÃÂ¨ge 0.1 (dual FWB+Ville) ÃÂ· Jardin Passion 0.1 ÃÂ· UCI races 0.6 ÃÂ· Leesbevordering 1.5 ÃÂ· Interfed poverty 0.2 ÃÂ· OVK 0.205 ÃÂ· BNA 0.15 ÃÂ· To Walk Again 0.1 ÃÂ· WWF 0.1
  - Grand ManÃÂ¨ge: CAV&MA partners NL+FWB+Ville; construction class ÃÂ15m historical medium
...
### 2026-08-03T03:45:00Z ÃÂ tick 474
- Unit: **rq_465** (FOI-adjacent hole-fill ÃÂ **poverty dual stack 2.61m + homeless innovation NL 1.28m**)
- Found (strong plan + Interfed service structure + prior VL Netwerk):
  ...
  - **NL poverty project call cat4.3 EUR 2.5m** (winners residual FOI) ÃÂ not double-counted in core stack
  - Interfed service: multi-entity ComitÃÂ© de gestion elaborates budget; host Place Victor Horta 40 CNTR; NL logo support; **structural multi-entity cash opaque**
...
### 2026-08-03T04:15:00Z ÃÂ¢ÃÂÃÂ tick 475
- Unit: **rq_466** (FOI-adjacent hole-fill ÃÂ¢ÃÂÃÂ **UCI 1.1 races 600k + Leesbevordering dual 1.5m + cat4 calls 9m**)
- Found (strong plan + primary press + UCI class sample):
  - **UCI Art3.31 EUR 600k** ÃÂ¢ÃÂÃÂ Belgian UCI **1.1 one-day only** (not UWT/ProSeries); Art5 committee note residual
  - **Race-class sample (medium, not award list):** Heistse Pijl ÃÂÃÂ· Gooikse pijl ÃÂÃÂ· BincheÃÂ¢ÃÂÃÂChimayÃÂ¢ÃÂÃÂBinche ÃÂÃÂ· GP Criquielion ÃÂÃÂ· Muur Classic Geraardsbergen
  - **Leesbevordering Art5.10 EUR 1.5m** (financial literacy focus) ÃÂ¢ÃÂÃÂ path **~3m 2024 ÃÂ¢ÃÂÃÂ 1.5m 2025**; dual VL Literatuur Vlaanderen + Iedereen Leest structural (separate euros not invented)
...
- Found (strong primary NL JV2024 + NOB dual partner + plan):
  - **Nationaal Prestige 2024 cash EUR 18.56684288m** ÃÂ¢ÃÂÃÂ **614 dossiers**; L3 split: culture **7.778m (42%)** ÃÂÃÂ· society **5.544m (30%)** ÃÂÃÂ· sport **5.245m (28%)**
  - **Path 2025 plan cat5.1 EUR 10.000016m** (prov 6.176m) ÃÂ¢ÃÂÃÂ perimeter/timing caveat medium vs 2024 cash
  - **Proximity 2024 EUR 1.257m** ÃÂ¢ÃÂÃÂ **1132** beneficiaries; plan 2025 1.0m
...
- Found (inventory + synthesis ticks 471-479 NL dual deep-fill wave):
  ...
  - **D L5:** **~28-41%** generous (+ Be Gold 3.5 ÃÂÃÂ· poverty dual 2.61 ÃÂÃÂ· cat4 9.0 ÃÂÃÂ· sport batch 7.25 ÃÂÃÂ· prestige cash 18.57 ÃÂÃÂ· financial supports 201 ÃÂÃÂ· society 385)
  - **E FOI ready:** **~234** (answered **~9**; total FOI rows **~245**)
- Inventory: budgets ~8361 ÃÂÃÂ· cmt ~857 ÃÂÃÂ· lb ~1603 ÃÂÃÂ· entities ~407 ÃÂÃÂ· sources ~874
- Waste top10: **stable** fossil/company-cars/cheque/EIWT; no reorder; NL duals off pure waste top10 (society/nominative mid-table)
- Dual/off-TE: NL society 385m ÃÂÃÂ· omzet 1.666bn stakes ÃÂÃÂ· financial supports arch 201m ÃÂÃÂ· prestige 18.57m
...
- Found (strong primary VL begroting 2025-2029 + prior WAL/BRU):
  - **Reform measures path mEUR:** 2025 **84** ÃÂÃÂ· 2026 **250** ÃÂÃÂ· 2027 **255** ÃÂÃÂ· 2028 **263** ÃÂÃÂ· 2029 **267**
...
- Found (strong primary Vlaamse begroting 2025-2029 full tables):
  - **Total measures path mEUR:** 2025 **722** ÃÂÃÂ· 2026 **1.832bn** ÃÂÃÂ· 2027 **2.465** ÃÂÃÂ· 2028 **2.601** ÃÂÃÂ· 2029 **2.764**
...
- Found (strong primary VL centenboekje + WAL budget press):
  - **Warm Vlaanderen VAK path mEUR:** 319 / **418** / 551 / 755 / **1.073bn** (handicap 102-478 ÃÂÃÂ· kinderopvang 100-200 ÃÂÃÂ· ouderenzorg ÃÂÃÂ· jeugdhulp)
  - **Welvarend VAK path:** 326 / **533** / 471 / 623 / **716** (innovatie ÃÂÃÂ· digi onderwijs 200 ÃÂÃÂ· Nederlands ÃÂÃÂ· inductie)
...
- Unit: **rq_476** (FOI-adjacent hole-fill - **BRU SEC trajectory measures 297mÃÂ¢ÃÂÃÂ1.186bn + dual triad VL/WAL/BRU**)
- Found (strong primary CoA Budgets RBC 2026 Table 1):
  - **Base SEC 2025:** **-1.241bn**; constant-policy path then new measures
  - **Total measures path mEUR:** 2026 **297** ÃÂÃÂ· 2027 **565** ÃÂÃÂ· 2028 **907** ÃÂÃÂ· 2029 **1.186bn**
  - Split 2026: **dep 177** + **rec 120**; 2029 dep **845** + rec **341**
  - **SEC after measures:** **-957** / **-719** / **-416** / **0** (balance 2029)
  - L5 thematic dep: personnel **84ÃÂ¢ÃÂÃÂ274** ÃÂÃÂ· fonct+IT **127ÃÂ¢ÃÂÃÂ281** ÃÂÃÂ· facultatives **25** flat ÃÂÃÂ· mobilite reinvest **-190ÃÂ¢ÃÂÃÂ-37** ÃÂÃÂ· logement 52ÃÂ¢ÃÂÃÂ15 ÃÂÃÂ· travail 30ÃÂ¢ÃÂÃÂ65 ÃÂÃÂ· env 34ÃÂ¢ÃÂÃÂ57 ÃÂÃÂ· urbanisme 18ÃÂ¢ÃÂÃÂ123
...
- Unit: **rq_477** (FOI-adjacent hole-fill - **FWB SEC path -1.608ÃÂ¢ÃÂÃÂ-1.224bn + dual Entity II quartet**)
- Found (strong primary DGBF elements-cles + GW CP; medium year-1 secondary):
  - **SEC path mEUR:** 2026 **-1.608bn** ÃÂÃÂ· 2027 **-1.405** ÃÂÃÂ· 2028 **-1.390** ÃÂÃÂ· 2029 **-1.224bn**
  ...
  - **Year-1 ÃÂÃÂ©conomies medium 255m** 2026 (RTBF/RTL/Le Soir; official L5 FOI)
...
- Found (strong primary FPB Report 13320 + xlsx DATA_BUDGET2027):
  - **Inventory:** **263** measure rows (press 250+; ~230 external + ~30 DC2024); **39** with 2029 annual impulse mEUR ÃÂ¢ÃÂÃÂ **not additive** (alternative scenarios)
  - **Entity I control-account residual gap 4.9bn** 2029 (0.67% GDP; CM Mar 2026 pre-Iran war) ÃÂ¢ÃÂÃÂ dual vs prior decided **9.2bn** package
  - **SS 147.3bn** (pens **72.3** ÃÂÃÂ· health **41.3** ÃÂÃÂ· invalid **15.9** ÃÂÃÂ· chom **4.6** ÃÂÃÂ· other 10.1 ÃÂÃÂ· admin 3.0)
  - **Federal own 41.9bn** (salaries **10.9** ÃÂÃÂ· fonct **8.5** ÃÂÃÂ· subs **7.9** ÃÂÃÂ· invest **6.5** ÃÂÃÂ· handicap/GRAPA 4.3)
  - Transfers C&R **81.5bn** ÃÂÃÂ· interest **12.3** ÃÂÃÂ· UE **9.1** ÃÂÃÂ· recettes total **267.4** (fiscal 164.3 ÃÂÃÂ· SSC 93.7 ÃÂÃÂ· IPP 64.2 ÃÂÃÂ· ISOC 26.0)
  - DC2024 ranges (options): cars+cheques **4.5-5.5bn** ÃÂÃÂ· globalisation **5.5-11.3** ÃÂÃÂ· wealth tax **2.0-7.5** ÃÂÃÂ· health norm **3.3-4.5** ÃÂÃÂ· fossil transport **0.8-1.25**
...
- Found (strong primary BOSA CM rapport 6 Jul 2026 dÃÂÃÂ©finitive):
  - **Entity I deficit path bn:** 2026 **-25.68** ÃÂÃÂ· 2027 **-30.34** ÃÂÃÂ· 2028 **-34.03** ÃÂÃÂ· 2029 **-38.28** ÃÂÃÂ· 2031 **-44.50** (ÃÂ¢ÃÂÃÂ3.9ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ5.7% GDP)
  - **Control-account cumulative gap:** 0.6 / 2.4 / 5.8 / **7.7bn** 2029 / 8.4 / **9.8bn** 2031 (upgrades Mar **4.9bn** pre-Iran)
  - **Net exp bn:** 197.6 ÃÂ¢ÃÂÃÂ **219.6** 2029; norms 2.96ÃÂ¢ÃÂÃÂ2.27%
  - **GG debt:** 110.7% 2026 ÃÂ¢ÃÂÃÂ **117.1** 2029 ÃÂ¢ÃÂÃÂ **122.6** 2031; Entity I debt **86.3ÃÂ¢ÃÂÃÂ97.7%**
  - **Unallocated measures total 2029 +2.192bn** L5: fraud+compliance **482** ÃÂÃÂ· FIOD **193** ÃÂÃÂ· subsidy cut **199** ÃÂÃÂ· reorg+central **150+150** ÃÂÃÂ· replace ratio **175** ÃÂÃÂ· social/tax fraud **200+200**
  - Sous-utilisation **1.625ÃÂ¢ÃÂÃÂ1.750bn**; interest ~**18.6bn** 2029 class
...
- Unit: none ÃÂ¢ÃÂÃÂ **paused=yes** (human)
...
- loop_state still **paused=yes** ÃÂ· ticks=488 ÃÂ· next on resume **rq_480**
...
- Unit: **rq_480** (FOI-adjacent hole-fill ÃÂ **Rekenhof Vlaams kunstenbeleid CoA 2026_36: Kunstendecreet awards 201.9m 2024 + dual culture**)
- Found (strong primary CoA NL chamber 30 Jun 2026 + FR press):
  ...
  - **WS 187.084m (92.7%)** / **KS 14.858m (7.3%)** ÃÂ KS share below decretal 12.5% residual (actual 11.5%)
  - L4 split: KI 7ÃÂ**69.401m** ÃÂ· 5y 209ÃÂ**83.787m** ÃÂ· 10y 16ÃÂ**30.224m** ÃÂ· kerntaken 4ÃÂ**3.673m**
  - KS: beurzen 2.05m ÃÂ· projects 10.90m ÃÂ· intl 1.91m (850 of 1756 awards)
  ...
  - Stable core 73.7%; 60ÃÂ85% awards concentrated Antwerpen/BHG/Gent
...
- FOI opened: gap_vl_kunsten_neg9_cash (ready, human send) ÃÂ not sent
- Next: prio5 **rq_481** (**progress@490 next tick**); deferred **rq_116** SWA


### 2026-07-28T17:35:00Z - tick 490
- Unit: **rq_481** (**progress milestone @490** ÃÂ coverage % layers AÃÂE + waste top10 refresh)
- Coverage vs ÃÂ347.956bn TE:
  - **A L0:** 100% ÃÂ· **B L1:** 100% ÃÂ· **C L2:** ~99% ÃÂ· **D L5:** ~29ÃÂ42% generous ÃÂ· **E FOI ready:** ~239 (answered ~9; total ~250)
- Inventory class: budgets ~8505 ÃÂ· cmt ~882 ÃÂ· lb ~1653 ÃÂ· entities ~407 ÃÂ· sources ~908 ÃÂ· rq ~476
- **Gain 480?490:** Entity I/II consolidation dual wave (VL measures path ÃÂ· WAL 270m ÃÂ· BRU SEC ÃÂ· FWB SEC + quartet 2.65bn ÃÂ· FPB 263 options ÃÂ· CM Jul control residual **7.7bn** unalloc L5) + CoA VL Kunstendecreet **201.9m** + NL Democracy/Regie residual
- **Waste top10:** stable (fossil/company-cars/cheque/EIWT); hedera CAP stock filtered (annual 0); no reorder
- Wrote: progress_every_10_ticks.md ÃÂ· doge_waste_top10_current.md ÃÂ· rq_481=done spawn **rq_482**; ticks=490
- FOI: none new this tick
- Next: prio5 **rq_482**; deferred **rq_116** SWA


### 2026-07-28T17:50:00Z - tick 491
- Unit: **rq_482** (FOI-adjacent hole-fill ÃÂ **CoA 2026_24 prison DBFM PPP follow-up + dual VL PPP decree**)
- Found (strong primary CoA AG 27 May 2026 + press 11 Jun):
  - **5 ops** DBFM (Marche Beveren Leuze Haren Dendermonde) + **4 project** (Antwerp mid-2026 ÃÂ· Leopoldsburg/Vresse 2029 ÃÂ· Verviers 2031) + 3 CPL DBFMO (Paifve Wavre Aalst)
  - Recs **9 applied / 16 ongoing / 5 not** (of 30); federal PPP legal frame still missing (WG Feb 2026); **VL decree 2019** dual
  - **Antwerp** annual invest redevance **ÃÂ17.1m** 2026 exposÃÂ©; **25y total missing**; Dendermonde invest fee **not fixed** (VAT residual)
  - **VFM** school example: DBFM NPV **254.5m** vs DBM **239.9m** at OLO30 **3.32%** = private finance premium **ÃÂ14.7m**; residual-value bias flagged
  - **Off-balance** legal commitments **still unrecorded** (2022 stock **ÃÂ2.6bn**); IWMS unfunded
...
- FOI opened: gap_dbfm_fees_full_table_2026 (ready, human send) ÃÂ not sent
- Next: prio5 **rq_483**; deferred **rq_116** SWA


### 2026-07-28T18:10:00Z - tick 492
- Unit: **rq_483** (FOI-adjacent hole-fill ÃÂ **CoA 2026_27 Flanders GIP MOW + dual SOFICO**)
- Found (strong primary Rekenhof NL 16 Jun 2026 + press):
  - **GIP 2025-27** annual avg **ÃÂ2.503bn**; plan 2026 **2.424bn** ? available **3.864bn** ? **actualisatie 2026 ÃÂ3.685bn** (VR 22 May)
  - Entity demand 2026 **ÃÂ4.270bn** (avg 26-29 **3.122bn**); recurrent fixed **~ÃÂ631m**/yr
  - Extra invest 2025: promised **530m** delivered **363m** (partly maintenance reclass)
  - **Fiets** actualisatie **~ÃÂ220m** vs target **ÃÂ300m**
  - Oosterweel extra **+ÃÂ857m** ÃÂ· leefbaarheid **+ÃÂ629.8m** ÃÂ· new projects **444.5m** ÃÂ· removed **316.4m** ÃÂ· non-input 43 proj **68.4m**
  - Pre-draws Q1 **>ÃÂ900m**; governance: weak legal frame, non-objective prioritisation, data quality fail, 3y not 5y horizon
...
- FOI opened: gap_gip_l5_outturn_2025_26 (ready, human send) ÃÂ not sent
- Next: prio5 **rq_484**; deferred **rq_116** SWA


### 2026-07-28T18:30:00Z - tick 493
- Unit: **rq_484** (FOI-adjacent hole-fill ÃÂ **CoA 2026_33 FWB budget adjustment 2026 + dual Entity II**)
- Found (strong primary Cour des comptes FR chamber 30 Jun 2026):
  - **SEC aju ÃÂ-1,752.8m** (init **-1,607.6m**, ? **-145.2m**)
  - Dep liquidations **ÃÂ15,591.5m** (+184.7); rec hors emprunts **ÃÂ13,674.4m** (+71.9); solde net **-1,917.1m**
  - Sous-utilisations **ÃÂ452.1m**; corrections SEC **-238.1m** (ÃÂcureuil requal **-71.2m**)
  - **Economies SEC path strong Table3:** 2026 **253.6** ÃÂ· 2027 **522.9** ÃÂ· 2028 **599.1** ÃÂ· 2029 **733.0** m
    - Edu obl **87.5** ÃÂ· Enfance **118.0** ÃÂ· Sup **17.9** ÃÂ· Culture **12.6** ÃÂ· FP **8.7** ÃÂ· Autres **8.8** (2026)
  - Upgrades prior medium year-1 ~255m and elements-clÃÂ©s -1.608bn path
...
- FOI opened: gap_fwb_economies_programme_l5 (ready, human send) ÃÂ not sent
- Next: prio5 **rq_485**; deferred **rq_116** SWA


### 2026-07-28T18:50:00Z - tick 494
- Unit: **rq_485** (FOI-adjacent hole-fill ÃÂ **CoA 2026_26 Wallonie budget adjustment 2026 + dual Entity II**)
- Found (strong primary Cour des comptes FR 11 Jun 2026):
  - **SEC aju ÃÂ-2,015.4m** (init -2,015.7 almost flat); rec **22,087.9m** ÃÂ· dep liq **21,937.9m** (+602 each)
  - Solde net **-2,798.6m**; sous-util **524m**; corr SEC **963.3m**; inst consol **-180.1m** (Aviq **-258.9**; OTW **+97.1**)
  - **ICN 2025 provisional ÃÂ-2,853m** (-572.4m vs gov aju estimate)
...
- FOI opened: gap_wal_fiches_budget_2026 (ready, human send) ÃÂ not sent
- Next: prio5 **rq_486**; deferred **rq_116** SWA


### 2026-07-28T19:10:00Z - tick 495
- Unit: **rq_486** (FOI-adjacent hole-fill ÃÂ **CoA 2026_23 DG 1. Haushaltsanpassung 2026 + dual Entity II**)
- Found (strong primary Rechnungshof AG 27 May 2026):
  - **HV AE ÃÂ750.8m** ÃÂ· VE **ÃÂ728.0m** ÃÂ· rec **ÃÂ672.6m** (+17.3)
  - **ESVG consol ÃÂ-123.8m** (ex-Gemeinschaftszentren **ÃÂ-110.5m**); gross saldo worse **ÃÂ36.7m** aju; ESVG worse **ÃÂ2.6m**
  - Deltas: RRF rec **+16.6** / exp **+21.0** ÃÂ· infra VE **+19.4** ÃÂ· Gemeinden **+3.3** ÃÂ· personnel **+1.8** ÃÂ· fed dot **-4.0**
  - **Debt consol:** 578m (2020) ? **1,252m** (2024) ? **1,344m** (2025) ? path **1,468m** eoy2026; interest **41.2m**; debt/rev **257%**
  - **NPA growth 2026 +8.98%** breaches 5% self-cap; invest neutralisation **ÃÂ291.3m** 2026-28 without EU flex approval
...
- FOI opened: gap_dg_infra_l5_2026 (ready, human send) ÃÂ not sent
- Next: prio5 **rq_487**; deferred **rq_116** SWA


### 2026-07-28T19:30:00Z - tick 496
- Unit: **rq_487** (FOI-adjacent hole-fill ÃÂ **CoA 2026_31 FWB Cepage teacher payroll IT + dual Persona/I-Police**)
- Found (strong primary Cour des comptes FR 16 Jun 2026):
  - Education **personnel ÃÂ7.1bn** BI2026 (86.2% Education); **~150k** agents ÃÂ· **2,700+** schools ÃÂ· **1,000+** POs
  - **Cepage** (2022?deploy not before **2030**): cost estimates **ÃÂ35.2m** build / **ÃÂ39.1m** 5y / **ÃÂ95.7m** 14y ÃÂ **unsubstantiated**; maint **ÃÂ3.9m**/yr
  - **Etnic** dot **ÃÂ119.7m** (2025) / **ÃÂ117.7m**+**5.3m** strategic (2026); FTE **68?381** (2002ÃÂ24); analytic costs weak since 2004 contract
  - RL10 payroll engine **1970s Cobol**; free PO payroll art.36 pacte scolaire unsustainability risk
  - **Dual IT failures:** VL AGODI **Persona ÃÂ16m** stopped (<10% features); federal **I-Police ÃÂ76.7/299m** cancelled
- Wrote: sources +3; budgets +12; cmt +3; lb +4; FOI **gap_fwb_cepage_cost_l5** ready+draft; raw PDFs; rq_487=done spawn **rq_488**; ticks=496
- FOI opened: gap_fwb_cepage_cost_l5 (ready, human send) ÃÂ not sent
- Next: prio5 **rq_488**; deferred **rq_116** SWA


### 2026-07-28T19:50:00Z - tick 497
- Unit: **rq_488** (FOI-adjacent hole-fill ÃÂ **VL Onderwijs BO2026 17.25bn + Persona 16m dual FWB Cepage**)
- Found (strong primary Vlaams Parlement Commissie Onderwijs 15-2025-26-7H + CoA 2026_31):
  - **OV VAK ÃÂ17.25bn / VEK ÃÂ17.24bn** (+404.5m / +436.7m vs 2025)
  - Coalition savings **ÃÂ141m** + extra BO **ÃÂ180.6m** class: SO growth **50** ÃÂ· LBV **33.3** ÃÂ· VO **50** ÃÂ· subs **4.7** ÃÂ· Digisprong **6** ÃÂ· defer inductie **10** / NL **35**
  - Extra invest class **ÃÂ412m** (digi **154** ÃÂ· NL **80+10** ÃÂ· inductie **~39** ÃÂ· zijinstroom **14** ÃÂ· tso/bso **18**)
  - HO cuts: Brussel **10.6** ÃÂ· niet-EER **~20.2** ÃÂ· werkingsmiddelen **-10.3**; leraar-specialist **15.7m** back to provisie
  - **Persona** AGODI IT stop Jan 2026 after **ÃÂ16m** / **<10%** features (CoA dual Cepage)
...
- FOI opened: gap_vl_persona_agodi_cash (ready, human send) ÃÂ not sent
- Next: prio5 **rq_489**; deferred **rq_116** SWA


### 2026-07-28T20:10:00Z - tick 498
- Unit: **rq_489** (FOI-adjacent hole-fill ÃÂ **CoA 2026_35 VL aanvangsbegeleiding + inductie + dual FWB teachers**)
- Found (strong primary Rekenhof NL 30 Jun 2026):
  - **AVB budget path:** ~**ÃÂ31m** (2019) ? **ÃÂ52.2m** (2024-25); pupil-based allocation mismatches starter needs
  - **Inductie** SY2026-27 envelope **ÃÂ48.7m** (not enough for 20% free-time all starters); SY2025-26 alt **ÃÂ38.7m** werkingsbudget
  - Total AVB+inductie **>ÃÂ100m** class (~3ÃÂ introduction) excl **lerarenbonus ÃÂ24.7m** / **3,499** teachers
  - Professionalisering: **ÃÂ120ÃÂ130**/organieke betrekking; large school disparities; ~1/3 spend off core teaching task
  - No closed AGODI control that coloured hours actually fund starter mentoring
  - **Dual:** VL starter cash package vs FWB Cepage/payroll under **ÃÂ7.1bn** personnel
...
- FOI opened: gap_vl_avb_inductie_spend_l5 (ready, human send) ÃÂ not sent
- Next: prio5 **rq_490** (**progress@500 next ticks**); deferred **rq_116** SWA


### 2026-07-28T20:30:00Z - tick 499
- Unit: **rq_490** (FOI-adjacent hole-fill ÃÂ¢ÃÂÃÂ **CoA 2026_32 VL Rekeningenrapport 2025 + dual Entity II**)
- Found (strong primary Rekenhof NL 30 Jun 2026 + press + addendum):
  - **ESR vorderingensaldo 2025 ÃÂ¢ÃÂÃÂ3.982,4m** (vs ÃÂ¢ÃÂÃÂ4.101,3m 2024; BA ÃÂ¢ÃÂÃÂ4.503,8m; +522m vs BA)
  - **Maastrichtschuld 50.171,9m** eoy2025 (from 41.788,6m; **+8.383,3m**); gross consol **58.721,9m**; direct **42.396,6m**
  - Debt 2019ÃÂ¢ÃÂÃÂ2025: **18,6 ÃÂ¢ÃÂÃÂ 50,2bn (+170%)** ÃÂ¢ÃÂÃÂ far exceeds cumulative deficits
  ...
  - VWF **6.062,8m** ÃÂÃÂ· VMSW **3.123,4m** ÃÂÃÂ· centraal gefinancierd **17.464,2m**
  - **Niet-budgettaire schuldopbouw 1.069,7m** 2025 ÃÂ¢ÃÂÃÂ Parlement onvoldoende uitleg (CoA)
  - Balans: onthouding; ontbrekende terreinen/gebouwen **~1,6bn**; kunst **1,4bn** deels; openstaande verbintenissen FWO **561,6** + FIO **188,6** ÃÂ¢ÃÂÃÂ **0,75bn** voorbehoud
  - Overdracht kredieten naar 2026 **1.415,3m**; Relance 2025 spend **399,4m** (ÃÂ¢ÃÂÃÂ342,2); cum 4,2bn vast / 3,5bn liq / 0,7bn open
  - **Dual Entity II:** VL certified ÃÂ¢ÃÂÃÂ4,0bn outturn vs WAL aju ÃÂ¢ÃÂÃÂ2,02 / FWB ÃÂ¢ÃÂÃÂ1,75 / DG ÃÂ¢ÃÂÃÂ0,11
...
- FOI opened: gap_vl_debt_nonbudget_bridge_l5 (ready, human send) ÃÂ¢ÃÂÃÂ not sent
- Next: prio5 **rq_491** (**progress@500 next tick**); deferred **rq_116** SWA

### 2026-07-28T20:50:00Z - tick 500
- Unit: **rq_491** (progress milestone @500 ÃÂ¢ÃÂÃÂ coverage % + waste top10; no invent euros)
- Found / inventory:
  - Layers: **A100** ÃÂÃÂ· **B100** ÃÂÃÂ· **C~99** ÃÂÃÂ· **D~30ÃÂ¢ÃÂÃÂ43%** ÃÂÃÂ· **E~248 ready** / ~9 answered / ~259 FOI rows
  - CSV class: budgets ~8685 ÃÂÃÂ· cmt ~914 ÃÂÃÂ· lb ~1697 ÃÂÃÂ· entities ~411 ÃÂÃÂ· sources ~936 ÃÂÃÂ· rq ~486
  - **Gain 490ÃÂ¢ÃÂÃÂ500:** CoA dual Entity II aju complete (FWB ÃÂ¢ÃÂÃÂ1.75 ÃÂÃÂ· WAL ÃÂ¢ÃÂÃÂ2.02 ÃÂÃÂ· DG ÃÂ¢ÃÂÃÂ0.11) ÃÂÃÂ· GIP 3.685bn ÃÂÃÂ· prison DBFM ÃÂÃÂ· education dual (Cepage 35ÃÂ¢ÃÂÃÂ96m ÃÂÃÂ· Persona 16m ÃÂÃÂ· OV 17.25bn ÃÂÃÂ· AVB+inductie >100m) ÃÂÃÂ· VL RR ESR ÃÂ¢ÃÂÃÂ3.98bn / debt 50.2bn (+8.4) / Zaventem 2.55bn
  - Waste top10 **stable** (fossil/company-cars/cheque/EIWT); no reorder; new near-list: VL debt stock 50.2bn ÃÂÃÂ· Zaventem 2.55bn ÃÂÃÂ· nonbudget 1.07bn ÃÂÃÂ· dual education IT
- Wrote: progress_every_10_ticks.md ÃÂÃÂ· doge_waste_top10_current.md ÃÂÃÂ· rq_491=done spawn **rq_492**; ticks=500
- FOI: none new (progress tick)
- Next: prio5 **rq_492**; deferred **rq_116** SWA

### 2026-07-28T21:10:00Z - tick 501
- Unit: **rq_492** (FOI-adjacent hole-fill ÃÂ¢ÃÂÃÂ **CoA 2026_19 DWV studieopdrachten + dual Lantis/GIP**)
- Found (strong primary Rekenhof NL 31 Mar 2026 + press):
  ...
  - **R0 Noord:** award **ÃÂ¢ÃÂÃÂ¬36m** ÃÂ¢ÃÂÃÂ spent Mar2025 **ÃÂ¢ÃÂÃÂ¬85.4m** ÃÂ¢ÃÂÃÂ est **ÃÂ¢ÃÂÃÂ¬103.6m**; OP-posten **ÃÂ¢ÃÂÃÂ¬9.4m** without competition
  - **R0 Oost:** **ÃÂ¢ÃÂÃÂ¬3.5m**/yr award ÃÂ¢ÃÂÃÂ spent **ÃÂ¢ÃÂÃÂ¬11.1m**; extra **ÃÂ¢ÃÂÃÂ¬3.7m** same provider quick wins 2023 unpublished
  - **Brabantnet:** award **ÃÂ¢ÃÂÃÂ¬5.9m** ÃÂ¢ÃÂÃÂ spent **ÃÂ¢ÃÂÃÂ¬11.0m** + extras **ÃÂ¢ÃÂÃÂ¬8.75m** (ring 0.1 ÃÂÃÂ· luchthaven 5.1 ÃÂÃÂ· sneltram 3.6); sneltram off GIP 2025-27
  - **R4 West/Oost:** award **ÃÂ¢ÃÂÃÂ¬12.1m** **+>40%**; deel4 budget **4.3ÃÂ¢ÃÂÃÂ9.2m** undermines plafond
  - Four-pack spent class **~ÃÂ¢ÃÂÃÂ¬125m** Mar2025; competition/transparency risks CoA
  - **Dual:** DWV study cash vs Lantis Toekomstverbond **ÃÂ¢ÃÂÃÂ¬3.85bn** / GIP mobility stack
...
- FOI opened: gap_dwv_studies_contractor_l5 (ready, human send) ÃÂ¢ÃÂÃÂ not sent
- Next: prio5 **rq_493**; deferred **rq_116** SWA

### 2026-07-28T21:30:00Z - tick 502
- Unit: **rq_493** (FOI-adjacent hole-fill ÃÂ¢ÃÂÃÂ **CoA 2026_18 Toekomstverbond 6e voortgang + dual DWV**)
- Found (strong primary Rekenhof NL 24 Mar 2026):
  - **Oosterweel exec budget ÃÂ¢ÃÂÃÂ¬10.055bn** (Jan2024) from task **ÃÂ¢ÃÂÃÂ¬4.391bn** (2019) ÃÂ¢ÃÂÃÂ **ÃÂ¢ÃÂÃÂ¬5.369bn** (2022); inflation **ÃÂ¢ÃÂÃÂ¬1.5bn** 2019-23
  - Adds: invest **299** ÃÂÃÂ· overmacht/PFAS **1.861** ÃÂÃÂ· LBH2 under **655** ÃÂÃÂ· risk **607**
  - **BC2026:** assets end-build **ÃÂ¢ÃÂÃÂ¬13.614bn** ÃÂÃÂ· fin need **ÃÂ¢ÃÂÃÂ¬8.273bn** ÃÂÃÂ· CAPEX remain **ÃÂ¢ÃÂÃÂ¬7.275bn** ÃÂÃÂ· bonds **ÃÂ¢ÃÂÃÂ¬7.751bn** ÃÂÃÂ· subloans **ÃÂ¢ÃÂÃÂ¬2.850bn** ÃÂÃÂ· **interest ÃÂ¢ÃÂÃÂ¬24.495bn** 2026-2083
  - Spent eoy2025: main **ÃÂ¢ÃÂÃÂ¬2.674bn** ÃÂÃÂ· PFAS **ÃÂ¢ÃÂÃÂ¬476.9m**; Linkeroever main within budget
  - **Table1 TV clusters:** main **7.917** ÃÂÃÂ· overmacht **2.258** ÃÂÃÂ· leefbaarheid **1.696** ÃÂÃÂ· HaventracÃÂÃÂ© **4.1ÃÂ¢ÃÂÃÂ15.9bn** ÃÂÃÂ· modal shift opaque
  - VL debt path MJR **41.7ÃÂ¢ÃÂÃÂ74.6bn** 2024-30; GIP vs Lantis multiyear unreconciled
  - **Dual:** TV mega-envelope vs DWV study overruns **~ÃÂ¢ÃÂÃÂ¬125m** (tick501)
...
- FOI opened: gap_tv_oosterweel_finance_l5 (ready, human send) ÃÂ¢ÃÂÃÂ not sent
- Next: prio5 **rq_494**; deferred **rq_116** SWA

### 2026-07-28T21:50:00Z - tick 503
- Unit: **rq_494** (FOI-adjacent hole-fill ÃÂ¢ÃÂÃÂ **CoA 2026_22 federal budget aju 2026 Entity I + dual E2**)
- Found (strong primary Rekenhof AG 21 May 2026):
  - **Entity I deficit ÃÂ¢ÃÂÃÂ¬24.5bn** aju (init ÃÂ¢ÃÂÃÂ¬24.6bn); MR 3 Apr **+ÃÂ¢ÃÂÃÂ¬615m** (tech 517 + policy 98)
  - Primary **ÃÂ¢ÃÂÃÂ¬12.2ÃÂ¢ÃÂÃÂ18.7bn** 2026-29; interest **ÃÂ¢ÃÂÃÂ¬12.3ÃÂ¢ÃÂÃÂ17.5bn**; VAT takeaway cancel **ÃÂ¢ÃÂÃÂ¬475m**
  - Defence 2025-29 **ÃÂ¢ÃÂÃÂ¬17.336bn** (+552.8 NATO 2%); higher def **ÃÂ¢ÃÂÃÂ¬4.804bn** / asset optim **ÃÂ¢ÃÂÃÂ¬3.17bn** not booked 2026 conclaves; Belfius 20% **ÃÂ¢ÃÂÃÂ¬2bn** ~2027
  - Russian assets CIT path **ÃÂ¢ÃÂÃÂ¬6.154bn** 2025-29; Euroclear exceptional **>ÃÂ¢ÃÂÃÂ¬1bn**/yr assumption to 2031
  - Fiscal fraud claim **ÃÂ¢ÃÂÃÂ¬300/600m** method opaque; SIOD social fraud **ÃÂ¢ÃÂÃÂ¬414.6m** 2025
  - Centenindex E1 **ÃÂ¢ÃÂÃÂ¬24ÃÂ¢ÃÂÃÂ363m**; energy policy **~ÃÂ¢ÃÂÃÂ¬2.6bn** (DG 1.2 + funds 1.4 CREG/Elia/NIRAS/Hedera)
  - Regions EU MFK **ÃÂ¢ÃÂÃÂ¬500m**/yr from 2028 no deal; personnel-save drag FOD Fin **ÃÂ¢ÃÂÃÂ¬433m** by 2029
  - **Dual:** E1 24.5bn vs VL RR ÃÂ¢ÃÂÃÂ4.0 / WAL ÃÂ¢ÃÂÃÂ2.02 / FWB ÃÂ¢ÃÂÃÂ1.75 / DG ÃÂ¢ÃÂÃÂ0.11
- Wrote: sources +2; budgets +24; cmt +4; lb +7; FOI **gap_fed_energy_funds_l5** ready+draft; raw PDF; rq_494=done spawn **rq_495**; ticks=503
- FOI opened: gap_fed_energy_funds_l5 (ready, human send) ÃÂ¢ÃÂÃÂ not sent
- Next: prio5 **rq_495**; deferred **rq_116** SWA

### 2026-07-28T22:10:00Z - tick 504
- Unit: **rq_495** (FOI-adjacent hole-fill ÃÂ¢ÃÂÃÂ **CoA 2026_04 Kustbeveiliging MPKV + Kustvisie dual GIP**)
- Found (strong primary Rekenhof NL 13 Jan 2026 + press):
  - **Masterplan Kustveiligheid:** spent end-2024 **ÃÂ¢ÃÂÃÂ¬321.4m** ÃÂÃÂ· remain min **ÃÂ¢ÃÂÃÂ¬144.3m** ÃÂÃÂ· total class **ÃÂ¢ÃÂÃÂ¬465.7m**
  ...
  - **Kustvisie** (since 2009): studies/consulting **ÃÂ¢ÃÂÃÂ¬21m** 2014-24; strategic plan draft 2024 **not approved**; not in GIP as programme
  - Century protection cost **ÃÂ¢ÃÂÃÂ¬2ÃÂ¢ÃÂÃÂ5bn** PV (2030-2130)
...
- FOI opened: gap_mpkv_measures_l5 (ready, human send) ÃÂ¢ÃÂÃÂ not sent
- Next: prio5 **rq_496**; deferred **rq_116** SWA

### 2026-07-28T22:30:00Z - tick 505
- Unit: **rq_496** (FOI-adjacent hole-fill ÃÂ¢ÃÂÃÂ **CoA 2026_29 KMO VenB control follow-up + dual fraud**)
- Found (strong primary Rekenhof AG 3 Jun 2026 + press):
  - VenB cash **ÃÂ¢ÃÂÃÂ¬25.729bn** 2024; PB **56.1** ÃÂÃÂ· BTW **37.5** ÃÂÃÂ· RV **14.5** ÃÂÃÂ· accijnzen **7.6** (CoA general account figure)
  - **111,988** VenB returns controlled 2024 ÃÂ¢ÃÂÃÂ income increases **>ÃÂ¢ÃÂÃÂ¬5.6bn**
  - Admin KMO staff gap **383 FTE** vs 2018 plan eoy2024; prior ÃÂ¢ÃÂÃÂ21% controllers 2016-21
  - Recommendations of 17: **3 done ÃÂÃÂ· 8 in progress ÃÂÃÂ· 2 not done ÃÂÃÂ· 4 N/A** after 3 years
...
- FOI opened: gap_kmo_venb_control_l5 (ready, human send) ÃÂ¢ÃÂÃÂ not sent
- Next: prio5 **rq_497**; deferred **rq_116** SWA

### 2026-07-28T22:50:00Z - tick 506
- Unit: **rq_497** (FOI-adjacent hole-fill ÃÂ¢ÃÂÃÂ **CoA 2026_20 BBI bank data + dual KMO/fraud**)
- Found (strong primary Rekenhof AG 18 Mar 2026 + press/samenvatting):
  ...
  - Dossiers with bank investigations 2015-24: taxes **assessed ÃÂ¢ÃÂÃÂ¬2.3bn** ÃÂÃÂ· **collected only ÃÂ¢ÃÂÃÂ¬36m** (~1.6%) ÃÂ¢ÃÂÃÂ preventive focus ~80% of corrections via 5th dir
  ...
  - **Dual:** BBI assess/collect stack vs KMO VenB **ÃÂ¢ÃÂÃÂ¬5.6bn** uplifts (tick505) vs fraud yield claims **ÃÂ¢ÃÂÃÂ¬300/600m** (tick503)
...
- FOI opened: gap_bbi_bank_collection_l5 (ready, human send) ÃÂ¢ÃÂÃÂ not sent
- Next: prio5 **rq_498**; deferred **rq_116** SWA

### 2026-07-28T23:10:00Z - tick 507
- Unit: **rq_498** (FOI-adjacent hole-fill ÃÂ¢ÃÂÃÂ **CoA 2026_22 residual Justice/Fedasil/Defence L5 dual**)
- Found (strong primary same CoA fed aju, deeper L5 extract):
  - **Justice** section **ÃÂ¢ÃÂÃÂ¬2,925m** aju (+81m); prison overcrowding infra **ÃÂ¢ÃÂÃÂ¬259m** (159+100) for **1,300** places by 2029; short **ÃÂ¢ÃÂÃÂ¬50m**/yr; efficiency **ÃÂ¢ÃÂÃÂ¬44m**; security+return ID **ÃÂ¢ÃÂÃÂ¬546m**
  - **MasterPlan IIIbis** **ÃÂ¢ÃÂÃÂ¬80m** ex inflation (Antwerp open Sep2026, St-Gilles, Hoogstraten, Bergen psych, Verviers)
  - **Fedasil** total **ÃÂ¢ÃÂÃÂ¬848.2m** BC (dot 743.9 + ID 104.3); asylum save target **ÃÂ¢ÃÂÃÂ172m** vs plan **ÃÂ¢ÃÂÃÂ110.8m** (gap **61.2**); cap 34,564ÃÂ¢ÃÂÃÂ~30,000; path targets 172/303/452/538
  - Return save **ÃÂ¢ÃÂÃÂ¬75m** hard to track; POD MI medical **100.3m** (ÃÂ¢ÃÂÃÂ12 vs IB)
  - **NATO** effort target **ÃÂ¢ÃÂÃÂ¬13,296m** (2% GDP 664.8bn); defence budget **10,958**; internal security **ÃÂ¢ÃÂÃÂ¬177m** (+trust 45ÃÂ¢ÃÂÃÂ222 class) classification opacity
...
- FOI opened: gap_fedasil_save_measures_l5 (ready, human send) ÃÂ¢ÃÂÃÂ not sent
- Next: prio5 **rq_499** (progress@510 soon); deferred **rq_116** SWA

### 2026-07-28T23:30:00Z - tick 508
- Unit: **rq_499** (FOI-adjacent hole-fill ÃÂ¢ÃÂÃÂ **CoA 2026_22 residual SS macro + POD MI soft saves dual**)
- Found (strong primary same CoA fed aju, SS/POD MI deep extract):
  - **SS BC2026:** rec **ÃÂ¢ÃÂÃÂ¬148,002m** ÃÂÃÂ· exp **ÃÂ¢ÃÂÃÂ¬148,027m** near balance; contributions **85,328** ÃÂÃÂ· altfin **27,583** ÃÂÃÂ· benefits **137,624**
  - Healthcare **ÃÂ¢ÃÂÃÂ¬43,857m** (+2.56bn vs IB); unemployment **4,836** (+198.5); employee pens **43,037**; invalidity **14,839**; public pens **22,527**
  - RSZ contrib **69,475m**; federal reductions class **ÃÂ¢ÃÂÃÂ¬5.14bn** (struct 4.29 + targeted 0.85; workbonus 1.83); wage ceiling **58.2m**
  - RSZ gov dots **8,656m**; equilibrium overfinance 2025 **547.5m** ÃÂ¢ÃÂÃÂ GB deficit booking 2026
  - **POD MI OCMW** total **ÃÂ¢ÃÂÃÂ¬2,309m** (RMI 2,133 + wet65 176); integ+wait save BC **13.1m** (was 40.2) ÃÂ¢ÃÂÃÂ **CoA: will not be achieved 2026**
  - RIZIV savings miss **ÃÂ¢ÃÂÃÂ¬183.1m** of 801.4 (145.7 drugs); invalidity follow-up save slip **ÃÂ¢ÃÂÃÂ110.2m** (exclusions 4,197)
  - Pension reform path **ÃÂ¢ÃÂÃÂ¬2,212m** to 2030; Zuidertoren **177.7m** RSZ reserves
...
- FOI opened: gap_podmi_ss_save_slip_l5 (ready, human send) ÃÂ¢ÃÂÃÂ not sent
- Next: prio5 **rq_500** (**progress@510 next tick**); deferred **rq_116** SWA

### 2026-07-28T23:45:00Z - tick 509
- Unit: **rq_500** (FOI-adjacent hole-fill ÃÂ **CoA 2026_22 residual Werk/werkloosheid + invalidity multi-year dual leefloon**)
- Found (strong primary same CoA fed aju, deeper L5 extract):
  - **Unemp BC2026** **ÃÂ4,836.4m** (+198.5 vs IB): volume **+287** ÃÂ· other **-96.7** ÃÂ· index **+8.2**; full unemp **+17,473** temporary **-3,851**; rate 9.6 vs 9.1
  - **Reform path** duration+degressivity: **1,685.2 / 2,286.7 / 2,440.6 / 2,447.8** m 2026-29; measures net total **1,578.5?2,421.2**
  - **Exclusion waves** total **193,904** (BRU 41,709 ÃÂ· VL 62,676 ÃÂ· WAL 88,566 ÃÂ· DG 953); Q1 actual **45,592** (93.4% of est)
  - **Leefloon shift** Q1: **17,606** new = **31.9%** of excluded (WAL 37.2 ÃÂ· VL 23.5 ÃÂ· BRU 27.5)
  - **Litigation** 3,696 dossiers 30 Apr (avg prior 3,185/yr); CoA est extra legal **~ÃÂ3m**; not in BC; GH pending
  - **SWT** close: stock **ÃÂ166.8m**/8,502 bens 2025; 2026 rush **-5.2m** (CoA: not visible in stats); 2029 save **64.8m**
  - **Family credit** backpack Entity I **ÃÂ40m** 2026 (full-yr 50); law not set; **tijdskrediet EL** save 1.6m (was 9.2)
...
- FOI opened: gap_rva_unemp_leefloon_l5 (ready, human send) ÃÂ not sent
- Next: prio5 **rq_501** (**progress@510 next tick**); deferred **rq_116** SWA

### 2026-07-29T00:05:00Z - tick 510
- Unit: **rq_501** (progress milestone @510 ÃÂ coverage % + waste top10; no invent euros)
- Found / inventory:
  - Layers: **A100** ÃÂ· **B100** ÃÂ· **C~99** ÃÂ· **D~31ÃÂ44%** ÃÂ· **E~257 ready** / ~9 answered / ~268 FOI rows
  - CSV class: budgets ~8848 ÃÂ· cmt ~945 ÃÂ· lb ~1756 ÃÂ· entities ~412 ÃÂ· sources ~958 ÃÂ· rq ~497
  - **Gain 500?510:** CoA mobility dual (DWV ~125m ÃÂ· Oosterweel 10.1bn / interest 24.5bn) ÃÂ· E1 aju 24.5bn ÃÂ· energy ~2.6bn ÃÂ· MPKV 466m/Kustvisie 21m ÃÂ· KMO VenB >5.6bn ÃÂ· BBI 2.3bn/36m ÃÂ· SS 148bn ÃÂ· unemp reform 1.69bn dual leefloon 32% ÃÂ· invalidity miss 334m
  - Waste top10 **stable** (fossil/company-cars/cheque/EIWT); #2/#3 annual tie-break may flip fossil accises vs company-cars FPB; new near-list: unemp reform 1.69bn ÃÂ· BBI collect gap ÃÂ· Oosterweel mega ÃÂ· SS 148bn
- Wrote: progress_every_10_ticks.md ÃÂ· doge_waste_top10_current.md ÃÂ· rq_501=done spawn **rq_502**; ticks=510
- FOI: none new (progress tick)
- Next: prio5 **rq_502**; deferred **rq_116** SWA

### 2026-07-29T00:20:00Z - tick 511
- Unit: **rq_502** (FOI-adjacent hole-fill ÃÂ **CoA 2026_22 residual energy L5 deep + federal debt path dual**)
- Found (strong primary same CoA fed aju, energy/debt extract):
  - **Energy total ~ÃÂ2.6bn**: DG Energie **1.2bn** + assignment funds CREG/Elia/NIRAS/Hedera **1.4bn** (opacity CoA)
  - **Energienorm** **ÃÂ249m** (law 24 Apr 2026) + **Fluxys ÃÂ100m**/yr 2026-28
  - **Social tariff** CREG **ÃÂ168.6m**; temp support **ÃÂ20m** (7.5/7.5/5)
  - **Phoenix CfD** **ÃÂ583.6m** 2026; strike price unknown to CoA at close; NIRAS passiva **258.6+62.5m**; decom contrib **ÃÂ100m** (ends 2027)
  - **Fed debt** eoy2026 **ÃÂ577.5bn** (+5.6 vs IB; +31.4 vs 2025) path **ÃÂ731bn** 2031
  - **Interest** **ÃÂ12.3bn** BC2026 path **ÃÂ22.6bn** 2031; snowball r-g **-0.91?-0.06** 2026-31
  - **Cash receipts** **ÃÂ167.2bn** (fiscal 159.3 ÃÂ· nonfiscal 7.8); transfers out **94.5**; middelen **72.6**; ESR fiscal **164.5**; measures net **+1.83bn**
...
- FOI opened: gap_phoenix_cfd_strike_l5 (ready, human send) ÃÂ not sent
- Next: prio5 **rq_503**; deferred **rq_116** SWA

### 2026-07-29T00:40:00Z - tick 512
- Unit: **rq_503** (FOI-adjacent hole-fill ÃÂ **CoA 2026_22 residual new fiscal measures + nonfiscal + primary exp cells dual**)
- Found (strong primary same CoA fed aju, Deel II residual):
  - **Conclave new fiscal +ÃÂ730.9m**: customs e-comm **+400.7** ÃÂ· EU handling fee **+77.4** (unallocated; law not final) ÃÂ· VVPR-bis re-est **+334.5** (JanÃÂApr +406.3 vs 2025; future reverse risk)
  - Customs mechanics: gross +449 dual EU -449; MS retention 25% **+112.3** nonfiscal; VAT volume **-48**
  - Insurance tax **+36.4** (was 51); non-res opcentiemen **~ÃÂ78m**/yr CJEU C-119/24 illegal; refunds open
  - Post-conclave: employer km credit **20m/month** MayÃÂJul (FPS no data; VAT-neutral claim disputed); service km provis **ÃÂ5m**
  - **Nonfiscal** middelen **ÃÂ7.829bn** (+1358): RSZ eq refund **548** ÃÂ· RIZIV COVID **187** ÃÂ· CREG energy **285** (max 412) ÃÂ· customs fee **1013.8** (+229) ÃÂ· SFPIM div actual **78.4** vs booked 55.8 ÃÂ· plates delay **-42.2**
  - **Primary cells** **ÃÂ92.050bn** (+41): support 3.72 (-497) ÃÂ· authority 23.05 (+390) ÃÂ· economic 6.58 ÃÂ· social 34.61 ÃÂ· specific 24.09
...
- FOI opened: gap_customs_vvpr_opcent_l5 (ready, human send) ÃÂ not sent
- Next: prio5 **rq_504**; deferred **rq_116** SWA

### 2026-07-29T01:00:00Z - tick 513
- Unit: **rq_504** (FOI-adjacent hole-fill ÃÂ **CoA 2026_22 residual defence multi-year financing + Fedasil save L5 dual**)
- Found (strong primary same CoA fed aju, ÃÂ§3.2.2 + ÃÂ§2.2ÃÂ2.3 residual):
  - **Defence 2025-29** **ÃÂ17,335.8m** (+552.8 NATO 2pct via GDP); higher deficit **ÃÂ4,804m** of which asset optim **ÃÂ3,170m** (40/30/20/10 ? 1268/951/634/317) **unbooked** in 2026 conclaves
  ...
  - **Belfius 20%** sale est **ÃÂ2bn** ~2027 (ECB/NBB/FSMA); residual asset optim after Belfius **ÃÂ1,170m** unexplained
  - **NATO effort** target **ÃÂ13,296m** / fill **ÃÂ13,246m** (def budget **10,958** + external **2,288**; pens **1,988** FPD -40 risk)
  - **Fedasil asylum save**: target **-172** path -303/-452/-538; plan only **-110.8** (cap25 36.4 ÃÂ· cap26 35.3 ÃÂ· extra 39.1); **gap 61.2** 2026 / 187 2029
  - Extra 23 measures: internal **27.1** ÃÂ· core tasks **10.4** ÃÂ· procedure **1.6** (from 2027 extra **220.7**); return **-75** untracked
  - **SIOD** social fraud **ÃÂ414.6m** 2025 (-20.3); fiscal fraud claim **300/600** method opaque; financial parket **196m** 2029 bill 56 1536
...
- FOI opened: gap_defence_asset_optim_l5 (ready, human send) ÃÂ not sent
- Next: prio5 **rq_505**; deferred **rq_116** SWA

### 2026-07-29T01:20:00Z - tick 514
- Unit: **rq_505** (FOI-adjacent hole-fill ÃÂ **CoA federal consultancy audit Oct 2025 dual IT/Smals**)
- Found (strong primary Rekenhof AG 22 Oct 2025, PDF local):
  - **Total consultancy 2020-22: ÃÂ2,524.7m** incl VAT (101 orgs survey); **IT ÃÂ2,032.3m (81%)** ÃÂ· non-IT **ÃÂ492.4m (19%)**
  - In-house federal-to-federal **ÃÂ619.2m** ÃÂ· other contracts **~ÃÂ1.9bn**; no central inventory (BOSA partial excl IT)
  - **Top buyers:** NMBS **465.1** ÃÂ· Infrabel **318.5** ÃÂ· FOD Fin **185.3** ÃÂ· BOSA **134.2** (45% of purchases!) ÃÂ· NIRAS **129.1** ÃÂ· Smals buyer **126.1** (79%) ÃÂ· RIZIV **115.5** ÃÂ· Health **70.1** ÃÂ· Kanselarij **68.2** ÃÂ· Credendo **61.5**
  - Nuclear non-IT **ÃÂ215.2m** (44% of non-IT); strategy/mgmt **87.2** ÃÂ· construction **72**
  - Smals external share of turnover **17.8% (2014) ? 36% (2024)**; detachments **1,395 ? 2,072** (+48.5%)
  - 101 contracts sample **ÃÂ2.2bn**; ~30% lack knowledge-transfer clause; deficiencies high in sample
...
- FOI opened: gap_fed_consultancy_inventory_l5 (ready, human send) ÃÂ not sent
- Next: prio5 **rq_506**; deferred **rq_116** SWA

### 2026-07-29T01:40:00Z - tick 515
- Unit: **rq_506** (FOI-adjacent hole-fill ÃÂ **CoA Brussels Region budget 2026 dual Entity II**)
- Found (strong primary Rekenhof AG 13 Mar 2026; 5 working days only):
  - **SEC SF** gov **-ÃÂ956.6m** (+591 vs prov 2025); CoA content adj **-ÃÂ978.2m**; base 2025 **-1,241m**
  - Measures path **ÃÂ297m (2026) ? ÃÂ1,186m (2029)**; receipt L5 missing; finops max **ÃÂ1bn** (SLRB 400 ÃÂ· Vivaqua 180 ÃÂ· Confex 150 ÃÂ· Kanal 60)
  - **Exp:** eng **ÃÂ8.9bn** ÃÂ· liq **ÃÂ8.0bn**; SGRBC net finance **-ÃÂ1,746.4m**; gross surplus **+ÃÂ11.4m**
  - **Debt consol** eoy2025 **ÃÂ16.1bn** (+3.5 2023-25); CoA est eoy2026 **ÃÂ17.7bn**; path limit +3bn ? **>ÃÂ19.1bn** 2029; direct LT **ÃÂ13.4bn**
  - **Top lines:** STIB **ÃÂ1,167.6m** (PPI cut **ÃÂ964.6m** 2026-29) ÃÂ· Actiris **ÃÂ648.1m** (-78) ÃÂ· titres-services **ÃÂ303.8m** ÃÂ· SLRB eng **687** ÃÂ· PropretÃÂ© **411** ÃÂ· local powers **758** ÃÂ· commissions **692** ÃÂ· debt service **728** ÃÂ· roads liq **264**
  - **Kanal** foundation budget omitted OAA2; credits **ÃÂ86.7m** (60m finops)
...
- FOI opened: gap_bru_measures_stib_kanal_l5 (ready, human send) ÃÂ not sent
- Next: prio5 **rq_507**; deferred **rq_116** SWA

### 2026-07-29T02:00:00Z - tick 516
- Unit: **rq_507** (FOI-adjacent hole-fill ÃÂ **CoA FAM medical accidents fund follow-up 2025 dual RIZIV**)
- Found (strong primary Rekenhof AG 19 Nov 2025):
  - **Recommendations:** 24 total ? **11 done ÃÂ· 12 in progress ÃÂ· 1 not done**
  ...
  - **Indemnities:** cumul **ÃÂ16.3m (2018) ? ÃÂ101.1m (eoy2024)**; annual **ÃÂ6.4m (2018) ? ÃÂ12.4m (2023)**
  - **Ops cost excl indemnities:** **ÃÂ12.5m 2024** (590 opinions ÃÂ· 681 closed); crude **~ÃÂ16,500/dossier** (was ~12k/open in 2020 audit)
...
- FOI opened: gap_fam_cost_role_l5 (ready, human send) ÃÂ not sent
- Next: prio5 **rq_508** (progress@520 soon); deferred **rq_116** SWA

### 2026-07-29T02:20:00Z - tick 517
- Unit: **rq_508** (FOI-adjacent hole-fill ÃÂ **CoA consultancy residual Smals broker L5 dual IT detach**)
- Found (strong primary same CoA consultancy Oct 2025, Ch5 residual):
  - **Broker framework** ProUnity lot1 est **ÃÂ1.8bn** (15 Dec 2022) + lot2 fixed-price **ÃÂ250m** = **ÃÂ2.05bn** class
  - **Orders 2023-24:** **ÃÂ471.4m** under broker framework; 2022 direct **ÃÂ20.9m** non-broker + **ÃÂ47m** on broker
  - **Day rates** (incl VAT, orders 2023ÃÂJan2025): junior avg **ÃÂ672** ÃÂ· senior **ÃÂ759** ÃÂ· expert **ÃÂ923** (max **ÃÂ2,128**)
  - **Detach vs external hourly:** programmer **65.71 vs 111.43** ÃÂ· analyst **93.62 vs 126.30**; admin **ÃÂ198**/month; 21% VAT wedge
...
- FOI opened: gap_smals_broker_rates_l5 (ready, human send) ÃÂ not sent
- Next: prio5 **rq_509** (progress@520 soon); deferred **rq_116** SWA

### 2026-07-29T02:40:00Z - tick 518
- Unit: **rq_509** (FOI-adjacent hole-fill ÃÂ **CoA consultancy Ch6 101-contract procurement compliance L5 dual**)
- Found (strong primary same CoA consultancy Oct 2025, Ch6 residual):
  - **Sample 101 contracts ~ÃÂ2.2bn** incl VAT (2020-22 execution path)
  - **Non-compliance rates (of applicable contracts):** incomplete docs **63.4% / ÃÂ1.5bn** ÃÂ· no cost-benefit **78.2% / ÃÂ1.8bn** ÃÂ· need unjustified **20.8% / ÃÂ1.0bn** ÃÂ· no realistic estimate **44.6% / ÃÂ1.4bn** ÃÂ· exclusion unchecked **67.5% / ÃÂ1.7bn** ÃÂ· selection fail **39.2% / ÃÂ1.1bn** ÃÂ· abnormal prices **60.2% / ÃÂ1.4bn** ÃÂ· award decision fail **40.5% / ÃÂ1.5bn** ÃÂ· delegation **12.9% / ÃÂ586m** ÃÂ· negotiation **10.3% / ÃÂ280m** ÃÂ· forfait **8.1% / ÃÂ78m**
  - **Named overruns:** org consult **1.8?>47m** ÃÂ· SAP **10?>22m** ÃÂ· datamine **72?110m** ÃÂ· micro **0.4?10m**
...
- FOI opened: gap_cons_101_named_overruns_l5 (ready, human send) ÃÂ not sent
- Next: prio5 **rq_510** (**progress@520 next tick**); deferred **rq_116** SWA

### 2026-07-29T03:00:00Z - tick 519
- Unit: **rq_510** (FOI-adjacent hole-fill ÃÂ¢ÃÂÃÂ **CoA 2025_01 Justice digital transformation + dual IT failures**)
- Found (strong primary Rekenhof AG Jan 2025 + press/summary):
  - **Policy-cell estimate digi cost ~ÃÂ¢ÃÂÃÂ¬140m 2023** (full calc not possible multi-source)
  - **SD ICT:** commit **ÃÂ¢ÃÂÃÂ¬61.3m (2020) ÃÂ¢ÃÂÃÂ ÃÂ¢ÃÂÃÂ¬93.4m (2023)**; liq **ÃÂ¢ÃÂÃÂ¬56.5m ÃÂ¢ÃÂÃÂ ÃÂ¢ÃÂÃÂ¬80.5m**; structural path **~43ÃÂ¢ÃÂÃÂ~80m** from 2025
  - **PHV/RRF:** nearly **ÃÂ¢ÃÂÃÂ¬115m excl VAT** to 2026 for Justice digital; CoA flags eligibility misuse risk
  - **Consultants ~500:** SD ICT **92** (26 Egov) vs 145 stat (Feb23); Crossborder **228** vs **6** stat (Nov23); DTO **137** + 6 int (Dec23)
  - **JustSign/bpost irregular ÃÂ¢ÃÂÃÂ¬5.8m** (JustSign **ÃÂ¢ÃÂÃÂ¬3.1m**) without regular tender; IF-flagged regularisations
  - No single coherent strategy; DTO ends **31 Dec 2025**; cabinet ops role strong; basic admin functions weak
  - **Dual:** Justice digi stack vs I-Police **76.7/299m** ÃÂÃÂ· Persona **16m** ÃÂÃÂ· Cepage **35ÃÂ¢ÃÂÃÂ96m** ÃÂÃÂ· federal consultancy **2.5bn**
- Wrote: sources +3; budgets +14; cmt +3; lb +7; FOI **gap_justice_digi_l5** ready+draft; raw PDFs; rq_510=done spawn **rq_511**; ticks=519
- FOI opened: gap_justice_digi_l5 (ready, human send) ÃÂ¢ÃÂÃÂ not sent
- Next: prio5 **rq_511** (**progress@520 next tick**); deferred **rq_116** SWA

### 2026-07-29T03:20:00Z - tick 520
- Unit: **rq_511** (progress milestone @520 ÃÂ¢ÃÂÃÂ coverage % + waste top10; no invent euros)
- Found / inventory:
  - **A/B:** still **100%** L0/L1 on EUR 347.956bn TE
  - **C L2:** **~99%** ÃÂ¢ÃÂÃÂ BRU SEC/STIB + Justice digi + consultancy inventory layer
  - **D L5:** **~32-45%** generous ÃÂ¢ÃÂÃÂ gain 510ÃÂ¢ÃÂÃÂ520: Phoenix/customs/defence residual + consultancy **2.5bn** + Smals broker **1.8bn** + 101-sample **2.2bn** + Justice digi **140m/~500** consultants + BRU Entity II + FAM
  - **E FOI:** ready **~265** ÃÂÃÂ· answered **~9** ÃÂÃÂ· total **~277**
  - **Rows:** budgets **~9027** ÃÂÃÂ· cmt **~974** ÃÂÃÂ· lb **~1822** ÃÂÃÂ· entities **~410** ÃÂÃÂ· sources **~974** ÃÂÃÂ· rq **~506**
  - **Waste top10 change:** fossil/cars/cheque stable #1-6/#8-9; **NEW** lb_cons_no_costbenefit_18bn **#7** ÃÂÃÂ· lb_cons_101_sample_2_2bn **#10**; EIWT drops just-outside
- Wrote: progress_every_10_ticks.md ÃÂÃÂ· doge_waste_top10_current.md ÃÂÃÂ· rq_511=done spawn **rq_512**; ticks=520
- FOI: none new (progress tick)
- Next: prio5 **rq_512**; deferred **rq_116** SWA

### 2026-07-29T03:40:00Z - tick 521
- Unit: **rq_512** (FOI-adjacent hole-fill ÃÂ¢ÃÂÃÂ **CoA Justice digi residual PHV L5 three projects + JustSign licenses dual prison**)
- Found (strong primary same CoA 2025_01 residual extract):
  - **PHV pack recon:** I-2.05 digi transform **ÃÂ¢ÃÂÃÂ¬85m** ÃÂÃÂ· I-2.03 cyber NTSU/CTIF **ÃÂ¢ÃÂÃÂ¬18m** ÃÂÃÂ· I-4.09 prison platforms **ÃÂ¢ÃÂÃÂ¬12m** = **ÃÂ¢ÃÂÃÂ¬115m** excl VAT (matches prior total)
  - **JustSign licenses ~ÃÂ¢ÃÂÃÂ¬720k/yr** incl VAT (CM May 2024 bridge after bpost to underaannemers; competitive retender planned)
...
- FOI opened: gap_justice_phv_projects_l5 (ready, human send) ÃÂ¢ÃÂÃÂ not sent
- Next: prio5 **rq_513**; deferred **rq_116** SWA

### 2026-07-29T04:00:00Z - tick 522
- Unit: **rq_513** (FOI-adjacent hole-fill ÃÂ¢ÃÂÃÂ **CoA 2025_30 HR social inspection + SIOD dual multi-agency**)
- Found (strong primary Rekenhof AG Sep 2025):
  - **Extra credits ÃÂ¢ÃÂÃÂ¬18.283m (2021ÃÂ¢ÃÂÃÂ24)** for **270 VTE** social inspectors (policy notes said 248)
  - **Net staff +8.2 VTE (+0.5%)** only: inspect **+50.6** ÃÂÃÂ· support **ÃÂ¢ÃÂÃÂ42.4** (attrition/pensions)
  - FTE path: **1,622.0 ÃÂ¢ÃÂÃÂ 1,630.2**; inspect **1,200.5 ÃÂ¢ÃÂÃÂ 1,251.1**; support **421.5 ÃÂ¢ÃÂÃÂ 379.1**
  - **Wage bill ÃÂ¢ÃÂÃÂ¬127.2m ÃÂ¢ÃÂÃÂ ÃÂ¢ÃÂÃÂ¬148.1m** (+16.4%); RSZ **56.2m** ÃÂÃÂ· TSW **25.6m** ÃÂÃÂ· RVA **22.6m** ÃÂÃÂ· TWW **15.7m** ÃÂÃÂ· RSVZ **13.3m** ÃÂÃÂ· RIZIV **13.0m** ÃÂÃÂ· SIOD experts **1.8m**
  - Credit split: TSW **5.84m**/83 ÃÂÃÂ· RSZ **5.74m**/92 ÃÂÃÂ· RSVZ **2.97m**/44 ÃÂÃÂ· TWW **1.86m**/25 ÃÂÃÂ· RVA **1.58m**/22 ÃÂÃÂ· SIOD **0.22m**/3
...
- FOI opened: gap_siod_inspect_net_fte_l5 (ready, human send) ÃÂ¢ÃÂÃÂ not sent
- Next: prio5 **rq_514**; deferred **rq_116** SWA

### 2026-07-29T04:20:00Z - tick 523
- Unit: **rq_514** (FOI-adjacent hole-fill ÃÂ¢ÃÂÃÂ **CoA 2025_12 Circulaire economie BBBC RRF dual federal/regional**)
- Found (strong primary Rekenhof AG 16 Apr 2025):
  - **BBBC PHV/RRF:** **ÃÂ¢ÃÂÃÂ¬28.97m ÃÂ¢ÃÂÃÂ ÃÂ¢ÃÂÃÂ¬28m** after BE RRF envelope cut (5.9ÃÂ¢ÃÂÃÂ4.5bn)
  - **Split:** project support **ÃÂ¢ÃÂÃÂ¬23.66m** ÃÂÃÂ· SME campaign **ÃÂ¢ÃÂÃÂ¬1.32m** ÃÂÃÂ· studies/consultancy **ÃÂ¢ÃÂÃÂ¬2.3m** ÃÂÃÂ· staff **ÃÂ¢ÃÂÃÂ¬0.794m**
  - **Call 1:** **12 projects / ÃÂ¢ÃÂÃÂ¬6.98m**; selection opacity (cabinet unilateral lower awards; projects vs memo rules)
  - **Underuse risk** on remaining project envelope vs RRF mid-2026 deadline; PPP nv design abandoned ÃÂ¢ÃÂÃÂ classic subsidies
  - **Delivery:** Roadmap 21 ÃÂ¢ÃÂÃÂ **12 done / 7 partial / 2 not**; FAP 31 ÃÂ¢ÃÂÃÂ **6 full / 21 partial risk / 4 not**
...
- FOI opened: gap_bbbc_l5_cash (ready, human send) ÃÂ¢ÃÂÃÂ not sent
- Next: prio5 **rq_515**; deferred **rq_116** SWA

### 2026-07-29T04:40:00Z - tick 524
- Unit: **rq_515** (FOI-adjacent hole-fill ÃÂ¢ÃÂÃÂ **CoA 2025_05 COVID federal support follow-up dual multi-level**)
- Found (strong primary Rekenhof AG 22 Jan 2025 + press):
  - **2020:** **103 measures**, est **ÃÂ¢ÃÂÃÂ¬19.40bn**; **H1 2021 +ÃÂ¢ÃÂÃÂ¬1.15bn**
  - **Split 2020:** benefits **ÃÂ¢ÃÂÃÂ¬11.83bn (61%)** ÃÂÃÂ· tax relief **ÃÂ¢ÃÂÃÂ¬3.05bn (16%)** ÃÂÃÂ· SSC **ÃÂ¢ÃÂÃÂ¬1.06bn (5%)** (+ deferrals/guarantees/reinsurance off estimate)
  - **Recs 19:** **2 done ÃÂÃÂ· 9 in progress ÃÂÃÂ· 6 not done ÃÂÃÂ· 2 not assessed**
...
- FOI opened: gap_covid_support_outturn_l5 (ready, human send) ÃÂ¢ÃÂÃÂ not sent
- Next: prio5 **rq_516**; deferred **rq_116** SWA

### 2026-07-29T05:00:00Z - tick 525
- Unit: **rq_516** (FOI-adjacent hole-fill ÃÂ¢ÃÂÃÂ **CoA kentekenplaten concession 240m + follow-up 0/17 recs dual bpost**)
- Found (strong primary CoA 2022_11 + 2024 press; secondary procurement summary 2025_03):
  - **Concession 2:** est **ÃÂ¢ÃÂÃÂ¬240m**, bpost, 1 Aug 2019ÃÂ¢ÃÂÃÂmax 31 Jul 2025; **sole bidder** (incumbent advantage in spec)
  - **User fee ÃÂ¢ÃÂÃÂ¬30**/plate+cert; costs shifted to owners; claimed admin save **ÃÂ¢ÃÂÃÂ¬3.8m** + **13 VTE**
  - DIV net receipts **ÃÂ¢ÃÂÃÂ¥ÃÂ¢ÃÂÃÂ¬44m** 2012ÃÂ¢ÃÂÃÂ18 (cum class **~ÃÂ¢ÃÂÃÂ¬70m**); 2021 receipts **ÃÂ¢ÃÂÃÂ¬9.82m** vs costs **ÃÂ¢ÃÂÃÂ¬8.67m**
  - Annual prod+dist class **ÃÂ¢ÃÂÃÂ¬28.9m** excl VAT; penalty paid **ÃÂ¢ÃÂÃÂ¬2m** (CoA: ÃÂ¢ÃÂÃÂ¥**ÃÂ¢ÃÂÃÂ¬2.5m** due); schrapping stream **~ÃÂ¢ÃÂÃÂ¬50m** class
  - **Follow-up 2024:** of **17 recs ÃÂ¢ÃÂÃÂ 0 done ÃÂÃÂ· 4 in progress ÃÂÃÂ· 5 none ÃÂÃÂ· 8 n/a**; **DIV refused documents** to CoA
  - **Secondary:** federal procurement sample **267 dossiers / ÃÂ¢ÃÂÃÂ¬989.7m** ex VAT (Ypto/TUC Rail systemic fails dual rail IT)
...
- FOI opened: gap_kenteken_concessie3_l5 (ready, human send) ÃÂ¢ÃÂÃÂ not sent
- Next: prio5 **rq_517**; deferred **rq_116** SWA

### 2026-07-29T05:20:00Z - tick 526
- Unit: **rq_517** (FOI-adjacent hole-fill ÃÂ¢ÃÂÃÂ **CoA 2025_03 procurement entity residual Ypto/TUC/Infrabel dual rail**)
- Found (strong primary residual same CoA procurement summary Dec 2024):
  - **Totals (prior):** 267 dossiers **ÃÂ¢ÃÂÃÂ¬989.7m** excl VAT ÃÂÃÂ· invoices **ÃÂ¢ÃÂÃÂ¬44.9m**
  - **FOD Economie:** 40d **ÃÂ¢ÃÂÃÂ¬27.3m** of ~50m (consultancy **ÃÂ¢ÃÂÃÂ¬21.6m**)
  - **Federal Police:** 35d **ÃÂ¢ÃÂÃÂ¬45.7m** of **ÃÂ¢ÃÂÃÂ¬225.8m** (IT supplies **31.7** ÃÂÃÂ· IT consult **9.7** ÃÂÃÂ· other **4.3**)
  - **SCK CEN:** 40d **ÃÂ¢ÃÂÃÂ¬108.9m** of **ÃÂ¢ÃÂÃÂ¬175.2m** PO>20k 2022
  - **FOD WASO:** 20d **ÃÂ¢ÃÂÃÂ¬4.3m**
  - **Beliris:** 35 forms **ÃÂ¢ÃÂÃÂ¬87.5m** of **ÃÂ¢ÃÂÃÂ¬101.3m** since 2020 (dual federal-BRU)
  - **Infrabel:** 40 contracts **ÃÂ¢ÃÂÃÂ¬550m** excl VAT (largest **214m** ÃÂÃÂ· cables **75.6m** ÃÂÃÂ· consultancy **ÃÂ¢ÃÂÃÂ¥10.5m**)
  - **Ypto:** does **not correctly apply** procurement law; awards class **>ÃÂ¢ÃÂÃÂ¬154m**; orders **~ÃÂ¢ÃÂÃÂ¬35.7m** class
  - **TUC Rail:** **>half** own-need purchases **without tender**; frameworks class **>ÃÂ¢ÃÂÃÂ¬39m**
...
- FOI opened: gap_rail_proc_ypto_tuc_l5 (ready, human send) ÃÂ¢ÃÂÃÂ not sent
- Next: prio5 **rq_518** (progress@530 soon); deferred **rq_116** SWA

### 2026-07-29T05:40:00Z - tick 527
- Unit: **rq_518** (FOI-adjacent hole-fill ÃÂ¢ÃÂÃÂ **CoA 2024_55 company-car COÃÂ¢ÃÂÃÂ SSC + mobility budget dual taxex**)
- Found (strong primary Rekenhof AG 30 Oct 2024 + press):
  - **Receipts 2022: ÃÂ¢ÃÂÃÂ¬278.52m** COÃÂ¢ÃÂÃÂ contribution (+12% vs 2008) for **560,941** vehicles (+82%)
  - Avg per vehicle **ÃÂ¢ÃÂÃÂ¬802 ÃÂ¢ÃÂÃÂ ÃÂ¢ÃÂÃÂ¬497** (ÃÂ¢ÃÂÃÂ38%); cumulative target gap **ÃÂ¢ÃÂÃÂ¬958m** 2008ÃÂ¢ÃÂÃÂ2022
  - Gap vs ordinary employer SSC on wage-equivalent **>ÃÂ¢ÃÂÃÂ¬1bn by 2026** (min COÃÂ¢ÃÂÃÂ generalisation)
  - **Febiac 1.105m** legal-person vehicles vs RSZ **578k** Q4 2022; leasing opacity; DIV data unused
  - **WLTP/NEDC gaming ~ÃÂ¢ÃÂÃÂ¬74.3m** cost to SS 2022; under-declaration risk **ÃÂ¢ÃÂÃÂ¥ÃÂ¢ÃÂÃÂ¬22m/yr** (band 4ÃÂ¢ÃÂÃÂ32m)
  - Mobility budget still **marginal** (~50ÃÂÃÂ fewer users than company cars); special contrib class **~ÃÂ¢ÃÂÃÂ¬15.5m** 2023
...
- FOI opened: gap_co2_bijdrage_div_cross_l5 (ready, human send) ÃÂ¢ÃÂÃÂ not sent
- Next: prio5 **rq_519** (**progress@530 next tick**); deferred **rq_116** SWA

### 2026-07-29T06:00:00Z - tick 528
- Unit: **rq_519** (FOI-adjacent hole-fill ÃÂ¢ÃÂÃÂ **CoA residual mobiliteitsbudget L5 dual company cars**)
- Found (strong primary same CoA 2024_55 Ch5 residual):
  - **MB 2023 total ÃÂ¢ÃÂÃÂ¬72.0m** for **10,250 workers** / **1,155 employers** (was ÃÂ¢ÃÂÃÂ¬0.65m / 141 in 2019)
  - **~50ÃÂÃÂ fewer** users than company-car COÃÂ¢ÃÂÃÂ fleet (**560,941** vehicles)
  - **Pillar 2 ÃÂ¢ÃÂÃÂ¬50.82m** (8,329 workers) ÃÂ¢ÃÂÃÂ practical use opaque (housing rent/mortgage heavy in studies)
  - **Pillar 3 ÃÂ¢ÃÂÃÂ¬15.54m** (21% of total; 6,551 workers) ÃÂ¢ÃÂÃÂ 38.07% special SSC limited deterrent
  - **SSC both pillars ÃÂ¢ÃÂÃÂ¬6.22m** 2023 (~2% of COÃÂ¢ÃÂÃÂ-class receipts)
  - Pillar 1 cars Q4 2023 only **947**; cap **ÃÂ¢ÃÂÃÂ¬16k/yr** and **1/5** gross wage
  - Residual: COÃÂ¢ÃÂÃÂ contrib **ÃÂ¢ÃÂÃÂ¬59.1m** from <20-staff employers (21%) without systematic control
...
- FOI opened: gap_mb_pillar2_use_l5 (ready, human send) ÃÂ¢ÃÂÃÂ not sent
- Next: prio5 **rq_520** (**progress@530 next tick**); deferred **rq_116** SWA

### 2026-07-29T06:15:00Z - tick 529
- Unit: **rq_520** (FOI-adjacent hole-fill ÃÂ¢ÃÂÃÂ **CoA 2025_33 MÃÂÃÂ©tro 3 BRU dual STIB+Beliris**)
- Found (strong primary Cour des comptes AG 8 Oct 2025 + press/synthÃÂÃÂ¨se):
  - **Total Dec2024: ÃÂ¢ÃÂÃÂ¬4,759.7m** vs **ÃÂ¢ÃÂÃÂ¬824.2m** 2012 (**+ÃÂ¢ÃÂÃÂ¬3,935.5m / +477%**); service **2035** (was 2020)
  - Segments: Nord-Albert class **ÃÂ¢ÃÂÃÂ¬1,323.1m** ÃÂÃÂ· Nord-Bordet **ÃÂ¢ÃÂÃÂ¬3,102.8m** ÃÂÃÂ· Bordet full **ÃÂ¢ÃÂÃÂ¬3,436.6m** (lot3 1,698.9+risk 254.8)
  - **Spent EOY2024: ÃÂ¢ÃÂÃÂ¬421.3m** (NA 316.4 + BN 104.9); remaining works **ÃÂ¢ÃÂÃÂ¬4,338.4m**
  - **Beliris:** envelope 516.3m ÃÂÃÂ· financed **464.4m** ÃÂÃÂ· **402.7m diverted** other metro ÃÂÃÂ· residual **51.9m**
  - **BCR financing gap ~ÃÂ¢ÃÂÃÂ¬4,286.5m** (~4bn class; >2/3 2024 receipts)
  - **EIB loan ÃÂ¢ÃÂÃÂ¬475m** 25y (draw by Dec 2027; need ÃÂ¢ÃÂÃÂ¥950m invest)
  - STIB scenarios: A **4,375** ÃÂÃÂ· A-PPP **7,743** ÃÂÃÂ· B **1,653** ÃÂÃÂ· C pause **4,807** ÃÂÃÂ· E stop **1,002**
...
- FOI opened: gap_metro3_cash_by_year_l5 (ready, human send) ÃÂ¢ÃÂÃÂ not sent
- Next: prio5 **rq_521** (**progress@530 THIS next tick**); deferred **rq_116** SWA

### 2026-07-29T06:30:00Z - tick 530
- Unit: **rq_521** (**progress milestone** ÃÂ¢ÃÂÃÂ coverage % layers A-E + waste top10 refresh)
- Progress snapshot (tick 530):
  - A/B still **100%**; C **~99%**; D **~33-46%** generous TE share (structural payroll/debt not L5)
  - Inventory: budgets **~9144** ÃÂÃÂ· cmt **~1002** ÃÂÃÂ· lb **~1879** ÃÂÃÂ· entities **~414** ÃÂÃÂ· sources **~1003** ÃÂÃÂ· FOI ready **~274** / answered **~9** / total **~286** ÃÂÃÂ· rq **~516**
  - Gain 520ÃÂ¢ÃÂÃÂ530: SIOD HR leakage ÃÂÃÂ· BBBC/COVID residual ÃÂÃÂ· plates 0/17 ÃÂÃÂ· rail Ypto/TUC ÃÂÃÂ· CO2/MB dual cars ÃÂÃÂ· **Metro3 4.76bn +477%** dual STIB+Beliris
...
- Wrote: progress_every_10_ticks.md ÃÂÃÂ· doge_waste_top10_current.md ÃÂÃÂ· lb Metro3 annual fix ÃÂÃÂ· rq_521=done spawn **rq_522**; ticks=530
- FOI: none new (progress tick)
- Next: prio5 **rq_522** hole-fill; deferred **rq_116** SWA

### 2026-07-29T06:45:00Z - tick 531
- Unit: **rq_522** (FOI-adjacent hole-fill ÃÂ¢ÃÂÃÂ **CoA 2025_49 SECAL/DAVO suivi dual Finance+Justice**)
- Found (strong primary Cour des comptes AG 26 Nov 2025 + press 16 Dec 2025):
  - **Advances 2024: ÃÂ¢ÃÂÃÂ¬38.79m** for **21,188** children (path 26.2m 2015 ÃÂ¢ÃÂÃÂ 31.3m 2020 ÃÂ¢ÃÂÃÂ 38.8m 2024)
  - **Dossiers:** new **5,378** 2024; active EOY **23,955** (ÃÂÃÂ2.6 since 2007); online apps 550ÃÂ¢ÃÂÃÂ3400+ (2021-24)
  - **Recovery 12m: 26.6%** 2024 / **32.9%** first 8m 2025; cumulative rate lost (was **29.25%** EOY2018)
  - **Stock EOY2024: ÃÂ¢ÃÂÃÂ¬452.7m** with **impairment ÃÂ¢ÃÂÃÂ¬403.3m** (~89%); CoA questions accounting reliability
  - **Undue advances:** ÃÂ¢ÃÂÃÂ¬1.558m / 1,599 dossiers Jun2023-Jun2025; ~2/3 recovered; fraud 100% path never used
  - **Recs 2019:** 5 done ÃÂÃÂ· 9 progress ÃÂÃÂ· 3 not ÃÂÃÂ· 1 n/a + **8 new** recs 2025; eval commission reports missing 2011-23
...
- FOI opened: gap_secal_recovery_kpi_l5 (ready, human send) ÃÂ¢ÃÂÃÂ not sent
- Next: prio5 **rq_523**; deferred **rq_116** SWA

### 2026-07-29T07:00:00Z - tick 532
- Unit: **rq_523** (FOI-adjacent hole-fill ÃÂ¢ÃÂÃÂ **CoA Taxe CaÃÂÃÂ¯man 2023 + suivi 2025 dual federal/regions**)
- Found (strong primary CoA 2023_13 + 2026_01 suivi AG 10 Dec 2025 + press 12 Jan 2026):
  - **Budget estimates:** **ÃÂ¢ÃÂÃÂ¬50m** 2015 ÃÂÃÂ· **ÃÂ¢ÃÂÃÂ¬460m** 2016; no separate line from 2017; **+ÃÂ¢ÃÂÃÂ¬50m** 2.0 path 2018
  - **Indicative realized class:** **ÃÂ¢ÃÂÃÂ¬160.98m** (spontaneous PM + controls) ÃÂÃÂ· **ÃÂ¢ÃÂÃÂ¬181.37m** incl leak dossiers ÃÂ¢ÃÂÃÂ well below early budgets
  - **Agisi:** 45 cases ÃÂÃÂ· enrolled **ÃÂ¢ÃÂÃÂ¬92.44m** ÃÂÃÂ· collected **ÃÂ¢ÃÂÃÂ¬11.25m (12.17%)** by Jun 2022
  - **AGFisc:** fines non-declaration **ÃÂ¢ÃÂÃÂ¬2.06m** + tax supplements **ÃÂ¢ÃÂÃÂ¬0.65m**
  - **Suivi 2025 recs:** **6 done ÃÂÃÂ· 4 progress ÃÂÃÂ· 4 not** of 14; annex **276 CJC** (measure method) but AGESS still no receipt calc to CoA
...
- FOI opened: gap_caiman_receipts_l5 (ready, human send) ÃÂ¢ÃÂÃÂ not sent
- Next: prio5 **rq_524**; deferred **rq_116** SWA

### 2026-07-29T07:15:00Z - tick 533
- Unit: **rq_524** (FOI-adjacent hole-fill ÃÂ¢ÃÂÃÂ **CoA 2025_25 gecombineerde vergunning dual DEM+DVZ**)
- Found (strong primary Rekenhof AG 2 Jul 2025 + press):
  - **2023 DEM:** apps **17,072** (first 9,031 + renew 8,041) ÃÂÃÂ· grants **11,764** ÃÂÃÂ· refusals **1,903 (11.14%)** ÃÂÃÂ· withdrawals **779**
  - Refuse rate jump from **~3.2ÃÂ¢ÃÂÃÂ3.7%** 2019-22 after fraud/Borealis/visa signals
  - First-app path class **4.8kÃÂ¢ÃÂÃÂ10.0kÃÂ¢ÃÂÃÂ8.9k** 2019-23
  - **DVZ BE first-app positives:** 5,251 / 9,540 / 9,967 (2021-23); refuse **~1%**
  - **DEM staff:** 26+14 VTE 2023 ÃÂ¢ÃÂÃÂ **35.6** Mar 2024 (18 handlers); backlog remains; DVZ wait times not disclosed
  - **VSI:** 19.56 VTE econ mig 2023; 1,865 investigations; DEM-requested 262; +11 inspectors Dec 2024 path
  - **Fines AG:** ÃÂ¢ÃÂÃÂ¬54k / ÃÂ¢ÃÂÃÂ¬123k / ÃÂ¢ÃÂÃÂ¬56k 2021-23; practice **ÃÂ¢ÃÂÃÂ¬2ÃÂ¢ÃÂÃÂ4k** low end of statutory fork; deterrent untested
...
- FOI opened: gap_gv_volumes_kpi_l5 (ready, human send) ÃÂ¢ÃÂÃÂ not sent
- Next: prio5 **rq_525**; deferred **rq_116** SWA

### 2026-07-29T07:30:00Z - tick 534
- Unit: **rq_525** (FOI-adjacent hole-fill ÃÂ¢ÃÂÃÂ **Kamer exposÃÂÃÂ© 2026 Table41 DBFM prison invest fees residual**)
- Found (strong primary DOC 56 1278/001 Table41 + CoA residual context):
  - **Haren:** quarterly **ÃÂ¢ÃÂÃÂ¬7.3m** ÃÂÃÂ· annual **ÃÂ¢ÃÂÃÂ¬29.4m** ÃÂÃÂ· 25y **ÃÂ¢ÃÂÃÂ¬733.9m** ÃÂÃÂ· paid **ÃÂ¢ÃÂÃÂ¬91.0m** ÃÂÃÂ· remain **ÃÂ¢ÃÂÃÂ¬638.5m** (87q)
  - **Beveren:** annual **ÃÂ¢ÃÂÃÂ¬9.1m** ÃÂÃÂ· 25y **ÃÂ¢ÃÂÃÂ¬228.7m** ÃÂÃÂ· paid **ÃÂ¢ÃÂÃÂ¬107.7m** ÃÂÃÂ· remain **ÃÂ¢ÃÂÃÂ¬121.0m**
  - **Marche-en-Famenne:** annual **ÃÂ¢ÃÂÃÂ¬6.9m** ÃÂÃÂ· 25y **ÃÂ¢ÃÂÃÂ¬172.3m** ÃÂÃÂ· paid **ÃÂ¢ÃÂÃÂ¬84.4m** ÃÂÃÂ· remain **ÃÂ¢ÃÂÃÂ¬87.9m**
  - **Leuze-en-Hainaut:** annual **ÃÂ¢ÃÂÃÂ¬7.5m** ÃÂÃÂ· 25y **ÃÂ¢ÃÂÃÂ¬188.6m** ÃÂÃÂ· paid **ÃÂ¢ÃÂÃÂ¬86.7m** ÃÂÃÂ· remain **ÃÂ¢ÃÂÃÂ¬101.9m**
  - **4 prisons sum:** annual **~ÃÂ¢ÃÂÃÂ¬53m** ÃÂÃÂ· 25y **~ÃÂ¢ÃÂÃÂ¬1.32bn** ÃÂÃÂ· paid **~ÃÂ¢ÃÂÃÂ¬370m** EOY2025 ÃÂÃÂ· remain **~ÃÂ¢ÃÂÃÂ¬950m**
  - **Antwerp:** annual **ÃÂ¢ÃÂÃÂ¬17.1m** (Q1 2026 start); 25y total still under construction
  - **Dendermonde:** variable fee; paid **>ÃÂ¢ÃÂÃÂ¬26.5m** since end-2022; annual/25y not fixed
  - **Residual:** maintenance/waste/laundry/catering fees still omitted (price revision); off-balance booking still open CoA rec10
- Wrote: sources +2; budgets +11; cmt +2; lb +6; FOI **gap_dbfm_maint_facility_fees_l5** ready+draft; updated prior gap_dbfm_fees note; raw exposÃÂÃÂ© PDF; rq_525=done spawn **rq_526**; ticks=534
...
- Unit: **rq_526** (FOI-adjacent hole-fill ÃÂ¢ÃÂÃÂ **CoA 2024_42 TACT annual securities-account tax dual wealth**)
- Found (strong primary Cour des comptes + press/synthÃÂÃÂ¨se Oct 2024):
  - **Due:** p1 **ÃÂ¢ÃÂÃÂ¬470.203m** ÃÂÃÂ· p2 **ÃÂ¢ÃÂÃÂ¬395.391m** (ÃÂ¢ÃÂÃÂ16%) ÃÂÃÂ· p3 prov **ÃÂ¢ÃÂÃÂ¬362.103m** (further decline)
  - **Budget est:** 2021 **ÃÂ¢ÃÂÃÂ¬397.8m** (actual above) ÃÂÃÂ· 2022 **ÃÂ¢ÃÂÃÂ¬428.6m** (actual below)
  - **Two periods net:** due after restitutions **ÃÂ¢ÃÂÃÂ¬859.2m** ÃÂÃÂ· perceived end-Aug 2023 **ÃÂ¢ÃÂÃÂ¬814.4m**
  - **Restitutions ÃÂ¢ÃÂÃÂ¬6.39m** (~80% nominative conversion + cash; ~80% conversion claims accepted)
  - Self-declarers **ÃÂ¢ÃÂÃÂ¬20.2m ÃÂ¢ÃÂÃÂ ÃÂ¢ÃÂÃÂ¬15.6m** (ÃÂ¢ÃÂÃÂ23%); foreign accounts not systematically matched
  - Const Court Oct 2022 annulled irrefragable anti-abuse (account split + nominative conversion)
  - No digital filing / First incomplete ÃÂ¢ÃÂÃÂ risk analysis & evaluation excluded until digitisation **ÃÂ¢ÃÂÃÂ¤2028**
  - Rate remains **0.15%** threshold **ÃÂ¢ÃÂÃÂ¬1m** (budget 2026 double to 0.30 / +ÃÂ¢ÃÂÃÂ¬414m path prior fill)
...
- FOI opened: gap_tact_digital_kpi_l5 (ready, human send) ÃÂ¢ÃÂÃÂ not sent
- Next: prio5 **rq_527**; deferred **rq_116** SWA

### 2026-07-29T08:00:00Z - tick 536
- Unit: **rq_527** (FOI-adjacent hole-fill ÃÂ¢ÃÂÃÂ **Kamer exposÃÂÃÂ© 2026 spending reviews + Entity I invest Table40**)
- Found (strong primary DOC 56 1278/001 ÃÂÃÂ§4ÃÂ¢ÃÂÃÂÃÂÃÂ§5):
  - **WASO postal SR:** credits **ÃÂ¢ÃÂÃÂ¬430k (2024) ÃÂ¢ÃÂÃÂ ÃÂ¢ÃÂÃÂ¬50k (2026)**; federal recurrent save band **ÃÂ¢ÃÂÃÂ¬15ÃÂ¢ÃÂÃÂ67.5m** (eBox invest not netted)
  - **Fedasil open centres SR:** flexible specialist model potential **ÃÂ¢ÃÂÃÂ¬1.1m/yr**; CM 3 Oct 2025 action plan path
  - **Return / closed centres:** CM Feb 2025 efficiency path to **ÃÂ¢ÃÂÃÂ¬150m by 2029**; linear **1.8%** opex+personnel; SR 2026 in progress
  ...
  - **Table40 Entity I invest 2026:** direct **ÃÂ¢ÃÂÃÂ¬5,174m** ÃÂÃÂ· GCF ESA **ÃÂ¢ÃÂÃÂ¬6,612m** ÃÂÃÂ· NMBS aid **ÃÂ¢ÃÂÃÂ¬1,094m** ÃÂÃÂ· gov-supported **ÃÂ¢ÃÂÃÂ¬7,706m (1.2% GDP)**; path 2025-29 to **ÃÂ¢ÃÂÃÂ¬8,344m**
- Wrote: sources +2; budgets +12; cmt +3; lb +7; FOI **gap_sr_save_delivery_l5** ready+draft; rq_527=done spawn **rq_528**; ticks=536
- FOI opened: gap_sr_save_delivery_l5 (ready, human send) ÃÂ¢ÃÂÃÂ not sent
- Next: prio5 **rq_528**; deferred **rq_116** SWA

### 2026-07-29T08:15:00Z - tick 537
- Unit: **rq_528** (FOI-adjacent hole-fill ÃÂ¢ÃÂÃÂ **Kamer exposÃÂÃÂ© 2026 vergrijzingsnota SCvV Jul2025 + policy dual E1/E2**)
- Found (strong primary DOC 56 1278/001 Ch2 + SCvV Jul2025 via exposÃÂÃÂ©):
  - **Social exp % GDP:** **25.8% (2024) ÃÂ¢ÃÂÃÂ 26.3% (2030) ÃÂ¢ÃÂÃÂ 27.6% (2050) ÃÂ¢ÃÂÃÂ 27.5% (2070)**; aging cost **+1.7 pp** 2024-70
  - **vs 2024 SCvV report:** cost **1.9 pp GDP lower** mainly pension reform (ÃÂ¢ÃÂÃÂ1.3pp) + UI time-limit (ÃÂ¢ÃÂÃÂ0.4pp)
  - **Pensions:** 11.3 ÃÂ¢ÃÂÃÂ 12.2 pct (+0.9); employees 6.6 public 3.8 self 0.9 (2024)
  - **Healthcare:** 8.0 ÃÂ¢ÃÂÃÂ 10.1 pct (+2.1) dominates long-run rise
  - **Unemployment:** 1.0 ÃÂ¢ÃÂÃÂ 0.4 pct (ÃÂ¢ÃÂÃÂ0.6) incl SWT
  - **Dual E1/E2:** E1 social 21.7% (+1.3pp to 2070) vs E2 4.2% (+0.4pp); federal pensions+health vs regional family benefits
  - **Policy path (medium):** exp control **>ÃÂ¢ÃÂÃÂ¬2.7bn by 2029**; LT-sick **>ÃÂ¢ÃÂÃÂ¬1.9bn by 2029** (>500k persons); SME + social cohesion envelopes **ÃÂ¢ÃÂÃÂ¬8.5m each 2026 ÃÂ¢ÃÂÃÂ ÃÂ¢ÃÂÃÂ¬15m 2029**
- Wrote: sources +2; budgets +14; cmt +3; lb +7; FOI **gap_aging_reform_cash_l5** ready+draft; rq_528=done spawn **rq_529**; ticks=537
- FOI opened: gap_aging_reform_cash_l5 (ready, human send) ÃÂ¢ÃÂÃÂ not sent
- Next: prio5 **rq_529**; deferred **rq_116** SWA

### 2026-07-29T08:30:00Z - tick 538
- Unit: **rq_529** (FOI-adjacent hole-fill ÃÂ¢ÃÂÃÂ **Kamer exposÃÂÃÂ© Graph1 dual federal/SS flows + Entity I Table3 saldo**)
- Found (strong primary DOC 56 1278/001 Graph1 + Tables 3ÃÂ¢ÃÂÃÂ4):
  - **Graph1 federal (2026 bn):** receipts **173.7** (fiscal **164.3**: IPP **64.2** VAT **45.1** CIT **26.0** excises **11.2** RV **8.0**); nonfiscal **9.4**
  - **Transfers out:** Entity II **81.5** ÃÂÃÂ· SS **54.3** ÃÂÃÂ· EU **9.1** ÃÂ¢ÃÂÃÂ **available federal only 27.5**
  - **Graph1 SS:** total=available **148.0** (SSC **85.5** + federal **54.3** + federated **0.4** + other **7.8**)
  - **Table3 Entity I 2026:** receipts **201.98bn** ÃÂÃÂ· primary exp **215.88bn** ÃÂÃÂ· primary saldo **ÃÂ¢ÃÂÃÂ12.47bn** ÃÂÃÂ· interest **12.17bn** ÃÂÃÂ· financing saldo **ÃÂ¢ÃÂÃÂ24.64bn (ÃÂ¢ÃÂÃÂ3.7% GDP)** vs **ÃÂ¢ÃÂÃÂ23.05bn (ÃÂ¢ÃÂÃÂ3.6%)** 2025
  - Defence ESR corr **ÃÂ¢ÃÂÃÂ1.9bn** less favourable 2026 + EU GNI **+1.2bn**; unallocated measures **+1.425bn (0.2% GDP)**
  - Defence effort save fill **ÃÂ¢ÃÂÃÂ¬250m 2026 ÃÂ¢ÃÂÃÂ ÃÂ¢ÃÂÃÂ¬1bn** path
- Wrote: sources +2; budgets +23; cmt +3; lb +7; FOI **gap_e1_unallocated_measures_l5** ready+draft; rq_529=done spawn **rq_530**; ticks=538
- FOI opened: gap_e1_unallocated_measures_l5 (ready, human send) ÃÂ¢ÃÂÃÂ not sent
- Next: prio5 **rq_530** (progress@540 soon); deferred **rq_116** SWA

### 2026-07-29T08:45:00Z - tick 539
- Unit: **rq_530** (FOI-adjacent hole-fill - **Kamer exposÃÂÃÂ© 2026 federal primary by dept Tables1-5 + econ Table6 + COFOG Table7 + interest**)
- Found (strong primary DOC 56 1278/001 Part III Ch3):
  - **Primary VEK 2026:** **ÃÂ¢ÃÂÃÂ¬99.656bn** (+6.5% vs adj 2025 ÃÂ¢ÃÂÃÂ¬93.855bn)
  - **Primary VLK 2026:** **ÃÂ¢ÃÂÃÂ¬90.949bn** (-0.9% vs adj ÃÂ¢ÃÂÃÂ¬91.774bn) - dual commit backlog **~ÃÂ¢ÃÂÃÂ¬8.7bn**
  - **Defence dual:** VEK **ÃÂ¢ÃÂÃÂ¬20.112bn** (+56.5%) vs VLK **ÃÂ¢ÃÂÃÂ¬10.770bn** (+3.3%) - backlog **~ÃÂ¢ÃÂÃÂ¬9.3bn**
  - **SS dept** ÃÂ¢ÃÂÃÂ¬30.724bn (-1.0%); evenwichtsdotaties -ÃÂ¢ÃÂÃÂ¬1.122bn; FPD +ÃÂ¢ÃÂÃÂ¬531m; handicap +ÃÂ¢ÃÂÃÂ¬194m
  - **Dotaties** ÃÂ¢ÃÂÃÂ¬17.744bn; **BNI EU** ÃÂ¢ÃÂÃÂ¬4.994bn (+30.2%); **Finance** -ÃÂ¢ÃÂÃÂ¬3.007bn (IMF capital 2025 ÃÂ¢ÃÂÃÂ¬2.945bn base effect)
  - **Provisions VLK ÃÂ¢ÃÂÃÂ¬2.128bn:** interdept 829.7 (justice 618.3 + bpost 78 + Fedasil 100 + vulnerable 33.5); Ukraine 442.8; security 366.9; index 485.2
  - **Econ class VLK:** SS transfers **ÃÂ¢ÃÂÃÂ¬26.530bn (29.2%)** ÃÂÃÂ· C&R **ÃÂ¢ÃÂÃÂ¬17.948bn (19.7%)** ÃÂÃÂ· wages 8.3 ÃÂÃÂ· foreign 6.6 ÃÂÃÂ· autonomous 5.9 ÃÂÃÂ· ops 5.2 ÃÂÃÂ· invest 5.0
  - **COFOG VLK:** gen admin **ÃÂ¢ÃÂÃÂ¬41.169bn (45.3%)** ÃÂÃÂ· social **ÃÂ¢ÃÂÃÂ¬24.176bn (26.6%)** ÃÂÃÂ· defence **ÃÂ¢ÃÂÃÂ¬10.879bn (12.0%)** ÃÂÃÂ· order 6.4 ÃÂÃÂ· econ 6.4
  - **Federal interest:** 2025 **ÃÂ¢ÃÂÃÂ¬10.944bn** (1.7% GDP) ÃÂÃÂ· 2026 **ÃÂ¢ÃÂÃÂ¬12.343bn** (+ÃÂ¢ÃÂÃÂ¬1.399bn)
...
- Unit: **rq_531** (FOI-adjacent hole-fill + **progress@540** - **Kamer exposÃÂÃÂ© ODA dual multi-actor + federal interest/debt financing schema**)
- Found (strong primary DOC 56 1278/001 Part III Afdeling 2-3):
  - **ODA total:** 2022 **ÃÂ¢ÃÂÃÂ¬2.532bn (0.45%)** ÃÂÃÂ· 2023 **2.604 (0.44)** ÃÂÃÂ· 2024 **2.990 (0.48 peak)** ÃÂÃÂ· 2025 **2.392 (0.37)** ÃÂÃÂ· 2026 **2.350 (0.35% GNI)**
  - **DGD 2026:** VEK **ÃÂ¢ÃÂÃÂ¬654m** / VLK **ÃÂ¢ÃÂÃÂ¬1.040bn**; ODA-eligible DGD **ÃÂ¢ÃÂÃÂ¬1.031bn**; **25%** cut path; DGD share **48%** of ODA 2024 (was 60% 2020)
  - **Multi-actor dual:** EC share **ÃÂ¢ÃÂÃÂ¬897m 2026** ÃÂÃÂ· Fedasil **ÃÂ¢ÃÂÃÂ¬437m 2024 ÃÂ¢ÃÂÃÂ ÃÂ¢ÃÂÃÂ¬234m 2026** ÃÂÃÂ· Foreign **ÃÂ¢ÃÂÃÂ¬92m** ÃÂÃÂ· Finance **ÃÂ¢ÃÂÃÂ¬16m** ÃÂÃÂ· non-fed **ÃÂ¢ÃÂÃÂ¬83m**
  - **Interest series:** trough **ÃÂ¢ÃÂÃÂ¬6.93bn 2022** ÃÂ¢ÃÂÃÂ **10.03 2024** ÃÂ¢ÃÂÃÂ **10.94 2025** ÃÂ¢ÃÂÃÂ **12.34bn 2026 (1.86% GDP)**; Treasury **12.165** + consol **55** + FPS Fin **124**
  - **Financing 2026:** gross **ÃÂ¢ÃÂÃÂ¬59.7bn** (net **28.5** + maturing **28.0** + prefin **3.2**); OLO **ÃÂ¢ÃÂÃÂ¬52bn** of LT **55.3**; wavg rate **3.83%** / maturity **16.04y**
  - **Unconsol fed debt:** eoy2024 **ÃÂ¢ÃÂÃÂ¬540.7bn (87.2%)** ÃÂ¢ÃÂÃÂ 2025 **570.2 (88.7%)** ÃÂ¢ÃÂÃÂ 2026 **601.3bn (90.8% GDP)**
...
- Unit: **rq_532** (FOI-adjacent hole-fill - **Kamer exposÃÂÃÂ© Ch4 dual federalÃÂ¢ÃÂÃÂC&R/SS/local Tables 1-5**)
- Found (strong primary DOC 56 1278/001 Part III Ch4):
  - **C&R total 2026:** **ÃÂ¢ÃÂÃÂ¬76.810bn** (C **50.418** + R **26.392**); 2025 **75.534**; 2024 **73.206**
  - **Communities:** VL **ÃÂ¢ÃÂÃÂ¬30.769bn** ÃÂÃÂ· FR **17.612** ÃÂÃÂ· DG **0.345** ÃÂÃÂ· GGC **1.576**; VAT **22.504** ÃÂÃÂ· PB **10.942**; family **9.170** ÃÂÃÂ· eldercare **5.677**
  - **Regions:** VL **~12.729** ÃÂÃÂ· WAL **~9.257** ÃÂÃÂ· BRU **~4.405** (credits heavy on BRU **438.5m** incl mobility **195** city **146**)
  - **SS federal means 2026:** **ÃÂ¢ÃÂÃÂ¬53.879bn** (credits **26.554** + fiscal **27.325**); employees **8.335** ÃÂÃÂ· self-emp **1.076** ÃÂÃÂ· public pensions **16.150**; dual Graph1 **54.3**
  - **Local 2026:** **ÃÂ¢ÃÂÃÂ¬4.257bn** (leefloon **2.085** ÃÂÃÂ· police **1.271** ÃÂÃÂ· refugees **0.156** ÃÂÃÂ· capital **0.207**)
  - **Dual gap:** Graph1 E2 **81.5** vs Table1 C&R **76.8** (~**ÃÂ¢ÃÂÃÂ¬4.7bn** perimeter)
...
- Unit: **rq_533** (FOI-adjacent hole-fill - **Kamer exposÃÂÃÂ© EU Table6 + consol institutions Ch5 dual**)
- Found (strong primary DOC 56 1278/001 Part III Ch4ÃÂÃÂ§4 + Ch5):
  - **EU financing 2026:** total **ÃÂ¢ÃÂÃÂ¬9.145bn** (customs **3.402** + VAT **0.748** = receipts **4.150** + GNI **4.994**); 2025 **7.869**; dual Graph1 **9.1**
  - **GNI** +**ÃÂ¢ÃÂÃÂ¬1.159bn** YoY drives total rise; customs rising post-2023 dip
  - **Consol orgs 2026:** receipts **ÃÂ¢ÃÂÃÂ¬10.991bn** ÃÂÃÂ· exp **ÃÂ¢ÃÂÃÂ¬9.976bn** ÃÂÃÂ· ESA saldo **+ÃÂ¢ÃÂÃÂ¬1.392bn** (+691 vs 2025 **+0.701**)
  - Receipts mix: institutional group dots **57.4%** ÃÂÃÂ· goods/services **21.4%** ÃÂÃÂ· property **12.2%**
  - Exp mix: ops **33.1%** ÃÂÃÂ· wages **26.0%** ÃÂÃÂ· invest **15.6%** ÃÂÃÂ· credit/equity **7.3%**
  - **Named ESA saldos 2026:** FPIM **+636.6** ÃÂÃÂ· BE-WATT **+499.3** (Phoenix new) ÃÂÃÂ· Hedera **+452.9** ÃÂÃÂ· ASEVA **+89.3** ÃÂÃÂ· Infrabel **-56.5** ÃÂÃÂ· CREG **-23.3**
  - Conclave: NIRAS nuclear passif **+ÃÂ¢ÃÂÃÂ¬198m** (ESA balance); Sciensano **+3m**; HealthdataÃÂ¢ÃÂÃÂHDA **ÃÂ¢ÃÂÃÂ¬6m** from RIZIV
...
- Unit: **rq_534** (FOI-adjacent hole-fill - **Kamer exposÃÂÃÂ© Part IV social protection Tables I.1-I.3 dual Graph1**)
- Found (strong primary DOC 56 1278/001 Part IV Ch1; thousand-EUR tables):
  - **Social protection 2026:** rec **ÃÂ¢ÃÂÃÂ¬194.673bn** ÃÂÃÂ· exp **ÃÂ¢ÃÂÃÂ¬194.514bn** ÃÂÃÂ· result **+ÃÂ¢ÃÂÃÂ¬97m** (vs 2025 result **-ÃÂ¢ÃÂÃÂ¬1.496bn**)
  - **SS own receipts ÃÂ¢ÃÂÃÂ¬148.017bn** = Graph1 SS **148.0**; **SSC ÃÂ¢ÃÂÃÂ¬85.525bn** = Graph1 **85.5**
  - **Benefits ÃÂ¢ÃÂÃÂ¬142.053bn** (SS **135.492** + assistance **6.561**): employees **63.342** ÃÂÃÂ· health **41.297** ÃÂÃÂ· public pensions **22.828** ÃÂÃÂ· self-emp **7.012**
  - **Admin ÃÂ¢ÃÂÃÂ¬2.996bn** (central **1.242** + third-party **1.754**)
  - **Federal transfers I.3:** SS **ÃÂ¢ÃÂÃÂ¬54.617bn** (dual Graph1 **54.3**) + assistance **ÃÂ¢ÃÂÃÂ¬6.563bn** = **ÃÂ¢ÃÂÃÂ¬61.181bn**
  - **Alt financing ÃÂ¢ÃÂÃÂ¬27.222bn:** emp VAT **16.989** (base 9.344 + health 7.645) + RV **6.403**; self-emp **3.829**
  - **Assistance L5:** handicap **3.286** ÃÂÃÂ· leefloon **2.085** ÃÂÃÂ· IGO **1.037** (excl Ukraine provision)
...
- Unit: **rq_535** (FOI-adjacent hole-fill - **exposÃÂÃÂ© employees L5 benefits Table II.2 + RIZIV IV.1 dual + assistance VI.1**)
- Found (strong primary DOC 56 1278/001 Part IV; thousand-EUR tables):
  - **Employees benefits L5 2026:** pensions **ÃÂ¢ÃÂÃÂ¬43.271bn** ÃÂÃÂ· illness/invalidity **ÃÂ¢ÃÂÃÂ¬14.879bn** ÃÂÃÂ· unemployment **ÃÂ¢ÃÂÃÂ¬4.638bn** ÃÂÃÂ· FEDRIS AO+BZ **ÃÂ¢ÃÂÃÂ¬0.546bn** ÃÂÃÂ· total **ÃÂ¢ÃÂÃÂ¬63.342bn**
  - **Unemployment dual:** **ÃÂ¢ÃÂÃÂ¬6.459bn (2025) ÃÂ¢ÃÂÃÂ ÃÂ¢ÃÂÃÂ¬4.638bn (ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ¬1.821bn)** UI time-limit path class
  - **Transfer to RIZIV** from employees table **ÃÂ¢ÃÂÃÂ¬35.990bn**; contrib reductions **ÃÂ¢ÃÂÃÂ¬1.197bn**
  - **RIZIV 2026:** benefits **ÃÂ¢ÃÂÃÂ¬41.297bn** (+1.49); admin **ÃÂ¢ÃÂÃÂ¬1.236bn** (third-party **ÃÂ¢ÃÂÃÂ¬1.116bn**); financed RSZ **ÃÂ¢ÃÂÃÂ¬35.839bn** + RSVZ **ÃÂ¢ÃÂÃÂ¬3.348bn** + own **ÃÂ¢ÃÂÃÂ¬7.212bn**
  - **TNW wave4:** save path **ÃÂ¢ÃÂÃÂ¬118m** employee illness benefits; thematic controls **ÃÂ¢ÃÂÃÂ¬25m** class
  - **Assistance VI.1:** leefloon **ÃÂ¢ÃÂÃÂ¬2.085bn (+17.6%)** ÃÂÃÂ· handicap **ÃÂ¢ÃÂÃÂ¬3.286bn (+6.3%)** ÃÂÃÂ· IGO **ÃÂ¢ÃÂÃÂ¬1.035bn** ÃÂÃÂ· total **ÃÂ¢ÃÂÃÂ¬6.561bn**
...
- Unit: **rq_536** (FOI-adjacent hole-fill - **exposÃÂÃÂ© self-employed Table III.2 + public pensions VII.2 dual three-stack**)
- Found (strong primary DOC 56 1278/001 Part IV Ch3+Ch7; thousand-EUR tables):
  - **Self-emp benefits 2026:** total **ÃÂ¢ÃÂÃÂ¬7.012bn** ÃÂ¢ÃÂÃÂ pensions **ÃÂ¢ÃÂÃÂ¬5.920bn** ÃÂÃÂ· illness **ÃÂ¢ÃÂÃÂ¬1.070bn** ÃÂÃÂ· bridging **ÃÂ¢ÃÂÃÂ¬15.3m** ÃÂÃÂ· caregiver **ÃÂ¢ÃÂÃÂ¬6.9m**
  - Transfer selfÃÂ¢ÃÂÃÂRIZIV **ÃÂ¢ÃÂÃÂ¬3.551bn**; admin **ÃÂ¢ÃÂÃÂ¬164m**
  - **Public pensions benefits 2026:** total **ÃÂ¢ÃÂÃÂ¬22.828bn** (+ÃÂ¢ÃÂÃÂ¬0.67bn YoY)
  - Treasury **ÃÂ¢ÃÂÃÂ¬17.016bn** ÃÂÃÂ· solidary local fund **ÃÂ¢ÃÂÃÂ¬2.891bn** ÃÂÃÂ· HR Rail **ÃÂ¢ÃÂÃÂ¬1.569bn** ÃÂÃÂ· parastatal **ÃÂ¢ÃÂÃÂ¬0.809bn** ÃÂÃÂ· fed police **ÃÂ¢ÃÂÃÂ¬0.186bn**
  - **Dual three-stack pensions:** emp **ÃÂ¢ÃÂÃÂ¬43.271** + self **ÃÂ¢ÃÂÃÂ¬5.920** + public **ÃÂ¢ÃÂÃÂ¬22.828** = **ÃÂ¢ÃÂÃÂ¬72.019bn** benefits 2026
...
- Next: prio5 **rq_537** (exposÃÂÃÂ© Part IV largely filled ÃÂ¢ÃÂÃÂ new public residual); deferred **rq_116** SWA
...
- Found (strong primary DOC 56 1278/001 Part IV Ch5; thousand-EUR tables):
  - **Other SS total 2025:** rec **EUR 1.645bn** ÃÂÃÂ· exp **1.522bn** ÃÂÃÂ· result **+122.9m**
  - **Other SS total 2026:** rec **EUR 1.569bn** ÃÂÃÂ· exp **1.570bn** ÃÂÃÂ· result **-1.2m**
  - **Benefits L5 2026:** FSO **319.9m** ÃÂÃÂ· Ex-OSZ **336.0m** ÃÂÃÂ· RVA emp missions **261.4m** ÃÂÃÂ· medical **37.6m** ÃÂÃÂ· asbestos **23.4m** ÃÂÃÂ· Fedris-AO cap **15.4m** ÃÂÃÂ· PPO **15.2m** ÃÂÃÂ· war/terror **4.7m** ÃÂÃÂ· total **1.014bn**
...
- Next: prio5 **rq_538** (Part IV complete class ÃÂ¢ÃÂÃÂ next public residual); deferred **rq_116** SWA; progress@550 in 4 ticks

### 2026-07-31T08:40:00Z - tick 547
- Unit: **rq_538** (FOI-adjacent hole-fill - **Kamer expose Part I ÃÂÃÂ§5 Table40 Entity I global investment effort 2025-29**)
- Found (strong primary DOC 56 1278/001 Part I ÃÂÃÂ§5; million-EUR table):
  - **Direct public invest:** 2025 **EUR 4.522bn** ÃÂÃÂ· 2026 **5.174** ÃÂÃÂ· 2027 **5.740** ÃÂÃÂ· 2028 **5.924** ÃÂÃÂ· 2029 **6.082**
  - **FOD/POD:** **2.972 ÃÂ¢ÃÂÃÂ 4.962bn 2026** (defence-driven); **ESA defence corr ÃÂ¢ÃÂÃÂ1.388bn 2026** (vs +175m 2025)
  - **ION/OIP:** **1.324 / 1.559bn** (Infrabel+Regie class); OISZ invest **51 / 40m**
  - **ESA GCF:** **5.914 ÃÂ¢ÃÂÃÂ 6.612 ÃÂ¢ÃÂÃÂ 7.204 ÃÂ¢ÃÂÃÂ 7.438 ÃÂ¢ÃÂÃÂ 7.632bn** (IT act **657m**, science **336m**, Infrabel+NIRAS **455m** flat)
  - **NMBS invest aid:** **1.049 / 1.094 / 0.776 / 0.697 / 0.712bn** 2025-29
  - **Gov-supported total:** **6.962 / 7.706bn** (1.1ÃÂ¢ÃÂÃÂ**1.2% GDP**) ÃÂ¢ÃÂÃÂ **8.344bn 2029**
...
- Found (strong primary DOC 56 1278/001 Part I; billion-EUR tables):
  - **No-policy financing:** 2026 **-EUR 26.2bn** ÃÂÃÂ· 2027 **-29.4** ÃÂÃÂ· 2028 **-31.8** ÃÂÃÂ· 2029 **-39.1** (-5.4% GDP)
  - **After measures:** **-24.6 / -26.9 / -28.8 / -31.2bn** (-3.7 to -4.3% GDP)
  - **Measures impact:** **+1.6 / +2.4 / +3.0 / +8.0bn** on financing; unalloc **+0.5 ÃÂ¢ÃÂÃÂ +1.5bn**
  - **Primary after:** **-12.5 / -13.0 / -13.0 / -13.4bn**; interest **12.2 ÃÂ¢ÃÂÃÂ 17.8bn**
  - **SPB Table32:** **-12.9 / -12.8 / -12.8 / -12.5bn** (-1.9 to **-1.7% GDP**); only **+0.4bn** improve 29vs26
  - **Debt ratio Table34:** **85.6 ÃÂ¢ÃÂÃÂ 87.1 ÃÂ¢ÃÂÃÂ 88.8 ÃÂ¢ÃÂÃÂ 90.3% GDP**; endogenous ~1.3-1.6pp/yr
...
- Progress layers vs EUR **347.956bn** TE:
  ...
  - **C L2:** ~**99%** (exposÃÂÃÂ© Part IIIÃÂ¢ÃÂÃÂIV dual + E1 invest/SPB/consol map)
  - **D L5:** ~**35-48%** generous (Part IV SS L5 close ÃÂÃÂ· other SS 1.57bn ÃÂÃÂ· E1 invest 7.7bn ÃÂÃÂ· nopol/SPB path ÃÂÃÂ· not near-complete of 348bn)
  - **E FOI ready:** ~**295** ÃÂÃÂ· answered ~**9** ÃÂÃÂ· total FOI rows ~**305**
- Inventory: budgets ~**9691** ÃÂÃÂ· cmt ~**1062** ÃÂÃÂ· lb ~**2022** ÃÂÃÂ· sources ~**1045** ÃÂÃÂ· entities ~**414**
- Waste top10: **unchanged** fossil/cars/cheque/consultancy (priority 8.55ÃÂ¢ÃÂÃÂ8.30); just-outside + E1 nopol 39bn; high-abs Metro3/wassalon; stock dual pension 72bn ÃÂÃÂ· SPB ÃÂÃÂ· invest 7.7bn ÃÂÃÂ· sensitivity
- Gain 540ÃÂ¢ÃÂÃÂ550: exposÃÂÃÂ© residual close (C&R/EU/SS stacks ÃÂÃÂ· E1 capital+fiscal path ÃÂÃÂ· sensitivity/one-offs/consol multi-year)
...
- Found (strong primary DOC 56 1278/001 Part II Ch2; million-EUR):
  - **ESA fiscal total:** 2024 **EUR 155.889bn** ÃÂÃÂ· 2025 **158.100** ÃÂÃÂ· 2026 **163.806** (+5.706 / +3.6%)
  - **L5 2026 ESA:** BVH **66.841** ÃÂÃÂ· VAT **45.149** (pure **40.274**) ÃÂÃÂ· VenB **26.748** ÃÂÃÂ· RV **7.990** ÃÂÃÂ· excise **11.211** ÃÂÃÂ· customs **3.402**
  - **Cash dual:** third-party+assigned **92.508bn** ÃÂÃÂ· Middelen **65.435bn** 2026
...
- Found (strong primary DOC 56 1278/001 Part II):
  - **Table4 measures 2026 total:** **+EUR 1.585bn** (VAT pure **+511** ÃÂÃÂ· excise **+57** ÃÂÃÂ· divers **+1148**; BVH measures **-383**)
  - **L5 raisers:** TACT **+414** ÃÂÃÂ· CGT **+236** ÃÂÃÂ· interest-ded abolish **+203** ÃÂÃÂ· UI tax-relief end **+257** ÃÂÃÂ· hospitality VAT stack **633** ÃÂÃÂ· bank **150** ÃÂÃÂ· VVPR **90**
  - **L5 costs:** tax-free sum **-531** ÃÂÃÂ· author-rights IT **-142** ÃÂÃÂ· meal vouchers **-76** ÃÂÃÂ· demo/rebuild VAT **-124**
  - **Non-fiscal corrected:** 2025 **6.971bn** ÃÂÃÂ· 2026 **5.850bn** (ÃÂ¢ÃÂÃÂ1.121); Finance **5.126** ÃÂÃÂ· SS **1.190ÃÂ¢ÃÂÃÂ0.002**; sleeping assets **+475**; Fluxys **+100**; F35 hedge **+321**
...
- Found (strong primary Rekenhof NL 30 Jun 2026):
  - **AVB path:** intro **EUR 31.0m** (2019-20) ÃÂ¢ÃÂÃÂ **52.2m** 2024-25 (basis **30.5** ÃÂÃÂ· sec **21.6**); pupil-based not starter-based
  - **Induction:** envelope **48.7m** (not enough for 20% all starters); alt workings **38.7m** 2025-26; 2026-27 total ~**3x** intro class
  - **Professionalization:** **50.8 ÃÂ¢ÃÂÃÂ 62.4m** 2020-25 (schools **44.9** ÃÂÃÂ· PBD **17.5** ÃÂÃÂ· priority themes **0**); **120-130 EUR**/relation
  - **Leerpunt:** **0.11 ÃÂ¢ÃÂÃÂ 5.7m** 2022-25; specialist mandates **577** underused
...
- Found (strong primary DOC 56 1278/001 Part II Table11; million-EUR cash):
  - **Total third-party+assigned 2026:** **EUR 92.508bn** (2025 91.100 ÃÂÃÂ· 2024 86.589)
  - **By beneficiary 2026:** EU **4.150** ÃÂÃÂ· Regions **25.600** ÃÂÃÂ· Communities **33.563** ÃÂÃÂ· SS **27.325** ÃÂÃÂ· divers **1.870**
  - **Communities:** PB **11.060** + VAT **22.504**; **Regions:** taxes **3.772** + PB share **7.539** + autonomy **14.288**
  - **SS alt fin L5:** emp **23.392** (RV **6.403** ÃÂÃÂ· VAT **13.275** ÃÂÃÂ· tobacco **2.774** ÃÂÃÂ· BVH **0.940**) ÃÂÃÂ· self **3.830** ÃÂÃÂ· BBSZ **0.102**
  - **Energy divers:** Elia **761.5** ÃÂÃÂ· CREG **512.4** ÃÂÃÂ· Hedera **148.7** (TACT+TBV+RV)
...
- Found (strong primary Rekenhof 30 Jun 2026 / 2026_32):
  ...
  - Opinions: economic **disclaimer** ÃÂÃÂ· budget **qualified** ÃÂÃÂ· ESA/consol **clean**
...
- Found (strong primary Rekenhof rekeningenrapport 2025 residual L5; million-EUR):
  - **Lantis under-vastlegging:** approved NEC4 bids **EUR 7.469bn**; prior **2.891bn**; needed extra **4.578bn**; booked only **+2.159bn** (tol share) ÃÂ¢ÃÂÃÂ shortfall **~2.419bn**; BA2026 extra kredieten
  - **Open verb toelage Table10 2025:** total **7.372bn** (2024 6.831): VMSW **1.745** ÃÂÃÂ· FIO **1.505** ÃÂÃÂ· De Lijn **0.941** ÃÂÃÂ· FWO **0.879** ÃÂÃÂ· VAPH **0.788** ÃÂÃÂ· AGIOn **0.591** ÃÂÃÂ· DVW **0.468** ÃÂÃÂ· VWF **0.457**
  - **Outside table:** ~**5.5bn** other open verb of which BAM **~4.5bn**; contracts **6.8bn** JV2025
  - **TV financing Table23 eoy2025 cum ~3.852bn:** cash **885** ÃÂÃÂ· natura **287** ÃÂÃÂ· land **176** ÃÂÃÂ· loans **2.401** ÃÂÃÂ· overkapping **102**; loans path **250/950/1.128**; plafond **6.7bn** @ **5%** subord
  - **New LT loans 2025 3.955bn:** VWF **1.550** ÃÂÃÂ· Lantis **1.128** ÃÂÃÂ· VMSW **1.000** ÃÂÃÂ· Roadrunner **216**; fin assets **+5.686bn**
...
- Found (strong primary Rekenhof RR2025 ÃÂÃÂ§4.3-4.5; million-EUR):
  - **Relance 2025:** raming **741.5** / spend **399.4** / underuse **342.1** (Table39): VV014 **92.2** ÃÂÃÂ· VV047 **34.4** ÃÂÃÂ· VV048 **20.2** ÃÂÃÂ· VV013 **18.9** ÃÂÃÂ· VV022 **17.3** (bankrupt 11) ÃÂÃÂ· VV018 **12.5** ÃÂÃÂ· VV017 **10.3**
  - **Open to liq Table40 ~664m class:** VV014 **92.2** ÃÂÃÂ· VV047 **87.1** ÃÂÃÂ· VV110 **57.5** ÃÂÃÂ· VV013 **48** ÃÂÃÂ· VV099 **48.1** (+Andere **331**); cum open **0.7bn**; deadline **30 Jun 2026** EU; PMV biotech realloc **39.8**
  - **REPowerEU:** **208ÃÂ¢ÃÂÃÂ191.4** (-16.6); paid cum **107.7** (2025 **72.2**); residual ~**83.7** for 2026; VAK lapse **27.5**
  ...
  - **VLAIO Table41 2025:** support **971.1** ÃÂÃÂ· recoveries **50.8** ÃÂÃÂ· receivables **125.6** ÃÂÃÂ· impaired **93.5** ÃÂÃÂ· writeoffs **26.1**; corona 2020-21 **1896+740**; Table42 paid **2627.6** inspect **15%** recover after annul **196.5**
...
- Found (strong primary Rekenhof RR2025 ÃÂÃÂ§4.5-4.7; million-EUR):
...
- Found (strong primary Rekenhof AG 7 Jan 2026):
  ...
  - **Non-reimb share:** **11ÃÂ¢ÃÂÃÂ12%** 2019-23 outside RIZIV control; quinolones **61ÃÂ¢ÃÂÃÂ66%** non-reimb; 3rd-gen ceph **87%** outside rules
...
- Progress layers vs EUR **347.956bn** TE:
  ...
  - **D L5:** ~**36-49%** generous (Part II fiscal L5 ÃÂÃÂ· VL RR residual Lantis/open-verb/relance/VLAIO ÃÂÃÂ· dual Ethias/Viapass/BAC ÃÂÃÂ· AMR 281m ÃÂÃÂ· not near-complete of 348bn)
  - **E FOI ready:** ~**301** ÃÂÃÂ· answered ~**9** ÃÂÃÂ· total FOI rows ~**313**
- Inventory: budgets ~**10032** ÃÂÃÂ· cmt ~**1104** ÃÂÃÂ· lb ~**2092** ÃÂÃÂ· sources ~**1069** ÃÂÃÂ· entities ~**414**
- Waste top10: **unchanged** fossil/cars/cheque/consultancy (priority 8.55ÃÂ¢ÃÂÃÂ8.30); stocks Metro3 still top raw prio but annual=0 filtered; high-abs Lantis 2.42bn ÃÂÃÂ· VLAIO prescription ÃÂÃÂ· AB non-reimb ÃÂÃÂ· GO inventory ÃÂÃÂ· AMR 281m
- Gain 550ÃÂ¢ÃÂÃÂ560: expose fiscal Part II (164/92.5bn) ÃÂÃÂ· CoA VL RR residual (debt 50.2 ÃÂÃÂ· Lantis 2.42 ÃÂÃÂ· open verb 7.37 ÃÂÃÂ· relance 342m ÃÂÃÂ· VLAIO ÃÂÃÂ· dual 66 gemengd) ÃÂÃÂ· antibiotics AMR 281m dual non-reimb
...
- Found (strong primary RIZIV press 13 Apr 2026 + 11 Mar 2026 + FPB PROMES 28 Apr 2026):
  ...
  - **Over:** verpleegdag **+121.0** ÃÂÃÂ· pharma net **+104** (art81/111 receipts **-145.7**; clawback **85.4**)
  - **Under:** artsen **-17.4** on **11.644bn** ÃÂÃÂ· thuisverpl **-95.6** ÃÂÃÂ· implant **-81.3** ÃÂÃÂ· psych **-64.4** ÃÂÃÂ· MAF **-36.0**
  - **PROMES ZIV real:** **37.666bn** 2025 (6% GDP) ÃÂ¢ÃÂÃÂ **48.599** 2035 (**+10.933**, **2.6%/yr**); pharma net **+3.412** ÃÂÃÂ· artsen **+2.182** ÃÂÃÂ· verpleegdag **+2.057** ÃÂÃÂ· thuis **+0.869**; demo **32%** of growth
...
- Found (strong primary VDAB JV2025 PDF):
  ...
  - **Savings Focus op de kern:** **20m** 2025 ÃÂÃÂ· **25m** 2026 ÃÂÃÂ· **40m** 2027 (4 axes beleid/werking/personeel/invest); PMO projects **200ÃÂ¢ÃÂÃÂ150**
  - **WZW Flanders eoy2025:** **224.630** rate **6.9%** (was 6.6): UI **117.500** ÃÂÃÂ· non-active **93.042** ÃÂÃÂ· BIT **11.057** ÃÂÃÂ· other **3.031**; rate ex-nonact **4.1%**
  - **Flows:** vac filled **36.536** ÃÂÃÂ· training starts **34.061** ÃÂÃÂ· non-active reach **212.036** (to work **69.348**) ÃÂÃÂ· to work Oct24-end25 **209.638** ÃÂÃÂ· NECzU vac **271.072** (-10%) ÃÂÃÂ· classic train **28.894** ÃÂÃÂ· knelpunt stream ~**21.000**
...
- Found (strong primary ONEM RA2025 vol1 Tables 1.4.6 + press):
  ...
  - **Missions exp 6.951bn** (+**350.15m** +5.3%): social benefits **6.383bn** (+0.32%) ÃÂÃÂ· OP indemnisation **233.6m** (ÃÂ¢ÃÂÃÂ0.59%) ÃÂÃÂ· diverses **333.8m** (+12.0%)
  - **Gestion 306.6m** (+11.4m): personnel **236.0m** (77%) ÃÂÃÂ· fonctionnement **65.8m** ÃÂÃÂ· invest **4.4m**
  - **Volumes:** full UI avg **288.077** (+1.13%) ÃÂÃÂ· temp UI **ÃÂ¢ÃÂÃÂ20.2%** ÃÂÃÂ· career interrupt **244.023** ÃÂÃÂ· total recipients **726.387** (ÃÂ¢ÃÂÃÂ2.9%) ÃÂÃÂ· bankruptcies **11.675** / jobs lost **34.238** ÃÂÃÂ· reform end-rights ~**173k**
  - **Service:** process 14d **90.03%** (was 99.8) ÃÂÃÂ· quality **96.07%** ÃÂÃÂ· eC3 **>2.1m** payments ÃÂÃÂ· dual partners VDAB/FOREM/Actiris/ADG/OP/CPAS
...
- Found (strong primary ONEM vol2 Tab 1.3.IÃÂ¢ÃÂÃÂII; million-EUR allocated):
  - **Total allocated 2025:** **EUR 6.589bn** (+**23.2m** +0.4%; dual vol1 budget prestations **6.383bn** different perimeter)
  - **By type:** full UI **4.433** (jobseek **4.324** +3.2%) ÃÂÃÂ· dispenses **516** ÃÂÃÂ· temp UI **465** (ÃÂ¢ÃÂÃÂ21.7%) ÃÂÃÂ· interrupt **794** (credit-temps **344** ÃÂÃÂ· thematic **355** ÃÂÃÂ· career **95**) ÃÂÃÂ· other **381** ÃÂÃÂ· emploi measures **109** ÃÂÃÂ· statut unique **65**
  - **By region:** Flanders **2.764** (41.9%, ÃÂ¢ÃÂÃÂ1.1%) ÃÂÃÂ· Wallonia **2.658** (40.3%, +0.6%) ÃÂÃÂ· Brussels **1.168** (17.7%, +3.3%)
  - **Full UI regional:** FL **1.607** ÃÂÃÂ· WAL **1.838** ÃÂÃÂ· BRU **988**; interrupt FL **70.5%** of package; emploi measures **71%** WAL
  - **Dual PES:** federal cash map vs VDAB/FOREM/Actiris activation (ticks 562ÃÂ¢ÃÂÃÂ563)
...
- Found (strong primary FOREM press 17 Jan 2025 + market infographic 2025):
  - **DEI avg:** **235.011** 2024 (+7%) ÃÂ¢ÃÂÃÂ **254.921** 2025 (+9.6%, excl DG)
  - **Split 2025:** DEDA **119.188** (+5.1%) ÃÂÃÂ· free **78.340** (+25.1%) ÃÂÃÂ· JSI **29.735** (ÃÂ¢ÃÂÃÂ3.8%) ÃÂÃÂ· other mand **27.658** (+8.4%)
  - **2024 rate:** **14.3%** of active pop (dual VDAB WZW rate **6.9%**); provinces Hainaut/LiÃÂÃÂ¨ge ~**17.5ÃÂ¢ÃÂÃÂ17.7%**
  - **Offers:** **532.623** 2024 (+30%, interim **63.4%**) ÃÂ¢ÃÂÃÂ **405.035** 2025 (ÃÂ¢ÃÂÃÂ24%); ~1/3 penury/critical
  - **Labour force 2025:** working-age **2.341m** ÃÂÃÂ· employed **1.480m** ÃÂÃÂ· BIT unemp **126k** ÃÂÃÂ· inactive **735k**
  - **Dual:** ONEM WAL benefits **ÃÂ¢ÃÂÃÂ¬2.66bn** vs FOREM stock; VDAB WZW **225k** / NECzU vac **271k**
...
- Found (strong primary Actiris press Dec2025/May/Jun2026 + ADG Arbeitsmarkt Q2 2026):
  - **Actiris DEI:** eoy2025 **96.650** rate **15.4%** ÃÂ¢ÃÂÃÂ May2026 **93.732** ÃÂ¢ÃÂÃÂ Jun2026 **93.445** (+3.0% YoY; excl65+ **91.707** +1.1%); rate **14.6%**
  - **Reform shift Jun:** UI-alloc DEI **-36.3%** (-18.120) ÃÂÃÂ· other DEI **+55.9%** ÃÂÃÂ· CPAS-linked **34.137** (36.5% of DEI **+83.5%** YoY) ÃÂÃÂ· JSI **+21%**
  ...
  - **Dual four-SPE rates:** VL **6.9** ÃÂÃÂ· WAL **14.3** ÃÂÃÂ· BRU **14.6** ÃÂÃÂ· DG **6.4**; ONEM BRU cash **ÃÂ¢ÃÂÃÂ¬1.17bn** vs Actiris stock
...
- Found (strong primary OTW RF2025 + RA2025 PDFs):
  ...
  - **CSP rewrite:** opex cut **20m** by 2029; farebox **10ÃÂ¢ÃÂÃÂ14%** by 2030; draft summer 2026
...
- Note: Infrabel JV2025 PDF (54MB) incomplete download this tick ÃÂ¢ÃÂÃÂ residual for later
...
- Progress layers vs EUR **347.956bn** TE:
  ...
  - **D L5:** ~**37-50%** generous (Part II fiscal + VL CoA residual + PES/ONEM/RIZIV wave + TEC/NMBS RRF/ETS + Infrabel 1.27bn ÃÂÃÂ· not near-complete of 348bn)
  - **E FOI ready:** ~**313** ÃÂÃÂ· answered ~**9** ÃÂÃÂ· total FOI rows ~**323**
- Inventory: budgets ~**10307** ÃÂÃÂ· cmt ~**1132** ÃÂÃÂ· lb ~**2160** ÃÂÃÂ· sources ~**1097** ÃÂÃÂ· entities ~**415**
- Waste top10: **unchanged** fossil/cars/cheque/consultancy (priority 8.55ÃÂ¢ÃÂÃÂ8.30); stocks Metro3 still top raw prio but annual=0 filtered; high-abs + dual: Actiris CPAS spill ÃÂÃÂ· four-PES rates ÃÂÃÂ· four-layer PT ÃÂÃÂ· Infrabel ETCS 2.8bn / assets 25.7bn ÃÂÃÂ· ONEM region cash
- Gain 560ÃÂ¢ÃÂÃÂ570: RIZIV/PROMES ÃÂÃÂ· VDAB/ONEM/FOREM/Actiris/ADG dual PES ÃÂÃÂ· TEC dual PT ÃÂÃÂ· NMBS RRF/ETS ÃÂÃÂ· Infrabel JV2025 dual rail
...
- Found (strong primary DWV JV2025 site + AWV Activiteitenverslag 2025):
  ...
  - Ops KPIs: **12** permits ÃÂÃÂ· **5** groundbreakings ÃÂÃÂ· **7** commissioned ÃÂÃÂ· **>70** participation moments
  - Staff **25** (lean PPS coordinator dual AWV capacity)
  - Projects: R4WO ÃÂÃÂ· SPI.R0 ÃÂÃÂ· NZL Fase1 ÃÂÃÂ· HOV ÃÂÃÂ· Gentspoort ÃÂÃÂ· R0 Noord-Zaventem dialoog
...
- Found (strong primary Aquafin JV2025 PDF 132 pp + ESG summary):
  ...
  - **Ops:** 332 WWTPs ÃÂÃÂ· 2,122 pumps ÃÂÃÂ· 7,562 km pipes ÃÂÃÂ· compliance **99.4%**
...
- Progress layers vs EUR **347.956bn** TE:
  - **A/B:** 100% (L0 TE + L1 subsectors)
  - **C L2:** ~**99%** (dual roads SOFICO/DWV ÃÂÃÂ· dual BE water stack ÃÂÃÂ· dual DSO trio ORES+Sibelga+Fluvius ÃÂÃÂ· ports POAB)
  - **D L5:** ~**38-51%** generous (utility+DSO+roads wave ÃÂÃÂ· not near-complete of 348bn)
  - **E FOI ready:** ~**321** ÃÂÃÂ· answered ~**9** ÃÂÃÂ· total FOI rows ~**333**
- Inventory: budgets ~**10579** ÃÂÃÂ· cmt ~**1156** ÃÂÃÂ· lb ~**2219** ÃÂÃÂ· sources ~**1121** ÃÂÃÂ· entities ~**414**
- Waste top10: **unchanged** fossil/cars/cheque/consultancy (priority 8.55ÃÂ¢ÃÂÃÂ8.30); stocks Metro3 still top raw prio but annual=0 filtered
- High-abs + dual NEW: DSO trio ORES/Sibelga/Fluvius ÃÂÃÂ· drink SWDE vs VL trio ÃÂÃÂ· Horizon2030 **3bn** ÃÂÃÂ· SOFICO/DWV roads ÃÂÃÂ· ORES invest **541m**
- Gain 570ÃÂ¢ÃÂÃÂ580: roads dual ÃÂÃÂ· water sanitation+drink BE stack ÃÂÃÂ· POAB cargo L5 ÃÂÃÂ· Sibelga RAB ÃÂÃÂ· ORES CA 1.16bn
...
- Found (strong primary INASEP Rapport annuel 2025, 179 pp ÃÂ¢ÃÂÃÂ new entity):
  ...
  - Ops: **113** STEPs ÃÂÃÂ· **352** pumps ÃÂÃÂ· **589 km** collectors ÃÂÃÂ· exploit ETP **97**
...
- Found (strong primary in BW Rapport de gestion 2025, 107 pp ÃÂ¢ÃÂÃÂ new entity):
...
- Found (strong primary AIDE comptes + rapport AG 25 Jun 2026, 40 pp ÃÂ¢ÃÂÃÂ new entity):
  ...
  - SPGE WAL envelopes cited: epuration **88m/yr** ÃÂÃÂ· demergement **10m** ÃÂÃÂ· egouttage **44m**
...
### 2026-07-31T12:00:00Z Ã¢ÂÂ tick 585
- Unit: rq_576 (FOI-adjacent dual waste hole-fill Ã¢ÂÂ INTRADEL LiÃÂ¨ge)
- Found: **INTRADEL** RG/comptes 2025 (primary PDF AG 2026, 116 pp). **CA Ã¢ÂÂ¬125.062m** (ventes Ã¢ÂÂ¬155.829m); **op loss Ã¢ÂÂ¬10.589m**; **net loss Ã¢ÂÂ¬12.682m** covered by **BEP+Idelux associate intervention Ã¢ÂÂ¬12.744m** (post-cover +Ã¢ÂÂ¬0.062m). **Assets Ã¢ÂÂ¬187.406m**; **equity Ã¢ÂÂ¬35.538m**; **dettes Ã¢ÂÂ¬114.687m** (LT Ã¢ÂÂ¬40.777m ST Ã¢ÂÂ¬55.705m); **provisions Ã¢ÂÂ¬37.182m**; personnel **Ã¢ÂÂ¬23.123m** / **314.2 ETP**; **72 communes / 1.049m hab**; **coÃÂ»t vÃÂ©ritÃÂ© Ã¢ÂÂ¬68.05/hab** (70.90 excl non-rec); UVE **348 kt** elec **Ã¢ÂÂ¬82.58/MWh** (Ã¢ÂÂ11.4m CA YoY); invest **Ã¢ÂÂ¬7.926m**; dual waste vs **HYGEA Mons Ã¢ÂÂ¬7.76m**; COPIDEC 7 public ops. Strong confidence.
...
- FOI opened: gap_intradel_commune_l5_2025 Ã¢ÂÂ ready (not sent)
- Next: rq_577; progress@590 in 5 ticks; rq_116 deferred

### 2026-07-31T12:15:00Z Ã¢ÂÂ tick 586
- Unit: rq_577 (FOI-adjacent dual waste hole-fill Ã¢ÂÂ **IPALLE** Wallonie picarde / Sud-Hainaut)
- Found: **IPALLE** RSE Finances et DurabilitÃÂ© 2025 (primary PDF Beloeil AG 2026, 244 pp). **CA Ã¢ÂÂ¬83.021m** (ventes Ã¢ÂÂ¬128.125m); **op Ã¢ÂÂ¬6.719m**; **net Ã¢ÂÂ¬8.886m**; **dividend Ã¢ÂÂ¬4.637m** + reserves Ã¢ÂÂ¬4.250m. **Assets Ã¢ÂÂ¬379.702m**; **equity Ã¢ÂÂ¬185.416m**; **dettes Ã¢ÂÂ¬162.900m** (LT Ã¢ÂÂ¬98.618m ST Ã¢ÂÂ¬55.072m); **provisions Ã¢ÂÂ¬31.386m**; personnel **Ã¢ÂÂ¬33.651m** / ~**420** staff; **31 communes** / **400k+ hab** (treats waste for ~**1m** incl Mons region); **26 recyparcs**; UVE Thumaide sector A prest **Ã¢ÂÂ¬37.578m** CA **Ã¢ÂÂ¬19.892m** net **Ã¢ÂÂ¬1.273m** elec ~**283 GWh**; eau F ventes **Ã¢ÂÂ¬27.080m** assets **Ã¢ÂÂ¬107.160m**; droit tirage **4.67 EUR/hab**; dual waste vs **INTRADEL** (profit 8.9m/assets 380m vs loss 12.7m/assets 187m). Strong confidence.
...
- FOI opened: gap_ipalle_commune_l5_2025 Ã¢ÂÂ ready (not sent)
- Next: rq_578; progress@590 in 4 ticks; rq_116 deferred

### 2026-07-31T12:30:00Z Ã¢ÂÂ tick 587
- Unit: rq_578 (FOI-adjacent dual waste hole-fill Ã¢ÂÂ **BEP Environnement** Namur province)
- Found: **BEP Environnement** RG/comptes 2024 (primary PDF bep.be, 112 pp) + press rÃÂ©sultats 2025 ops. **CA Ã¢ÂÂ¬26.760m** (ventes Ã¢ÂÂ¬69.409m); **op Ã¢ÂÂ¬2.607m**; **net Ã¢ÂÂ¬2.375m** (100% to reserves, **no dividend**). **Assets Ã¢ÂÂ¬77.190m**; **equity Ã¢ÂÂ¬36.182m**; **dettes Ã¢ÂÂ¬36.973m** (LT Ã¢ÂÂ¬22.113m ST Ã¢ÂÂ¬14.542m); **provisions Ã¢ÂÂ¬4.034m**; personnel **Ã¢ÂÂ¬18.261m** / **327** staff; **commune contrib Ã¢ÂÂ¬36.268m** + public sub **Ã¢ÂÂ¬5.166m**; **Energywall RV Ã¢ÂÂ¬8.548m**; 39 communes Province Namur; dual waste vs **IPALLE** (83m/380m) + **INTRADEL** (125m/187m loss). Ops 2025 medium: 500 kg/hab residual 96.9; 34 recyparcs. Strong confidence on 2024.
...
- FOI opened: gap_bep_env_comptes_l5_2025 Ã¢ÂÂ ready (not sent)
- Next: rq_579; progress@590 in 3 ticks; rq_116 deferred

### 2026-07-31T12:45:00Z Ã¢ÂÂ tick 588
- Unit: rq_579 (FOI-adjacent dual waste hole-fill Ã¢ÂÂ **IDELUX Environnement** Luxembourg)
- Found: **IDELUX** RA 2025 (primary PDF 122 pp). **Environnement CA Ã¢ÂÂ¬66.058m** result **+Ã¢ÂÂ¬3.007m** (turnaround from **Ã¢ÂÂÃ¢ÂÂ¬4.141m** 2024 / Ã¢ÂÂ2.011m 2023); capital **Ã¢ÂÂ¬0.960m**. Ops: **54 communes** (43 Lux + 11 Liege) / **54 recyparcs**; **276 413 t**; **564 kg/EqH**; **cout 114.20 EUR/EqH**; **387 952 EqH**; biometh **36 827 t**; elec **8 988 MWh**. **Eau CA Ã¢ÂÂ¬26.320m** net **Ã¢ÂÂ¬1.722m** (111 STEPs 41.9 Mm3). Group staff **536**. Dual waste quartet vs **BEP** 26.8m / **IPALLE** 83m / **INTRADEL** 125m. Strong on CA/result; full BS residual FOI.
...
- FOI opened: gap_idelux_env_bilan_l5_2025 Ã¢ÂÂ ready (not sent)
- Next: rq_580; progress@590 in 2 ticks; rq_116 deferred

### 2026-07-31T13:00:00Z Ã¢ÂÂ tick 589
- Unit: rq_580 (FOI-adjacent dual waste hole-fill Ã¢ÂÂ **Tibi** Charleroi region)
- Found: **Tibi** RG 2025 (primary PDF AG 24 Jun 2026, 101 pp) + RA 2025. **CA Ã¢ÂÂ¬25.404m** (ventes Ã¢ÂÂ¬41.410m); **op loss Ã¢ÂÂÃ¢ÂÂ¬56.318m**; **net Ã¢ÂÂÃ¢ÂÂ¬54.840m**; **cout net communes Ã¢ÂÂ¬42.738m** (after retrospections Ã¢ÂÂ¬12.102m). **Assets Ã¢ÂÂ¬151.020m**; **equity Ã¢ÂÂ¬26.847m**; **dettes Ã¢ÂÂ¬94.117m** (LT Ã¢ÂÂ¬62.443m of which UVE rehab **Ã¢ÂÂ¬52.507m** ST Ã¢ÂÂ¬26.007m); **provisions Ã¢ÂÂ¬30.056m** (GER 5.6 + responsabilisation 24.4); personnel **Ã¢ÂÂ¬47.018m** (47.8% of costs); **14 communes / 428 772 hab**; residual **146 kg/hab** total **431 kg/hab**; 14 recyparcs 82 969 t. Dual COPIDEC: largest commune bill vs IDELUX/IPALLE profits / Intradel loss. Strong confidence.
...
- FOI opened: gap_tibi_commune_l5_2025 Ã¢ÂÂ ready (not sent)
- Next: rq_581; **progress@590 next tick**; rq_116 deferred

### 2026-07-31T13:15:00Z Ã¢ÂÂ tick 590 (PROGRESS MILESTONE)
...
- Found (synthesis strong, primary-sourced no invent euros):
  - **COPIDEC 7 ops map:** Tibi CA **25.4m** cout net communes **42.7m** net loss **54.8m** assets **151m** personnel **47m** ÃÂ· IDELUX Env **66.1m**/+**3.0m** cout **114.20 Ã¢ÂÂ¬/EqH** ÃÂ· IPALLE **83.0m**/+**8.9m** assets **380m** ÃÂ· Intradel **125.1m**/Ã¢ÂÂ**12.7m** ÃÂ· BEP Env **26.8m**/+**2.4m** (2024) ÃÂ· HYGEA Mons package only **7.76m** (full FOI) ÃÂ· inBW waste **Ã¢ÂÂ1.87m** partial
  - Dual incentive: multi-utility profit model (IPALLE/IDELUX) vs structural commune-funded loss (Tibi/Intradel)
- Progress coverage:
  - **A/B:** 100% (L0 TE + L1 subsectors)
  - **C L2:** ~**99%** (dual COPIDEC waste ÃÂ· dual OAA water ÃÂ· prior utility/DSO/roads)
  - **D L5:** ~**39-52%** generous (waste dual wave ÃÂ· not near-complete of 348bn)
  - **E FOI ready:** ~**330** ÃÂ· answered ~**9** ÃÂ· total FOI rows ~**342**
- Inventory: budgets ~**10905** ÃÂ· cmt ~**1179** ÃÂ· lb ~**2280** ÃÂ· sources ~**1142** ÃÂ· entities ~**424**
- Waste top10: **unchanged** fossil/cars/cheque/consultancy (priority 8.55Ã¢ÂÂ8.30); stocks Metro3 still top raw prio but annual=0 filtered
- High-abs + dual NEW: COPIDEC stack ÃÂ· Tibi vs IPALLE loss/profit ÃÂ· Tibi cout net 42.7m
- Gain 580Ã¢ÂÂ590: WAL multi-utility OAA ÃÂ· COPIDEC waste dual five full RAs
...
### 2026-07-31T13:30:00Z Ã¢ÂÂ tick 591
- Unit: rq_582 (FOI-adjacent dual soil hole-fill Ã¢ÂÂ **SPAQuE** vs OVAM)
- Found: **SPAQuE** RA/comptes 2024 (primary PDF, 43 pp). **Ventes Ã¢ÂÂ¬31.533m** CA **Ã¢ÂÂ¬12.449m**; **op +Ã¢ÂÂ¬3.587m**; **net Ã¢ÂÂÃ¢ÂÂ¬27.764m** (Marshall SOWAFINAL fin charges **Ã¢ÂÂ¬31.673m**; RW capital cover path). **Assets Ã¢ÂÂ¬534.101m**; equity **Ã¢ÂÂ¬7.675m** (capital 66.6m / perte report Ã¢ÂÂ59.1m); **dettes Ã¢ÂÂ¬437.380m** (LT 230.4 ST 170.5); **provisions Ã¢ÂÂ¬89.046m**; cash **Ã¢ÂÂ¬236.178m**; capital diffÃÂ©rÃÂ© RW **Ã¢ÂÂ¬253.730m**. Dotation CG **Ã¢ÂÂ¬24.386m**; FEDER env **Ã¢ÂÂ¬142.349m** (spend 1.355m); Relance 143 **Ã¢ÂÂ¬37.5m**; SAREC **Ã¢ÂÂ¬8m**. Staff **80.6 ETP** personnel **Ã¢ÂÂ¬13.253m**. Ops: 7 chantiers 63 810 t 49 sites maintenance. Dual OVAM ISE Afval class. Strong confidence.
...
- FOI opened: gap_spaque_site_l5_2024 Ã¢ÂÂ ready (not sent)
- Next: rq_583; progress@600 in 9 ticks; rq_116 deferred

### 2026-07-31T13:45:00Z Ã¢ÂÂ tick 592
- Unit: rq_583 (FOI-adjacent dual env science hole-fill Ã¢ÂÂ **ISSeP** dual VITO)
- Found: **ISSeP** RA/comptes 2024 (primary PDF, 108 pp). **CA Ã¢ÂÂ¬34.770m** (ventes Ã¢ÂÂ¬38.269m); **op Ã¢ÂÂÃ¢ÂÂ¬0.963m**; **net +Ã¢ÂÂ¬1.751m**. **Assets Ã¢ÂÂ¬24.575m**; equity **Ã¢ÂÂ¬9.298m**; dettes **Ã¢ÂÂ¬7.264m**; provisions **Ã¢ÂÂ¬8.012m** (pension 3.7 + env 4.3); cash **Ã¢ÂÂ¬10.390m**. Personnel **Ã¢ÂÂ¬27.051m** / **304** staff / **262.1 ETP** (LiÃÂ¨ge 263 Colfontaine 41). UAP scientific env surveillance dual **VITO** Flanders + stack with **SPAQuE** soil. Strong confidence.
...
- FOI opened: gap_issep_client_l5_2024 Ã¢ÂÂ ready (not sent)
- Next: rq_584; progress@600 in 8 ticks; rq_116 deferred

### 2026-07-31T14:00:00Z Ã¢ÂÂ tick 593
- Unit: rq_584 (FOI-adjacent dual env science hole-fill Ã¢ÂÂ **VITO** dual ISSeP)
- Found: **VITO** Impactrapport 2024 (primary PDF) + JV 2023. **Inkomsten Ã¢ÂÂ¬297.056m** (bedrijfsopbrengsten **Ã¢ÂÂ¬141.107m** +19% ÃÂ· R&D activering **Ã¢ÂÂ¬90m** ÃÂ· subsidies **Ã¢ÂÂ¬65.949m**); **uitgaven Ã¢ÂÂ¬299.666m** (personnel **Ã¢ÂÂ¬128.539m** ÃÂ· werkings **Ã¢ÂÂ¬72.256m** ÃÂ· R&D amort **Ã¢ÂÂ¬90m**). Staff **~1.300** / **+66 FTE** YoY. VL beheersovereenkomst 2024-28 uplift **+Ã¢ÂÂ¬8m** 2024; pilot invest **Ã¢ÂÂ¬6m**. Private rev **Ã¢ÂÂ¬18.9m** / public **Ã¢ÂÂ¬31.1m**. Dual **ISSeP** CA 34.8m/304 staff (~8.5x scale). Strong on P&L lines; full BS residual FOI.
...
- FOI opened: gap_vito_jaarrekening_l5_2024 Ã¢ÂÂ ready (not sent)
- Next: rq_585; progress@600 in 7 ticks; rq_116 deferred

### 2026-07-31T14:15:00Z Ã¢ÂÂ tick 594
- Unit: rq_585 (FOI-adjacent dual Flanders SOC hole-fill Ã¢ÂÂ **imec** dual VITO)
- Found: **imec** Consolidated FS 2025 (primary PDF, 5 pp). **Op income Ã¢ÂÂ¬1,216.900m** (turnover **Ã¢ÂÂ¬846.263m** + other **Ã¢ÂÂ¬361.938m**); **op profit Ã¢ÂÂ¬96.181m**; **gain Ã¢ÂÂ¬145.696m** (vs 57.3m 2024). **Assets Ã¢ÂÂ¬1,692.302m**; equity **Ã¢ÂÂ¬519.158m**; minority **Ã¢ÂÂ¬411.121m**; payable **Ã¢ÂÂ¬761.306m**; personnel **Ã¢ÂÂ¬426.091m**; CAPEX acquisitions **Ã¢ÂÂ¬272.786m**; cash investments **Ã¢ÂÂ¬679.070m**. Dual **VITO** inkomsten 297m/personnel 129m. Strong confidence.
...
- FOI opened: gap_imec_vl_toelage_l5_2025 Ã¢ÂÂ ready (not sent)
- Next: rq_586; progress@600 in 6 ticks; rq_116 deferred

### 2026-07-31T14:30:00Z Ã¢ÂÂ tick 595
- Unit: rq_586 (FOI-adjacent dual Flanders SOC hole-fill Ã¢ÂÂ **VIB** dual imec/VITO)
- Found: **VIB** Annual Report 2024 (primary PDF). **Op income Ã¢ÂÂ¬168.830m** (grants **Ã¢ÂÂ¬122.852m** ÃÂ· contract **Ã¢ÂÂ¬44.050m**); op exp **Ã¢ÂÂ¬167.795m**; personnel **Ã¢ÂÂ¬92.884m**; **profit Ã¢ÂÂ¬2.676m**. **Assets Ã¢ÂÂ¬309.061m** (investments **Ã¢ÂÂ¬175.186m** ÃÂ· allocated funds **Ã¢ÂÂ¬124.490m** ÃÂ· cash **Ã¢ÂÂ¬7.167m**). Industrial income **Ã¢ÂÂ¬27.1m**; **1,900 FTE**. Dual SOC trio with **imec** 1.22bn / **VITO** 297m. Strong confidence.
...
- FOI opened: gap_vib_vl_grant_l5_2024 Ã¢ÂÂ ready (not sent)
- Next: rq_587; progress@600 in 5 ticks; rq_116 deferred

### 2026-07-31T14:45:00Z Ã¢ÂÂ tick 596
- Unit: rq_587 (FOI-adjacent dual Flanders SOC hole-fill Ã¢ÂÂ **Flanders Make** dual imec/VIB/VITO)
- Found: **Flanders Make** Activity Report 2025 (primary balance image + site conclusion). **Revenues Ã¢ÂÂ¬37.325m** (turnover **Ã¢ÂÂ¬33.220m**: convenant **Ã¢ÂÂ¬20.876m** ÃÂ· non-convenant **Ã¢ÂÂ¬10.980m** ÃÂ· membership **Ã¢ÂÂ¬1.364m** + other **Ã¢ÂÂ¬4.105m**); costs **Ã¢ÂÂ¬37.134m** (salaries SS **Ã¢ÂÂ¬24.319m** ÃÂ· op **Ã¢ÂÂ¬12.440m**); **op result Ã¢ÂÂ¬0.191m**; fin **Ã¢ÂÂ¬1.710m**; tax **Ã¢ÂÂ¬0.356m**; **profit Ã¢ÂÂ¬1.545m**. **Assets Ã¢ÂÂ¬234.739m** (cash **Ã¢ÂÂ¬131.396m** ÃÂ· stocks **Ã¢ÂÂ¬42.818m**); equity **Ã¢ÂÂ¬26.028m**; creditors **Ã¢ÂÂ¬208.648m** (ST 105.6 ÃÂ· reg 86.6). Ecosystem graphic: **Ã¢ÂÂ¬134m** rev ÃÂ· **+1100** researchers ÃÂ· **+210** members ÃÂ· 526 companies ÃÂ· 1200 projects. Dual SOC quartet vs **imec** 1.22bn / **VIB** 169m / **VITO** 297m (FM smallest manufacturing). Strong confidence.
...
- FOI opened: gap_fm_vl_convenant_l5_2025 Ã¢ÂÂ ready (not sent)
- Next: rq_588; progress@600 in 4 ticks; rq_116 deferred

### 2026-07-31T15:00:00Z Ã¢ÂÂ tick 597
- Unit: rq_588 (FOI-adjacent dual agri research hole-fill Ã¢ÂÂ **ILVO** VO/EV)
- Found: **ILVO** AR2024 (primary PDF) + **Rekenhof** Onderzoek VL begroting 2025 p52. Dual **IVA ILVO-VO**: inkomsten **Ã¢ÂÂ¬2.6m** ÃÂ· uitgaven **Ã¢ÂÂ¬24.9m** VAK/VEK. **EV ILVO**: ESR in **Ã¢ÂÂ¬34.4m** ÃÂ· ESR out **Ã¢ÂÂ¬50.3m**. Staff Dec2024 **756** / FTE **710.7** (VO 206/191.6 ÃÂ· EV 550/519.1). Base endowment **29%** of op funds ÃÂ· project **71%**; mix ALZ 29+9 ÃÂ· VLAIO 4 ÃÂ· VL domains 6 ÃÂ· federal 12 ÃÂ· EU 14 ÃÂ· other 25. EV/VO ~2/3Ã¢ÂÂ1/3. Absolute total werkingsmiddelen not published Ã¢ÂÂ FOI. Dual CRA-W WAL class residual. Strong on CoA Ã¢ÂÂ¬ + AR structure.
...
- FOI opened: gap_ilvo_total_op_funds_l5_2024 Ã¢ÂÂ ready (not sent)
- Next: rq_589; progress@600 in 3 ticks; rq_116 deferred

### 2026-07-31T15:15:00Z Ã¢ÂÂ tick 598
- Unit: rq_589 (FOI-adjacent dual agri research hole-fill Ã¢ÂÂ **CRA-W** dual ILVO)
- Found: **CRA-W** budget ajustÃÂ© 2025 (primary dÃÂ©cret 9 Jul 2025 Art.21 Wallex): **recettes Ã¢ÂÂ¬53.417m** ÃÂ· **dÃÂ©penses Ã¢ÂÂ¬54.839m**. **RA 2025** (primary PDF): staff **454** (scientifiques **141**; hires **34**); statut mix 31% statutaire / 34% CDI / 33% CDD. Dual ILVO: WAL single UAP **54.8m/454** vs VL IVA **24.9m** + EV **50.3m** / **756** staff. Strong confidence.
...
- FOI opened: gap_craw_comptes_l5_2025 Ã¢ÂÂ ready (not sent)
- Next: rq_590; progress@600 in 2 ticks; rq_116 deferred

### 2026-07-31T15:30:00Z Ã¢ÂÂ tick 599
- Unit: rq_590 (FOI-adjacent dual marine research hole-fill Ã¢ÂÂ **VLIZ** dual ILVO/Belgica)
- Found: **VLIZ** management indicators 2025 (primary PDF). **Turnover Ã¢ÂÂ¬19.610837m** (2025) ÃÂ· **Ã¢ÂÂ¬26.402745m** (2024 spike) ÃÂ· **Ã¢ÂÂ¬19.162933m** (2023). **Flemish grants Ã¢ÂÂ¬11.879m** ÃÂ· **external financing Ã¢ÂÂ¬10.07797m** (84.8% of Flemish grants). Social liability **Ã¢ÂÂ¬1.593513m**. Staff **178** (fixed 66 ÃÂ· contractual 109). 27 new external projects. Dual marine vs **ILVO** stack (InnovOcean Ostend) + RV Belgica federal. Project revenue methodology change 2025 noted. Strong confidence.
...
- FOI opened: gap_vliz_jaarrekening_l5_2025 Ã¢ÂÂ ready (not sent)
- Next: rq_591; **progress@600 next tick**; rq_116 deferred

### 2026-07-31T15:45:00Z Ã¢ÂÂ tick 600 (PROGRESS MILESTONE)
- Unit: rq_591 (progress@600 + **dual public research wave synthesis** ticks591-599)
- Found (synthesis strong, primary-sourced no invent euros):
  - **Flanders SOC quartet:** imec consol op income **1.22bn** ÃÂ· VIB **169m**/1900 FTE ÃÂ· VITO **297m**/~1300 ÃÂ· Flanders Make **37.3m**/convenant **21m**/assets **235m**
  - **Agri dual:** ILVO IVA **24.9m**/EV ESR **50.3m**/staff **756** ÃÂ· CRA-W dep **54.8m**/staff **454**
  - **Marine + env:** VLIZ turnover **19.6m** (2024 spike **26.4m**) ÃÂ· ISSeP **34.8m** dual VITO ÃÂ· SPAQuE soil dual OVAM
- Progress coverage:
  - **A/B:** 100% (L0 TE + L1 subsectors)
  - **C L2:** ~**99%** (+ dual research RTOs ÃÂ· prior COPIDEC/OAA/utility)
  - **D L5:** ~**40-53%** generous (research dual wave ÃÂ· not near-complete of 348bn)
  - **E FOI ready:** ~**342** ÃÂ· answered ~**9** ÃÂ· total FOI rows ~**352**
- Inventory: budgets ~**11093** ÃÂ· cmt ~**1197** ÃÂ· lb ~**2334** ÃÂ· sources ~**1163** ÃÂ· entities ~**434**
- Waste top10: **unchanged** fossil/cars/cheque/consultancy (priority 8.55Ã¢ÂÂ8.30); stocks Metro3 still top raw prio but annual=0 filtered
- High-abs + dual NEW: SOC quartet ÃÂ· agri CRA-W/ILVO ÃÂ· marine VLIZ/ILVO ÃÂ· env ISSeP/VITO
- Gain 590Ã¢ÂÂ600: Flanders dual research / agri / marine / env science wave
...
### 2026-07-31T16:00:00Z Ã¢ÂÂ tick 601
- Unit: rq_592 (FOI-adjacent dual community science hole-fill Ã¢ÂÂ **Plantentuin Meise** dual VL/FWB)
- Found: **Plantentuin Meise** JV2025 (primary PDF, prelim). **Ontvangsten Ã¢ÂÂ¬33.291m** (VL dotatie **Ã¢ÂÂ¬16.366m** ÃÂ· FFEU invest **Ã¢ÂÂ¬8.105m** ÃÂ· eigen/project **Ã¢ÂÂ¬8.820m** of which entrance **1.955** projects **4.240** federal **0.849**). **Uitgaven Ã¢ÂÂ¬30.004m** (salaries **Ã¢ÂÂ¬16.056m** 53.5% ÃÂ· invest/repairs **Ã¢ÂÂ¬9.022m**). Saldo **+Ã¢ÂÂ¬3.287m** (invest underspend). Staff **217** 1Jan2026 (VL **101** ÃÂ· FWB **25** ÃÂ· own **91**) Ã¢ÂÂ classic dual community funding of one garden. Strong confidence (prelim).
...
- FOI opened: gap_meise_final_accounts_l5_2025 Ã¢ÂÂ ready (not sent)
- Next: rq_593; progress@610 in 9 ticks; rq_116 deferred

### 2026-07-31T16:15:00Z Ã¢ÂÂ tick 602
- Unit: rq_593 (FOI-adjacent dual stats hole-fill Ã¢ÂÂ **IWEPS** dual multi-layer stats)
- Found: **IWEPS** RA2024 (primary PDF) + decret Art.22 2025. **Recettes 2024 Ã¢ÂÂ¬9.066m** (dot fonct **Ã¢ÂÂ¬7.742m** ÃÂ· ODT **0.103m** ÃÂ· FWB synergy **0.194m** ÃÂ· federal precompte **0.602m** ÃÂ· other sub **0.413m**). **DÃÂ©penses Ã¢ÂÂ¬11.394m** (personnel **Ã¢ÂÂ¬6.836m** ÃÂ· services **0.910m** ÃÂ· tresorerie transfer **Ã¢ÂÂ¬3.0m** ÃÂ· inventaire **0.105m** ÃÂ· missions **0.543m**); hors transfer **Ã¢ÂÂ¬8.394m** (+9.67% YoY). Staff **60** / ETP **58.3** (research **41**). Budget 2025b: rec **Ã¢ÂÂ¬9.288m** / dep **Ã¢ÂÂ¬17.213m**. Dual multi-layer stats (Statbel/IBSA/FWB). Strong confidence.
...
- FOI opened: gap_iweps_2025_outturn_l5 Ã¢ÂÂ ready (not sent)
- Next: rq_594; progress@610 in 8 ticks; rq_116 deferred

### 2026-07-31T16:30:00Z Ã¢ÂÂ tick 603
- Unit: rq_594 (FOI-adjacent dual multi-layer stats hole-fill Ã¢ÂÂ **IBSA** dual IWEPS)
- Found: **IBSA** RA2025+2024 (primary PDFs). Embedded **department of perspective.brussels** (not standalone UAP). Staff **42** (end-2025) / **41** (end-2024). Ops credits only: **2025 eng Ã¢ÂÂ¬809k / liq Ã¢ÂÂ¬680k**; **2024 eng Ã¢ÂÂ¬1.130m / liq Ã¢ÂÂ¬516k**. Personnel/comms/IT **in Perspective parent AB** Ã¢ÂÂ incomplete public TCO. Dual **IWEPS** full UAP rec **Ã¢ÂÂ¬9.1m** / staff **60** vs IBSA ops-only **Ã¢ÂÂ¬0.68m** / staff **42**. Strong confidence; residual full TCO FOI.
...
- FOI opened: gap_ibsa_full_tco_l5_2025 Ã¢ÂÂ ready (not sent)
- Next: rq_595; progress@610 in 7 ticks; rq_116 deferred

### 2026-07-31T16:45:00Z Ã¢ÂÂ tick 604
- Unit: rq_595 (FOI-adjacent dual heritage hole-fill deepen Ã¢ÂÂ **AWaP** dual OE Flanders)
- Found: **AWaP** RA2025 (primary PDF) + decret Art.16. **EngagÃÂ© Ã¢ÂÂ¬46.075933m** ÃÂ· **liquidÃÂ© Ã¢ÂÂ¬49.134500m** ÃÂ· **subventions eng Ã¢ÂÂ¬31.313974m** (68%). RW subvention **Ã¢ÂÂ¬49.5m** ÃÂ· own **<Ã¢ÂÂ¬0.7m**. Staff **312**. Subs split: public **14.1m** ÃÂ· cadres **5.9m** ÃÂ· private **4.0m** ÃÂ· regional props **3.0m**. 176 dossiers. Budget 2025b: rec **Ã¢ÂÂ¬51.624m** / dep **Ã¢ÂÂ¬52.246m**. Dual OE Flanders VEK **Ã¢ÂÂ¬127.8m**. Strong confidence.
...
- FOI opened: gap_awap_subs_l5_2025 Ã¢ÂÂ ready (not sent)
- Next: rq_596; progress@610 in 6 ticks; rq_116 deferred

### 2026-07-31T17:00:00Z Ã¢ÂÂ tick 605
- Unit: rq_596 (FOI-adjacent dual climate hole-fill Ã¢ÂÂ **AWAC** dual VEKA)
- Found: **AWAC** SACA (primary CoA Table33 + decret Art.15). **BI2025 SEC:** recettes **Ã¢ÂÂ¬19.428m** ÃÂ· dÃÂ©penses **Ã¢ÂÂ¬19.333m** ÃÂ· solde **+Ã¢ÂÂ¬0.095m**. **BI2024 SEC:** rec **Ã¢ÂÂ¬19.664m** ÃÂ· dep **Ã¢ÂÂ¬23.142m** ÃÂ· solde **Ã¢ÂÂÃ¢ÂÂ¬3.478m** (path +Ã¢ÂÂ¬3.573m). Dual **VEKA** Flanders E&K domain VEK ~**Ã¢ÂÂ¬1.1bn** package scale vs AWAC agency **Ã¢ÂÂ¬19.3m**. Strong confidence budget; staff/RA residual FOI.
...
- FOI opened: gap_awac_ra_staff_l5_2025 Ã¢ÂÂ ready (not sent)
- Next: rq_597; progress@610 in 5 ticks; rq_116 deferred

### 2026-07-31T17:15:00Z Â tick 606
- Unit: rq_597 (FOI-adjacent dual climate hole-fill deepen Â **VEKA** apparaatrek dual AWAC)
- Found: **VEKA** BBT Energie & Klimaat Begrotingsuitvoering 2025 (primary VP PDF). **Apparaatrek QA QE0:** BA VAK **Â18.470m** / VEK **Â18.620m**; BA-JR **Â18.765m** / **Â18.985m**; **BU VAK Â16.828m** / VEK **Â16.730m**. **Lonen** BU **Â15.853m** / **Â15.782m** (BA-JR 17.787/17.937; underbenutting **Â1.934m** delayed Fit for 55 vacancies). **Werking** BU **Â0.976m** / **Â0.948m**. IVA zonder rechtspersoonlijkheid. Dual **AWAC** SACA SEC dep **Â19.333m** agency-scale (vs prior domain E&K VEK **~Â1.1Â1.2bn** policy package). Strong confidence; staff FTE residual FOI.
...
### 2026-07-31T17:30:00Z Â tick 607
- Unit: rq_598 (FOI-adjacent dual disaster hole-fill Â **FWCN** Type1)
- Found: **FWCN** Fonds wallon des calamitÃ©s naturelles (primary CoA Table33 + p26). **BI2025 SEC:** recettes **Â9.912m** Â· dÃ©penses **Â73.250m** Â· solde **-Â63.338m**. **BI2024 SEC:** rec **Â20.439m** Â· dep **Â111.639m** Â· solde **-Â91.200m** (path dep -Â38.389m). Gov SEC objectif **-Â165m** (indemnitÃ©s inondations juil2021; subsidies versÃ©es 2022-23) vs budget project **-Â63.3m** (dossiers en cours). Type1 UAP BCE **772472960**. Dual VL disaster residual FOI. Strong confidence SEC; claims L5 residual.
...
### 2026-07-31T17:45:00Z Â tick 608
- Unit: rq_599 (FOI-adjacent dual CAP hole-fill deepen Â **OPW** SACA dual VL Landbouw)
- Found: **OPW** Organisme Payeur de Wallonie (primary CoA Table33 + decret Art.17). **BI2025 SEC:** recettes **Â84.961m** Â· dÃ©penses **Â84.961m** Â· solde **0**. **BI2024 SEC:** rec **Â89.090m** Â· dep **Â111.790m** Â· solde **-Â22.700m** (path dep -Â26.829m / solde +Â22.7m). **BA2025b:** rec=dep **Â87.873m**. Prior DO15 2026 package **Â81.813m**. Dual **VL Landbouw** domain VEK **Â140.8m**. Strong confidence; staff/RA residual FOI.
...
### 2026-07-31T18:00:00Z Â tick 609
- Unit: rq_600 (FOI-adjacent dual agri promo hole-fill Â **APAQ-W** Type2 dual VL)
- Found: **APAQ-W** Agence wallonne pour la promotion d'une agriculture de qualitÃ© (primary CoA Table33 + Wallex Type2 list). **BI2025:** recettes **Â14.197m** Â· dÃ©penses **Â14.759m** Â· solde **-Â0.562m**. **BI2024:** rec **Â11.185m** Â· dep **Â11.452m** Â· solde **-Â0.267m** (dep path **+Â3.307m**). Type2 UAP BCE **267400492**. Dual **VL TK Promotie** **Â5.659m** BO2026 (+ VLAM full residual FOI). Strong confidence CoA; campaign/staff L5 residual.
...
### 2026-07-31T18:15:00Z Â tick 610 (PROGRESS MILESTONE)
- Unit: rq_601 (progress@610 + **dual SACA/UAP wave synthesis** ticks601-609)
- Found (synthesis strong, primary-sourced no invent euros):
  - **Climate agency dual:** AWAC SEC dep **19.3m** Â· VEKA apparaatrek BU **16.8m** (lonen **15.9m**; domain E&K **~1.2bn** separate)
  - **Heritage dual:** AWaP liq **49.1m**/subs **31.3m**/staff **312** Â· OE Flanders VEK **128m**
  - **Stats dual:** IWEPS rec **9.1m**/staff **60** Â· IBSA ops **0.68m**/staff **42** (TCO FOI)
  - **CAP + disaster + agri promo:** OPW SEC **85.0m** Â· FWCN dep **73.3m**/solde **-63.3m** (gov **-165m**) Â· APAQ-W **14.8m** dual VL TK **5.7m**
  - **Community:** Meise **33.3m**/staff **217** dual VL/FWB
- Progress coverage:
  - **A/B:** 100% (L0 TE + L1 subsectors)
  - **C L2:** ~**99%** (+ dual climate/heritage/stats/CAP/disaster Â· prior research/utility)
  - **D L5:** ~**41-54%** generous (not near-complete of 348bn)
  - **E FOI ready:** ~**349** Â· answered ~**9** Â· total FOI rows ~**363**
- Inventory: budgets ~**11224** Â· cmt ~**1219** Â· lb ~**2389** Â· sources ~**1191** Â· entities ~**443**
- Waste top10: **unchanged** fossil/cars/cheque/consultancy (priority 8.55Â8.30)
- High-abs + dual NEW: climate AWAC/VEKA Â· heritage AWaP Â· FWCN solde gap Â· CAP OPW
...
### 2026-07-31T18:30:00Z Â tick 611
- Unit: rq_602 (FOI-adjacent dual local finance hole-fill Â **CRAC** Type1)
- Found: **CRAC** Centre rÃ©gional d'aide aux communes (primary CoA Table33+10 + decret Art.3/6/19). **Fonct SEC BI2025:** rec=dep **Â7.710m** (BI2024 **Â7.965m**). **BA2025b fonct:** **Â8.020m**. **Alt finance impact** Table10: CRAC **Â13.067m** BI2025 vs **Â26.285m** BA2024 (path -Â13.2m); FA **Â21.928m** Â· PWI **-Â12.213m** Â· long terme **Â3.352m** (was **Â23.625m**). **Fonds communes** CRAC channel **Â38.553m** BA2025b. Prior Oxygene borrow **Â210m**. Type1 BCE **254714773**. Dual VL local finance residual FOI. Strong confidence; loan book L5 residual.
...
### 2026-07-31T18:45:00Z Â tick 612
- Unit: rq_603 (FOI-adjacent dual vocational hole-fill deepen Â **IFAPME** Type2 SEC dual SYNTRA)
- Found: **IFAPME** (primary CoA Table33 + prog112). **BI2025 SEC:** recettes **Â142.518m** Â· dÃ©penses **Â142.212m** Â· solde **+Â0.306m**. **BI2024 SEC:** rec **Â140.156m** Â· dep **Â149.850m** Â· solde **-Â9.694m** (path solde **+Â10.0m**). **Prog 112 / EPJE class:** ~**Â82.3m** BI2025 (CoA) / **Â88.3m** 2026 Â **subset** of full SEC UAP (**gap ~Â60m** own/other residual FOI). Dual **SYNTRA** package **Â49.7m**. Strong confidence SEC; perimeter recon FOI.
...
### 2026-07-31T19:00:00Z Â tick 613
- Unit: rq_604 (FOI-adjacent dual tourism hole-fill deepen Â **CGT** Tourisme Wallonie Type1)
- Found: **CGT** Commissariat gÃ©nÃ©ral au tourisme (primary CoA Table33 + decret Art.23). **BI2025:** recettes **Â64.998m** Â· dÃ©penses **Â66.998m** Â· solde **-Â2.000m**. **BI2024:** rec **Â73.657m** Â· dep **Â81.296m** Â· solde **-Â7.639m** (dep path **-Â14.298m**). **BA2025b:** rec **Â68.845m** / dep **Â70.845m**. Prior DO fonct sub **Â48.578m** 2026 is **subset** of full SEC. Dual **Toerisme VL** SQ **Â74.8m** + **visit.brussels** **Â14.9m** + **VISITWallonia** promo **Â13.1m**. Strong confidence; staff/L5 awards residual FOI.
...
### 2026-07-31T19:15:00Z Â tick 614
- Unit: rq_605 (FOI-adjacent dual export hole-fill deepen Â **AWEX** Type2 SEC dual FIT/hub)
- Found: **AWEX** (primary CoA Table33 + p26). **BI2025 SEC:** recettes **Â72.733m** Â· dÃ©penses **Â79.385m** Â· solde **-Â6.652m**. **BI2024 SEC:** rec **Â80.086m** Â· dep **Â91.231m** Â· solde **-Â11.145m** (dep path **-Â11.846m** / solde path **+Â4.493m**). CoA notes dotation cut path **~-Â9m**. Prior EP package **Â67.547m** 2025 / **Â76.843m** 2026 is **subset** of full SEC (**gap ~Â11.8m** 2025 residual FOI). Dual **FIT** package **Â63.1m** + **hub.brussels** **Â46.2m**. Strong confidence; staff/L5 residual FOI.
...
### 2026-07-31T19:30:00Z Â tick 615
- Unit: rq_606 (FOI-adjacent dual public-admin school hole-fill Â **EAP** Type2 joint FWB-RW)
- Found: **EAP** Ãcole d'administration publique commune (primary CoA Table33 + p58 + FWB share). **BI2025:** recettes **Â7.146m** Â· dÃ©penses **Â6.692m** Â· solde **+Â0.454m**. **BI2024:** rec=dep **Â7.147m**. CoA note RW dotation **~Â4.5m** (no increase). Prior **FWB share Â2.592m** BI2026 (**35%** dual key). Classic dual one-school two-funders. Strong confidence; staff/funding recon residual FOI.
...
- Progress coverage:
  ...
  - **E FOI ready:** ~**358** Â· answered ~**9** Â· total FOI rows ~**372**
- Inventory: budgets ~**11309** Â· cmt ~**1236** Â· lb ~**2445** Â· sources ~**1216** Â· entities ~**444**
- Waste top10: **unchanged** fossil/cars/cheque/consultancy (priority 8.55-8.30)
- High-abs + dual NEW: Forem/VDAB Â· WBI Â· AWEX Â· CGT Â· IFAPME Â· ISSeP Â· inland ports
...
- Found: **Sowaer objet social** (primary CoA Table33). **BI2025:** rec **EUR52.986m** / dep **EUR81.366m** / solde **-EUR28.380m**. **BA2024:** rec **EUR54.577m** / dep **EUR68.034m** / solde **-EUR13.457m** (path dep **+EUR13.333m** / solde **-EUR14.923m**). **Secteur aÃÂ©roportuaire impact:** BA2024 **+EUR27.486m** / BI2025 **-EUR28.391m** (path **-EUR55.877m**). **DF046** BI2025 CE **EUR90.776m** / CL **EUR90.797m** (path vs BA2024 **+EUR6.2m** eng / **+EUR6.3m** liq). Missions dÃÂ©lÃÂ©guÃÂ©es **EUR2.822m** BI2025; treasury rembours **EUR20m**; BA2024 ajust **+EUR34.1m** (baux +13.5 / ZAE +7.1 / LiÃÂ¨ge invest slow +15.3). Dual **BAC** rev **EUR828m** / **BSCA** turnover class **EUR127m**. Strong confidence CoA; stake/DF046 recon residual FOI.
...
- Progress coverage:
  ...
  - **E FOI ready:** ~**372** ÃÂ· answered ~**9** ÃÂ· total FOI rows ~**382**
- Inventory: budgets ~**11468** ÃÂ· cmt ~**1261** ÃÂ· lb ~**2501** ÃÂ· sources ~**1239** ÃÂ· entities ~**447**
- Waste top10: **unchanged** fossil/cars/cheque/consultancy (priority 8.55-8.30)
- High-abs + dual NEW: AViQ ÃÂ· housing tripod ÃÂ· WE claimed cut ÃÂ· SPAQuE Nordion ÃÂ· Kyoto stock ÃÂ· Sowaer sector path
...
- Progress coverage:
  ...
  - **E FOI ready:** ~**382** ÃÂ· answered ~**9** ÃÂ· total FOI rows ~**392**
- Inventory: budgets ~**11626** ÃÂ· cmt ~**1300** ÃÂ· lb ~**2557** ÃÂ· sources ~**1259** ÃÂ· entities ~**460**
- Waste top10: **unchanged** fossil/cars/cheque/consultancy (priority 8.55-8.30)
- High-abs + dual NEW: DO16 prive -90m ÃÂ· OTW CSP 22m ÃÂ· EPR ghost 1.3m ÃÂ· SEE 200m no EU ÃÂ· env stock 495m ÃÂ· dual DO17/14/16 maps
...
### 2026-08-01T03:15:00Z -- tick 646
- Unit: rq_637 (FOI-adjacent dual recovery hole-fill -- **DO10 Secretariat + PRW/FRR** dual VV)
- Found: **DO10** (primary CoA): BI2025 CE **EUR732.8m** / CL **EUR2.274bn** (path eng **-EUR1.303bn** / liq **-EUR117.3m**). **Prog 122 PRW+FRR:** CE **EUR713.5m** / CL **EUR2.255bn** (path eng **-EUR1.286bn** / liq **+EUR16.0m**); provision eng **EUR444.1m** (path **-43.7%** vs BI2024 **EUR1.017bn**); exec class only **EUR4.6m** vs CL 2.255bn. **FRR rec EUR920m** + **RePower EUR109.6m**. Trajectory **EUR2.240bn** BI2025 â **EUR1.181bn** 2026 â **EUR150m** 2028-29. Prog028 zeroed (**-EUR119.5m** CL reclass). Companion **DO12 Digital** CL **EUR55.1m**. Dual **Vlaamse Veerkracht** cum **EUR4.2bn** / paid **EUR3.5bn** / underuse 2025 **EUR342m**. Strong confidence CoA; project L5 residual FOI.
...
- Progress coverage:
  ...
  - **E FOI ready:** ~**392** Â· answered ~**9** Â· total FOI rows ~**402**
- Inventory: budgets ~**11878** Â· cmt ~**1345** Â· lb ~**2612** Â· sources ~**1278** Â· entities ~**471**
- Waste top10: **unchanged** fossil/cars/cheque/consultancy (priority 8.55-8.30)
- High-abs + dual NEW: OCPP requalif 125m Â· encours incomplete 2.08bn Â· FWCN gap 165/63 Â· PRW 2.25bn Â· debt 30bn Â· Ste-Emilie 4.67bn
...
### 2026-08-01T08:15:00Z -- tick 666
- Unit: rq_657 (FOI-adjacent dual fiscal residual -- **aju2026 full DO CE/CL matrix + SPW remun 740.8m + Emploi Table13 + OCPP/sous-util**)
