# ephemeral tick2021 — PPC Pittem YE2025 Medium (leftover psych dual after PC Sint-Hiëronymus EVERY-10)
import csv
import sys
...
SRC_KBO = "src_ppc_pittem_kbo_2021"
SRC_SITE = "src_ppc_pittem_site_2021"
...
for ns in [
    {
        **{k: "" for k in sfields},
        ...
        "notes": f"tick2021; YE2025 omzet JUMP {OMZET} pnl JUMP {PNL} equity JUMP {EQUITY} bruto JUMP {BRUTO} FTE {FTE}; neerlegging 10.07.2026; assets/debt Unknown; raw docs/doge/data/raw/tick2021/ppc_pittem.html",
    },
    {
        **{k: "" for k in sfields},
        "source_id": SRC_EN,
        ...
        "accessed_date": "2026-08-24",
        "source_class": "secondary_aggregator",
        "notes": "tick2021; EN mirror YE2025 Medium; filed 10-07-2026; Last balance sheet year 2025; FTE 291.6; raw docs/doge/data/raw/tick2021/ppc_pittem_en.html",
    },
    {
        **{k: "" for k in sfields},
        "source_id": SRC_FR,
        ...
        "accessed_date": "2026-08-24",
        "source_class": "secondary_aggregator",
        "notes": "tick2021; FR mirror YE2025 Medium; déposés le 10-07-2026; raw docs/doge/data/raw/tick2021/ppc_pittem_fr.html",
    },
    {
        **{k: "" for k in sfields},
        "source_id": SRC_KBO,
        ...
        "notes": "tick2021; Actief VZW since 26.10.1964; Boterstraat 6 8740 Pittem; 1 VE; no KBO email; commercial name Kliniek Sint-Jozef VZW",
    },
    {
        **{k: "" for k in sfields},
        "source_id": SRC_SITE,
        ...
        "notes": "tick2021; info@ppcpittem.be; Boterstraat 6 8740 Pittem; Tel 051 46 70 41",
    },
]:
...
for nb in [
    {
        ...
        "source_id": SRC,
        "confidence": "medium",
        "notes": f"tick2021; omzet JUMP {OMZET} +9.00pct vs YE2024 {OMZET24}",
    },
    {
        ...
        "source_id": SRC,
        "confidence": "medium",
        "notes": f"tick2021; pnl JUMP {PNL} +115.08pct vs YE2024 {PNL24}",
    },
    {
        ...
        "source_id": SRC,
        "confidence": "medium",
        "notes": f"tick2021; equity JUMP {EQUITY} +2.43pct vs YE2024 {EQUITY24}",
    },
    {
        ...
        "source_id": SRC,
        "confidence": "medium",
        "notes": f"tick2021; bruto JUMP {BRUTO} +2.43pct vs YE2024 {BRUTO24}",
    },
    {
...
nc = {
    **{k: "" for k in cfields},
    ...
    "notes": "tick2021; Medium CW; assets/debt Unknown; preferred AGB Bornem JR2024; FARO NBB YE2025 unpublished; AIESH/REW still opaque/YE2024; Maria Rustoord YE2025 deferred; Vincentius Avelgem YE2025 deferred",
}
...
nlb = {
    **{k: "" for k in lfields},
    ...
    "status": "active",
    "struck_reason": "",
    "notes": "tick2021 leftover psych dual; Medium CW; TE-adjacent care flow not pure-waste top10; next every-10 2030",
}
...
ne = {
    **{k: "" for k in efields},
    ...
    "notes": (
        "tick2021 YE2025 Medium CW NL+EN+FR + Strong KBO 0409.956.147 Actief VZW; omzet JUMP 42.45m pnl JUMP 2.27m equity JUMP 82.90m bruto JUMP 23.34m FTE 291.6; "
        "assets/debt Unknown; neerlegging 10.07.2026; 1 VE; FOI "
        + GAP
        + "; preferred AGB Bornem JR2024; FARO/AIESH/REW YE2024; do not redo PC Sint-Hiëronymus/WZC Sint-Barbara/PC Gent-Sleidinge/AZ Rivierenland/AZ Zeno/HH Tienen/HH Leuven/Sint-Trudo/Sint-Andries/HH Lier/Vlaamse Zorgkas/OLVT/AZ Oostende/Glorieux/Alma/Herentals/Vitaz/Emmaüs/AZORG/Z.org/AZ Delta/AZJP/ZAS"
    ),
}
...
- Preferred stall: AGB Bornem JR2024; FARO NBB YE2025 unpublished; AIESH/REW YE2024/opaque. PC Sint-Hiëronymus / WZC Sint-Barbara / PC Gent-Sleidinge already mined. Maria Rustoord / Vincentius Avelgem YE2025 deferred.
...
for x in qrows:
    if x.get("task_id") == "rq_2021":
        ...
        x["updated_utc"] = UTC
        x["entity_id"] = ENTITY
        x["title"] = "leftover dual hole-fill after PC Sint-Hiëronymus EVERY-10 — PPC Pittem YE2025 Medium"
        x["notes"] = (
            "tick2021 PPC Pittem Medium omzet JUMP 42.45m pnl JUMP 2.27m equity JUMP 82.90m; FOI ready; "
            "AGB Bornem JR2024; FARO/AIESH/REW YE2024; Maria Rustoord/Vincentius Avelgem YE2025 deferred; next rq_2022; next every-10 2030"
        )
        x["instructions"] = (
    ...
    qrows.append(
        {
            **{k: "" for k in qfields},
            ...
            "entity_id": "",
            "instructions": (
                "Tick 2021 after PPC Pittem YE2025 Medium. Prefer leftover AGB/APB if JR2025 PDF live, else FARO if TRUE NBB YE2025, else AIESH/REW if YE2025, "
                "else unused water/DSO/IGS/HVZ/energy/hospital/WZC/psych (Multiversum-Evara if not double-count / St Vincentius Avelgem YE2025 / Maria's Rustoord YE2025 / Sint-Carolus / Zilverbos / other unused YE2025 if live with omzet). "
                "Do NOT redo PPC Pittem, PC Sint-Hiëronymus, WZC Sint-Barbara Herselt, PC Gent-Sleidinge, AZ Rivierenland, AZ Zeno, Heilig Hart Tienen, Heilig Hart Leuven, Sint-Trudo, Sint-Andries Tielt, Heilig Hart Lier, Vlaamse Zorgkas, OLVT/AZ Sint-Blasius, AZ Oostende, Damiaan shell, Werken Glorieux, AZ Alma, AZ St.-Elisabeth Herentals, Vitaz, Emmaüs, AZORG, Z.org KU Leuven, AZ Delta, AZJP, ZAS, CHR Verviers, CNDG, Haute Senne, CHBA, Saint-Luc, GHdC, Humani, CHIREC, CHU Tivoli, CHR Citadelle, ISoSL, Epicura, CHwapi, CHU UCL Namur, IDETA, SPI, Vivalia, "
            ...
            "created_utc": UTC,
            "updated_utc": UTC,
            "notes": "spawned after tick2021 PPC Pittem; next every-10 2030; Maria Rustoord/Vincentius Avelgem YE2025 deferred",
        }
    )
...
lsrows[-1].update(
    {
        ...
        "paused": "no",
        "notes": (
            "tick2021 leftover PPC Pittem 0409.956.147 Medium CW (omzet JUMP 42.45m pnl JUMP 2.27m equity JUMP 82.90m bruto JUMP 23.34m FTE 291.6; "
            "assets/debt Unknown); AGB Bornem JR2024; FARO/AIESH/REW YE2024; Maria Rustoord/Vincentius Avelgem YE2025 deferred; next rq_2022; next every-10 2030; continuous hole_fill"
        ),
    }
)
...
## Tick 2021 - {UTC} - rq_2021 PPC Pittem (omzet JUMP 42.45m / pnl JUMP 2.27m / Medium)

- Unit: **rq_2021** leftover dual after **rq_2020 PC Sint-Hiëronymus EVERY-10**. Prefer NON-stall live: AGB Bornem still **JR2024-only**; FARO still **YE2024**; AIESH/REW still opaque/YE2024. Took preferred unused leftover **PPC Pittem** YE2025 (KBO **0409.956.147**; Boterstraat 6 Pittem; West-Vlaanderen **psych hospital VZW** / commercial Kliniek Sint-Jozef). Maria Rustoord / Vincentius Avelgem YE2025 live deferred. Do not redo PC Sint-Hiëronymus/WZC Sint-Barbara/PC Gent-Sleidinge/AZ Rivierenland/AZ Zeno/HH Tienen/Heilig Hart Leuven/Sint-Trudo/Sint-Andries/Heilig Hart Lier/Vlaamse Zorgkas/OLVT/AZ Oostende/Werken Glorieux/AZ Alma/AZ St.-Elisabeth Herentals/Vitaz/Emmaüs/AZORG/Z.org KU Leuven/AZ Delta/AZJP/ZAS.
...
- Wrote: sources (+5); budgets (+5); commitments (+1); leaderboard (+1); entities (+1 vzw_ppc_pittem); foi + draft {GAP}; rq_2021=done + rq_2022 open; loop_state ticks=2021; raw under docs/doge/data/raw/tick2021/.
- FOI: **ready not sent** (human-gated; info@ppcpittem.be).
- NOT every-10 (**next every-10 is 2030**). Next: rq_2022 (AGB/FARO-if-YE2025 / AIESH-REW / Multiversum-Evara / Vincentius Avelgem / Maria Rustoord / unused DSO-IGS-HVZ).
"""
