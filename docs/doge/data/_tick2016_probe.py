# ephemeral tick2016 — claim + prefer AGB/FARO/AIESH/REW else AZ Zeno/unused hospital
import csv
import re
import ssl
import sys
...
r = next(x for x in rows if x.get("task_id") == "rq_2016")
...
with p.open("w", encoding="utf-8", newline="") as f:
    ...
    w.writeheader()
    w.writerows(rows)
print("claimed rq_2016")

dst = Path("docs/doge/data/raw/tick2016")
...
targets = [
    ...
    ("azzeno_en", "https://www.companyweb.be/en/0410123819"),
    ("azzeno_nl", "https://www.companyweb.be/nl/0410123819"),
    ("azzeno_fr", "https://www.companyweb.be/fr/0410123819"),
    ("jessa_en", "https://www.companyweb.be/en/0413602857"),
    ("zol_en", "https://www.companyweb.be/en/0412120669"),
    ("klina_en", "https://www.companyweb.be/en/0434302850"),
    ("rivierenland_en", "https://www.companyweb.be/en/0455868415"),
    ("sfz_en", "https://www.companyweb.be/en/0411695746"),
]
