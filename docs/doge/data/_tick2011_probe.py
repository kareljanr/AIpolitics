# ephemeral tick2011 — claim + probe unused YE2025 hospitals
import csv
import re
import ssl
import sys
...
r = next(x for x in rows if x.get("task_id") == "rq_2011")
...
with p.open("w", encoding="utf-8", newline="") as f:
    ...
    w.writeheader()
    w.writerows(rows)
print("claimed rq_2011")

dst = Path("docs/doge/data/raw/tick2011")
...
def summarize(name):
    ...
    print(" FTE", em[:2], "blocks", len(blocks), blocks[:1])
    if blocks:
        try:
...
urls = [
    ...
    ("lier_en", "https://www.companyweb.be/en/0412080645"),
    ("lier_nl", "https://www.companyweb.be/nl/0412080645"),
    ("vesalius_en", "https://www.companyweb.be/en/0406735156"),  # guess
    ("sintjan_en", "https://www.companyweb.be/en/0418050495"),  # guess AZ Sint-Jan Brugge
    ("andries_en", "https://www.companyweb.be/en/0408661691"),
]
