...
| `lb_ab_nonreimb_share_12pct` | **8.5** | AB outside RIZIV control rising |
| `lb_amr_cost_281m` | **8.0** | resistance social cost |
| `lb_actiris_cpas_spill_34k` | **7.5** | **NEW 566** reform spillover DEI→CPAS +83% |
| `lb_dual_pes_four_rates` | **7.5** | **NEW 566** FL6.9 WAL14.3 BRU14.6 DG6.4 |
| `lb_dual_pt_four_layer` | **7.0** | **NEW 568** NMBS+De Lijn+STIB+TEC |
...
| `lb_infrabel_assets_25_7bn` / equity 20.5 | **25.7 / 20.5 bn** | **NEW 569** infra SOE balance |
| `lb_infrabel_etcs_2_8bn` | **2.8 bn** completed | **NEW 569** ETCS Masterplan done |
| `lb_infrabel_invest_1_27bn` / NMBS 820m | **1.27 / 0.82 bn**/yr | **569/160** dual rail capex |
...
| `lb_onem_wal_2_66bn` / fl 2.76 / bru 1.17 | **2.66 / 2.76 / 1.17 bn** | **564** dual ONEM region cash |
| `lb_riziv_care_39_7bn_2025` | **39.7 bn** | **561** care authorized outturn |
| `lb_tec_used_804m_2025` / dual PT three | **0.80 / multi bn** | **567** TEC dual De Lijn/STIB |
