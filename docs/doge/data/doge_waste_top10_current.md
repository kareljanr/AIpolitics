...
| 2 | `lb_ipolice_spent_77m_cancelled` | 9.0 | **76.7 m** | I-Police IT 76.7m spent then cancelled |
| 3 | `lb_vl_airco_mvp_luchtlucht` | 9.0 | **300** | Flanders MVP air-to-air heat pump (aircon dual-use) |
| 4 | `lb_company_cars_fpb` | 8.5 | **4.70 bn** | Company cars TE package FPB ~4.7-5.2bn |
| 5 | `lb_cheque_economy` | 8.5 | **1.07 bn** | Cheque economy meal vouchers (para)fiscal |
| 6 | `lb_ipolice_claim_228m` | 8.5 | **228.1 m** | I-Police vendor claim 228.1m |
| 7 | `lb_union_pay_admin_169m` | 8.5 | **169.00 m** | Union unemployment payment admin grants ~169m |
| 8 | `lb_vl_mijn_kortingsbon_appliances` | 8.5 | **3.66 m** | Flanders Mijn Kortingsbon 250 EUR fridge/washer |
