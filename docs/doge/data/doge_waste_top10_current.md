...
**As-of:** tick **1880** (2026-08-26) · **7662+** leaderboard rows  
...
**Stock filter (off pure annual top10):** Metro3 overrun/gap · OWV snowball **€27bn** eoy2083 · Hedera CAP · VL/WAL/FWB/BCR debt stocks · federal unconsol debt · **Defence eng / SAFE loans €8.34bn** · **EU GNI / MFF** · **Entity II HermReg €7.9bn** · **illness €14.2bn / RIZIV €41.3bn** · **SS spend €140bn class** · **MOG II €7–8bn** CAPEX · **university/city balance sheets** · **AGB/zorg dual + IGS/HVZ/CAW/CGG/woonmaatschappij shells** · **NEW leftover 1871-1880:** **iCUBES / Werkpand / BC Tienen / Hangar K / BC Mechelen** POM ladder · **LRM incubator stack Greenville / IncubaThor / C-Mine Crib / Droneport / Agropolis Service** · prior Digipolis/BCVA–De Punt/TRY Dendermonde/Bosgroep FOI · prior **Eneco continuum** · **LUWA PPP €590m** · private gambling **€31.5bn** market.

**Change vs tick 1870:** pure annual top10 **stable** (GIP #1; fossil/cars/cheque/reporté #2–10). Re-verified from leaderboard (corrupt AGB pi≥12 / Metro3 stock / OWV snowball stock filtered off). **Major NEW residual 1871-1880 (off pure top10 / dual):** POM bedrijfencentrum ladder continued + **LRM incubator stack** (Greenville→Agropolis). Count NEW since 1870: 10 residual dual ticks. **Prior Digipolis/Bosgroep/Eneco stack retained.** Not TE-additive of ~348bn.
