# ephemeral fetch tick2028 WZC De Foyer Gent
import re
import ssl
...
for name, url in [
    ("foyer_nl", "https://www.companyweb.be/nl/0413796456/woon-en-zorgcentra-de-foyer"),
    ("foyer_en", "https://www.companyweb.be/en/0413796456/woon-en-zorgcentra-de-foyer"),
    ("foyer_fr", "https://www.companyweb.be/fr/0413796456/woon-en-zorgcentra-de-foyer"),
    (
        "foyer_kbo",
        "https://kbopub.economie.fgov.be/kbopub/toonondernemingps.html?ondernemingsnummer=0413796456",
    ),
    ("foyer_site", "https://www.defoyer.be/"),
    ("foyer_site2", "https://defoyer.be/"),
]:
    try:
