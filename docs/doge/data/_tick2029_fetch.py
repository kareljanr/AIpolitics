# ephemeral fetch tick2029 Karus
import re
import ssl
...
for name, url in [
    ("karus_nl", "https://www.companyweb.be/nl/0861314369/karus"),
    ("karus_en", "https://www.companyweb.be/en/0861314369/karus"),
    ("karus_fr", "https://www.companyweb.be/fr/0861314369/karus"),
    (
        "karus_kbo",
        "https://kbopub.economie.fgov.be/kbopub/toonondernemingps.html?ondernemingsnummer=0861314369",
    ),
    ("karus_site", "https://www.karus.be/"),
]:
    try:
