# ephemeral tick2012 — claim + FARO/AIESH/REW + Sint-Andries YE2025
import csv
import re
import ssl
import sys
...
r = next(x for x in rows if x.get("task_id") == "rq_2012")
...
with p.open("w", encoding="utf-8", newline="") as f:
    ...
    w.writeheader()
    w.writerows(rows)
print("claimed rq_2012")

dst = Path("docs/doge/data/raw/tick2012")
...
urls = [
    ...
    ("andries_nl", "https://www.companyweb.be/nl/0408661691/sint-andriesziekenhuis"),
    ("andries_en", "https://www.companyweb.be/en/0408661691/sint-andriesziekenhuis"),
    ("andries_fr", "https://www.companyweb.be/fr/0408661691/sint-andriesziekenhuis"),
    (
        "andries_kbo",
        "https://kbopub.economie.fgov.be/kbopub/toonondernemingps.html?ondernemingsnummer=0408661691",
    ),
    ("andries_site", "https://www.sintandriestielt.be/"),
]
