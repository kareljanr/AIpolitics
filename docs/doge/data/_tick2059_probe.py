# ephemeral probe tick2059 candidates
import csv
import re
import ssl
...
def ent_hits(needle, kbo=""):
    hits = []
    for e in ents:
        blob = ((e.get("entity_id") or "") + (e.get("name") or "") + (e.get("notes") or "")).lower()
        if needle.lower() in blob or (kbo and kbo in blob):
            hits.append(e.get("entity_id"))
    return hits[:5]


for n, k in [
    ("vrijzicht", "0416337262"),
    ("christine", "0421903676"),
    ("zusterhof", "0473762450"),
    ("ter_burg", "0479401318"),
    ("ter burg", "0479401318"),
...
cands = [
    ...
    ("vrijzicht", "https://www.companyweb.be/en/0416337262/woon-en-zorgcentrum-home-vrijzicht-vzw"),
    ("christine", "https://www.companyweb.be/en/0421903676/woonzorgcentrum-christine"),
    ("zusterhof", "https://www.companyweb.be/en/0473762450/zusterhof-woon-en-zorgcentrum"),
    ("ter_burg", "https://www.companyweb.be/en/0479401318/woon-en-zorgcentrum-ter-burg"),
    ("wezembeek", "https://www.companyweb.be/en/0433419259/woon-en-zorgcentrum-onze-lieve-vrouw-te-wezembeek-oppem"),
    ("pura", "https://www.companyweb.be/en/0666565984/woon-en-zorgresidentie-pura"),
