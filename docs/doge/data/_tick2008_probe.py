# ephemeral tick2008 — claim + FARO/AIESH/REW/AGB Bornem + AZ Damiaan YE2025
import csv
import re
import ssl
import sys
...
UTC = "2026-08-24T06:10:00Z"

p = Path("docs/doge/data/research_queue.csv")
with p.open(encoding="utf-8", newline="") as f:
    rows = list(csv.DictReader(f))
    fields = list(rows[0].keys())
r = next(x for x in rows if x.get("task_id") == "rq_2008")
...
def summarize(name):
    ...
    for lab in ["Last balance sheet year", "filed on", "neergelegd op", "Laatste balansjaar", "déposés le"]:
        i = t.find(lab)
        if i >= 0:
...
urls = [
    ...
    ("damiaan_nl", "https://www.companyweb.be/nl/0464564177/damiaan-oostende"),
    ("damiaan_en", "https://www.companyweb.be/en/0464564177/damiaan-oostende"),
    ("damiaan_fr", "https://www.companyweb.be/fr/0464564177/damiaan-oostende"),
    ("azo_en", "https://www.companyweb.be/en/0800023336/algemeen-ziekenhuis-oostende"),
    ("mm_en", "https://www.companyweb.be/en/0405236067"),
    ("imelda_en", "https://www.companyweb.be/en/0409835490/imelda"),
    ("yperman_en", "https://www.companyweb.be/en/search?q=Jan+Yperman"),
]
