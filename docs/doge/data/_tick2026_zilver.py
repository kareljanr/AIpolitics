# ephemeral probe Zilverbos for tick2026
import re
import ssl
import urllib.request
from pathlib import Path

outdir = Path("docs/doge/data/raw/tick2026")
...
for name, url in [
    ("zilverbos_nl", "https://www.companyweb.be/nl/0644984078/woonzorgcentrum-zilverbos"),
    ("zilverbos_en", "https://www.companyweb.be/en/0644984078/woonzorgcentrum-zilverbos"),
    ("zilverbos_fr", "https://www.companyweb.be/fr/0644984078/woonzorgcentrum-zilverbos"),
    (
        "zilverbos_kbo",
        "https://kbopub.economie.fgov.be/kbopub/toonondernemingps.html?ondernemingsnummer=0644984078",
    ),
]:
    try:
        ...
        print(name, (title.group(1)[:80] if title else None), "year", year, "n", len(blocks))
        if blocks:
