# ephemeral tick2015 — claim + prefer AGB/FARO/AIESH/REW else AZ Zeno/Vesalius
import csv
import re
import ssl
import sys
...
r = next(x for x in rows if x.get("task_id") == "rq_2015")
...
urls = [
    ...
    ("aiesh_fr", "https://www.companyweb.be/fr/0201712587"),
    ("rew_en", "https://www.companyweb.be/en/0644638937"),
    ("rew_fr", "https://www.companyweb.be/fr/0644638937"),
    ...
    ("portaels_en", "https://www.companyweb.be/en/0407671418"),
