# ephemeral tick2013 — claim + FARO + Sint-Trudo / HH Leuven YE2025
import csv
import re
import ssl
import sys
...
r = next(x for x in rows if x.get("task_id") == "rq_2013")
...
with p.open("w", encoding="utf-8", newline="") as f:
    ...
    w.writeheader()
    w.writerows(rows)
print("claimed rq_2013")

dst = Path("docs/doge/data/raw/tick2013")
...
urls = [
    ...
    ("trudo_en", "https://www.companyweb.be/en/0443260603/sint-trudo-ziekenhuis"),
    ("trudo_nl", "https://www.companyweb.be/nl/0443260603/sint-trudo-ziekenhuis"),
    ("hhleuven_en", "https://www.companyweb.be/en/0412939886"),
    ("hhleuven_nl", "https://www.companyweb.be/nl/0412939886"),
    ("sintjan_en", "https://www.companyweb.be/en/0266559859"),
]
