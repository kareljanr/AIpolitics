# ephemeral fetch tick2064 Huize Sint-Jozef Ieper
import re
import ssl
...
nl = fetch(
    "huize_sj_nl.html",
    "https://www.companyweb.be/nl/0409942289/huize-sint-jozef",
)
en = fetch(
    "huize_sj_en.html",
    "https://www.companyweb.be/en/0409942289/huize-sint-jozef",
)
fr = fetch(
    "huize_sj_fr.html",
    "https://www.companyweb.be/fr/0409942289/huize-sint-jozef",
)
kbo = fetch(
    "huize_sj_kbo.html",
    "https://kbopub.economie.fgov.be/kbopub/toonondernemingps.html?ondernemingsnummer=0409942289",
)

site_html = None
for u in [
    "https://www.huizesintjozef.be/",
    "https://huizesintjozef.be/",
    "https://www.huizesj.be/",
    "https://www.sintjozefieper.be/",
    "https://www.wzcsintjozefieper.be/",
]:
    try:
        site_html = fetch("huize_sj_site.html", u)
        print("SITE OK", u)
        break
