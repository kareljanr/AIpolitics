...
print(
    "familiezorg mined?",
    mined("familiezorg west", "0405.112.085", "0405112085", "familiezorg-west-vlaanderen"),
)
...
CANDS = [
    ...
    ("0598966387", "de-hoeksteen-samenwerking-in-woonzorg"),
    ("0405112085", "familiezorg-west-vlaanderen"),
...
for kbo, slug in CANDS:
    ...
    try:
        ...
        print("FAIL", kbo, type(e).__name__, str(e)[:120])
