# tick2212 — Odas Brugge YE2025 Medium (omzet JUMP 11.34m / bruto≫omzet ~1.72x / pnl LOSS NARROW)
...
SRC_KBO = "src_odas_kbo_2212"
SRC_SITE = "src_odas_site_contact_2212"
...
def update_research_queue() -> None:
    ...
    r["updated_utc"] = UTC
    r["notes"] = (
        "tick2212 Odas 0407.201.149 YE2025 Medium CW NL+EN+FR; omzet 11339072 JUMP +12.36%; "
        ...
        "FARO/AIESH/REW YE2024; Groep Maatwerk YE2025 deferred; ECOSO YE2025 deferred"
    )
    r["instructions"] = (
        "DONE tick2212 Odas YE2025. Do not redo. Next: AGB/FARO-if-YE2025 / AIESH-REW / "
        "Groep Maatwerk or ECOSO or unused maatwerk-WZC-IGS."
    )
    # spawn rq_2213 if missing
    if "rq_2213" not in by_id:
        rows.append(
            {
                "task_id": "rq_2213",
                "title": (
                    "leftover dual hole-fill after Odas — prefer "
                    "AGB/FARO-YE2025/AIESH-REW/GroepMaatwerk-ECOSO-unused maatwerk-WZC-IGS"
                ),
                "sprint": "hole_fill",
                "priority": "8",
                "status": "open",
                ...
                "entity_id": "",
                "instructions": (
                    "Tick 2213 after rq_2212 Odas YE2025 Medium (omzet JUMP 11.34m / "
                    ...
                    "0421.292.675 YE2025 or ECOSO YE2025 or unused maatwerk/WZC/IGS with live sourced €. "
                    "Do not redo Odas/Werkhuizen MIN/ACG/Noordheuvel/Arcor/Kemphaan/Entiris/Oesterbank."
                ),
                "blocked_gap_id": "",
                "created_utc": UTC,
                "updated_utc": UTC,
                "notes": (
                    "spawned after tick2212 Odas; FARO/AIESH/REW still YE2024; AGB Bornem JR2024; "
                    "Groep Maatwerk + ECOSO YE2025 deferred; next EVERY-10 2220"
                ),
            }
        )
    else:
        by_id["rq_2213"]["status"] = "open"
        by_id["rq_2213"]["updated_utc"] = UTC
    write_csv(DATA / "research_queue.csv", fields, rows)
    print("research_queue updated; open head rq_2213")
...
def update_loop_state() -> None:
    ...
    row["paused"] = "no"
    row["notes"] = (
        "tick2212 Odas Brugge 0407.201.149 Medium (omzet JUMP 11.34m; bruto≫omzet ~1.72x 19.48m; "
        "pnl LOSS NARROW -285k; equity DROP 11.26m -3.15%; FTE DROP 518.1; 8 VE Brugge); "
        "AGB Bornem JR2024; FARO/AIESH/REW YE2024; Groep Maatwerk/ECOSO YE2025 deferred; "
        "next rq_2213; next every-10 2220; continuous hole_fill"
    )
...
- Assets/debt/cash Unknown. Preferred stall: AGB Bornem JR2024; FARO/AIESH/REW YE2024. Deferred FREE Groep Maatwerk / ECOSO YE2025.
...
def append_log() -> None:
    entry = f"""
## Tick {TICK} - {UTC} - rq_2212 Odas Brugge (omzet JUMP 11.34m / bruto≫omzet ~1.72x / pnl LOSS NARROW -285k / Medium)

- Unit: **rq_2212** leftover dual after **rq_2211 Werkhuizen MIN**. Prefer NON-stall live: AGB Bornem still **JR2024-only**; FARO still **YE2024**; AIESH still **404/YE2024-class**; REW still **YE2024**. Took named FREE leftover **Odas VZW** YE2025 (KBO **0407.201.149**; Pathoekeweg 11G Brugge; **Actief** **8 VE**; RSZ NACE **88.993**) — previously deferred as YE2024-only, now live. Deferred FREE Groep Maatwerk **0421.292.675** YE2025 / ECOSO YE2025. Do not redo Werkhuizen MIN/ACG/Noordheuvel/Arcor/Kemphaan/Entiris/Oesterbank/Werkplus/Trianval/Ijsedal/Aarova/MWP/AGE stack.
...
- Wrote: sources (+5); budgets (+6); commitments (+1); leaderboard (+1 pi 6.90); entities (+1 {ENTITY_ID}); foi + draft {GAP_ID}; rq_2212=done + rq_2213 open; loop_state ticks=2212; raw docs/doge/data/raw/tick2212/.
- FOI: **ready not sent** (human-gated).
- NOT every-10 (**last every-10 was 2210**; next **2220**). Next: rq_2213 (AGB/FARO-if-YE2025 / AIESH-REW / GroepMaatwerk-ECOSO-or-unused).
"""
        ...
        [
            ...
            },
            {
                ...
                "notes": (
                    ...
                    "Marge brute 19484424; Perte -285014; Capitaux propres 11259247; raw tick2212/"
                ),
            },
            {
                "source_id": SRC_KBO,
