...
def update_rq():
    ...
    for r in rows:
        if r.get("task_id") == RQ and r.get("status") == "open":
            ...
            r["instructions"] = (
                f"Completed leftover ZS Vesdre after Val de Sambre; "
        ...
        rows.append(
            {
                ...
                "instructions": (
                    ...
                    "Do NOT redo Zone de secours Vesdre, Zone de secours Val de Sambre, Zone de secours HEMECO, "
                    ...
                    "Denderrust Dienstengroep, Zorgcampus Denderrust, Brandweerzone Antwerpen, Flemish HVZ stack, "
...
for s in [
    {
        ...
        "notes": (
            ...
            f"no omzet-bruto-pnl-equity on free CW; raw docs/doge/data/raw/tick2151/vesdre_en.html"
        ),
    },
    {
        "source_id": "src_vesdre_cw_nl_2151",
        "title": "Companyweb NL Zone de secours Vesdre-Hoëgne & Plateau",
        "url": f"https://www.companyweb.be/nl/{KBO_DIGITS}",
        "publisher": "Companyweb",
        "accessed_date": "2026-08-25",
        "source_class": "secondary_aggregator",
        "notes": f"tick{TICK}; NL mirror; FTE {FTE}; Brandweer; no YE kerncijfers; raw tick2151/vesdre_nl.html",
    },
    {
        "source_id": "src_vesdre_cw_fr_2151",
        "title": "Companyweb FR Zone de secours Vesdre-Hoëgne & Plateau",
        "url": f"https://www.companyweb.be/fr/{KBO_DIGITS}",
        "publisher": "Companyweb",
        "accessed_date": "2026-08-25",
        "source_class": "secondary_aggregator",
        "notes": f"tick{TICK}; FR mirror; raw tick2151/vesdre_fr.html",
    },
    {
...
append_csv(
    DATA / "entities.csv",
    {
        ...
        "notes": (
            ...
            "DISTINCT Val de Sambre / HEMECO / WAPI / Hesbaye / Dinaphi / Hainaut-Centre / Brandweerzone Antwerpen / Flemish HVZ; ~19 communes"
        ),
    },
)
...
append_csv(
    DATA / "budgets.csv",
    {
        "budget_id": "bud_vesdre_fte_cw_2151",
        "entity_id": ENTITY,
        "year": "2025",
        "amount_eur": FTE,
        "amount_min_eur": FTE,
...
append_csv(
    DATA / "commitments.csv",
    {
        ...
        "notes": (
            ...
            "FARO/AIESH/REW YE2024; not TE-additive of 348bn; DISTINCT VDS / HEMECO / WAPI / Hesbaye / Dinaphi / ZHC / Flemish HVZ"
        ),
    },
)
...
append_csv(
    DATA / "leaderboard.csv",
    {
        ...
        "notes": (
            ...
            "DISTINCT Val de Sambre / HEMECO / Wallonie Picarde / Hesbaye / Dinaphi / Hainaut-Centre / Brandweerzone Antwerpen / Flemish HVZ"
        ),
    },
)
...
- Unit: **{RQ}** leftover dual after **rq_2150 Val de Sambre EVERY-10**. Prefer NON-stall live: AGB Bornem still **JR2024-only**; FARO still **YE2024**; AIESH still **YE2024**; REW still **YE2024**. Took named deferred unused leftover **Zone de secours Vesdre – Hoëgne & Plateau (VHP)** (KBO **{KBO}**; Rue Simon Lobet 36 Verviers; **Hulpverleningszone** / **10 VE**; NACE **84.250**; aanbestedende overheid; ~19 communes). Do not redo Val de Sambre/HEMECO/WAPI/Hesbaye/ZHC/Dinaphi/Flemish HVZ stack.
...
- Wrote: sources (+5); budgets (+1 FTE-only); commitments (+1); leaderboard (+1 pi 5.45 opacity); entities (+1 {ENTITY}); foi + draft {GAP}; {RQ}=done + {NEXT_RQ} open; loop_state ticks={TICK}; raw docs/doge/data/raw/tick2151/.
