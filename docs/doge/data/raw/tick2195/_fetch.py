...
d = "0404745465"
assert d not in used, "Kunnig already used"
print("FREE kunnig", d)

urls = {
    "en": f"https://www.companyweb.be/en/{d}/kunnig-operations",
    "nl": f"https://www.companyweb.be/nl/{d}/kunnig-operations",
    "fr": f"https://www.companyweb.be/fr/{d}/kunnig-operations",
...
for sname, surl in [
    ("site", "https://www.kunnig.be/"),
    ("site2", "https://kunnig.be/"),
    ("contact", "https://www.kunnig.be/contact"),
    ("contact2", "https://kunnig.be/contact"),
]:
    try:
