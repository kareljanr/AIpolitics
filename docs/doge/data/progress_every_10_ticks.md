...
| **A. L0 total** | **100%** | Strong (NBB/ESA 2025 TE EUR 347.956bn) |
| **B. L1 subsectors** | **100%** of unconsol. map | Strong; fed/C&R/local/SS |
| **C. L2 entity totals** | **~99%** (order of magnitude) | **+** residual dual 1041-1050: Putte / Lede / Assenede / Sint-Gillis-Waas **EUR109.7m** / Zelzate **EUR59.5m** / Sint-Laureins **EUR54.7m** / **Hulshout EUR63.7m** · prior 1031-1040 stack retained |
| **D. L5 named / measure end-lines** | **~74-88%** of TE (generous) | **Gain 1041-1050 is VL residual dual L5 (not near-complete of 348bn):** personnel SGW **EUR16.02m** / Assenede **EUR11.18m** / Hulshout **EUR9.51m** · FOI-adjacent: **Hulshout pension JUMP EUR6.26m (+1.25m)** / BBR **EUR8.92m VERY HIGH** / invest **EUR2.59 vs MJP EUR10.74m MASSIVE UNDERSPEND** / OCMW gap **EUR1.67m** / toelagen **EUR2.54m** (police **0.961** / WZC **0.730**) / P&L **−EUR0.367m** / new loans **0** · **Sint-Laureins BBR EUR6.78m** / OCMW cover **EUR0.798m FULL** cum equity **0** · **Zelzate BBR EUR7.96m** / OCMW cover **EUR1.64m** · **SGW fin debt EUR32.51m JUMP** / new loans **EUR14.81m** / OCMW cover **EUR2.39m** · **Assenede budget −EUR1.14m** / OCMW cover **EUR1.42m** · **Lede OCMW cover 0** cum **−EUR8.94m** |
| **E. FOI-ready gaps** | **~705** drafts ready | Human send only; answered **~9**; partial **~27**; total FOI rows **~742** |

**Off-TE (do not mix into 348 bn):** federal taxex **EUR 29.7bn+** · company cars/cheque/EIWT · lottery · Tax Shelter · private PPP · equity injections · reform savings paths · **gross financing / OLO** · **debt principal repay** · **SAFE loans EUR8.34bn BE** · **Entity II HermReg soldes EUR7.9bn** · **VL/WAL/FWB/BCR debt stocks** · **Hedera CAP EUR15bn** · **MOG II / PE Island multi-bn grid** · **Metro3 multi-bn** · **university/city balance sheets** (KUL **EUR3.4bn** / Brugge **EUR1.46bn** / SGW **EUR110m** / Hulshout **EUR64m** / Zelzate **EUR60m** / Sint-Laureins **EUR55m** / prior dual stack retained not full TE) · **AGB dual AFM near-zero/NEG** · **LUWA PPP EUR590m** · private gambling **EUR31.5bn** market · Moody/S&P ratings (not euros).
...
|------|-------------:|
| budgets.csv | ~26342 |
| commitments.csv | ~3256 |
| leaderboard.csv | ~5156 |
| entities.csv | ~769 |
| sources.csv | ~1963 |
| FOI ready | ~705 |
| FOI answered | ~9 |
| FOI partial | ~27 |
| FOI total rows | ~742 |
| research_queue open | rq_116 deferred + rq_1051 hole-fill after progress |

### What improved since tick 1040

- **VL residual dual JR2025 (tick1041-1050):** Putte / Lede / Assenede / Sint-Gillis-Waas · Zelzate · Sint-Laureins · **Hulshout EUR63.7m** / pension JUMP **EUR6.26m (+1.25m)** / BBR **EUR8.92m VERY HIGH** / invest **EUR2.59 vs MJP EUR10.74m** / OCMW gap **EUR1.67m** / toelagen **EUR2.54m** (police **0.961** / WZC **0.730**) / new loans **0** / P&L **−EUR0.367m** · **Sint-Laureins OCMW cover EUR0.798m FULL** zeros equity · **Zelzate BBR EUR7.96m** · **SGW fin debt EUR32.51m** / loans **EUR14.81m** · **Assenede budget −EUR1.14m**.
- **Dual map:** HIGH-BBR no-loan cluster (Hulshout **EUR8.92m** / Sint-Laureins **EUR6.78m** / Zelzate **EUR7.96m**) vs JUMP-loan cluster (SGW **EUR14.81m**) · FULL OCMW-cover (Sint-Laureins / Zelzate / Assenede / SGW) vs structural-gap-only (Hulshout **EUR1.67m** no classic tussenkomst line) · WZC/WV grant path (Hulshout WZC **EUR0.730m**).
- **No pure-annual waste top10 reshuffle:** GIP / fossil / company cars / cheque / reporté stack remains #1-10.
...
| **A. L0 total** | **100%** | Strong (NBB/ESA 2025 TE EUR 347.956bn) |
| **B. L1 subsectors** | **100%** of unconsol. map | Strong; fed/C&R/local/SS |
| **C. L2 entity totals** | **~99%** (order of magnitude) | **+** WAL BI2026 spend **€21.34bn** / SEC **−€2.02bn** / debt gross **€30.3bn** · VMSW statutory balance **€12.38bn** / loans **€11.60bn** · KU Leuven **€3.4bn** · UGent **€1.376bn** · MOG II CAPEX class **€7–8bn** dual Elia · prior CoA consultancy ~**€0.84bn/yr** retained |
| **D. L5 named / measure end-lines** | **~61-75%** of TE (generous) | **Gain 810→820 is energy/claim/housing/Entity-II/university residual (not near-complete of 348bn):** SECAL encours **€452.7m** / advances **€38.8m** / recovery **26.6%** · flexi wage mass **€220m**/Q4 · MPKV **€321m** residual **≥€144m** · MOG II **€7–8bn** (from **€2.2bn**) · tariff path **~€800m/yr** from 2034 · Elia unilateral design **≥€1.57bn** · PEZ CfD min **€470–520m/yr** class · ISI bank-inquiry established **€2.3bn** / collected **€36m** (**1.57%**) · AGIsi total assessments **€18.7bn** · DWV R0 Noord study **€85.4m** path **€103.6m** · four-pack studies **~€133.7m** · WAL cabinets **€28.0m** · tourisme **€65.6m** · commerce ext **€76.8m** · encours eng **€6.83bn** · interest **€1.102bn** · SPW remun **€736m** · KU research **€781.9m** / Stuvo **−€10.1m** / VL cut **−€31.4m** · UGent personnel **~€667m** / result **+€61.9m** / net cash **€643m** · FOI still PEZ strike cash · ISI collection matrix · DWV change-orders · WAL FOREM/AVIQ L5 · uni first-stream grants |
| **E. FOI-ready gaps** | **~545** drafts ready | Human send only; answered **~9**; total FOI rows **~559** |

**Off-TE (do not mix into 348 bn):** federal taxex **EUR 29.7bn+** · company cars/cheque/EIWT · lottery society redistributor · Tax Shelter · private PPP · equity injections · reform *savings paths* · **gross financing / OLO** · **debt principal repay** · **SAFE loans €8.34bn BE** · **Entity II HermReg soldes €7.9bn** · **VL/WAL/FWB/BCR debt stocks** (WAL gross **€30.3bn** class) · **Hedera CAP €15bn** · **Phoenix LTO / CfD** · **Defence eng-liq / SFPIM Defence capital** · **Ukraine multi-year 1bn/yr** · **EU GNI / MFF class** · **housing finance stocks** (VMSW loans **€11.6bn**) · **MOG II / PE Island multi-bn grid** (tariff path not TE until booked) · **Regie rent/DBFM lock-in** · **Metro3 multi-bn stock** · **university balance sheets** (KUL **€3.4bn** / UGent **€1.38bn** not full TE) · **private gambling stakes €31.5bn** (market) · Moody/S&P rating actions (not euros).
...
|------|-------------:|
| budgets.csv | ~16900 |
| commitments.csv | ~2273 |
| leaderboard.csv | ~3650 |
| entities.csv | ~570 |
| sources.csv | ~1618 |
| FOI ready | ~545 |
| FOI answered | ~9 |
| FOI total rows | ~559 |
| research_queue open | rq_116 deferred + rq_812 hole-fill after progress |

### What improved since tick 810

- **SECAL + flexi + kust (tick811):** encours **€452.7m** · impairment **€403.3m** · recovery **26.6%** · advances **€38.8m** · flexi **€220m** Q4 · MPKV **€321m** / residual **≥€144m** · Kustvisie **€2–5bn** class.
- **MOG II / PEZ energy (tick812):** CAPEX **€2.2→7–8bn** · tariff **~€800m/yr** · Elia unilateral **≥€1.57bn** · PEZ CfD **€470–520m/yr** class · EIB island **€650m**/€1.105bn · lot1 appraisal **€1bn**/€2.5bn.
- **VMSW housing finance (tick813):** balance **€12.38bn** · loans **€11.60bn** · FS3 draw **€1bn** · capital-subs stock **€813m** · Ukraine units **€40.8m**.
- **ISI bank data CoA (tick814):** bank-inquiry assessments **€2.3bn** / collected **€36m** (**1.57%**) · AGIsi total **€18.7bn** · PCC **55.3m** accounts · dual SECAL recovery.
- **DWV studies CoA (tick815):** R0 Noord **€85.4m**/€103.6m · four-pack **~€133.7m** · OP posts **€9.4m** · R4 +44% · dual GIP.
- **WAL BI2026 + L5 tables (tick816–817):** spend **€21.34bn** · SEC **−€2.02bn** · debt gross **€30.3bn** · interest **€1.102bn** · cabinets **€28.0m** · tourisme **€65.6m** · commerce **€76.8m** · encours **€6.83bn**.
- **Universities dual (tick818–819):** KU Leuven **€3.4bn** / research **€781.9m** / VL cut **−€31.4m** / Stuvo **−€10.1m** · UGent **€1.376bn** / equity **€902m** / result **+€62m** / personnel **~€667m** / net cash **€643m**.
- **Dual map:** ISI collection vs SECAL recovery · MOG II tariff vs PEZ CfD · VMSW vs WAL housing · DWV vs GIP · WAL vs FWB cabinets/SEC · KU Leuven vs UGent HE books.
