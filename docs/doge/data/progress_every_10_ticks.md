...
| **E. FOI-ready gaps** | **~1774** drafts ready | Human send only; answered **~11**; partial **~28**; total FOI rows **~1826** |
...
|------|-------------:|
| budgets.csv | 52814 |
| commitments.csv | 5824 |
| leaderboard.csv | 7945 |
| entities.csv | 1855 |
| sources.csv | 5680 |
| FOI ready | 1774 |
| FOI answered | 11 |
| FOI partial | 28 |
| FOI total rows | 1826 |
| research_queue open | rq_2151 after progress |
