...
| budgets.csv | ~8302 |
| commitments.csv | ~832 |
| leaderboard.csv | ~1551 |
| entities.csv | ~398 |
| sources.csv | ~831 |
| FOI ready | ~223 |
| FOI answered | ~9 |
| FOI total rows | ~234 |
| research_queue | ~456 (open: rq_116 deferred + hole-fill after progress) |
...
| budgets.csv | ~8160 |
| commitments.csv | ~814 |
| leaderboard.csv | ~1489 |
| entities.csv | ~371 |
| sources.csv | ~800 |
| FOI ready | ~217 |
| FOI answered | ~9 |
| FOI total rows | ~227 |
| research_queue | ~448 (open: rq_116 deferred + hole-fill after progress) |
