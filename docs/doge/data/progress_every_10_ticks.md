...
| **A. L0 total** | **100%** | Strong (NBB/ESA 2025 TE EUR 347.956bn) |
| **B. L1 subsectors** | **100%** of unconsol. map | Strong; fed/C&R/local/SS |
| **C. L2 entity totals** | **~99%** (order of magnitude) | **+** post-650 wave: AViQ branch **7.256bn** · CAF stack **~2.69bn** · solde SEC **−2.287bn** · fonds budg **530m**/report **1.75bn** · traj to **+58m 2029** · CSF NPE dual · prior finance/UAP/DO mega retained |
| **D. L5 named / measure end-lines** | **~46-59%** of TE (generous) | **Gain 650→660 is WAL CoA dual governance/fiscal/HR/social residual:** IPP **€3.74bn** + enreg reform · nonfiscal **€872m**/remonte **€537m** · CAF private **€1.58bn** dual Groeipakket · ports+DO02/09 · AViQ non-marchand **€276m**/Papy-boom residual · **119quater** UAP **€34.4m** vs SPW net **€15.9m** · revent eng **€2.36bn** specialty · sous-util squeeze **€148m** · traj SEC **−€2.29bn→+€58m** · debt ratio **190%** · CSF WAL NPE **1.32%** / 2026 **0.90%** · BA2024 **+€806m** · titres **€568m**/RSC **+€40m** · FOI still bulk L5 awards + dual unit-cost matrices |
| **E. FOI-ready gaps** | **~402** drafts ready | Human send only; answered **~9**; total FOI rows **~412** (+ IPP · nonfiscal/WE · CAF · ports · AViQ branch · 119quater/specialty · solde/fonds · traj/debt · CSF/BA2024/emploi · dual wave 651–660 matrix · …) |

**Off-TE (do not mix into 348 bn):** federal taxex **EUR 29.7bn** · company cars/cheque/EIWT · lottery · Tax Shelter · private PPP · equity injections · reform *savings paths* · **gross financing / OLO** · **unconsol federal debt** · **WAL direct debt stock ~€30–34bn** path / VL Maastricht **€50.2bn** · **encours stock €7.57bn** (+ incomplete **€2.08bn**) · **fonds stocks** (report liq **€1.75bn** · Kyoto **445m** · env **495m** · déchets **221m** · RDI **171m**) · UAP treasury remonte **€537–576m** · WE equity **~5bn** · SPAQuE/Sowaer BS · FRR/RePower conditional · **CSF NPE growth caps** (rates not euros) · hospital debt unalloc **€3.9bn**.
...
|------|-------------:|
| budgets.csv | ~12256 |
| commitments.csv | ~1395 |
| leaderboard.csv | ~2666 |
| entities.csv | ~498 |
| sources.csv | ~1300 |
| FOI ready | ~402 |
| FOI answered | ~9 |
| FOI total rows | ~412 |
| research_queue open | rq_116 deferred + rq_652 hole-fill after progress |

### What improved since tick 650

- **Fiscal + nonfiscal (tick651–652):** IPP regional **€3.74bn** / dep fiscales **€883m** dual VL · enreg reform path · nonfiscal diverses **€872m** (remonte UAP **€537m**) · WE Type3 residual dual PMV · PP night overstate residual.
- **Social duals (tick653–655):** CAF private aggregate **€1.58bn** (Parentia/Camille/Infino) + Famiwal **€1.11bn** stack **~€2.69bn** dual Groeipakket · Type3 annex gap **46/112** · ports PAC+PACO **€12.4m** dual Waterweg · AViQ Table34 dep **€7.256bn** / non-marchand **€276m** / Papy-boom residual beds dual VAPH · Parlement DO01 **€77.4m**.
- **HR + budget governance (tick656–657):** UAP **119quater overcost €34.4m** vs SPW net **€15.9m** · specialty revent eng **€2.36bn** 2023 · sous-util SG **€609m** / UAP squeeze **€148m** · factures shift **€248m** · fonds budg rec **€530m** / report liq **€1.75bn** · solde SEC **−€2.287bn** dual VL.
- **Trajectory + EU dual (tick658–659):** SEC path **−€2.286bn → +€58m 2029** · debt **€25.3→34.1bn** / ratio **190%** · interest **€605m** / +1% **€44m** · Moody A3 negative · CSF NPE dual (WAL **1.32%** avg / **0.90%** 2026) · BA2024 **+€806m CE** · titres **€568m** / RSC path **+€40m** dual VDAB · MTFSP gap Nov2024 (4y ref).
