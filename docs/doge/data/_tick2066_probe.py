# ephemeral probe tick2066 — claim + Deinze/Leiehome
import csv
import re
import ssl
import sys
...
cands = [
    ...
    ("deinze", "https://www.companyweb.be/en/0454090355/bejaardenzorg-zusters-sint-vincentius"),
    ("deinze2", "https://www.companyweb.be/en/0454090355"),
    ("leiehome", "https://www.companyweb.be/en/0410556557/leiehome"),
]
...
for n, k in [("0454090355", "0454090355"), ("bejaardenzorg", ""), ("zusters sint-vincentius", "")]:
    hits = [
        e.get("entity_id")
        for e in ents
