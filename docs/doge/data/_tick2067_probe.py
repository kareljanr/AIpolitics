# ephemeral probe tick2067 — claim + stalls + Leiehome
import csv
import re
import ssl
import sys
...
for n, k in [("leiehome", "0410556557"), ("compostela", "0432401155"), ("vulpia", "0521970559"), ("always_home", "0821289991")]:
    hits = [
        e.get("entity_id")
        for e in ents
