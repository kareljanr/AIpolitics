# ephemeral probe tick2042 — preferred leftovers + unused psych/WZC/hospital
import re
import ssl
...
urls = [
    ...
    ("de_verlosser_en", "https://www.companyweb.be/en/0446340946/woonzorgcentrum-de-verlosser"),
