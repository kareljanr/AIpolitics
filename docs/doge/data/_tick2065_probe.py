# ephemeral probe tick2065 — claim rq_2065 + probe candidates
import csv
import re
import ssl
import sys
...
if st == "open":
    ...
    print("CLAIMED rq_2065 in_progress")
else:
    print("ALREADY in_progress rq_2065")
...
for n, k in [
    ("leiehome", "0410556557"),
    ("compostela", "0432401155"),
    ("always_home", "0821289991"),
    ("always home", "0821289991"),
    ("vulpia", "0521970559"),
]:
    hits = [
        e.get("entity_id")
