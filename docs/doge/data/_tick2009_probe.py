# ephemeral tick2009 — claim + prefer stall checks + unused hospital YE2025
import csv
import re
import ssl
import sys
...
r = next(x for x in rows if x.get("task_id") == "rq_2009")
...
urls = [
    ...
    ("zottegem_en", "https://www.companyweb.be/en/0418558166/algemeen-ziekenhuis-sint-elisabeth-zottegem"),
    ("zottegem_nl", "https://www.companyweb.be/nl/0418558166/algemeen-ziekenhuis-sint-elisabeth-zottegem"),
    ("palfijn_en", "https://www.companyweb.be/en/0406583319"),
    ("palfijn_nl", "https://www.companyweb.be/nl/0406583319"),
    ...
    ("waregem_en", "https://www.companyweb.be/en/0405460592"),
    ("waregem_nl", "https://www.companyweb.be/nl/0405460592"),
]
