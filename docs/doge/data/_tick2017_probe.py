# ephemeral tick2017 — claim + prefer AGB/FARO/AIESH/REW else unused hospital
import csv
import re
import ssl
import sys
...
r = next(x for x in rows if x.get("task_id") == "rq_2017")
...
targets = [
    ...
    ("rivierenland_az_en", "https://www.companyweb.be/en/0455868415"),
