...
KBO = "0407.841.646"
KBO_BARE = "0407841646"
SRC_EN = "src_vdg_jr2025_cw_en"
GAP = "gap_vdg_nbb_pdf_assets_debt_pnl_drop_22pct_fte_241_eta_matrix_l5"
COMM = "comm_vdg_jr2025_statutory_eta_omzet_pnl_drop_22pct"
LB = "lb_vdg_omzet_10_75m_pnl_drop_22pct_fte_241_jr2025"
RQ = "rq_2258"
RQ_NEXT = "rq_2259"
        ...
        rows.append(
            {
                ...
                "instructions": (
                    ...
                    "else unused ETA/VAPH/WZC/maatwerk (e.g. Les Erables / Alteria / Stallbois if YE2025 FREE; "
                    "skip Val du Geer/Nekto/Belair/Corelap/Cambier/Gaillettes/Hunelle/Dauphins Gembloux/Saupont/"
    ...
    rows[0].update(
        {
            ...
            "notes": (
                ...
                f"pnl DROP {PNL} {PNL_PCT}%; bruto JUMP {BRUTO}; equity JUMP {EQUITY}; FTE {FTE}; 4 VE Bassenge ETA); "
                f"after Nekto@2257; AGB Bornem JR2024; FARO/AIESH/REW YE2024; Relais Haute Sambre YE2024; "
                f"deferred FREE Les Erables; next {RQ_NEXT}; next EVERY-10 2260; continuous hole_fill"
            ),
        }
    )
    with path.open("w", newline="", encoding="utf-8") as f:
...
def write_foi_draft():
    ...
    (FOI / f"{GAP}.md").write_text(
        f"""# FOI draft — Val du Geer (NBB PDF / pnl DROP {PNL_PCT}% / FTE {FTE})
...
**sources:** [CW EN](https://www.companyweb.be/en/{KBO_BARE}) · [CW NL](https://www.companyweb.be/nl/{KBO_BARE}) · [CW FR](https://www.companyweb.be/fr/{KBO_BARE}) · [KBO](https://kbopub.economie.fgov.be/kbopub/zoeknummerform.html?lang=nl&nummer={KBO_BARE}) · [site](https://www.valdugeer.be/)  
**tick:** {TICK}  
**confidence:** Medium (Strong KBO + Medium CW YE2025; assets/debt Unknown)

## Context
- KBO Strong: Actief VZW/ASBL VAL DU GEER; **4 VE**; zetel Bassenge; NACE **88.993** (+88.995); replaces 0410.523.103.
- CW YE2025: omzet **EUR{OMZET:,}** DROP {OMZET_PCT}% vs YE2024 EUR{OMZET24:,}; bruto **EUR{BRUTO:,}** JUMP +{BRUTO_PCT}% (bruto/omzet ~{RATIO}x); pnl **EUR{PNL:,}** DROP {PNL_PCT}% vs YE2024 EUR{PNL24:,}; equity **EUR{EQUITY:,}** JUMP +{EQUITY_PCT}%; FTE **{FTE}**; filed **09.06.2026**.
...
5. Répartition coûts vêtements / emballages bois / métallurgie / 4 VE.
...
- Found: Companyweb NL+EN+FR YE2025 - omzet **EUR{OMZET}** DROP {OMZET_PCT}% vs YE2024 EUR{OMZET24}; bruto **EUR{BRUTO}** JUMP +{BRUTO_PCT}% (bruto/omzet ~{RATIO}x); pnl **EUR{PNL}** DROP {PNL_PCT}% vs YE2024 EUR{PNL24}; equity **EUR{EQUITY}** JUMP +{EQUITY_PCT}%; FTE **{FTE}**; neerlegging **09.06.2026**. Strong KBO Actief 4 VE. Assets/debt Unknown. Medium. FOI via info@valdugeer.be.
- Wrote: sources (+5); budgets (+6); commitments (+1); leaderboard (+1 pi 6.35); entities (+1 {ENTITY}); foi + draft {GAP}; rq_2258=done + rq_2259 open; loop_state ticks={TICK}; raw docs/doge/raw/tick2258/.
...
def main():
    append_csv(
        ...
        [
            {
                "source_id": "src_vdg_jr2025_cw_nl",
                ...
                "notes": (
                    ...
                    f"bruto {BRUTO} FTE {FTE}; neerlegging 09.06.2026; assets/debt Unknown; "
            ...
            {
                "source_id": "src_vdg_jr2025_cw_fr",
            ...
            },
            {
                ...
                "notes": (
                    ...
                    f"4 VE; NACE 88.993/88.995; begindatum 18.10.1964; replaces 0410.523.103; KBO email empty"
                ),
            },
            {
                "source_id": f"src_vdg_site_contact_{TICK}",
                "title": "Val du Geer FOI channel info@valdugeer.be",
                "url": "https://www.valdugeer.be/",
                "publisher": "Val du Geer ASBL",
                "accessed_date": DATE,
                "source_class": "foi_contact",
                "notes": (
                    f"tick{TICK}; info@valdugeer.be / cv@valdugeer.be; Rue de la Cerisaie 8 4690 Bassenge; "
                    "also leseta.be annuaire"
                ),
            },
        ],
    )
    ...
    append_csv(
        ...
        [
            {
                "budget_id": "bud_vdg_omzet_jr2025_statutory",
                "entity_id": ENTITY,
                "year": "2025",
            ...
            {
                "budget_id": "bud_vdg_bruto_jr2025_statutory",
                "entity_id": ENTITY,
                "year": "2025",
            ...
            {
                "budget_id": "bud_vdg_pnl_jr2025_statutory",
                "entity_id": ENTITY,
                "year": "2025",
                "amount_eur": str(PNL),
            ...
            {
                "budget_id": "bud_vdg_equity_jr2025_statutory",
                "entity_id": ENTITY,
                "year": "2025",
            ...
            {
                "budget_id": "bud_vdg_fte_jr2025_statutory",
                "entity_id": ENTITY,
                "year": "2025",
                "amount_eur": str(FTE),
            ...
            {
                "budget_id": "bud_vdg_omzet_jr2024_statutory_cmp",
                "entity_id": ENTITY,
                "year": "2024",
        ...
        [
            {
                ...
                "stated_goal": "Walloon ETA clothing / wood packaging / metal Bassenge",
                "cut_option": (
                    "Publish NBB PDF assets/debt FOI; reconcile pnl DROP -22% vs AVIQ ETA subsidy matrix; "
                    "disclose 4-VE cost allocation"
                ),
                "source_id": SRC_EN,
                "confidence": "medium",
                ...
                "notes": (
                    ...
                    f"FTE {FTE}; 4 VE; after Nekto@2257; AGB Bornem JR2024; FARO/AIESH/REW YE2024; "
        ...
        [
            {
                ...
                "stated_goal": "Walloon ETA clothing / wood packaging / metal",
                "measured_outcome": (
                ...
                "cut_proposal": (
                    ...
                    "reconcile pnl DROP -22% + 4-VE allocation"
                ),
                "status": "open",
                "struck_reason": "",
                "notes": (
    ...
    append_csv(
        ...
        [
            {
                "entity_id": ENTITY,
                "name_nl": "Val du Geer VZW (Bassenge / ETA maatwerk Luik)",
                "name_fr": "Val du Geer ASBL (Bassenge / entreprise de travail adapté Liège)",
                ...
                "notes": (
                    ...
                    f"equity JUMP {EQUITY} FTE {FTE}; neerlegging 09.06.2026; assets/debt Unknown; FOI {GAP}; "
                    "preferred stalls AGB Bornem JR2024; FARO/AIESH/REW YE2024; after Nekto@2257; "
                    "not TE-additive of 348bn"
                ),
            }
        ],
    ...
    append_csv(
        ...
        [
            {
                "gap_id": GAP,
                "hierarchy_path": "Wallonie>Liege>Bassenge>ValDuGeer>NBB_PDF_assets_debt_pnl_drop_fte",
                "entity_id": ENTITY,
                "what_is_missing": (
                    ...
                    f"FTE {FTE}; AVIQ ETA subsidy matrix; 4-VE cost allocation"
                ),
                "why_it_matters": (
                    f"Medium CW shows large Walloon ETA ASBL (omzet 10.75m / pnl DROP {PNL_PCT}% / FTE {FTE} / 4 VE) "
