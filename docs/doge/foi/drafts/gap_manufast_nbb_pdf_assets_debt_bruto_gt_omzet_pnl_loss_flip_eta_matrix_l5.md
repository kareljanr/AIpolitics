# FOI draft — Manufast-ABP (NBB PDF / bruto≫omzet ~1.87x / pnl LOSS FLIP)

**gap_id:** `gap_manufast_nbb_pdf_assets_debt_bruto_gt_omzet_pnl_loss_flip_eta_matrix_l5`  
...
2. Composition marge brute EUR6254925 vs chiffre d'affaires EUR3337881 (~1.87x).
3. PnL LOSS FLIP EUR-299652 vs bénéfice YE2024 EUR949872 — réconciliation avec equity DROP −27,53% et FTE DROP.
4. Matrice des subsides CoCoF / ETA derrière la marge brute EUR6254925.
5. Explication du rétrécissement structurel vs YE2023 (CA ~EUR7,94m / FTE 357,6).

Période YE2025 (+ comparative YE2024/YE2023). Réf: gap_manufast_nbb_pdf_assets_debt_bruto_gt_omzet_pnl_loss_flip_eta_matrix_l5
